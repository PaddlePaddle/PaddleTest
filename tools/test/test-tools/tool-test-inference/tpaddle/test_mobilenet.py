...
def check_model_exist():
    ...
    check model exist
    """
    resnet50_url = "https://paddle-qa.bj.bcebos.com/inference_model/2.0/class/MobileNetV1.tgz"
    if not os.path.exists("./MobileNetV1/model.pdmodel"):
        wget.download(resnet50_url, out="./")
        tar = tarfile.open("MobileNetV1.tgz")
        tar.extractall()
        tar.close()
...
def test_config():
    ...
    test_suite.load_config(model_file="./MobileNetV1/model.pdmodel", params_file="./MobileNetV1/model.pdiparams")
...
def test_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1-10 MobileNetV1 outputs with true val
    """
    check_model_exist()

    file_path = "./MobileNetV1"
    images_size = 224
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite2.load_config(model_file="./MobileNetV1/model.pdmodel", params_file="./MobileNetV1/model.pdiparams")
...
def test_trt_fp32_bz1_multi_thread():
    """
    compared trt fp32 batch_size=1 MobileNetV1 multi_thread outputs with true val
    """
    check_model_exist()
...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1-10 MobileNetV1 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp16_bz1_multi_thread():
    """
    compared trt fp16 batch_size=1 MobileNetV1 multi_thread outputs with true val
    """
    check_model_exist()
...
def test_mkldnn():
    """
    compared mkldnn MobileNetV1 outputs with true val
    """
    check_model_exist()
...
def test_gpu_bz1():
    """
    compared trt gpu batch_size=1-10 MobileNetV1 outputs with true val
    """
    check_model_exist()
