...
def get_cmd_output(cmd):
    ...
    if commit_id:
        ...
        cmd = "python -m pip uninstall -y paddlepaddle-gpu; python -m pip install -U https://paddle-qa.bj.bcebos.com/paddle-pipeline/\
Develop-GpuAll-LinuxCentos-Gcc82-Cuda112-Trtoff-Py38-Compile/%s/\
paddlepaddle_gpu-0.0.0-cp38-cp38-linux_x86_64.whl -i https://mirror.baidu.com/pypi/simple" % (commit_id)
        os.system(cmd)
...
def run(args):
    ...
    # os.system('python -m pip install paddlepaddle-gpu==2.4.2.post112 -f https://www.paddlepaddle.org.cn/whl/linux/mkl/avx/stable.html -i https://mirror.baidu.com/pypi/simple')
