...
/***************************************************************************
  ...
  * @file dist_rpc_get_worker_info.py
...
def test_rpc_get_worker_info():
    ...
    if paddle.distributed.ParallelEnv().local_rank == 0:
        ...
        result_worker0 = rpc.get_worker_info("worker0")
        print(result_worker0)
    else:
        os.environ["PADDLE_WORKER_ENDPOINT"] = "127.0.0.1:9003"
        rpc.init_rpc("worker1", rank=1, world_size=2, master_endpoint="127.0.0.1:8004")
        result_worker1 = rpc.get_worker_info("worker1")
        print(result_worker1)

    rpc.shutdown()

    print("test_rpc_get_worker_info ... ok")
