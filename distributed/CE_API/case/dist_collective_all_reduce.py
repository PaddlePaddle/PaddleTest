...
/***************************************************************************
  ...
  * @file dist_collective_all_reduce.py
...
def test_collective_all_reduce_sum():
    ...
    for t in types:
        ...
        assert out[0][0] == 5
        assert len(out) == 2
        print("test_collective_all_reduce_sum %s... ok" % t)


@run_priority(level="P0")
def test_collective_all_reduce_max():
    ...
    for t in types:
        ...
        assert out[0][0] == 4
        assert len(out) == 2
        print("test_collective_all_reduce_max %s... ok" % t)


@run_priority(level="P0")
def test_collective_all_reduce_min():
    ...
    for t in types:
        ...
        assert out[0][0] == 1
        assert len(out) == 2
        print("test_collective_all_reduce_min %s... ok" % t)


@run_priority(level="P0")
def test_collective_all_reduce_prod():
    ...
    for t in types:
        ...
        assert out[0][0] == 4
        assert len(out) == 2
        print("test_collective_all_reduce_prod %s... ok" % t)
