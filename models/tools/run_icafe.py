...
def create_issue(title,detail,repo,password, AGILE_PULL_ID, xly_link, type="Bug",emailto=["jiaxiao01@baidu.com",],owner="jiaxiao01"):
     """
     creat issue
     """
...
if __name__=="__main__":
        ...
        xly_link="https://xly.bce.baidu.com/paddlepaddle/"+keyword+"/newipipe/detail/"+AGILE_PIPELINE_BUILD_ID+"/job/"+AGILE_JOB_BUILD_ID
