...
if [ ${tmp_exit_code} -eq 0 ]; then
    echo "ppdiffusers/deploy/ipadapter/sd15 ipadapter_sd15_export_model success" >>"${log_dir}/ce_res.log"
else
    echo "ppdiffusers/deploy/ipadapter/sd15 ipadapter_sd15_export_model fail" >>"${log_dir}/ce_res.log"
fi
echo "*******ppdiffusers/deploy/ipadapter/sd15 ipadapter_sd15_export_model end***********"
