...
python tools/main.py -c configs/dcgan_mnist.yaml -o total_iters=100 log_config.interval=10 > log/dcgan_mnist_1card.log 2>&1
cat log/dcgan_mnist_1card.log | grep " INFO: Iter: 100/100" > ../log/dcgan_mnist_1card.log
