...
python -m paddle.distributed.launch tools/main.py -c configs/esrgan_psnr_x4_div2k.yaml -o total_iters=100 log_config.interval=10 > log/esrgan_psnr_x4_div2k_2card.log 2>&1
cat log/esrgan_psnr_x4_div2k_2card.log | grep " INFO: Iter: 100/100" > ../log/esrgan_psnr_x4_div2k_2card.log
