...
python tools/main.py -c configs/starganv2_afhq.yaml -o total_iters=100 log_config.interval=10 > log/starganv2_afhq_1card.log 2>&1
cat log/starganv2_afhq_1card.log | grep " INFO: Iter: 100/100" > ../log/starganv2_afhq_1card.log
