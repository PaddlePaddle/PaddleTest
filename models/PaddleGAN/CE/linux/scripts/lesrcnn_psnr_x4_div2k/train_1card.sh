...
python tools/main.py -c configs/lesrcnn_psnr_x4_div2k.yaml -o total_iters=100 log_config.interval=10 > log/lesrcnn_psnr_x4_div2k_1card.log 2>&1
cat log/lesrcnn_psnr_x4_div2k_1card.log | grep " INFO: Iter: 100/100" > ../log/lesrcnn_psnr_x4_div2k_1card.log
