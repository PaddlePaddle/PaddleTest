...
python tools/main.py -c configs/edvr_m_wo_tsa.yaml -o total_iters=100 log_config.interval=10 > log/edvr_m_wo_tsa_1card.log 2>&1
cat log/edvr_m_wo_tsa_1card.log | grep " INFO: Iter: 100/100" > ../log/edvr_m_wo_tsa_1card.log
