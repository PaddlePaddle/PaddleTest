...
python -m paddle.distributed.launch tools/main.py -c configs/edvr_l_wo_tsa.yaml -o total_iters=100 log_config.interval=10 > log/edvr_l_wo_tsa_2card.log 2>&1
cat log/edvr_l_wo_tsa_2card.log | grep " INFO: Iter: 100/100" > ../log/edvr_l_wo_tsa_2card.log
