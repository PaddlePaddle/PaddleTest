...
cd config
rm -rf $model_release.yaml
cp -r edvr_m_wo_tsa_release.yaml $model_release.yaml
sed -i "" "s|config/edvr_m_wo_tsa_release_release.yaml|$line|g" $model_release.yaml
sed -i "" s/edvr_m_wo_tsa/$model/g $model_release.yaml
...
#     sed -i "" "s|P0_release|P1_release|g" $model_release.yaml 
#     sed -i "" "s|6.43611|0.0|g" $model_release.yaml #linux_train_单卡
#     sed -i "" "s|6.62874|0.0|g" $model_release.yaml #linux_train_多卡
#     sed -i "" "s|0.93207|0.0|g" $model_release.yaml #linux_eval
#     sed -i "" "s|16.04218|0.0|g" $model_release.yaml #linux_train_eval

#     sed -i "" "s|6.81317|0.0|g" $model_release.yaml #windows_train
#     sed -i "" "s|0.93661|0.0|g" $model_release.yaml #windows_eval
#     sed -i "" "s|190.68218|0.0|g" $model_release.yaml #windows_train_eval
