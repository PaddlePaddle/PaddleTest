...
cp -r edvr_m_wo_tsa_release.yaml ${model}_release.yaml
sed -i "" "s|config/edvr_m_wo_tsa_release_release.yaml|$line|g" ${model}_release.yaml
sed -i "" s/edvr_m_wo_tsa/${model}/g ${model}_release.yaml
...
if [[ ${model} == 'ugatit_photo2cartoon' ]]; then
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    ...
    sed -i "" "s|9151.643|0.022|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|9151.643|0.044|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|P0_releas|P0_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|loss_pix|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|0.164|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.172|g" ${model}_release.yaml #linux_train_多卡

elif [[ ${model} == 'singan_finetune' ]]; then
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|scale1/D_gradient_penalty|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|0.156|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.156|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|scale9/D_gradient_penalty|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|0.119|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.119|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|P0_releas|P0_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|loss_pixel|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|11.331|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|9.658|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|loss_pixel|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|0.255|g" ${model}_release.yaml #linux_train_单卡
    ...
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|loss_pixel|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|8268.696|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|8860.704|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|9151.643|5.725|g" ${model}_release.yaml #linux_train_多卡

elif [[ ${model} == 'msvsr_reds' ]]; then
    sed -i "" "s|P0_releas|P0_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|loss_pix|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|0.024|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.054|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|loss_pixel|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|10505.313|g" ${model}_release.yaml #linux_train_单卡
    ...
    sed -i "" "s|8462.812|0.206|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.206|g" ${model}_release.yaml #linux_train_多卡

elif [[ ${model} == 'singan_animation' ]]; then
    sed -i "" "s|P0_releas|P1_releas|g" ${model}_release.yaml
    sed -i "" "s|loss_pixel|scale6/D_gradient_penalty|g" ${model}_release.yaml #指标
    sed -i "" "s|8462.812|0.269|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.269|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|9151.643|19116.625|g" ${model}_release.yaml #linux_train_多卡
    ...
    sed -i "" "s|8462.812|0.447|g" ${model}_release.yaml #linux_train_单卡
    sed -i "" "s|9151.643|0.454|g" ${model}_release.yaml #linux_train_多卡
...
# sed -i "" "s|threshold: 0|threshold: 0.0 #|g" config/*_release.yaml
# sed -i "" "s|kpi_base: 0|kpi_base: 0.0 #|g" config/*_release.yaml


# sed -i "" "s|"-"|"="|g" config/*_release.yaml
# # sed -i "" "s|infer_linux,eval_linux,infer_linux|infer_linux,eval_linux|g" config/AlexNet_release.yaml
# sed -i "" "s|infer_linux,eval_linux|eval_linux,infer_linux|g" config/*_release.yaml


# sed -i "" "s|"="|"-"|g" config/*_release.yaml #错误
# sed -i "" 's|"="|"-"|g' config/AlexNet_release.yaml
# sed -i "" 's|"="|"-"|g' config/*_release.yaml


# sed -i "" "s|function_test|linux_function_test|g" config/AlexNet_release.yaml
# sed -i "" 's|exec_tag:|exec_tag: $EXEC_TAG #|g' config/AlexNet_release.yaml
