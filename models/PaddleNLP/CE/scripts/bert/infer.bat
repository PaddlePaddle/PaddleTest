...
python -u ./predict_glue.py --task_name SST2 --model_type bert --model_path ./infer_model/model --batch_size 32 --max_seq_length 128 > %logpath%\bert_win_predict.log 2>&1
