...
python -u predict.py --device %1 --params_path "./checkpoints/model_10/model_state.pdparams" --batch_size 16 --input_file ./test/public_test_A --result_file "predict_result" > %logpath%\infer_%1.log 2>&1
