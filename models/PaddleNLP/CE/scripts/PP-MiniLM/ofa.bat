...
python export_model.py --model_type ppminilm --model_name_or_path pruned_models/%3/0.75/best_model --sub_model_output_dir pruned_models/%3/0.75/sub/  --static_sub_model pruned_models/%3/0.75/sub_static/float  --n_gpu 1 --width_mult 0.75
