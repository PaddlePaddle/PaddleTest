...
if "%3"=="point-wise" (
    ...
    python -u -m paddle.distributed.launch --gpus %2 train_pairwise.py --device %1 --save_dir ./checkpoints/%3 --batch_size 32 --epochs 1 --save_step 10 --max_step 30 --learning_rate 2E-5 > %logpath%/train_%3_%1.log 2>&1
)
