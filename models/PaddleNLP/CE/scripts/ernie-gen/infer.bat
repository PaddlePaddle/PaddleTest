...
python -u ./predict.py --model_name_or_path ernie-1.0 --max_encode_len 24 --max_decode_len 72 --batch_size 48 --init_checkpoint tmp\model_1000\model_state.pdparams --device %1 > %logpath%/infer_%1.log 2>&1
