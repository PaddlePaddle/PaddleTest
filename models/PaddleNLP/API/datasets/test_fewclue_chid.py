...
def get_examples(mode='train'):
    ...
    examples = {
        'train':
        ({"id": 242, "candidates": ["风云人物", "气势汹汹", "予取予求", "乘龙佳婿", "正中下怀", "天方夜谭", "心如刀割"], "content": "据俄罗斯卫星通讯社3月15日报道,新八国联军#idiom#逼近附近海域,但是军舰却遭岸舰导弹锁定,英承认今非昔比。 最近一段时间,北约多个国家开始频繁进行军事演习,来对其他国家进行威慑。3月12日当天,英国出动了兰开斯特号、威斯敏斯特号...", "answer": 1})
    }
