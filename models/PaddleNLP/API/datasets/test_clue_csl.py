...
def get_examples(mode="train"):
    ...
    examples = {
        "train": (
            {
                "id": 1,
                "abst": "目的探讨常见氧化铁纳米粒子几种神经干细胞标记技术的标记效率.材料与方法使用超顺磁性氧化铁纳米粒子(SPIO)和超微超顺磁性氧化铁纳米粒子(USPIO)以25μgFe/ml分别单独标记、"
                ...
                "联合标记时R2高于USPIO(P＜0.05).结论SPIO、USPIO单独标记及与PLL、脂质体联合标记均可以成功标记神经干细胞,提高R2,其中SPIO与PLL联合标记效率最高.",
                "keyword": ["粒子", "铁化合物", "联合", "0.05"],
                "label": "0",
            }
        ),
        "dev": (
