...
def get_examples(mode='train'):
    ...
    examples = {
        'train':
        ({"level": "hard", "sentence1": "七五期间开始,国家又投资将武汉市区的部分土堤改建为钢筋泥凝土防水墙", "sentence2": "八五期间会把剩下的土堤都改建完", "label": "neutral", "label0": "null", "label1": "null", "label2": "null", "label3": "null", "label4": "null", "genre": "news", "prem_id": "news_1553", "id": 0}),
        'dev':
