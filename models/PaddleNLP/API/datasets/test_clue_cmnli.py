...
def get_examples(mode="train"):
    ...
    """
    examples = {
        "train": ({"sentence1": "从概念上讲，奶油略读有两个基本维度-产品和地理。", "sentence2": "产品和地理位置是使奶油撇油起作用的原因。", "label": "neutral"}),
        "test": ({"sentence1": "新的权利已经足够好了", "sentence2": "每个人都很喜欢最新的福利", "label": "neutral"}),
        "dev": ({"id": 0, "sentence1": "最近，全世界都在看着最新的航天飞机进行处女航。", "sentence2": "全世界都在看着最近的航天飞机发射。"}),
    }
