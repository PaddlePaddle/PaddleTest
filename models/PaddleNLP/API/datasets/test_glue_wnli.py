...
def get_examples(mode='train'):
    ...
    examples = {
        'train':
        ({'sentence1': 'I stuck a pin through a carrot. When I pulled the pin out, it had a hole.', 'sentence2': 'The carrot had a hole.', 'labels': 1}),
        'dev':
        ({'sentence1': 'The drain is clogged with hair. It has to be cleaned.', 'sentence2': 'The hair has to be cleaned.', 'labels': 0}),
        'test':
        ({'sentence1': 'Maude and Dora had seen the trains rushing across the prairie, with long, rolling puffs of black smoke streaming back from the engine. Their roars and their wild, clear whistles could be heard from far away. Horses ran away when they came in sight.', 'sentence2': 'Horses ran away when Maude and Dora came in sight.'}),
    }
