...
def get_examples(mode='train'):
    ...
    examples = {
        'train':
        ({"id": 0, "abst": "无线传感器网络中实现隐私保护通用近似查询是具有挑战性的问题．文中提出一种无线传感器网络中隐私保护通用近似查询协议PGAQ．PGAQ将传感器节点编号和其采集数据隐藏于设计的数据结构中，"
        ...
        "PGAQ的安全性和有效性．", "keyword": ["无线传感器网络", "数据聚集", "物联网", "近似查询"], "label": "1"}),
        'dev':
