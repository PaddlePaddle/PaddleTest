...
def get_examples(mode="train"):
    ...
    examples = {
        "train": (
            {
                "label": "11",
                "label_des": "薅羊毛",
                "sentence": "活动新用户领5元现金即日起成功注册酷划的新用户，填写邀请码80008即可领取5元现金奖励哦。小伙伴们不要错过，赶快来酷划锁屏领红包吧~每天解锁50次，一年可赚上千元酷划锁屏是一款可以自动赚钱的手机锁屏APP，"
        ...
        "dev": (
            {
                "label": "110",
                "label_des": "社区超市",
                "sentence": "朴朴快送超市创立于2016年，专注于打造移动端30分钟即时配送一站式购物平台，商品品类包含水果、蔬菜、肉禽蛋奶、海鲜水产、粮油调味、酒水饮料、休闲食品、日用品、外卖等。朴朴公司希望能以全新的商业模式，"
        ...
        "test": (
            {
                "id": 0,
                "sentence": "大疆商城DJIStore，手机下单，快人一步，获得专享优惠，查找航拍点，了解热门的无人机资讯。优惠活动随时参与获得活动消息，专享移动端购机优惠。新品动态即时购买一站购物，查找门店，电池预约，以旧换新。探索附近航拍地点发现和分享航拍点，上帝"
