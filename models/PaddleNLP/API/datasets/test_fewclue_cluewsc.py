...
def get_examples(mode="train"):
    ...
    examples = {
        "train": (
            {
                "target": {"span2_index": 30, "span1_index": 22, "span1_text": "树叶", "span2_text": "他"},
                "idx": 0,
                "label": "false",
                "text": "为什么要出现一个身穿军装的高大男人？就像一片树叶飘入了树林，他走到了我的家人中间。",
            }
        ),
        "dev": (
            {
                ...
                "idx": 1,
                "label": "true",
                "text": "有些这样的“洋人”就站在大众之间，如同鹤立鸡群，毫不掩饰自己的优越感。他们排在非凡的甲菜盆后面，虽然人数寥寥无几，但却特别惹眼。",
            }
        ),
        "test": (
            {
                "id": 0,
                "target": {"span1_index": 46, "span1_text": "曹操", "span2_index": 17, "span2_text": "他们"},
                "text": "作为代价，这个兵种在不拔剑的时候，他们看起来就跟普通的精锐没什么区别，顺带从这里也可以看出来曹操给曹真补了这五千多锐士是怎么个想法，很明显曹操也不是好鸟。",
            }
        ),
        "test1.0": (
            {
                "target": {"span2_index": 15, "span1_index": 0, "span1_text": "杨百顺", "span2_text": "他"},
                "id": 1,
                "text": "杨百顺他爹是个卖豆腐的。别人叫他卖豆腐的老杨。",
            }
        ),
    }
