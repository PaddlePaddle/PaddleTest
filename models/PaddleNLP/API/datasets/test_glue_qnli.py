...
def get_examples(mode='train'):
    ...
    examples = {
        'train':
        ({'sentence1': 'When did the third Digimon series begin?', 'sentence2': 'Unlike the two seasons before it and most of the seasons that followed, Digimon Tamers takes a darker and more realistic approach to its story featuring Digimon who do not reincarnate after their deaths and more complex character development in the original Japanese.', 'labels': 1}),
        'dev':
        ({'sentence1': 'What came into force after the new constitution was herald?', 'sentence2': 'As of that day, the new constitution heralding the Second Republic came into force.', 'labels': 0}),
        'test':
        ({'sentence1': 'What organization is devoted to Jihad against Israel?', 'sentence2': 'For some decades prior to the First Palestine Intifada in 1987, the Muslim Brotherhood in Palestine took a "quiescent" stance towards Israel, focusing on preaching, education and social services, and benefiting from Israel\'s "indulgence" to build up a network of mosques and charitable organizations.'}),
    }
