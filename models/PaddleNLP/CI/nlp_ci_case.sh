...
CUDA_VISIBLE_DEVICES=${cudaid2}
time (python -m paddle.distributed.launch  --log_dir hyp run_classifier.py --epochs 15 --layerwise_decay 0.7 --learning_rate 5e-5 --batch_size 4 --save_steps 2000  --dataset hyp --output_dir hyp >${log_path}/hyp) >>${log_path}/hyp 2>&1
print_info $? hyp
# time (python -m paddle.distributed.launch  --log_dir cmrc2018 run_mrc.py --batch_size 4 --layerwise_decay 0.8 --dropout 0.2 --learning_rate 4.375e-5 --epochs 1 --save_steps 5000 --dataset cmrc2018 --output_dir cmrc2018  >${log_path}/cmrc2018) >>${log_path}/cmrc2018 2>&1
# print_info $?  cmrc2018
