...
=======
<<<<<<< HEAD
>>>>>>> 813c98de8f99a68c840dab46a396cdce2128f5c7
...
>>>>>>> 813c98de8f99a68c840dab46a396cdce2128f5c7
    ...
    if not os.path.exists(path):
        os.mkdir(path)
    os.system("cd %s && wget %s" % (path,"https://user-images.githubusercontent.com/40840292/203457596-8dbc9241-833d-4b0e-9291-f134a790d0e1.jpeg"))
    os.system("cd %s && wget %s" % (path,"https://user-images.githubusercontent.com/40840292/203457719-84a70241-607e-4bb1-ab4c-3d9beee9e254.jpeg"))
    os.system("cd %s && wget %s" % (path,"https://user-images.githubusercontent.com/40840292/203457817-76fe638a-3277-4619-9066-d1dffd52c5d4.jpg "))
