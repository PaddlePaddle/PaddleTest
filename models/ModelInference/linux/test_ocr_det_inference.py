...
def test_ch_PP_OCRv2_det_infer():
    ...
    test case
    """ 
    model = TestOcrDetInference(model='ch_PP-OCRv2_det', 
                                infer_imgs='./doc/imgs_en/img_10.jpg')
    model.test_get_ocr_det_inference_model(category='PP-OCRv2/chinese')
    model.test_ocr_det_predict(expect_det_bbox=[[[41, 85], [201, 74], [203, 101], [43, 113]], 
...
def test_ch_PP_OCRv2_det_slim_quant_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='ch_PP-OCRv2_det_slim_quant', 
                                infer_imgs='./doc/imgs_en/img_10.jpg')
    model.test_get_ocr_det_inference_model(category='PP-OCRv2/chinese')
    model.test_ocr_det_predict(expect_det_bbox= [[[39, 88], [204, 76], [206, 100], [41, 112]], 
...
def test_ch_ppocr_mobile_v2_det_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='ch_ppocr_mobile_v2.0_det', 
                                infer_imgs='./doc/imgs_en/img_10.jpg')
    model.test_get_ocr_det_inference_model(category='dygraph_v2.0/ch')
    model.test_ocr_det_predict(expect_det_bbox=[[[45, 86], [196, 78], [198, 100], [46, 109]], 
                                                [[40, 54], [201, 53], [201, 77], [40, 78]]])

def test_ch_ppocr_mobile_v2_det_prune_infer():
    """
    test case
    """
    model = TestOcrDetInference(model='ch_ppocr_mobile_v2.0_det_prune', 
                                infer_imgs='./doc/imgs_en/img_10.jpg')
    model.test_get_ocr_det_inference_model(category='dygraph_v2.0/slim')
    model.test_ocr_det_predict(expect_det_bbox=[[[46, 90], [197, 79], [198, 96], [47, 108]], 
...
def test_ch_ppocr_server_v2_det_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='ch_ppocr_server_v2.0_det', 
                                infer_imgs='./doc/imgs_en/img_10.jpg')
    model.test_get_ocr_det_inference_model(category='dygraph_v2.0/ch')
    model.test_ocr_det_predict(expect_det_bbox= [[[41, 88], [198, 78], [199, 100], [42, 110]], 
...
def test_det_r50_vd_east_v2_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='det_r50_vd_east_v2.0', 
                                infer_imgs='./doc/imgs_en/img_10.jpg', 
    ...
    model.test_ocr_det_predict(expect_det_bbox=[[[44, 88], [145, 78], [149, 104], [47, 113]], 
...
def test_det_r50_vd_sast_icdar15_v2_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='det_r50_vd_sast_icdar15_v2.0', 
                                infer_imgs='./doc/imgs_en/img_10.jpg', 
                                yaml='configs/det/det_r50_vd_sast_icdar15.yml', 
                                algorithm='SAST')
    model.test_get_ocr_det_train_model(category='dygraph_v2.0/en')
    model.test_ocr_det_export_model()
    model.test_ocr_det_predict(expect_det_bbox=[[[36, 88], [151, 79], [153, 103], [38, 112]], 
...
def test_det_r50_vd_sast_totaltext_v2_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='det_r50_vd_sast_totaltext_v2.0', 
                                infer_imgs='./doc/imgs_en/img_10.jpg', 
                                yaml='configs/det/det_r50_vd_sast_totaltext.yml', 
                                algorithm='SAST')
    model.test_get_ocr_det_train_model(category='dygraph_v2.0/en')
    model.test_ocr_det_export_model()
    model.test_ocr_det_predict(expect_det_bbox=[[[35, 91], [150, 77], [153, 100], [40, 113]], 
...
def test_det_r50_vd_pse_v2_infer():
    ...
    test case
    """
    model = TestOcrDetInference(model='det_r50_vd_pse_v2.0',
                                infer_imgs='./doc/imgs_en/img_10.jpg',
                                yaml='configs/det/det_r50_vd_pse.yml',
                                algorithm='PSE')
    model.test_get_ocr_det_train_model(category='dygraph_v2.1/en_det')
    model.test_ocr_det_export_model()
    model.test_ocr_det_predict(expect_det_bbox=[[[30, 17], [109, 24], [107, 51], [28, 44]], 
