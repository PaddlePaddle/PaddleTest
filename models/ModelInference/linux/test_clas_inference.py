...
def test_MobileNetV3_large_x1_0():
    ...
    """
    model = TestClasInference(model='MobileNetV3_large_x1_0', 
...
def test_DeiT_base_distilled_patch16_224():
    ...
    """
    model = TestClasInference(model='DeiT_base_distilled_patch16_224', 
                               yaml='ppcls/configs/ImageNet/DeiT/DeiT_base_distilled_patch16_224.yaml')
    model.test_get_pretrained_model()
    model.test_clas_export_model()
...
def test_EfficientNetB0():
    ...
    """
    model = TestClasInference(model='EfficientNetB0',
                               yaml='ppcls/configs/ImageNet/EfficientNet/EfficientNetB0.yaml')
    model.test_get_pretrained_model()
    model.test_clas_export_model()
...
def test_ResNeXt101_32x16d_wsl():
    ...
    """
    model = TestClasInference(model='ResNeXt101_32x16d_wsl', 
                               yaml='ppcls/configs/ImageNet/ResNeXt101_wsl/ResNeXt101_32x16d_wsl.yaml')
    model.test_get_pretrained_model()
    model.test_clas_export_model()
...
def test_ShuffleNetV2_x1_0():
    ...
    """
    model = TestClasInference(model='ShuffleNetV2_x1_0', 
                               yaml='ppcls/configs/ImageNet/ShuffleNet/ShuffleNetV2_x1_0.yaml')
    model.test_get_pretrained_model()
    model.test_clas_export_model()
...
def test_SwinTransformer_base_patch4_window7_224():
    ...
    """
    model = TestClasInference(model='SwinTransformer_base_patch4_window7_224', 
...
def test_ViT_base_patch16_224():
    ...
    """
    model = TestClasInference(model='ViT_base_patch16_224', 
                               yaml='ppcls/configs/ImageNet/VisionTransformer/ViT_base_patch16_224.yaml')
    model.test_get_pretrained_model()
    model.test_clas_export_model()
...
def test_Xception41_deeplab():
    ...
    """
    model = TestClasInference(model='Xception41_deeplab', 
                               yaml= 'ppcls/configs/ImageNet/Xception/Xception41_deeplab.yaml')
    model.test_get_pretrained_model()
    model.test_clas_export_model()
