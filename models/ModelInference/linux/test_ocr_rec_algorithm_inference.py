...
def test_rec_r34_vd_none_none_ctc():
    ...
    test case
    """ 
    model = TestOcrRecInference(model='rec_r34_vd_none_none_ctc_v2.0', 
...
def test_rec_mv3_none_none_ctc():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_mv3_none_none_ctc_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_r34_vd_none_bilstm_ctc():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_r34_vd_none_bilstm_ctc_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_mv3_none_bilstm_ctc():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_mv3_none_bilstm_ctc_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_r34_vd_tps_bilstm_ctc():
    ...
    """
    model = TestOcrRecInference(model='rec_r34_vd_tps_bilstm_ctc_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_mv3_tps_bilstm_ctc():
    ...
    """
    model = TestOcrRecInference(model='rec_mv3_tps_bilstm_ctc_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_r34_vd_tps_bilstm_att():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_r34_vd_tps_bilstm_att_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_mv3_tps_bilstm_att():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_mv3_tps_bilstm_att_v2.0',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_r50_vd_srn():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_r50_vd_srn',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="./ppocr/utils/ic15_dict.txt",
...
def test_rec_r31_sar():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_r31_sar',
...
def test_rec_mtb_nrtr():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_mtb_nrtr',
...
def test_rec_resnet_stn_bilstm_att():
    ...
    test case
    """
    model = TestOcrRecInference(model='rec_resnet_stn_bilstm_att',
                                infer_imgs='./doc/imgs_words_en/word_336.png',
                                rec_char_dict="/ppocr/utils/ic15_dict.txt",
