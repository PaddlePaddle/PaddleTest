...
def test_ch_PP_OCRv2_rec_slim_quant():
    ...
    """
    model = TestOcrRecInference(
        model="ch_PP-OCRv2_rec_slim_quant",
        infer_imgs="doc/imgs_words/ch/word_1.jpg",
        rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt",
    )
    model.test_get_ocr_rec_inference_model(category="PP-OCRv2/chinese")
...
def test_ch_ppocr_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="ch_ppocr_mobile_v2.0_rec",
        infer_imgs="doc/imgs_words/ch/word_1.jpg",
        rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt",
    )
...
def test_ch_ppocr_mobile_v2_rec_slim():
    ...
    """
    model = TestOcrRecInference(
        model="ch_ppocr_mobile_v2.0_rec_slim",
        infer_imgs="doc/imgs_words/ch/word_1.jpg",
        rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt",
    )
    model.test_get_ocr_rec_inference_model(category="dygraph_v2.0/ch")
...
def test_ch_ppocr_server_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="ch_ppocr_server_v2.0_rec",
        infer_imgs="doc/imgs_words/ch/word_1.jpg",
        rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt",
    )
    model.test_get_ocr_rec_inference_model(category="dygraph_v2.0/ch")
...
def test_en_number_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="en_number_mobile_v2.0_rec",
...
def test_en_number_mobile_v2_rec_slim():
    ...
    """
    model = TestOcrRecInference(
        model="en_number_mobile_v2.0_rec_slim",
        infer_imgs="doc/imgs_words/en/word_1.png",
        rec_char_dict="./ppocr/utils/en_dict.txt",
    )
...
def test_chinese_cht_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="chinese_cht_mobile_v2.0_rec",
...
def test_latin_ppocr_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="latin_ppocr_mobile_v2.0_rec",
        infer_imgs="doc/imgs_words/french/2.jpg",
...
def test_arabic_ppocr_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="arabic_ppocr_mobile_v2.0_rec",
...
def test_cyrillic_ppocr_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="cyrillic_ppocr_mobile_v2.0_rec",
...
def test_devanagari_ppocr_mobile_v2_rec():
    ...
    """
    model = TestOcrRecInference(
        model="devanagari_ppocr_mobile_v2.0_rec",
