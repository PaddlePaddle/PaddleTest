...
def setup_module():
    ...
    RepoInstructions(cmd='''sed -i '/config.enable_tensorrt_engine/i\            config.collect_shape_range_info("shape_range.pbtxt")'  tools/infer/utility.py
                            sed -i '/min_subgraph_size=args.min_subgraph_size)/a\            config.enable_tuned_tensorrt_dynamic_shape("shape_range.pbtxt", True)'  tools/infer/utility.py''')
...
def test_ch_PP_OCRv2_rec():
    """
    test case
    """ 
    model = TestOcrRecInference(model='ch_PP-OCRv2_rec', 
...
def test_ch_PP_OCRv2_rec_slim_quant():
    """
    test case
    """
    model = TestOcrRecInference(model='ch_PP-OCRv2_rec_slim_quant', 
                                infer_imgs='doc/imgs_words/ch/word_1.jpg', 
                                rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt")
    model.test_get_ocr_rec_inference_model(category='PP-OCRv2/chinese')
    model.test_ocr_rec_predict(expect_rec_docs='韩国小馆', expect_rec_scores=0.9967337)
...
def test_ch_ppocr_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='ch_ppocr_mobile_v2.0_rec', 
                                infer_imgs='doc/imgs_words/ch/word_1.jpg', 
                                rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt")
    model.test_get_ocr_rec_inference_model(category='dygraph_v2.0/ch')
    model.test_ocr_rec_predict(expect_rec_docs='韩国小馆', expect_rec_scores=0.9967337)
    
def test_ch_ppocr_mobile_v2_rec_slim():
    """
    test case
    """
    model = TestOcrRecInference(model='ch_ppocr_mobile_v2.0_rec_slim',
                                infer_imgs='doc/imgs_words/ch/word_1.jpg',
                                rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt")
    model.test_get_ocr_rec_inference_model(category='dygraph_v2.0/ch') 
    model.test_ocr_rec_predict(expect_rec_docs='韩国小馆', expect_rec_scores=0.9967337)

def test_ch_ppocr_server_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='ch_ppocr_server_v2.0_rec', 
                                infer_imgs='doc/imgs_words/ch/word_1.jpg', 
                                rec_char_dict="./ppocr/utils/ppocr_keys_v1.txt")
    model.test_get_ocr_rec_inference_model(category='dygraph_v2.0/ch')
    model.test_ocr_rec_predict(expect_rec_docs='韩国小馆', expect_rec_scores=0.9967337)
...
def test_en_number_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='en_number_mobile_v2.0_rec', 
...
def test_en_number_mobile_v2_rec_slim():
    """
    test case
    """
    model = TestOcrRecInference(model='en_number_mobile_v2.0_rec_slim', 
                                infer_imgs='doc/imgs_words/en/word_1.png', 
                                rec_char_dict="./ppocr/utils/en_dict.txt")
...
def test_french_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='french_mobile_v2.0_rec', 
...
def test_german_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='german_mobile_v2.0_rec', 
...
def test_korean_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='korean_mobile_v2.0_rec', 
...
def test_japan_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='japan_mobile_v2.0_rec', 
...
def test_chinese_cht_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='chinese_cht_mobile_v2.0_rec', 
                                infer_imgs='doc/imgs_words/chinese_traditional/chinese_cht_1.png', 
                                rec_char_dict="ppocr/utils/dict/chinese_cht_dict.txt")
    model.test_get_ocr_rec_inference_model(category='dygraph_v2.0/multilingual')
    model.test_ocr_rec_predict(expect_rec_docs='始終如壹', expect_rec_scores=0.9866849)

def test_te_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='te_mobile_v2.0_rec', 
...
def test_ka_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='ka_mobile_v2.0_rec', 
...
def test_ta_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='ta_mobile_v2.0_rec', 
...
def test_latin_ppocr_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='latin_ppocr_mobile_v2.0_rec', 
                                infer_imgs='doc/imgs_words/french/2.jpg', 
...
def test_arabic_ppocr_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='arabic_ppocr_mobile_v2.0_rec', 
...
def test_cyrillic_ppocr_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='cyrillic_ppocr_mobile_v2.0_rec', 
...
def test_devanagari_ppocr_mobile_v2_rec():
    """
    test case
    """
    model = TestOcrRecInference(model='devanagari_ppocr_mobile_v2.0_rec', 
