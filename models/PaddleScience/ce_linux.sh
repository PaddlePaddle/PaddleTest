...
ignore="log.py dataset.py download_dataset.py loading_cfd_data.py cylinder2d_unsteady_predict.py"
bug=0
...
ignore="log.py dataset.py download_dataset.py loading_cfd_data.py viv_inverse_predict.py viv_inverse_train.py cylinder2d_unsteady_train.py cylinder2d_unsteady_predict.py"
