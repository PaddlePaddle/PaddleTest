...
if __name__ == "__main__":
    ...
    geo = psci.geometry.Rectangular(
        time_dependent=True, time_origin=0, time_extent=0.5, space_origin=(-0.05, -0.05), space_extent=(0.05, 0.05)
    )
    ...
    # Discretization
    pdes, geo = psci.discretize(pdes, geo, time_nsteps=6, space_nsteps=(101, 101))
