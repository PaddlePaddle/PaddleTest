...
# N-S
pde = psci.pde.NavierStokes(nu=0.01, rho=1.0, dim=2, time_dependent=True, weight=0.0001)
...
net = psci.network.FCNet(num_ins=3, num_outs=3, num_layers=10, hidden_size=50, activation="tanh")
...
psci.visu.save_vtk(time_array=pde_disc.time_array, geo_disc=pde_disc.geometry, data=solution)
