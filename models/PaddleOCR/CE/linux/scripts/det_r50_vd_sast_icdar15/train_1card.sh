...
cat log/det_r50_vd_sast_icdar15_1card.log | grep "2/2" > ../log/det_r50_vd_sast_icdar15_1card_tmp.log

linenum=`cat ../log/det_r50_vd_sast_icdar15_1card_tmp.log | wc -l`
linenum_last1=`expr $linenum - 1`
if [ $linenum_last1 -eq 0 ]
  then cp ../log/det_r50_vd_sast_icdar15_1card_tmp.log ../log/det_r50_vd_sast_icdar15_1card.log
  else sed ''1,"$linenum_last1"'d' ../log/det_r50_vd_sast_icdar15_1card_tmp.log > ../log/det_r50_vd_sast_icdar15_1card.log
fi
rm -rf ../log/det_r50_vd_sast_icdar15_1card_tmp.log
