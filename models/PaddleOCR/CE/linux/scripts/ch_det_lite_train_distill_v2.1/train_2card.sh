...
cat log/ch_det_lite_train_distill_v2.1_2card.log
cat log/ch_det_lite_train_distill_v2.1_2card.log | grep "2/2" > ../log/ch_det_lite_train_distill_v2.1_2card.log
