...
python -m paddle.distributed.launch tools/train.py -c configs/det/det_mv3_db.yml -o Global.epoch_num=2 > log/det_mv3_db_2card.log 2>&1
cat log/det_mv3_db_2card.log
cat log/det_mv3_db_2card.log | grep "2/2" > ../log/det_mv3_db_2card.log
