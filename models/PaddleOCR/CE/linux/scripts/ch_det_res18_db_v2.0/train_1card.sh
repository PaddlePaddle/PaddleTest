...
python tools/train.py -c configs/det/ch_ppocr_v2.0/ch_det_res18_db_v2.0.yml -o Global.epoch_num=2 > log/ch_det_res18_db_v2.0_1card.log 2>&1
cat log/ch_det_res18_db_v2.0_1card.log | grep "2/2" > ../log/ch_det_res18_db_v2.0_1card_tmp.log
