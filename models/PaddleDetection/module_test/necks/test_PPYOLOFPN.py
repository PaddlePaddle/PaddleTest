...
from ppdet.modeling.necks import PPYOLOFPN
from module.test_module import Test

class Config:
    def __init__(self):
        paddle.seed(33)
        self.module_name = "PPYOLOFPN"
        self.net = PPYOLOFPN(in_channels=[8 ,16 ,32], norm_type='bn', freeze_norm=False, data_format='NCHW')
