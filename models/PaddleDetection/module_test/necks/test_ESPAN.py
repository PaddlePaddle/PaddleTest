...
from ppdet.modeling.necks import ESPAN
from module.test_module import Test

class Config:
    def __init__(self):
        paddle.seed(33)
        self.module_name = "ESPAN" 
        self.net = ESPAN(in_channels=[8, 16, 32], out_channels=8, kernel_size=5, num_features=3, use_depthwise=True, act='hard_swish', spatial_scales=[0.125, 0.0625, 0.03125])
