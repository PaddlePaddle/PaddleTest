...
from ppdet.modeling.heads import SparseRoIHead
from module.test_module import Test

class Config:
    def __init__(self):
        paddle.seed(33)
        self.module_name = "SparseRoIHead"
        self.net = SparseRoIHead(num_stages=6, bbox_head='DIIHead', mask_head='DynamicMaskHead', loss_func='QueryInstLoss')
        self.net.eval()
