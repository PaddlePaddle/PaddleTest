...
from ppdet.modeling.necks import BBoxHead
from module.test_module import Test

class Config:
    def __init__(self):
        paddle.seed(33)
        self.module_name = "BBoxHead"
        self.net = BBoxHead(in_channels=[8 ,16 ,32], norm_type='bn', freeze_norm=False, data_format='NCHW')
