...
class Config:
    def __init__(self):
        ...
        self.net = MaskHead(head=maskfeat, roi_extractor=_get_class_default_kwargs(RoIAlign), mask_assigner='MaskAssigner', num_classes=3, share_bbox_feat=False, export_onnx=False)
        self.net.eval()
