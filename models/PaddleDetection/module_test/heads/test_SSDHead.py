...
class Config:
    def __init__(self):
        ...
        self.net = SSDHead(num_classes=3, in_channels=(16, 32, 16, 8, 8, 8), anchor_generator=_get_class_default_kwargs(AnchorGeneratorSSD), kernel_size=3, padding=1, use_sepconv=False, conv_decay=0., loss='SSDLoss', use_extra_head=False)
        self.net.eval()
