...
class Config:
    def __init__(self):
        ...
        self.net = TOODHead(num_classes=3, feat_channels=8, stacked_convs=6, fpn_strides=(8, 16, 32), grid_cell_scale=8, grid_cell_offset=0.5, norm_type='gn', norm_groups=8, static_assigner_epoch=4, use_align_head=True, nms='MultiClassNMS', static_assigner='ATSSAssigner', assigner='TaskAlignedAssigner')
        self.net.eval()
