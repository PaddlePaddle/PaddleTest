...
class Config:
    def __init__(self):
        ...
        self.net = RetinaHead(num_classes=3, conv_feat=fcosfeat, anchor_generator=retinaanchorgenerator, bbox_assigner='MaxIoUAssigner', loss_class='FocalLoss', loss_bbox='SmoothL1Loss', nms='MultiClassNMS', prior_prob=0.01, nms_pre=100, weights=[1., 1., 1., 1.])
        self.net.eval()
