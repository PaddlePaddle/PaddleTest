...
class Config:
    def __init__(self):
        ...
        self.net = CenterTrackHead(in_channels=16, num_classes=3, head_planes=16, task='tracking', loss_weight={'tracking': 1.0, 'ltrb_amodal': 0.1}, add_ltrb_amodal=True)
        self.net.eval()
        ...
        self.input = {'inputs':inputs, 'bboxes':bboxes, 'bbox_inds':bbox_inds, 'topk_ys':topk_ys, 'topk_xs':topk_xs}
