...
class Config:
    def __init__(self):
        ...
        self.net = SOLOv2Head(num_classes=3, in_channels=32, seg_feat_channels=32, stacked_convs=4, num_grids=[40, 36, 24, 16, 12], kernel_out_channels=32, dcn_v2_stages=[], segm_strides=[8, 8, 16, 32, 32])
        self.net.eval()
