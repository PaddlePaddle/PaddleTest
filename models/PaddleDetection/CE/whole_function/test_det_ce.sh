...
find . | grep .yml | grep -v benchmark |  grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep  -v minicoco | grep -v detector | grep -v bytetrack |  grep -v pruner | grep -v mot | grep -v cascade_rcnn | grep -v centernet | grep -v picodet | grep faster_rcnn | awk '{print $NF}' | tee config_list2
cat config_list1 config_list2 >>config_list
elif [ "$1" == 'develop_d3' ];then
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep  -v minicoco | grep -v bytetrack | grep -v detector | grep mot | awk '{print $NF}' | tee config_list3
find . | grep .yml | grep -v benchmark |  grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep  -v minicoco | grep -v bytetrack | grep -v mot | grep -v detector |  grep -v cascade_rcnn | grep -v centernet | grep -v picodet | grep ssd | awk '{print $NF}' | tee config_list4
find . | grep .yml | grep -v benchmark |  grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner |  grep  -v minicoco | grep -v mot | grep -v bytetrack | grep -v detector | grep -v cascade_rcnn | grep -v centernet | grep -v picodet | grep -v yolov3 | grep -v ssd | grep -v dcn | grep -v faster_rcnn  | grep mask_rcnn | awk '{print $NF}' | tee mask_list
cat  mask_list config_list3 config_list4 >>config_list
elif [ "$1" == 'develop_d4' ];then
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep -v bytetrack | grep cascade_rcnn | awk '{print $NF}' | tee cascade_list
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep -v bytetrack | grep  -v minicoco | grep centernet | awk '{print $NF}' | tee centernet_list
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep -v bytetrack | grep picodet | awk '{print $NF}' | tee picodet_list
find . | grep .yml | grep -v benchmark |  grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep -v mot | grep -v bytetrack | grep -v cascade_rcnn | grep -v centernet | grep -v picodet | grep dcn | awk '{print $NF}' | tee config_list5
...
find . | grep .yml | grep -v benchmark |  grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep  -v minicoco | grep -v detector |  grep -v pruner | grep -v mot | grep -v cascade_rcnn | grep -v centernet | grep -v picodet | grep faster_rcnn | awk '{print $NF}' | tee config_list2
cat config_list1 config_list2 >>config_list
elif [ "$1" == 'develop_d3' ];then
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep  -v minicoco | grep -v detector | grep mot | awk '{print $NF}' | tee config_list3
...
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep cascade_rcnn | awk '{print $NF}' | tee cascade_list
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep centernet | awk '{print $NF}' | tee centernet_list
find . | grep .yml | grep -v benchmark | grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep picodet | awk '{print $NF}' | tee picodet_list
find . | grep .yml | grep -v benchmark |  grep configs | grep -v static | grep -v _base_ | grep -v datasets | grep -v runtime | grep -v slim | grep -v roadsign | grep -v deepsort | grep -v test | grep -v pruner | grep -v detector | grep  -v minicoco | grep -v mot | grep -v cascade_rcnn | grep -v centernet | grep -v picodet | grep dcn | awk '{print $NF}' | tee config_list5
cat cascade_list centernet_list picodet_list config_list5 >>config_list
else
