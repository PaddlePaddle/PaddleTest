...
train_bisenet_convergence(){
    ...
    echo  "Iou: `grep image: ../log/bisenet_cityscapes_1024x1024_160k/bisenet_cityscapes_1024x1024_160k_train_convergence.log | tail -1 | awk '{print $NF}'`" >>../log/bisenet_cityscapes_1024x1024_160k/bisenet_cityscapes_1024x1024_160k_train_convergence.log
}
