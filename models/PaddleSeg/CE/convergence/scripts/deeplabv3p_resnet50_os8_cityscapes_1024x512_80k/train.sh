...
train_deeplabv3p_convergence(){
    ...
    echo  "Iou: `grep image: ../log/deeplabv3p_resnet50_os8_cityscapes_1024x512_80k/deeplabv3p_resnet50_os8_cityscapes_1024x512_80k_train_convergence.log | tail -1 | awk '{print $NF}'`" >>../log/deeplabv3p_resnet50_os8_cityscapes_1024x512_80k/deeplabv3p_resnet50_os8_cityscapes_1024x512_80k_train_convergence.log
