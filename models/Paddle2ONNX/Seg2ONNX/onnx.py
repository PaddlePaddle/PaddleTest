...
parser.add_argument("--with_argmax", type=str, default=None, help="model name for predict.")
parser.add_argument(
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(args.model_name, args.with_argmax, "onnx_model", "model.onnx")
    input_path = os.path.join(args.model_name, args.with_argmax, "input_np")
    output_path = os.path.join(args.model_name, args.with_argmax, "onnx_output_np")
    ...
    for i in range(len(input_list)):
        ...
        print("{} No.{} {}/input onnx_result:".format(args.model_name, i, args.with_argmax))
        print(onnx_result[0])
