...
if [ "$1" = "linux_dy_gpu1_con" ];then
    ...
    python -u ../../../tools/infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_dnn_dy_all" > ${log_path}/$2.log 2>&1
    print_info $? $2
...
# 单卡静态图预测收敛性
    ...
    # 修改use_gpu选项
    sed -i "s/  use_gpu: False/  use_gpu: True/g" config_bigdata.yaml
    python -u ../../../tools/static_infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_dnn_st_all" > ${log_path}/$2.log 2>&1
    print_info $? $2
...
#    mv $code_path/log $log_path/$2_dist_log
    ...
    sed -i "s/  use_gpu: False/  use_gpu: True/g" config_bigdata.yaml
    python -u ../../../tools/static_infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_dnn_all_st_gpu1" > ${log_path}/$2.log 2>&1
    print_info $? $2
