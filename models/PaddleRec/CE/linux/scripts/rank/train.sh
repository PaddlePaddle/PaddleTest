...
if [ "$1" = "linux_dy_gpu1" ];then #单卡
    ...
    python -u ../../../tools/trainer.py -m config_bigdata.yaml -o runner.model_save_path="output_model_dnn_all_dy_cpu" > ${log_path}/$2.log 2>&1
    print_info $? $2
    ...
    sed -i "s/  use_gpu: True/  use_gpu: False/g" config_bigdata.yaml
    python -u ../../../tools/static_trainer.py -m config_bigdata.yaml -o runner.model_save_path="output_model_dnn_all_st_cpu" > ${log_path}/$2.log 2>&1
    print_info $? $2
else
