...
if [ "$1" = "linux_dy_gpu1_con" ]; then
    ...
    python -u ../../../tools/infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_sharebottom_all_dy" > ${log_path}/$2.log 2>&1
    print_info $? $2
...
# 单卡静态图预测收敛性
    ...
    # 修改use_gpu选项
    sed -i "s/  use_gpu: False/  use_gpu: True/g" config_bigdata.yaml
    python -u ../../../tools/static_infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_sharebottom_all_st" > ${log_path}/$2.log 2>&1
    print_info $? $2
...
if [ "$1" = "linux_dy_gpu1" ];then #单卡
    sed -i "s/  use_gpu: False/  use_gpu: True/g" config_bigdata.yaml
    python -u ../../../tools/infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_sharebottom_all_dy_gpu1" > ${log_path}/$2.log 2>&1
    print_info $? $2
    ...
    sed -i "s/  use_gpu: False/  use_gpu: True/g" config_bigdata.yaml
    python -u ../../../tools/static_infer.py -m config_bigdata.yaml -o runner.infer_load_path="output_model_sharebottom_all_st_gpu1" > ${log_path}/$2.log 2>&1
    print_info $? $2
...
# mac small_data infer
    ...
    python -u ../../../tools/infer.py -m config.yaml -o runner.infer_load_path="output_model_sharebottom_all_mac_dy_cpu" > ${log_path}/$2.log 2>&1
    print_info $? $2

elif [ "$1" = "mac_st_cpu" ];then
    python -u ../../../tools/static_infer.py -m config.yaml -o runner.infer_load_path="output_model_sharebottom_all_mac_st_cpu" > ${log_path}/$2.log 2>&1
    print_info $? $2
