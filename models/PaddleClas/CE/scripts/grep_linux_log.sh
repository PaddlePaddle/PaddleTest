...
if [[ $2 == 'train_linux_gpu1' ]] ; then
    ...
    cat tmp_1card.log | tr '\n' ',' > /workspace/task/${log_path}/${model}_1card.log
    cat /workspace/task/${log_path}/${model}_1card.log
    ...
    cat tmp_2card.log | tr '\n' ',' > /workspace/task/${log_path}/${model}_2card.log
    cat /workspace/task/${log_path}/${model}_2card.log
    ...
    cat tmp_eval.log | tr '\n' ',' > /workspace/task/${log_path}/${model}_eval.log
    cat /workspace/task/${log_path}/${model}_eval.log
    ...
    cat ${log_path}/infer/${model}.log | grep infer_exit_code >/workspace/task/${log_path}/${model}_infer.log
    cat /workspace/task/${log_path}/${model}_infer.log

elif [[ $2 == 'export_linux' ]] ; then
    echo '#####export_linux'
    cat ${log_path}/export_model/${model}.log | grep export_exit_code
    cat ${log_path}/export_model/${model}.log | grep export_exit_code >/workspace/task/${log_path}/${model}_export.log
    cat /workspace/task/${log_path}/${model}_export.log
    ...
    cat ${log_path}/predict/${model}.log | grep predict_exit_code >/workspace/task/${log_path}/${model}_predict.log
    cat /workspace/task/${log_path}/${model}_predict.log
