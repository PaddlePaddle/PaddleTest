...
python tools/train.py -c ppcls/configs/ImageNet/Inception/GoogLeNet.yaml -o Global.epochs=2 -o DataLoader.Train.sampler.shuffle=False -o DataLoader.Train.sampler.batch_size=4 -o DataLoader.Eval.sampler.batch_size=4 > log/GoogLeNet_1card.log 2>&1
cat log/GoogLeNet_1card.log | grep Train | grep Avg | grep 'Epoch 2/2' > ../log/GoogLeNet_1card.log
