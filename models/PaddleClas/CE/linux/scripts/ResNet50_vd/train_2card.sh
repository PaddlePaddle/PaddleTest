...
python -m paddle.distributed.launch tools/train.py -c ppcls/configs/ImageNet/ResNet/ResNet50_vd.yaml  \
    -o Global.epochs=5  \
    -o Global.seed=1234 \
    ...
    -o DataLoader.Train.sampler.batch_size=4 > log/resnet50_vd_2card.log 2>&1
cat log/resnet50_vd_2card.log | grep Avg | grep 'Epoch 5/5' > ../log/resnet50_vd_2card.log
