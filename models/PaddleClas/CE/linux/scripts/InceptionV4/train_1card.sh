...
python tools/train.py -c ppcls/configs/ImageNet/Inception/InceptionV4.yaml -o epochs=5 -o Global.epochs=2 -o Global.eval_during_train=False > log/inceptionv4_1card.log 2>&1
cat log/inceptionv4_1card.log | grep Avg | grep 'Epoch 2/2' > ../log/inceptionv4_1card.log
