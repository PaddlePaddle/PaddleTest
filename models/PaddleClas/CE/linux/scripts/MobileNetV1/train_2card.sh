...
python -m paddle.distributed.launch tools/train.py -c ppcls/configs/ImageNet/MobileNetV1/MobileNetV1.yaml  \
    -o Global.epochs=5  \
    -o Global.seed=1234 \
    ...
    -o DataLoader.Train.sampler.batch_size=4  > log/mv1_2card.log 2>&1
cat log/mv1_2card.log | grep Avg | grep 'Epoch 5/5' > ../log/mv1_2card.log
