...
python -m paddle.distributed.launch  tools/train.py -c ppcls/configs/ImageNet/MobileNetV1/MobileNetV1.yaml -o Global.epochs=2 -o Global.eval_during_train=False > log/mv1_2card.log 2>&1
cat log/mv1_2card.log | grep Avg | grep 'Epoch 2/2' > ../log/mv1_2card.log
