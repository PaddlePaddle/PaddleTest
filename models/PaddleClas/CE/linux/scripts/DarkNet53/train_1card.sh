...
python tools/train.py -c ppcls/configs/ImageNet/DarkNet/DarkNet53.yaml -o Global.epochs=2 -o DataLoader.Train.sampler.shuffle=False -o DataLoader.Train.sampler.batch_size=4 -o DataLoader.Eval.sampler.batch_size=4 > log/DarkNet53_1card.log 2>&1
cat log/DarkNet53_1card.log | grep Train | grep Avg | grep 'Epoch 2/2' > ../log/DarkNet53_1card.log
