...
python -m paddle.distributed.launch tools/train.py -c ppcls/configs/ImageNet/VisionTransformer/ViT_small_patch16_224.yaml  \
    -o Global.epochs=5  \
    -o Global.seed=1234 \
    ...
    -o DataLoader.Train.sampler.batch_size=4 > log/ViT_small_patch16_224_2card.log 2>&1
