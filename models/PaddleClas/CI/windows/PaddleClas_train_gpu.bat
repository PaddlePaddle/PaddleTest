...
echo "GoogLeNet VGG11 ViT_small_patch16_224 PPLCNet_x1_0 MobileNetV3_large_x1_0 RedNet50 TNT_small LeViT_128S SwinTransformer_large_patch4_window12_384"|findstr !model! >nul
if !errorlevel! equ 0 (
