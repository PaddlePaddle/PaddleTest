...
def test_esrgan_psnr_x4_div2k():
    ...
    """
    model = TestGanModel(model="esrgan_psnr_x4_div2k", yaml="configs/esrgan_psnr_x4_div2k.yaml")
...
def test_edvr_m_wo_tsa():
    ...
    """
    model = TestGanModel(model="edvr_m_wo_tsa", yaml="configs/edvr_m_wo_tsa.yaml")
    model.test_gan_train()
