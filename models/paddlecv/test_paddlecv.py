...
def get_model_list(filename='utils/models_list/paddlecv_list_1.txt'):
    """
    get_model_list
    """    
    result = []
...
def u_test_paddlecv_gpu_predict(model_name, run_mode):
...
def U_test_paddlecv_cpu_predict(model_name, run_mode):
...
@pytest.mark.parametrize('model_name', get_model_list('utils/models_list/paddlecv_list_1.txt'))
