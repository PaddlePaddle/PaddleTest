...
def test_pyramidbox_lite_server_predict():
    """pyramidbox_lite_server predict"""
    os.system("hub install pyramidbox_lite_server")
    ...
    print(result)
    os.system("hub uninstall pyramidbox_lite_server")
