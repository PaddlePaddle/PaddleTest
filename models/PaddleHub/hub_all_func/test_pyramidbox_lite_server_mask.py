...
def test_pyramidbox_lite_server_mask_predict():
    """pyramidbox_lite_server_mask predict"""
    os.system("hub install pyramidbox_lite_server_mask")
    ...
    print(result)
    os.system("hub uninstall pyramidbox_lite_server_mask")
