...
def test_japan_ocr_db_crnn_mobile_predict():
    """japan_ocr_db_crnn_mobile predict"""
    os.system("hub install japan_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall japan_ocr_db_crnn_mobile")
