...
def test_french_ocr_db_crnn_mobile_predict():
    """french_ocr_db_crnn_mobile predict"""
    os.system("hub install french_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall french_ocr_db_crnn_mobile")
