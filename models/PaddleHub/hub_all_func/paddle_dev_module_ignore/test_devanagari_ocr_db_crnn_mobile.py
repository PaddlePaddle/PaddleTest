...
def test_devanagari_ocr_db_crnn_mobile_predict():
    """devanagari_ocr_db_crnn_mobile"""
    os.system("hub install devanagari_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall devanagari_ocr_db_crnn_mobile")
