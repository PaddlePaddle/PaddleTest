...
def test_german_ocr_db_crnn_mobile_predict():
    """german_ocr_db_crnn_mobile predict"""
    os.system("hub install german_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall german_ocr_db_crnn_mobile")
