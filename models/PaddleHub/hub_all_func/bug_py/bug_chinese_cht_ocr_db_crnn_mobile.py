...
def test_chinese_cht_ocr_db_crnn_mobile_predict():
    """chinese_cht_ocr_db_crnn_mobile"""
    os.system("hub install chinese_cht_ocr_db_crnn_mobile")
    ...
    os.system("hub uninstall chinese_cht_ocr_db_crnn_mobile")
