...
def test_telugu_ocr_db_crnn_mobile_predict():
    """telugu_ocr_db_crnn_mobile predict"""
    os.system("hub install telugu_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall telugu_ocr_db_crnn_mobile")
