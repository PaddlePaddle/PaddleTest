...
def test_faster_rcnn_resnet50_fpn_coco2017_predict():
    """faster_rcnn_resnet50_fpn_coco2017 predict"""
    os.system("hub install faster_rcnn_resnet50_fpn_coco2017")
    ...
    print(result)
    os.system("hub uninstall faster_rcnn_resnet50_fpn_coco2017")
