...
def test_yolov3_mobilenet_v1_coco2017_predict():
    """yolov3_mobilenet_v1_coco2017 predict"""
    os.system("hub install yolov3_mobilenet_v1_coco2017")
    ...
    print(result)
    os.system("hub uninstall yolov3_mobilenet_v1_coco2017")
