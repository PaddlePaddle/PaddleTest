...
def test_latin_ocr_db_crnn_mobile_predict():
    """latin_ocr_db_crnn_mobile predict"""
    os.system("hub install latin_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall latin_ocr_db_crnn_mobile")
