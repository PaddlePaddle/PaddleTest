...
def test_tamil_ocr_db_crnn_mobile_predict():
    """tamil_ocr_db_crnn_mobile predict"""
    os.system("hub install tamil_ocr_db_crnn_mobile")
    ...
    print(result)
    os.system("hub uninstall tamil_ocr_db_crnn_mobile")
