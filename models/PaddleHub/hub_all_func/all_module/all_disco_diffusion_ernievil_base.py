...
def test_disco_diffusion_ernievil_base_predict():
    """
    disco_diffusion_ernievil_base
    """
    os.system("hub install disco_diffusion_ernievil_base")
    ...
    da = module.generate_image(
        text_prompts=text_prompts, artist="齐白石", output_dir="./disco_diffusion_ernievil_base_out/"
    )
    # 手动将最终生成的图像保存到指定路径
    ...
    os.system("hub uninstall disco_diffusion_ernievil_base")
