...
def test_humanseg_server_predict():
    """humanseg_server predict"""
    os.system("hub install humanseg_server")
    ...
    human_seg.save_inference_model("humanseg_server_model_save")
    os.system("hub uninstall humanseg_server")
