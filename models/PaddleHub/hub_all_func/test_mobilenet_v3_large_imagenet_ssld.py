...
def test_mobilenet_v3_large_imagenet_ssld_predict():
    """mobilenet_v3_large_imagenet_ssld predict"""
    os.system("hub install mobilenet_v3_large_imagenet_ssld")
    ...
    print(result)
    os.system("hub uninstall mobilenet_v3_large_imagenet_ssld")
