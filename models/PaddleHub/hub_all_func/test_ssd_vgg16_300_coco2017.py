...
def test_ssd_vgg16_300_coco2017_predict():
    """ssd_vgg16_300_coco2017 predict"""
    os.system("hub install ssd_vgg16_300_coco2017")
    ...
    print(result)
    os.system("hub uninstall ssd_vgg16_300_coco2017")
