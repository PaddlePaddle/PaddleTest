...
def test_panns_cnn6_predict():
    """panns_cnn6"""
    os.system("hub install panns_cnn6")
    sr = 44100  # 音频文件的采样率
    ...
    model = hub.Module(
        name="panns_cnn6", task="sound-cls", num_class=ESC50.num_class, label_map=label_map, load_checkpoint=checkpoint
    )
    ...
    os.system("hub uninstall panns_cnn6")
