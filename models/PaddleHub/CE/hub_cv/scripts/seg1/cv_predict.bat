...
python cv_predict.py --model_name %1 --use_finetune_model %2 --use_gpu %3 --visualization %4 --checkpoint_dir %5 --output_dir %6 --img_path %7 >> %log_path%/%1_predict_%2_%3_%4.log 2>&1
if not !errorlevel! == 0 (
