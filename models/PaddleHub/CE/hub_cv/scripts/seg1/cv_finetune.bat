...
python cv_finetune.py --model_name %1 --use_gpu %2 --batch_size %3 --num_epoch %4 --optimizer %5 --learning_rate %6 --target_size %7 --class_num %8 --save_interval %9 >> %log_path%/%1_finetune_%2_%3_%4_%5_%6_%7_%8_%9.log 2>&1
if not !errorlevel! == 0 (
