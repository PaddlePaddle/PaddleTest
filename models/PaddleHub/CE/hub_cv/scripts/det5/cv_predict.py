...
if __name__ == "__main__":
    ...
    object_detector = hub.Module(name=args.model_name)
    ...
    result1 = object_detector.object_detection(
        paths=inputs2,
        batch_size=args.batch_size,
        use_gpu=args.use_gpu,
        visualization=args.visualization,
    ...
    print(result)
    print(result1)
    assert len(os.listdir(os.path.join(args.output_dir))) == 2 * len(inputs1)
