...
python cv_predict.py --model_name %1 --use_gpu %2 --visualization %3 --face_detection %4 --scale %5 --batch_size %6 --output_dir %7 --img_path %8 >> %log_path%/%1_predict_%2_%3_%4_%5_%6.log 2>&1
if not !errorlevel! == 0 (
