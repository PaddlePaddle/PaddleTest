...
parser.add_argument("--line", type=int, default=4, help="Number of sentences")
parser.add_argument("--word", type=int, default=7, help="Number of words of each sentence")
parser.add_argument("--beam_width", type=int, default=5, help="beam search width.")
args = parser.parse_args()

if __name__ == "__main__":
    module = hub.Module(name=args.model_name, line=args.line, word=args.word)
    test_text = ["我喜欢你"]
