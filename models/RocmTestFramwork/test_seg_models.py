...
def test_deeplabv3_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="deeplabv3_resnet50_os8_cityscapes_1024x512_80k",
...
def test_fcn_hrnetw48_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="fcn_hrnetw48_cityscapes_1024x512_80k", yaml="configs/fcn/fcn_hrnetw48_cityscapes_1024x512_80k.yml"
    )
    model.test_seg_train()
...
def test_danet_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="danet_resnet50_os8_cityscapes_1024x512_80k",
...
def test_fastscnn_cityscapes_1024x1024_160k():
    ...
    """
    model = TestSegModel(
        model="fastscnn_cityscapes_1024x1024_160k", yaml="configs/fastscnn/fastscnn_cityscapes_1024x1024_160k.yml"
    )
    model.test_seg_train()
...
def test_ocrnet_hrnetw18_cityscapes_1024x512_160k():
    ...
    """
    model = TestSegModel(
        model="ocrnet_hrnetw18_cityscapes_1024x512_160k",
...
def test_unet_cityscapes_1024x512_160k():
    ...
    """
    model = TestSegModel(model="unet_cityscapes_1024x512_160k", yaml="configs/unet/unet_cityscapes_1024x512_160k.yml")
    model.test_seg_train()
...
def test_ann_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="ann_resnet50_os8_cityscapes_1024x512_80k",
...
def test_bisenet_cityscapes_1024x1024_160k():
    ...
    """
    model = TestSegModel(
        model="bisenet_cityscapes_1024x1024_160k", yaml="configs/bisenet/bisenet_cityscapes_1024x1024_160k.yml"
    )
    model.test_seg_eval()
...
def test_gcnet_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="gcnet_resnet50_os8_cityscapes_1024x512_80k",
...
def test_gscnn_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="gscnn_resnet50_os8_cityscapes_1024x512_80k",
...
def test_hardnet_cityscapes_1024x1024_160k():
    ...
    """
    model = TestSegModel(
        model="hardnet_cityscapes_1024x1024_160k", yaml="configs/hardnet/hardnet_cityscapes_1024x1024_160k.yml"
    )
    model.test_seg_eval()
...
def test_decoupledsegnet_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="decoupledsegnet_resnet50_os8_cityscapes_1024x512_80k",
...
def test_emanet_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="emanet_resnet50_os8_cityscapes_1024x512_80k",
...
def test_isanet_resnet50_os8_cityscapes_769x769_80k():
    ...
    """
    model = TestSegModel(
        model="isanet_resnet50_os8_cityscapes_769x769_80k",
...
def test_dnlnet_resnet50_os8_cityscapes_1024x512_80k():
    ...
    """
    model = TestSegModel(
        model="dnlnet_resnet50_os8_cityscapes_1024x512_80k",
