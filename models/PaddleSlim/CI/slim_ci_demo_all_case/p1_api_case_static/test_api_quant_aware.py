...
class TestQuantAwareCase1(StaticCase):
    ...
    def test_quant_op(self):
        ...
        print("----op_nums_1----", op_nums_1, "--quant_op_nums_1---", quant_op_nums_1, "convert_op_nums_1:",
              convert_op_nums_1, "convert_quant_op_nums_1:", convert_quant_op_nums_1)
        print("----op_nums_2----", op_nums_2, "--quant_op_nums_2---", quant_op_nums_2, "convert_op_nums_2:",
              convert_op_nums_2, "convert_quant_op_nums_2:", convert_quant_op_nums_2)
    ...
    def te_quant_op1(self):
        ...
        for config in config_list:
            ...
            convert_op_nums_2, convert_quant_op_nums_2 = self.get_op_number_2(
                convert_prog_2)
