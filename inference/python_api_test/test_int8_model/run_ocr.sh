...
python test_ocr_infer.py --model_path="./models/PPOCRV3_det_QAT" --model_filename="inference.pdmodel" --params_filename="inference.pdiparams" --image_file="test.jpg" --device='GPU' --use_trt=True --precision='int8' --benchmark=True --deploy_backend=paddle
