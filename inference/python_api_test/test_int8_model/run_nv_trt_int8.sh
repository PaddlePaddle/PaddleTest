...
$PYTHON test_segmentation_infer.py --model_path=models/pp_liteseg_int8/ppliteseg_int8.onnx --dataset='cityscape' --dataset_config=configs/cityscapes_1024x512_scale1.0.yml --deploy_backend=tensorrt --precision=int8 --model_name=ppliteseg --calibration_file=models/pp_liteseg_int8/calibration.cache
# HRNet trt int8
