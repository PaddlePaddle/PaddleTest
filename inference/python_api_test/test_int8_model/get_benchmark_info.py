...
def res_summary(trt_int8, trt_fp16, mkldnn_int8, mkldnn_fp32):
    ...
    gsb_total["jingdu"]["g"] = gsb_trt_int8["jingdu"]["g"] + gsb_trt_fp16["jingdu"]["g"] + gsb_mkldnn_int8["jingdu"]["g"] + gsb_mkldnn_fp32["jingdu"]["g"]
    gsb_total["jingdu"]["s"] = gsb_trt_int8["jingdu"]["s"] + gsb_trt_fp16["jingdu"]["s"] + gsb_mkldnn_int8["jingdu"]["s"] + gsb_mkldnn_fp32["jingdu"]["s"]
    gsb_total["jingdu"]["b"] = gsb_trt_int8["jingdu"]["b"] + gsb_trt_fp16["jingdu"]["b"] + gsb_mkldnn_int8["jingdu"]["b"] + gsb_mkldnn_fp32["jingdu"]["b"]
    gsb_total["jingdu"]["total"] = gsb_trt_int8["jingdu"]["total"] + gsb_trt_fp16["jingdu"]["total"] + gsb_mkldnn_int8["jingdu"]["total"] + gsb_mkldnn_fp32["jingdu"]["total"]
    gsb_total["jingdu"]["gsb"] = "{}:{}:{}".format(gsb_total["jingdu"]["g"], gsb_total["jingdu"]["s"], gsb_total["jingdu"]["b"])
    ...
    gsb_total["xingneng"]["g"] = gsb_trt_int8["xingneng"]["g"] + gsb_trt_fp16["xingneng"]["g"] + gsb_mkldnn_int8["xingneng"]["g"] + gsb_mkldnn_fp32["xingneng"]["g"]
    gsb_total["xingneng"]["s"] = gsb_trt_int8["xingneng"]["s"] + gsb_trt_fp16["xingneng"]["s"] + gsb_mkldnn_int8["xingneng"]["s"] + gsb_mkldnn_fp32["xingneng"]["s"]
    gsb_total["xingneng"]["b"] = gsb_trt_int8["xingneng"]["b"] + gsb_trt_fp16["xingneng"]["b"] + gsb_mkldnn_int8["xingneng"]["b"] + gsb_mkldnn_fp32["xingneng"]["b"]
    gsb_total["xingneng"]["total"] = gsb_trt_int8["xingneng"]["total"] + gsb_trt_fp16["xingneng"]["total"] + gsb_mkldnn_int8["xingneng"]["total"] + gsb_mkldnn_fp32["xingneng"]["total"]
    gsb_total["xingneng"]["gsb"] = "{}:{}:{}".format(gsb_total["xingneng"]["g"], gsb_total["xingneng"]["s"], gsb_total["xingneng"]["b"])
...
def res2xls(env, res, tongji):
    ...
    #sheet_detail.title = "detail"
    sheet_detail = wb.create_sheet(index=0, title="detail")
    #sheet_detail = wb.get_sheet_by_name("detail")
    ...
    #sheet_gsb = wb.get_sheet_by_name("gsb")
    sheet_gsb = wb["gsb"]
...
def run():
    ...
    #print(json.dumps(tongji, indent=4))
