...
$PYTHON test_ppyoloe_infer.py --model_path=models/picodet_s_416_coco_npu_no_postprocess_quant --reader_config=configs/picodet_reader.yml --precision=int8 --model_name=PicoDet --exclude_nms --device=XPU
$PYTHON test_ppyoloe_infer.py --model_path=models/picodet_s_416_coco_npu_no_postprocess_quant --reader_config=configs/picodet_reader.yml --precision=int8 --model_name=PicoDet --exclude_nms --device=XPU --use_l3=True
# YOLOv5s XPU int8
