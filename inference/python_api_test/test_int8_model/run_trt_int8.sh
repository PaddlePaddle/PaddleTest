...
$PYTHON test_yolo_series_infer.py --model_path=models/yolov5s_quant --use_trt=True --precision=int8 --arch=YOLOv5 --model_name=YOLOv5s
# YOLOv6s trt int8
echo "[Benchmark] Run YOLOv6s trt int8"
$PYTHON test_yolo_series_infer.py --model_path=models/yolov6s_quant --use_trt=True --precision=int8 --arch=YOLOv6 --model_name=YOLOv6s
# YOLOv7 trt int8
echo "[Benchmark] Run YOLOv7 trt int8"
$PYTHON test_yolo_series_infer.py --model_path=models/yolov7_quant --use_trt=True --precision=int8 --arch=YOLOv7 --model_name=YOLOv7
