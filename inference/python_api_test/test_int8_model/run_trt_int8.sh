...
# PPYOLOE+ trt int8
echo "[Benchmark] Run PPYOLOE+ trt int8"
$PYTHON test_ppyoloe_infer.py --model_path=models/ppyoloe_plus_crn_s_80e_coco_no_nms_quant --reader_config=configs/ppyoloe_reader.yml --use_trt=True --precision=int8 --model_name=PPYOLOE --exclude_nms
# PicoDet trt int8
