...
$PYTHON test_ppyoloe_infer.py --model_path=models/ppyoloe_crn_l_300e_coco --reader_config=configs/ppyoloe_reader.yml --use_trt=True --precision=fp32 --model_name=PPYOLOE
# PPYOLOE+ trt fp32
echo "[Benchmark] Run PPYOLOE+ trt fp32"
$PYTHON test_ppyoloe_infer.py --model_path=models/ppyoloe_plus_crn_s_80e_coco_no_nms --reader_config=configs/ppyoloe_plus_reader.yml --use_trt=True --precision=fp32 --model_name=PPYOLOE_PLUS --exclude_nms
# PicoDet trt fp32
...
# PicoDet no nms trt fp32
echo "[Benchmark] Run PicoDet no nms trt fp32"
$PYTHON test_ppyoloe_infer.py --model_path=models/picodet_s_416_coco_npu_no_postprocess --reader_config=configs/picodet_reader.yml --use_trt=True --precision=fp32 --model_name=PicoDet --exclude_nms
# YOLOv5s trt fp32
...
$PYTHON test_image_classification_infer.py --model_path=models/ResNet50_vd_infer --use_trt=True --use_gpu=True --model_name=ResNet_vd
# MobileNetV3_large trt fp32
echo "[Benchmark] Run MobileNetV3_large trt fp32"
$PYTHON test_image_classification_infer.py --model_path=models/MobileNetV3_large_x1_0_infer --use_trt=True --use_gpu=True --model_name=MobileNetV3_large
# PPLCNetV2 trt fp32
echo "[Benchmark] Run PPLCNetV2 trt fp32"
$PYTHON test_image_classification_infer.py --model_path=models/PPLCNetV2_base_infer --use_trt=True --use_gpu=True --model_name=PPLCNetV2
# PPHGNet_tiny trt fp32
echo "[Benchmark] Run PPHGNet_tiny trt fp32"
$PYTHON test_image_classification_infer.py --model_path=models/PPHGNet_tiny_infer --use_trt=True --use_gpu=True --model_name=PPHGNet_tiny
...
$PYTHON test_nlp_infer.py --model_path=models/AFQMC --model_filename=infer.pdmodel --params_filename=infer.pdiparams --task_name='afqmc' --use_trt --precision=fp32 --model_name=ERNIE_3.0-Medium
# PP-MiniLM trt fp32
echo "[Benchmark] Run PP-MiniLM trt fp32"
$PYTHON test_nlp_infer.py --model_path=models/afqmc --task_name='afqmc' --use_trt --precision=fp32 --model_name=PP-MiniLM
# BERT Base trt fp32
echo "[Benchmark] Run BERT Base trt fp32"
$PYTHON test_bert_infer.py --model_path=models/x2paddle_cola --use_trt --precision=fp32 --batch_size=1 --model_name=BERT_Base
