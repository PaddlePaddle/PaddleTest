...
def check_model_exist():
    ...
    ViT_base_patch16_224_url = (
        "https://paddle-qa.bj.bcebos.com/inference_model/unknown/vit_models/ViT_base_patch16_224.tgz"
    )
...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1-10 ViT_base_patch16_224 outputs with true val
    """
    check_model_exist()
