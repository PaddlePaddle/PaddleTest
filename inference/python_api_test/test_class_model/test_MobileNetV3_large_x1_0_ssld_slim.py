...
"""
test MobileNetV3_large_x1_0_ssld_act_qat model
"""
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 batch_size=1 MobileNetV3_large_x1_0_ssld_act_qat outputs with true val
    """
    check_model_exist()
