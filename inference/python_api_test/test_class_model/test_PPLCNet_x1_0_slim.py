...
def check_model_exist():
    ...
    check model exist
    """
    resnet50_slim_url = "https://paddle-qa.bj.bcebos.com/PaddleSlim/ACT_models/PPLCNet_x1_0_act_qat.tar"
    if not os.path.exists("./PPLCNet_x1_0_act_qat/inference.pdmodel"):
        wget.download(resnet50_slim_url, out="./")
        tar = tarfile.open("PPLCNet_x1_0_act_qat.tar")
        tar.extractall()
        tar.close()
...
def test_config():
    ...
    test_suite.load_config(
        model_file="./PPLCNet_x1_0_act_qat/inference.pdmodel",
        params_file="./PPLCNet_x1_0_act_qat/inference.pdiparams",
    )
...
def test_trt_int8_more_bz():
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite.collect_shape_info(
            model_path="./PPLCNet_x1_0_act_qat/", input_data_dict=input_data_dict, device="gpu"
        )
        del test_suite
        ...
        test_suite.trt_bz1_slim_test(
            ...
            dynamic=True,
            shape_range_file="./PPLCNet_x1_0_act_qat/shape_range.pbtxt",
            # use_calib_mode=True,
            with_benchmark=True,
            base_latency_ms=0.74,
