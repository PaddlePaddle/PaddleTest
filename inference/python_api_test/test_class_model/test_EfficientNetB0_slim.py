...
"""
test EfficientNetB0_act_qat model
"""
...
def check_model_exist():
    ...
    check model exist
    """
    resnet50_slim_url = "https://paddle-qa.bj.bcebos.com/PaddleSlim/ACT_models/EfficientNetB0_act_qat.tar"
    if not os.path.exists("./EfficientNetB0_act_qat/inference.pdmodel"):
        wget.download(resnet50_slim_url, out="./")
        tar = tarfile.open("EfficientNetB0_act_qat.tar")
        tar.extractall()
        tar.close()
...
def test_config():
    ...
    test_suite.load_config(
        model_file="./EfficientNetB0_act_qat/inference.pdmodel",
        params_file="./EfficientNetB0_act_qat/inference.pdiparams",
    )
...
def test_trt_int8_more_bz():
    """
    compared trt_int8 batch_size=1 EfficientNetB0_act_qat outputs with true val
    """
    check_model_exist()
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite.collect_shape_info(
            model_path="./EfficientNetB0_act_qat/", input_data_dict=input_data_dict, device="gpu"
        )
        del test_suite
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 batch_size=1 EfficientNetB0_act_qat outputs with true val
    """
    check_model_exist()
