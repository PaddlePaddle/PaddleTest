...
def check_model_exist():
    ...
    ViT_small_patch16_224_url = (
        "https://paddle-qa.bj.bcebos.com/inference_model/unknown/vit_models/ViT_small_patch16_224.tgz"
    )
...
def test_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1-10 ViT_small_patch16_224 outputs with true val
    """
    check_model_exist()
