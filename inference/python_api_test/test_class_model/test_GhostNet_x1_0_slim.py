...
"""
test GhostNet_x1_0_act_qat model
"""
...
def check_model_exist():
    ...
    check model exist
    """
    resnet50_slim_url = "https://paddle-qa.bj.bcebos.com/PaddleSlim/ACT_models/GhostNet_x1_0_act_qat.tar"
    if not os.path.exists("./GhostNet_x1_0_act_qat/inference.pdmodel"):
        wget.download(resnet50_slim_url, out="./")
        tar = tarfile.open("GhostNet_x1_0_act_qat.tar")
        tar.extractall()
        tar.close()
...
def test_trt_int8_more_bz():
    """
    compared trt_int8 batch_size=1 GhostNet_x1_0_act_qat outputs with true val
    """
    check_model_exist()
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite.collect_shape_info(
            model_path="./GhostNet_x1_0_act_qat/", input_data_dict=input_data_dict, device="gpu"
        )
        del test_suite
        ...
        test_suite.trt_bz1_slim_test(
            ...
            dynamic=True,
            shape_range_file="./GhostNet_x1_0_act_qat/shape_range.pbtxt",
            with_benchmark=True,
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 batch_size=1 GhostNet_x1_0_act_qat outputs with true val
    """
    check_model_exist()
