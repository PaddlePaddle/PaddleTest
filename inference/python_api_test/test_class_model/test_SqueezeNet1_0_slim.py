...
"""
test SqueezeNet1_0_act_qat model
"""
...
def test_trt_int8_more_bz():
    """
    compared trt_int8 batch_size=1 SqueezeNet1_0_act_qat outputs with true val
    """
    check_model_exist()
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite.collect_shape_info(
            model_path="./SqueezeNet1_0_act_qat/", input_data_dict=input_data_dict, device="gpu"
        )
        del test_suite
        ...
        test_suite.trt_bz1_slim_test(
            ...
            dynamic=True,
            shape_range_file="./SqueezeNet1_0_act_qat/shape_range.pbtxt",
            # use_calib_mode=True,
            with_benchmark=True,
            base_latency_ms=0.57,
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 batch_size=1 SqueezeNet1_0_act_qat outputs with true val
    """
    check_model_exist()
