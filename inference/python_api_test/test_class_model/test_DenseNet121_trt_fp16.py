...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1-2 DenseNet121 outputs with true val
    """
    check_model_exist()
...
def test_jetson_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1 DenseNet121 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp16_bz1_multi_thread():
    """
    compared trt fp16 batch_size=1 DenseNet121 multi_thread outputs with true val
    """
    check_model_exist()
