...
def test_trtfp32_more_bz():
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite2.trt_fp32_more_bz_test(input_data_dict, output_data_dict, delta=5e-2)
...
def test_trtfp32_bz1_multi_thread():
    ...
    test_suite2.trt_fp32_bz1_multi_thread_test(input_data_dict, output_data_dict, delta=1e-2)
...
def test_trtfp16_more_bz():
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite2.trt_fp16_more_bz_test(input_data_dict, output_data_dict, delta=1e-1)
...
def test_trtfp16_bz1_multi_thread():
    ...
    test_suite2 = InferenceTest()
    test_suite2.load_config(model_file="./pcpvt_base/inference.pdmodel", params_file="./pcpvt_base/inference.pdiparams")
    test_suite2.trt_fp16_bz1_multi_thread_test(input_data_dict, output_data_dict, delta=1e-1)
...
def test_mkldnn():
    ...
    test_suite2 = InferenceTest()
    test_suite2.load_config(model_file="./pcpvt_base/inference.pdmodel", params_file="./pcpvt_base/inference.pdiparams")
    test_suite2.mkldnn_test(input_data_dict, output_data_dict, delta=5e-3)
