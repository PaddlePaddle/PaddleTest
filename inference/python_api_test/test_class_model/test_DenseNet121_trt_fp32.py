...
def test_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1-2 DenseNet121 outputs with true val
    """
    check_model_exist()
...
def test_jetson_trt_fp32_bz1():
    """
    compared trt fp32 batch_size=1 DenseNet121 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp32_bz1_multi_thread():
    """
    compared trt fp32 batch_size=1 DenseNet121 multi_thread outputs with true val
    """
    check_model_exist()
