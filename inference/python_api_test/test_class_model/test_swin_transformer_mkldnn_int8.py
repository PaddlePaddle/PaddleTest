...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 swin_transformer outputs with true val
    """
    check_model_exist()
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite2.mkldnn_test(input_data_dict, output_data_dict, repeat=1, delta=1e-4, precision="int8")
