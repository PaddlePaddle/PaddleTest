...
def test_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1-2 deeplabv3 outputs with true val
    """
    check_model_exist()
...
def test_jetson_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1 deeplabv3 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp32_bz1_multi_thread():
    """
    compared trt fp32 batch_size=1 deeplabv3 multi_thread outputs with true val
    """
    check_model_exist()
