...
def test_trt_fp16_bz1():
    ...
    test_suite1.trt_more_bz_test(
        input_data_dict, output_data_dict, delta=1e-3, max_batch_size=1, precision="trt_fp16", dynamic=True, tuned=True
    )
    ...
    test_suite2.trt_more_bz_test(
        input_data_dict, output_data_dict, delta=1e-3, max_batch_size=1, precision="trt_fp16", dynamic=True
    )
