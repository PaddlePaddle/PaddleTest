...
class benchmark_argparser:
    def __init__(self):
        ...
        self.parser.add_argument(
            "--csv_file_path", dest="csv_file_path", help="csv for model download and parameters", type=str
        )
        ...
        benchmark_group.add_argument(
            "--model_name", dest="model_name", help="only specified models will be executed", type=str
        )
        benchmark_group.add_argument(
            "--all", dest="all", help="all models from DropBox will be downloaded", action="store_true"
        )
        self.parser.add_argument(
            "--jetson_devkit", dest="jetson_devkit", default="xavier-nx", help="Input Jetson Devkit name", type=str
        )
        ...
        self.parser.add_argument(
            "--precision", dest="precision", default="int8", help="precision for model int8 or fp16", type=str
        )
        ...
        self.parser.add_argument(
            "--jetson_clocks",
            dest="jetson_clocks",
            help="Set Clock Frequency to Max (jetson_clocks)",
            action="store_true",
        )
