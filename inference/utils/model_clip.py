...
def parse_args():
    ...
    parser.add_argument("--model_dir", type=str, default="./input_inference_model", help="input model path prefix")
    parser.add_argument("--model_file", type=str, default=None, help="input model file_name")
    parser.add_argument("--params_file", type=str, default=None, help="input params file_name")

    parser.add_argument("--path_prefix", type=str, default=None, help="input model path prefix")
    ...
    if path_prefix and not model_dir:
        ...
        if model_file and params_file:
            ...
            [inference_program, feed_target_names, fetch_targets] = paddle.fluid.io.load_inference_model(
                dirname=model_dir, executor=exe, model_filename=model_file, params_filename=params_file
            )
        else:
            [inference_program, feed_target_names, fetch_targets] = paddle.fluid.io.load_inference_model(
