...
def test_conv2d8():
    ...
    res = np.array(
        [
            [[[10.8965, 11.4650, 10.1772, 10.7457], [11.1693, 13.3298, 13.2501, 15.4106]]],
            [[[11.5616, 13.0999, 12.1508, 13.6891], [15.1975, 15.1694, 13.6606, 13.6325]]],
        ]
    )
    obj.run(
        res=res,
...
def test_conv2d9():
    ...
    res = np.array(
        [
            [[[14.0708, 11.8796, 9.9366, 10.3045], [12.3989, 13.3298, 13.2501, 14.4000]]],
            [[[11.6388, 12.2609, 11.9894, 13.6088], [16.7781, 15.1694, 13.6606, 13.7325]]],
        ]
    )
    obj.run(
        res=res,
...
def test_conv2d10():
    ...
    res = np.array(
        [
            [[[13.4084, 12.6462, 12.4637, 13.7390], [12.3192, 13.3298, 13.2501, 14.4797]]],
            [[[13.2020, 12.9375, 13.1067, 14.2273], [15.2694, 15.1694, 13.6606, 15.2412]]],
        ]
    )
    obj.run(
        res=res,
