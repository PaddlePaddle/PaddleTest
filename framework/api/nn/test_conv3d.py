...
def test_conv3d8():
    ...
    res = np.array(
        [
            [
                [
                    [[31.212072, 36.005825, 32.827934, 37.62167], [38.86807, 44.092163, 42.229324, 47.45341]],
                    [[35.650703, 38.057327, 34.95474, 37.361355], [41.854683, 44.12357, 39.39304, 41.661926]],
                ]
            ],
            [
                [
                    [[45.362045, 42.906467, 44.43419, 41.978603], [36.93101, 38.189747, 37.721684, 38.98042]],
                    [[40.621605, 42.058163, 46.969616, 48.406178], [42.471336, 43.393806, 43.987297, 44.90977]],
                ]
            ],
        ]
    )
...
def test_conv3d9():
    ...
    res = np.array(
        [
            [
                [
                    [[33.3041, 36.2519, 35.8157, 35.1824], [42.0793, 42.7396, 43.4696, 44.8771]],
                    [[40.6510, 36.6411, 34.6294, 40.0582], [44.9131, 44.1236, 39.3930, 37.7209]],
                ]
            ],
            [
                [
                    [[46.6887, 44.9393, 47.1106, 48.2136], [39.6648, 35.0459, 37.1553, 42.6259]],
                    [[37.2624, 41.3674, 44.2589, 46.4076], [44.5598, 43.3938, 43.9873, 46.6693]],
                ]
            ],
        ]
    )
...
def test_conv3d10():
    ...
    res = np.array(
        [
            [
                [
                    [[39.0804, 37.8193, 37.7592, 40.6474], [41.5604, 43.3670, 40.9862, 43.4428]],
                    [[40.7270, 40.2201, 38.0990, 42.4358], [40.1826, 44.1236, 39.3930, 42.4515]],
                ]
            ],
            [
                [
                    [[44.2844, 39.8735, 44.3788, 44.9034], [45.4391, 39.5882, 41.8209, 44.7978]],
                    [[44.2499, 42.8917, 46.3904, 46.5235], [45.1533, 43.3938, 43.9873, 46.0758]],
                ]
            ],
        ]
    )
