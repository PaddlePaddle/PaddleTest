...
obj = TestMaxout(paddle.nn.Maxout)
...
def test_maxout_base():
    ...
    obj.base(res=res, data=x, groups=2)
...
def test_maxout():
    ...
    # print(res)
    res = np.transpose(np.array(res), (1, 0, 2, 3))
    obj.run(res=res, data=x, groups=groups)
...
def test_maxout1():
    ...
    obj.run(res=res, data=x, groups=groups, axis=3)
...
def test_maxout2():
    ...
    # print(res)
    # res = np.transpose(np.array(res), (1, 0, 2, 3))
    obj.exception(etype=ValueError, mode="python", data=x, groups=groups)
