...
class TestFunctionalAvgPool3d(APIBase):
    """
    test
    """
...
obj = TestFunctionalAvgPool3d(paddle.nn.functional.avg_pool3d)
...
@pytest.mark.api_nn_avg_pool3d_vartype
...
@pytest.mark.api_nn_avg_pool3d_parameters
def test_avg_pool3d():
    """
    default
    """
...
def test_avg_pool3d1():
    ...
    padding = [0, 0, 0]
    ceil_mode = True
    res = avg_pool3D_forward_naive(
        x=x, ksize=kernel_size, strides=stride, paddings=padding, ceil_mode=ceil_mode, exclusive=False
    )
...
def test_avg_pool3d2():
    ...
    obj.run(
        res=res, x=x, kernel_size=kernel_size, stride=stride, padding=padding, data_format=data_format, exclusive=False
    )
...
def test_avg_pool3d3():
    ...
    padding = [0, 0, 0]
    res = avg_pool3D_forward_naive(x=x, ksize=kernel_size, strides=stride, paddings=padding)
    obj.run(res=res, x=x, kernel_size=kernel_size, stride=stride, padding=padding, exclusive=False)
...
def test_avg_pool3d5():
    ...
    padding = [1, 0, 0]
    res = avg_pool3D_forward_naive(x=x, ksize=kernel_size, strides=stride, paddings=padding)
    obj.run(res=res, x=x, kernel_size=kernel_size, stride=stride, padding=padding, exclusive=True)
...
def test_avg_pool3d12():
    ...
    padding = [0, 0, 0]
    exclusive = False
    res = avg_pool3D_forward_naive(x=x, ksize=kernel_size, strides=stride, paddings=padding, exclusive=exclusive)
