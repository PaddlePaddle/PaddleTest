...
class TestFunctionalAdaptiveAvgPool2d(APIBase):
    """
    test
    """
...
obj = TestFunctionalAdaptiveAvgPool2d(paddle.nn.functional.adaptive_avg_pool2d)
...
def test_adaptive_avg_pood2d3():
    ...
    obj.run(res=res, x=x, output_size=output_size, data_format="NHWC")
