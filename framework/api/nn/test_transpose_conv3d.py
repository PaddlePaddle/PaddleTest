...
class TestTransposeConv3d(APIBase):
    """
    test
    """
...
obj = TestTransposeConv3d(paddle.nn.Conv3DTranspose)


@pytest.mark.api_nn_Conv3DTranspose_vartype
...
@pytest.mark.api_nn_Conv3DTranspose_parameters
