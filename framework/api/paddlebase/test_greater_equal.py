...
class TestGreaterEqual(APIBase):
    """
    test greater_equal
    """
...
obj = TestGreaterEqual(paddle.greater_equal)


@pytest.mark.api_base_greater_equal_vartype
def test_greater_equal_base():
    """
    greater_equal_base
    """
    x_data = np.array([[2.0, 1.0, -3.5], [-2.7, 1.5, 3], [0, 4.1, 8.6]])
    y_data = np.array([[-2.0, 1.1, -3.5], [-2.5, 1.5, 3.5], [0.5, 4.2, 8.3]])
    res = np.greater_equal(x_data, y_data)
    obj.base(res=res, x=x_data, y=y_data)


@pytest.mark.api_base_greater_equal_parameters
def test_greater_equal_dicimal():
    """
    greater_equal_dicimal
    """
    x_data = np.array([[2.0, 1.0, -3.5], [-2.7, 1.5, 3], [0, 4.1, 8.6]])
    y_data = np.array([[-2.0, 1.1, -3.5], [-2.5, 1.5, 3.5], [0.5, 4.2, 8.3]])
    res = np.greater_equal(x_data, y_data)
...
@pytest.mark.api_base_greater_equal_parameters
def test_greater_equal_1D_tensor():
    """
    1D_tensor
    """
...
@pytest.mark.api_base_greater_equal_parameters
def test_greater_equal_broadcast_1():
    """
    broadcast_1
    """
...
@pytest.mark.api_base_greater_equal_parameters
def test_greater_equal_broadcast_2():
    """
    broadcast_2
    """
