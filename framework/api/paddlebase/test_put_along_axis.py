...
class PutAlongAxis(object):
    ...
    def cal_dynamic(self, device, dtype):
        ...
        return paddle.put_along_axis(arr, indices, values, self.axis, self.reduce)
    ...
    def cal_static(self, device):
        ...
        with paddle.utils.unique_name.guard():
            with paddle.static.program_guard(main_program=main_program, startup_program=startup_program):
                ...
                out = paddle.put_along_axis(data0, indices=data1, values=data2, axis=self.axis, reduce=self.reduce)
