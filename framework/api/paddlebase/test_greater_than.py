...
obj = TestGreaterThan(paddle.greater_than)


@pytest.mark.api_base_greater_than_vartype
def test_greater_than_base():
    """
    greater_than_base
    """
    x_data = np.array([[2.0, 1.0, -3.5], [-2.7, 1.5, 3], [0, 4.1, 8.6]])
    y_data = np.array([[-2.0, 1.1, -3.5], [-2.5, 1.5, 3.5], [0.5, 4.2, 8.3]])
    res = np.greater(x_data, y_data)
    obj.base(res=res, x=x_data, y=y_data)


@pytest.mark.api_base_greater_than_parameters
def test_greater_than_dicimal():
    """
    greater_than_dicimal
    """
    x_data = np.array([[2.0, 1.0, -3.5], [-2.7, 1.5, 3], [0, 4.1, 8.6]])
    y_data = np.array([[-2.0, 1.1, -3.5], [-2.5, 1.5, 3.5], [0.5, 4.2, 8.3]])
    res = np.greater(x_data, y_data)
...
@pytest.mark.api_base_greater_than_parameters
def test_greater_than_1D_tensor():
    """
    1D_tensor
    """
...
@pytest.mark.api_base_greater_than_parameters
def test_greater_than_broadcast_1():
    """
    broadcast_1
    """
...
@pytest.mark.api_base_greater_than_parameters
def test_greater_than_broadcast_2():
    """
    broadcast_2
    """
