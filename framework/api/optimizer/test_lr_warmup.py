...
def test_warmup_2():
    ...
    scheduler_2 = paddle.optimizer.lr.LinearWarmup(\
        learning_rate=learning_rate, warmup_steps=warmup_steps,\
        start_lr=start_lr, end_lr=end_lr, last_epoch=last_epoch, verbose=False)
...
def test_warmup_3():
    ...
    try:
        ...
        scheduler_3 = paddle.optimizer.lr.LinearWarmup(\
            learning_rate=learning_rate, warmup_steps=0,\
            start_lr=start_lr, end_lr=end_lr, verbose=True)
