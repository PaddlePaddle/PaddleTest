...
failed_ce_case_list = []
ignore_case_dir = {'device': [], 'fft': [], 'incubate': [], 'linalg': [], 'loss': [], 'nn': ['test_adaptive_avg_pool1D.py', 'test_adaptive_avg_pool2D.py', 'test_adaptive_avg_pool3D.py', 'test_beamsearchdecoder.py'], 'paddlebase': [], 'optimizer': []}
pwd = os.getcwd()
