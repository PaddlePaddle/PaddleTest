...
@pytest.mark.jit_logical_and_vartype
def test_jit_logical_and_base():
    """
...
def test_jit_logical_and_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.logical_and
        """
        a = paddle.logical_and(inputs, inputs_)
        return a
...
@pytest.mark.jit_logical_and_parameters
def test_jit_logical_and_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.logical_and(inputs, inputs_)
