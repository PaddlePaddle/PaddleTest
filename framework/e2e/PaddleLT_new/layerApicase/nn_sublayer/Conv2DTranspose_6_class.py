...
class LayerCase(paddle.nn.Layer):
    """
    case名称: Conv2DTranspose_6
    api简介: 2维反卷积
    """

    def __init__(self):
        super(LayerCase, self).__init__()
        self.func = paddle.nn.Conv2DTranspose(in_channels=6, out_channels=3, kernel_size=[3, 3], stride=2, padding=[1, 0], dilation=1, groups=3, data_format='NHWC', output_padding=1, )
