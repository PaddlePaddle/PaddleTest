...
class LayerCase(paddle.nn.Layer):
    """
    case名称: Transformer_2
    api简介: Transformer模型
    """

    def __init__(self):
        super(LayerCase, self).__init__()
        self.func = paddle.nn.Transformer(d_model=128, nhead=2, num_encoder_layers=4, num_decoder_layers=4, dim_feedforward=512, attn_dropout=0.4, )
