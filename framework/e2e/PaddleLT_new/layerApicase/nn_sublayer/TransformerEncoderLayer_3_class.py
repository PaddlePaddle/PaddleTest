...
class LayerCase(paddle.nn.Layer):
    """
    case名称: TransformerEncoderLayer_3
    api简介: Transformer编码器层
    """

    def __init__(self):
        super(LayerCase, self).__init__()
        self.func = paddle.nn.TransformerEncoderLayer(d_model=128, nhead=2, dim_feedforward=512, normalize_before=True, )
...
def create_inputspec(): 
    inputspec = ( 
        paddle.static.InputSpec(shape=(2, 4, 128), dtype=paddle.float32, stop_gradient=False), 
