...
def create_tensor_inputs():
    q = paddle.randn([1, 1024, 32, 128], dtype="float32")
    k = paddle.randn([1, 1024, 32, 128], dtype="float32")
    cos = paddle.randn([1, 1024, 1, 128], dtype="float32")
    sin = paddle.randn([1, 1024, 1, 128], dtype="float32")
