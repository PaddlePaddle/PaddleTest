...
def create_inputspec(): 
    inputspec = ( 
        paddle.static.InputSpec(shape=(2, 3, 4, 5, 6), dtype=paddle.float32, stop_gradient=False), 
        paddle.static.InputSpec(shape=(3, 2, 4, 5, 6), dtype=paddle.float32, stop_gradient=False), 
    )
    return inputspec
