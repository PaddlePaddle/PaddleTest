...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_6 = paddle.nn.functional.conv._conv_nd(var_0, self.parameter_2, bias=self.parameter_23, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_7 = paddle.tensor.linalg.transpose(var_6, [0, 2, 3, 1])
        var_8 = paddle.tensor.manipulation.reshape(var_7, [0, -1, 4])
        var_9 = paddle.nn.functional.conv._conv_nd(var_0, self.parameter_15, bias=self.parameter_21, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_10 = paddle.tensor.linalg.transpose(var_9, [0, 2, 3, 1])
        var_11 = paddle.tensor.manipulation.reshape(var_10, [0, -1, 21])
        var_12 = paddle.nn.functional.conv._conv_nd(var_1, self.parameter_7, bias=self.parameter_20, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_13 = paddle.tensor.linalg.transpose(var_12, [0, 2, 3, 1])
        var_14 = paddle.tensor.manipulation.reshape(var_13, [0, -1, 4])
        var_15 = paddle.nn.functional.conv._conv_nd(var_1, self.parameter_19, bias=self.parameter_10, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_16 = paddle.tensor.linalg.transpose(var_15, [0, 2, 3, 1])
        var_17 = paddle.tensor.manipulation.reshape(var_16, [0, -1, 21])
        var_18 = paddle.nn.functional.conv._conv_nd(var_2, self.parameter_12, bias=self.parameter_8, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_19 = paddle.tensor.linalg.transpose(var_18, [0, 2, 3, 1])
        var_20 = paddle.tensor.manipulation.reshape(var_19, [0, -1, 4])
        var_21 = paddle.nn.functional.conv._conv_nd(var_2, self.parameter_0, bias=self.parameter_1, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_22 = paddle.tensor.linalg.transpose(var_21, [0, 2, 3, 1])
        var_23 = paddle.tensor.manipulation.reshape(var_22, [0, -1, 21])
        var_24 = paddle.nn.functional.conv._conv_nd(var_3, self.parameter_13, bias=self.parameter_14, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_25 = paddle.tensor.linalg.transpose(var_24, [0, 2, 3, 1])
        var_26 = paddle.tensor.manipulation.reshape(var_25, [0, -1, 4])
        var_27 = paddle.nn.functional.conv._conv_nd(var_3, self.parameter_17, bias=self.parameter_16, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_28 = paddle.tensor.linalg.transpose(var_27, [0, 2, 3, 1])
        var_29 = paddle.tensor.manipulation.reshape(var_28, [0, -1, 21])
        var_30 = paddle.nn.functional.conv._conv_nd(var_4, self.parameter_5, bias=self.parameter_22, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_31 = paddle.tensor.linalg.transpose(var_30, [0, 2, 3, 1])
        var_32 = paddle.tensor.manipulation.reshape(var_31, [0, -1, 4])
        var_33 = paddle.nn.functional.conv._conv_nd(var_4, self.parameter_11, bias=self.parameter_6, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_34 = paddle.tensor.linalg.transpose(var_33, [0, 2, 3, 1])
        var_35 = paddle.tensor.manipulation.reshape(var_34, [0, -1, 21])
        var_36 = paddle.nn.functional.conv._conv_nd(var_5, self.parameter_9, bias=self.parameter_18, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_37 = paddle.tensor.linalg.transpose(var_36, [0, 2, 3, 1])
        var_38 = paddle.tensor.manipulation.reshape(var_37, [0, -1, 4])
        var_39 = paddle.nn.functional.conv._conv_nd(var_5, self.parameter_3, bias=self.parameter_4, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
