...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_8 = paddle.nn.functional.conv._conv_nd(var_5, self.parameter_2, bias=None, stride=[1, 1], padding=[2, 2], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=160, data_format='NCHW', channel_dim=1, op_type='depthwise_conv2d', use_cudnn=False)
        var_9 = paddle.nn.functional.conv._conv_nd(var_6, self.parameter_1, bias=None, stride=[1, 1], padding=[3, 3], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=160, data_format='NCHW', channel_dim=1, op_type='depthwise_conv2d', use_cudnn=False)
