...
def create_tensor_inputs():
    inputs = (
        paddle.rand(shape=[21, 256], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[21, 256]).astype('float32'),
