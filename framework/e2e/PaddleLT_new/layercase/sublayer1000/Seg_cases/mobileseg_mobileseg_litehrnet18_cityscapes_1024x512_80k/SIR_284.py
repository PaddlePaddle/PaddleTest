...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_9 = paddle.nn.functional.conv._conv_nd(var_8, self.parameter_12, bias=self.parameter_15, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_10 = paddle.nn.functional.activation.relu(var_9)
        var_11 = paddle.nn.functional.conv._conv_nd(var_10, self.parameter_9, bias=self.parameter_1, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_12 = paddle.nn.functional.sigmoid(var_11)
        ...
        var_15 = paddle.nn.functional.conv._conv_nd(var_14, self.parameter_4, bias=self.parameter_13, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_16 = paddle.nn.functional.activation.relu(var_15)
        var_17 = paddle.nn.functional.conv._conv_nd(var_16, self.parameter_7, bias=self.parameter_8, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_18 = paddle.nn.functional.sigmoid(var_17)
        ...
        var_21 = paddle.nn.functional.conv._conv_nd(var_20, self.parameter_3, bias=self.parameter_0, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_22 = paddle.nn.functional.activation.relu(var_21)
        var_23 = paddle.nn.functional.conv._conv_nd(var_22, self.parameter_6, bias=self.parameter_14, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_24 = paddle.nn.functional.sigmoid(var_23)
        ...
        var_27 = paddle.nn.functional.conv._conv_nd(var_26, self.parameter_2, bias=self.parameter_10, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_28 = paddle.nn.functional.activation.relu(var_27)
        var_29 = paddle.nn.functional.conv._conv_nd(var_28, self.parameter_11, bias=self.parameter_5, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_30 = paddle.nn.functional.sigmoid(var_29)
