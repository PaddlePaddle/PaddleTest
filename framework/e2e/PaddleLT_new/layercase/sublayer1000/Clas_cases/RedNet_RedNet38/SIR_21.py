...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [22, 32, 28, 28], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [22, 128, 28, 28], dtype: paddle.float32, stop_gradient: False)
    ):
        ...
        var_3 = var_2.reshape((22, 8, 49, 28, 28,))
        var_4 = var_3.unsqueeze(2)
        var_5 = paddle.nn.functional.common.unfold(var_1, 7, 1, 3, 1)
        var_6 = var_5.reshape((22, 8, 16, 49, 28, 28,))
        var_7 = var_4.__mul__(var_6)
        var_8 = var_7.sum(axis=3)
        var_9 = var_8.reshape((22, 128, 28, 28,))
        return var_9


def create_tensor_inputs():
    inputs = (
        paddle.rand(shape=[22, 32, 28, 28], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[22, 32, 28, 28]).astype('float32'),
