...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [10, 16, 56, 56], dtype: paddle.float32, stop_gradient: False)
        ...
        var_3 = var_2.reshape((10, 4, 49, 56, 56,))
        var_4 = var_3.unsqueeze(2)
        var_5 = paddle.nn.functional.common.unfold(var_1, 7, 1, 3, 1)
        var_6 = var_5.reshape((10, 4, 16, 49, 56, 56,))
        var_7 = var_4.__mul__(var_6)
        var_8 = var_7.sum(axis=3)
        var_9 = var_8.reshape((10, 64, 56, 56,))
        return var_9


def create_paddle_inputs():
    inputs = (
        paddle.rand(shape=[10, 16, 56, 56], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[10, 16, 56, 56]).astype('float32'),
