...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_10 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_9, output_size=(7, 7,), data_format='NCHW', name=None)
        var_11 = var_10.reshape([10, 49])
        var_12 = var_1.pow(2)
        var_13 = var_12.mean(1, keepdim=True)
        var_14 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_13, output_size=(7, 7,), data_format='NCHW', name=None)
        var_15 = var_14.reshape([10, 49])
        var_16 = var_2.pow(2)
        var_17 = var_16.mean(1, keepdim=True)
        var_18 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_17, output_size=(7, 7,), data_format='NCHW', name=None)
        var_19 = var_18.reshape([10, 49])
        var_20 = var_3.pow(2)
        var_21 = var_20.mean(1, keepdim=True)
        var_22 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_21, output_size=(7, 7,), data_format='NCHW', name=None)
        var_23 = var_22.reshape([10, 49])
        var_24 = var_4.pow(2)
        var_25 = var_24.mean(1, keepdim=True)
        var_26 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_25, output_size=(7, 7,), data_format='NCHW', name=None)
        var_27 = var_26.reshape([10, 49])
        var_28 = var_5.pow(2)
        var_29 = var_28.mean(1, keepdim=True)
        var_30 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_29, output_size=(7, 7,), data_format='NCHW', name=None)
        var_31 = var_30.reshape([10, 49])
        var_32 = var_6.pow(2)
        var_33 = var_32.mean(1, keepdim=True)
        var_34 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_33, output_size=(7, 7,), data_format='NCHW', name=None)
        var_35 = var_34.reshape([10, 49])
        var_36 = var_7.pow(2)
        var_37 = var_36.mean(1, keepdim=True)
        var_38 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_37, output_size=(7, 7,), data_format='NCHW', name=None)
        var_39 = var_38.reshape([10, 49])
