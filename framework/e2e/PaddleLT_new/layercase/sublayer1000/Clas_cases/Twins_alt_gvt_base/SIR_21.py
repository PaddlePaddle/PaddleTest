...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_1 = paddle.nn.functional.common.linear(x=var_0, weight=self.parameter_1, bias=self.parameter_5, name=None)
        ...
        var_9 = paddle.nn.functional.norm.layer_norm(var_8, normalized_shape=[192], weight=self.parameter_4, bias=self.parameter_6, epsilon=1e-05)
        var_10 = paddle.nn.functional.common.linear(x=var_9, weight=self.parameter_7, bias=self.parameter_3, name=None)
