...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_2 = var_1.reshape([43, 384, 14, 14])
        var_3 = paddle.nn.functional.conv._conv_nd(var_2, self.parameter_1, bias=self.parameter_0, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=384, data_format='NCHW', channel_dim=1, op_type='depthwise_conv2d', use_cudnn=False)
