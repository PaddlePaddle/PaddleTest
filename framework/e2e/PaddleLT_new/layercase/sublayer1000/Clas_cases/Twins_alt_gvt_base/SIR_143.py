...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_1 = paddle.nn.functional.common.linear(x=var_0, weight=self.parameter_0, bias=self.parameter_2, name=None)
        var_2 = var_1.reshape([11, 49, 24, 32])
        var_3 = var_2.transpose([0, 2, 1, 3])
        var_4 = paddle.nn.functional.common.linear(x=var_0, weight=self.parameter_3, bias=self.parameter_1, name=None)
        var_5 = var_4.reshape([11, 49, 2, 24, 32])
