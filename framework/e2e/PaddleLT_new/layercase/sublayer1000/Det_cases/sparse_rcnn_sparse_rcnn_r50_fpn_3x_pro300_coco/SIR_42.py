...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 256, 144, 216], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 256, 72, 108], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 36, 54], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 18, 27], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 300, 4], dtype: paddle.float32, stop_gradient: True)
...
def create_tensor_inputs():
    inputs = (
        ...
        paddle.rand(shape=[1, 256, 72, 108], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 36, 54], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 18, 27], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 256, 72, 108]).astype('float32'),
        np.random.random(size=[1, 256, 36, 54]).astype('float32'),
        np.random.random(size=[1, 256, 18, 27]).astype('float32'),
