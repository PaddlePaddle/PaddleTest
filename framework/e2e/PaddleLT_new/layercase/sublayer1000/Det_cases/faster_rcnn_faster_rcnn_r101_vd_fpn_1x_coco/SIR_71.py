...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 256, 184, 280], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 256, 92, 140], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 46, 70], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 23, 35], dtype: paddle.float32, stop_gradient: False)
