...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 256, 176, 176], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 256, 88, 88], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 44, 44], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 22, 22], dtype: paddle.float32, stop_gradient: False)
...
def create_paddle_inputs():
    inputs = (
        ...
        paddle.rand(shape=[1, 256, 22, 22], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 256, 22, 22]).astype('float32'),
