...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_5,    # (shape: [1, 3549, 68], dtype: paddle.float32, stop_gradient: False)
...
def create_tensor_inputs():
    inputs = (
        ...
        paddle.rand(shape=[1, 3549, 68], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 3549, 68]).astype('float32'),
