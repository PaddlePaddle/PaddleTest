...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: False)
        var_5,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: True)
        var_6,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: True)
        var_7,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: True)
        var_8,    # (shape: [1, 3, 42, 42, 1], dtype: paddle.float32, stop_gradient: True)
    ):
...
def create_tensor_inputs():
    inputs = (
        paddle.rand(shape=[1, 3, 42, 42, 1], dtype=paddle.float32),
        paddle.rand(shape=[1, 3, 42, 42, 1], dtype=paddle.float32),
        paddle.rand(shape=[1, 3, 42, 42, 1], dtype=paddle.float32),
        paddle.rand(shape=[1, 3, 42, 42, 1], dtype=paddle.float32),
        paddle.rand(shape=[1, 3, 42, 42, 1], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 3, 42, 42, 1]).astype('float32'),
        np.random.random(size=[1, 3, 42, 42, 1]).astype('float32'),
        np.random.random(size=[1, 3, 42, 42, 1]).astype('float32'),
        np.random.random(size=[1, 3, 42, 42, 1]).astype('float32'),
        np.random.random(size=[1, 3, 42, 42, 1]).astype('float32'),
