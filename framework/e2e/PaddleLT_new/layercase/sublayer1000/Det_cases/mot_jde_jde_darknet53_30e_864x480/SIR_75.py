...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_55 = self.parameter_0.__neg__()
        var_56 = paddle.tensor.ops.exp(var_55)
        var_57 = var_56.__mul__(var_8)
        var_58 = var_57.__add__(self.parameter_0)
