...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [4, 4], dtype: paddle.float32, stop_gradient: True)
        var_1,    # (shape: [1], dtype: paddle.int32, stop_gradient: True)
        var_2,    # (shape: [1, 256, 176, 264], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 88, 132], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 256, 44, 66], dtype: paddle.float32, stop_gradient: False)
        var_5,    # (shape: [1, 256, 22, 33], dtype: paddle.float32, stop_gradient: False)
    ):
