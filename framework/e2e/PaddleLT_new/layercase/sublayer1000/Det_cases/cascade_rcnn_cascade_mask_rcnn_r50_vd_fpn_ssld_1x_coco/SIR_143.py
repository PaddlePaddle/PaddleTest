...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [4, 1], dtype: paddle.int64, stop_gradient: True)
        var_1,    # (shape: [1], dtype: paddle.int32, stop_gradient: True)
        var_2,    # (shape: [4], dtype: paddle.int32, stop_gradient: True)
        var_3,    # (shape: [4, 28, 28], dtype: paddle.int32, stop_gradient: True)
