...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1027], dtype: paddle.int64, stop_gradient: True)
        var_1,    # (shape: [1027], dtype: paddle.int32, stop_gradient: True)
        var_2,    # (shape: [27], dtype: paddle.int32, stop_gradient: True)
    ):
...
def create_tensor_inputs():
    inputs = (
        paddle.randint(low=0, high=10, shape=[1027], dtype=paddle.int64),
        paddle.randint(low=0, high=10, shape=[1027], dtype=paddle.int32),
        paddle.randint(low=0, high=10, shape=[27], dtype=paddle.int32),
    )
    return inputs
...
def create_numpy_inputs():
    inputs = (
        np.random.randint(low=0, high=10, size=[1027], dtype='int64'),
        np.random.randint(low=0, high=10, size=[1027], dtype='int32'),
        np.random.randint(low=0, high=10, size=[27], dtype='int32'),
    )
    return inputs
