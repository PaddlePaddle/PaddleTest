...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 256, 200, 272], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 256, 100, 136], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 50, 68], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 25, 34], dtype: paddle.float32, stop_gradient: False)
...
def create_tensor_inputs():
    inputs = (
        ...
        paddle.rand(shape=[1, 256, 100, 136], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 50, 68], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 25, 34], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 256, 100, 136]).astype('float32'),
        np.random.random(size=[1, 256, 50, 68]).astype('float32'),
        np.random.random(size=[1, 256, 25, 34]).astype('float32'),
