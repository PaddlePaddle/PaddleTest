...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 64, 136, 208], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 64, 68, 104], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 64, 34, 52], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 64, 17, 26], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [390, 4], dtype: paddle.float32, stop_gradient: True)
...
def create_tensor_inputs():
    inputs = (
        paddle.rand(shape=[1, 64, 136, 208], dtype=paddle.float32),
        paddle.rand(shape=[1, 64, 68, 104], dtype=paddle.float32),
        paddle.rand(shape=[1, 64, 34, 52], dtype=paddle.float32),
        paddle.rand(shape=[1, 64, 17, 26], dtype=paddle.float32),
        paddle.rand(shape=[390, 4], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 64, 136, 208]).astype('float32'),
        np.random.random(size=[1, 64, 68, 104]).astype('float32'),
        np.random.random(size=[1, 64, 34, 52]).astype('float32'),
        np.random.random(size=[1, 64, 17, 26]).astype('float32'),
        np.random.random(size=[390, 4]).astype('float32'),
