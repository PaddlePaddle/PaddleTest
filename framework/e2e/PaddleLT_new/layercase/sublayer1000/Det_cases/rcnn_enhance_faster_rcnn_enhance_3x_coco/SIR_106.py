...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [6, 1, 1], dtype: paddle.float32, stop_gradient: True)
        var_1,    # (shape: [6, 1, 1], dtype: paddle.float32, stop_gradient: True)
        var_2,    # (shape: [6, 1, 1], dtype: paddle.float32, stop_gradient: True)
