...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 4096, 80], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 1024, 80], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 80], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 4096, 4], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 1024, 4], dtype: paddle.float32, stop_gradient: False)
        var_5,    # (shape: [1, 256, 4], dtype: paddle.float32, stop_gradient: False)
        var_6,    # (shape: [1, 4096, 1], dtype: paddle.float32, stop_gradient: False)
        var_7,    # (shape: [1, 1024, 1], dtype: paddle.float32, stop_gradient: False)
        var_8,    # (shape: [1, 256, 1], dtype: paddle.float32, stop_gradient: False)
    ):
        ...
        var_12 = paddle.tensor.creation.arange(64)
        var_13 = var_12.__add__(0.0)
        var_14 = var_13.__mul__(8)
        var_15 = paddle.tensor.creation.arange(64)
        ...
        var_22 = paddle.tensor.creation.full([4096, 1], 8, dtype='float32')
        var_23 = paddle.tensor.creation.arange(32)
        var_24 = var_23.__add__(0.0)
        var_25 = var_24.__mul__(16)
        var_26 = paddle.tensor.creation.arange(32)
        ...
        var_33 = paddle.tensor.creation.full([1024, 1], 16, dtype='float32')
        var_34 = paddle.tensor.creation.arange(16)
        var_35 = var_34.__add__(0.0)
        var_36 = var_35.__mul__(32)
        var_37 = paddle.tensor.creation.arange(16)
        ...
        var_44 = paddle.tensor.creation.full([256, 1], 32, dtype='float32')
        ...
        var_57 = paddle.tensor.creation.arange(64)
        var_58 = var_57.__add__(0.5)
        var_59 = var_58.__mul__(8)
        var_60 = paddle.tensor.creation.arange(64)
        ...
        var_67 = paddle.tensor.creation.full([4096, 1], 8, dtype='float32')
        var_68 = paddle.tensor.creation.arange(32)
        var_69 = var_68.__add__(0.5)
        var_70 = var_69.__mul__(16)
        var_71 = paddle.tensor.creation.arange(32)
        ...
        var_78 = paddle.tensor.creation.full([1024, 1], 16, dtype='float32')
        var_79 = paddle.tensor.creation.arange(16)
        var_80 = var_79.__add__(0.5)
        var_81 = var_80.__mul__(32)
        var_82 = paddle.tensor.creation.arange(16)
        ...
        var_89 = paddle.tensor.creation.full([256, 1], 32, dtype='float32')
...
def create_tensor_inputs():
    inputs = (
        paddle.rand(shape=[1, 4096, 80], dtype=paddle.float32),
        paddle.rand(shape=[1, 1024, 80], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 80], dtype=paddle.float32),
        paddle.rand(shape=[1, 4096, 4], dtype=paddle.float32),
        paddle.rand(shape=[1, 1024, 4], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 4], dtype=paddle.float32),
        paddle.rand(shape=[1, 4096, 1], dtype=paddle.float32),
        paddle.rand(shape=[1, 1024, 1], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 1], dtype=paddle.float32),
    )
    return inputs
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 4096, 80]).astype('float32'),
        np.random.random(size=[1, 1024, 80]).astype('float32'),
        np.random.random(size=[1, 256, 80]).astype('float32'),
        np.random.random(size=[1, 4096, 4]).astype('float32'),
        np.random.random(size=[1, 1024, 4]).astype('float32'),
        np.random.random(size=[1, 256, 4]).astype('float32'),
        np.random.random(size=[1, 4096, 1]).astype('float32'),
        np.random.random(size=[1, 1024, 1]).astype('float32'),
        np.random.random(size=[1, 256, 1]).astype('float32'),
    )
    return inputs
