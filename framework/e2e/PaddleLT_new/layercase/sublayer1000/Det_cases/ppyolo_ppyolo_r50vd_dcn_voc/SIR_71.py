...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_4,    # (shape: [1, 3, 48, 48, 1], dtype: paddle.float32, stop_gradient: False)
        ...
        var_8,    # (shape: [1, 3, 48, 48, 1], dtype: paddle.float32, stop_gradient: True)
    ):
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 3, 48, 48, 1]).astype('float32'),
        np.random.random(size=[1, 3, 48, 48, 1]).astype('float32'),
        np.random.random(size=[1, 3, 48, 48, 1]).astype('float32'),
        np.random.random(size=[1, 3, 48, 48, 1]).astype('float32'),
        np.random.random(size=[1, 3, 48, 48, 1]).astype('float32'),
