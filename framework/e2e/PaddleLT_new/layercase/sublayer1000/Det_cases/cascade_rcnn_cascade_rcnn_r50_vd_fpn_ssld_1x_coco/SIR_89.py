...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,  # (shape: [1, 256, 200, 304], dtype: paddle.float32, stop_gradient: False)
        ...
        var_3,  # (shape: [1, 256, 25, 38], dtype: paddle.float32, stop_gradient: False)
        ...
        var_15 = paddle.vision.ops.roi_align(
            x=var_0, boxes=var_6, boxes_num=var_11, output_size=7, spatial_scale=0.25, sampling_ratio=0, aligned=True
        )
        var_16 = paddle.vision.ops.roi_align(
            x=var_1, boxes=var_7, boxes_num=var_12, output_size=7, spatial_scale=0.125, sampling_ratio=0, aligned=True
        )
        var_17 = paddle.vision.ops.roi_align(
            x=var_2, boxes=var_8, boxes_num=var_13, output_size=7, spatial_scale=0.0625, sampling_ratio=0, aligned=True
        )
        var_18 = paddle.vision.ops.roi_align(
            x=var_3, boxes=var_9, boxes_num=var_14, output_size=7, spatial_scale=0.03125, sampling_ratio=0, aligned=True
        )
