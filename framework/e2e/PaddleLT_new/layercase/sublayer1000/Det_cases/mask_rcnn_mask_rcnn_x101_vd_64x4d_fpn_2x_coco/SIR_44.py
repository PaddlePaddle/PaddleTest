...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 3, 168, 256]).astype('float32'),
        np.random.random(size=[1, 3, 84, 128]).astype('float32'),
        np.random.random(size=[1, 3, 42, 64]).astype('float32'),
        np.random.random(size=[1, 3, 21, 32]).astype('float32'),
        np.random.random(size=[1, 3, 11, 16]).astype('float32'),
        np.random.random(size=[1, 12, 168, 256]).astype('float32'),
        np.random.random(size=[1, 12, 84, 128]).astype('float32'),
        np.random.random(size=[1, 12, 42, 64]).astype('float32'),
        np.random.random(size=[1, 12, 21, 32]).astype('float32'),
        np.random.random(size=[1, 12, 11, 16]).astype('float32'),
        np.random.random(size=[129024, 4]).astype('float32'),
        np.random.random(size=[32256, 4]).astype('float32'),
        np.random.random(size=[8064, 4]).astype('float32'),
        np.random.random(size=[2016, 4]).astype('float32'),
        np.random.random(size=[528, 4]).astype('float32'),
    )
    return inputs
