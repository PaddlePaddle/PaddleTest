...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_2,    # (shape: [1, 256, 168, 256], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 84, 128], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 256, 42, 64], dtype: paddle.float32, stop_gradient: False)
        var_5,    # (shape: [1, 256, 21, 32], dtype: paddle.float32, stop_gradient: False)
    ):
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 256, 21, 32]).astype('float32'),
    )
    return inputs
