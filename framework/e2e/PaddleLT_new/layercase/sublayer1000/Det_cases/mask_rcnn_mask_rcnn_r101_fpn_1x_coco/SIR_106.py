...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_2,    # (shape: [1, 256, 192, 288], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 96, 144], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 256, 48, 72], dtype: paddle.float32, stop_gradient: False)
        var_5,    # (shape: [1, 256, 24, 36], dtype: paddle.float32, stop_gradient: False)
    ):
