...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,  # (shape: [1, 1, 4116], dtype: paddle.float32, stop_gradient: True)
        var_1,  # (shape: [1, 1], dtype: paddle.int32, stop_gradient: True)
        var_2,  # (shape: [1, 1, 1], dtype: paddle.int32, stop_gradient: True)
        var_3,  # (shape: [1, 4116], dtype: paddle.float32, stop_gradient: True)
        var_4,  # (shape: [1, 1, 4], dtype: paddle.float32, stop_gradient: True)
        var_5,  # (shape: [1, 1, 4116], dtype: paddle.float32, stop_gradient: True)
        var_6,  # (shape: [1, 1, 4116], dtype: paddle.float32, stop_gradient: True)
    ):
        ...
        var_13 = var_12.reshape([1, 4116])
        var_14 = var_3.__gt__(0)
        var_15 = paddle.tensor.creation.full_like(var_13, 20)
