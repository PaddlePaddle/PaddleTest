...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 3, 192, 288], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 3, 96, 144], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 3, 48, 72], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 3, 24, 36], dtype: paddle.float32, stop_gradient: False)
        var_4,    # (shape: [1, 3, 12, 18], dtype: paddle.float32, stop_gradient: False)
        var_5,    # (shape: [1, 12, 192, 288], dtype: paddle.float32, stop_gradient: False)
        var_6,    # (shape: [1, 12, 96, 144], dtype: paddle.float32, stop_gradient: False)
        var_7,    # (shape: [1, 12, 48, 72], dtype: paddle.float32, stop_gradient: False)
        var_8,    # (shape: [1, 12, 24, 36], dtype: paddle.float32, stop_gradient: False)
        var_9,    # (shape: [1, 12, 12, 18], dtype: paddle.float32, stop_gradient: False)
        var_10,    # (shape: [165888, 4], dtype: paddle.float32, stop_gradient: True)
        var_11,    # (shape: [41472, 4], dtype: paddle.float32, stop_gradient: True)
        var_12,    # (shape: [10368, 4], dtype: paddle.float32, stop_gradient: True)
        var_13,    # (shape: [2592, 4], dtype: paddle.float32, stop_gradient: True)
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 3, 192, 288]).astype('float32'),
        np.random.random(size=[1, 3, 96, 144]).astype('float32'),
        np.random.random(size=[1, 3, 48, 72]).astype('float32'),
        np.random.random(size=[1, 3, 24, 36]).astype('float32'),
        np.random.random(size=[1, 3, 12, 18]).astype('float32'),
        np.random.random(size=[1, 12, 192, 288]).astype('float32'),
        np.random.random(size=[1, 12, 96, 144]).astype('float32'),
        np.random.random(size=[1, 12, 48, 72]).astype('float32'),
        np.random.random(size=[1, 12, 24, 36]).astype('float32'),
        np.random.random(size=[1, 12, 12, 18]).astype('float32'),
        np.random.random(size=[165888, 4]).astype('float32'),
        np.random.random(size=[41472, 4]).astype('float32'),
        np.random.random(size=[10368, 4]).astype('float32'),
        np.random.random(size=[2592, 4]).astype('float32'),
