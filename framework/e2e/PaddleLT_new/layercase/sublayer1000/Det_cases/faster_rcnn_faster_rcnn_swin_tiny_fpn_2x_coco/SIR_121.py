...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 256, 136, 160], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 256, 68, 80], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 34, 40], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 17, 20], dtype: paddle.float32, stop_gradient: False)
...
def create_tensor_inputs():
    inputs = (
        paddle.rand(shape=[1, 256, 136, 160], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 68, 80], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 34, 40], dtype=paddle.float32),
        paddle.rand(shape=[1, 256, 17, 20], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 256, 136, 160]).astype('float32'),
        np.random.random(size=[1, 256, 68, 80]).astype('float32'),
        np.random.random(size=[1, 256, 34, 40]).astype('float32'),
        np.random.random(size=[1, 256, 17, 20]).astype('float32'),
