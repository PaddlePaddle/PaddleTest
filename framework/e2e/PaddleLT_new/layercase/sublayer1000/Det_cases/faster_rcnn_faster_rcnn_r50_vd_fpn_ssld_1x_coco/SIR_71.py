...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 256, 160, 240], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 256, 80, 120], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 256, 40, 60], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 256, 20, 30], dtype: paddle.float32, stop_gradient: False)
