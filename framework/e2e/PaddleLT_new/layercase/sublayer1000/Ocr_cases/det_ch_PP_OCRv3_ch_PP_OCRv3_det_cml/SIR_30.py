...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_4 = paddle.nn.functional.conv._conv_nd(var_3, self.parameter_30, bias=None, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_5 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_4, output_size=1, data_format='NCHW', name=None)
        var_6 = paddle.nn.functional.conv._conv_nd(var_5, self.parameter_33, bias=self.parameter_12, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_7 = paddle.nn.functional.activation.relu(var_6)
        var_8 = paddle.nn.functional.conv._conv_nd(var_7, self.parameter_10, bias=self.parameter_0, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_12 = paddle.nn.functional.conv._conv_nd(var_2, self.parameter_19, bias=None, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_13 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_12, output_size=1, data_format='NCHW', name=None)
        var_14 = paddle.nn.functional.conv._conv_nd(var_13, self.parameter_14, bias=self.parameter_21, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_15 = paddle.nn.functional.activation.relu(var_14)
        var_16 = paddle.nn.functional.conv._conv_nd(var_15, self.parameter_37, bias=self.parameter_38, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_20 = paddle.nn.functional.conv._conv_nd(var_1, self.parameter_8, bias=None, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_21 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_20, output_size=1, data_format='NCHW', name=None)
        var_22 = paddle.nn.functional.conv._conv_nd(var_21, self.parameter_9, bias=self.parameter_22, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_23 = paddle.nn.functional.activation.relu(var_22)
        var_24 = paddle.nn.functional.conv._conv_nd(var_23, self.parameter_5, bias=self.parameter_2, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_28 = paddle.nn.functional.conv._conv_nd(var_0, self.parameter_36, bias=None, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_29 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_28, output_size=1, data_format='NCHW', name=None)
        var_30 = paddle.nn.functional.conv._conv_nd(var_29, self.parameter_17, bias=self.parameter_18, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_31 = paddle.nn.functional.activation.relu(var_30)
        var_32 = paddle.nn.functional.conv._conv_nd(var_31, self.parameter_24, bias=self.parameter_31, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_42 = paddle.nn.functional.conv._conv_nd(var_11, self.parameter_3, bias=None, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_43 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_42, output_size=1, data_format='NCHW', name=None)
        var_44 = paddle.nn.functional.conv._conv_nd(var_43, self.parameter_27, bias=self.parameter_28, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_45 = paddle.nn.functional.activation.relu(var_44)
        var_46 = paddle.nn.functional.conv._conv_nd(var_45, self.parameter_35, bias=self.parameter_4, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_50 = paddle.nn.functional.conv._conv_nd(var_37, self.parameter_7, bias=None, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_51 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_50, output_size=1, data_format='NCHW', name=None)
        var_52 = paddle.nn.functional.conv._conv_nd(var_51, self.parameter_6, bias=self.parameter_13, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_53 = paddle.nn.functional.activation.relu(var_52)
        var_54 = paddle.nn.functional.conv._conv_nd(var_53, self.parameter_29, bias=self.parameter_16, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_58 = paddle.nn.functional.conv._conv_nd(var_39, self.parameter_20, bias=None, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_59 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_58, output_size=1, data_format='NCHW', name=None)
        var_60 = paddle.nn.functional.conv._conv_nd(var_59, self.parameter_32, bias=self.parameter_25, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_61 = paddle.nn.functional.activation.relu(var_60)
        var_62 = paddle.nn.functional.conv._conv_nd(var_61, self.parameter_23, bias=self.parameter_1, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_66 = paddle.nn.functional.conv._conv_nd(var_41, self.parameter_15, bias=None, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_67 = paddle.nn.functional.pooling.adaptive_avg_pool2d(var_66, output_size=1, data_format='NCHW', name=None)
        var_68 = paddle.nn.functional.conv._conv_nd(var_67, self.parameter_11, bias=self.parameter_39, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_69 = paddle.nn.functional.activation.relu(var_68)
        var_70 = paddle.nn.functional.conv._conv_nd(var_69, self.parameter_34, bias=self.parameter_26, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
