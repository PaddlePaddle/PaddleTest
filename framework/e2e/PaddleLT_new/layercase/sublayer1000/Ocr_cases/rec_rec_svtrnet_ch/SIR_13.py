...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_18 = paddle.nn.functional.common.linear(x=var_17, weight=self.parameter_2, bias=self.parameter_1, name=None)
...
def create_tensor_inputs():
    inputs = (
        ...
        paddle.rand(shape=[1, 1, 640, 640], dtype=paddle.float32),
    )
    return inputs
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 1, 640, 640]).astype('float32'),
    )
    return inputs
