...
def create_tensor_inputs():
    inputs = (
        ...
        paddle.randint(low=0, high=10, shape=[2, 28, 28], dtype=paddle.int32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[2, 256, 28, 28]).astype('float32'),
        np.random.randint(low=0, high=10, size=[2], dtype='int32'),
        np.random.randint(low=0, high=10, size=[2, 28, 28], dtype='int32'),
        np.random.random(size=[2]).astype('float32'),
    )
    return inputs
