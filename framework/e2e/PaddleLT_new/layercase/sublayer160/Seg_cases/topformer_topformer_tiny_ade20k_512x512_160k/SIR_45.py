...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_0,    # (shape: [1, 16, 128, 128], dtype: paddle.float32, stop_gradient: False)
        var_1,    # (shape: [1, 32, 64, 64], dtype: paddle.float32, stop_gradient: False)
        var_2,    # (shape: [1, 64, 32, 32], dtype: paddle.float32, stop_gradient: False)
        var_3,    # (shape: [1, 96, 16, 16], dtype: paddle.float32, stop_gradient: False)
    ):
...
def create_paddle_inputs():
    inputs = (
        paddle.rand(shape=[1, 16, 128, 128], dtype=paddle.float32),
        paddle.rand(shape=[1, 32, 64, 64], dtype=paddle.float32),
        paddle.rand(shape=[1, 64, 32, 32], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[1, 16, 128, 128]).astype('float32'),
        np.random.random(size=[1, 32, 64, 64]).astype('float32'),
        np.random.random(size=[1, 64, 32, 32]).astype('float32'),
