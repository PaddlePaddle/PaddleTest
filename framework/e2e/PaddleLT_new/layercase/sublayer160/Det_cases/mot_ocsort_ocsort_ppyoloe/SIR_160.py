...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_0 = paddle.tensor.creation.arange(end=17)
        var_1 = var_0.__add__(0.5)
        var_2 = var_1.__mul__(32)
        var_3 = paddle.tensor.creation.arange(end=17)
        ...
        var_18 = paddle.tensor.creation.full([289, 1], 32, dtype='float32')
        var_19 = paddle.tensor.creation.arange(end=34)
        var_20 = var_19.__add__(0.5)
        var_21 = var_20.__mul__(16)
        var_22 = paddle.tensor.creation.arange(end=34)
        ...
        var_37 = paddle.tensor.creation.full([1156, 1], 16, dtype='float32')
        var_38 = paddle.tensor.creation.arange(end=68)
        var_39 = var_38.__add__(0.5)
        var_40 = var_39.__mul__(8)
        var_41 = paddle.tensor.creation.arange(end=68)
        ...
        var_56 = paddle.tensor.creation.full([4624, 1], 8, dtype='float32')
