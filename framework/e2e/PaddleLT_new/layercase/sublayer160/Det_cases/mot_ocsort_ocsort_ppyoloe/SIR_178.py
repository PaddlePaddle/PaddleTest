...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_3,    # (shape: [1, 6069, 1], dtype: paddle.float32, stop_gradient: True)
...
def create_paddle_inputs():
    inputs = (
        ...
        paddle.rand(shape=[1, 6069, 4], dtype=paddle.float32),
        paddle.rand(shape=[1, 6069, 1], dtype=paddle.float32),
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 6069, 4]).astype('float32'),
        np.random.random(size=[1, 6069, 1]).astype('float32'),
