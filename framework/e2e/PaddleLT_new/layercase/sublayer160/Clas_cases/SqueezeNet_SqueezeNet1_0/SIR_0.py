...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_1 = paddle.nn.functional.conv._conv_nd(var_0, self.parameter_37, bias=self.parameter_4, stride=[2, 2], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_4 = paddle.nn.functional.conv._conv_nd(var_3, self.parameter_5, bias=self.parameter_34, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_5 = paddle.nn.functional.activation.relu(var_4)
        var_6 = paddle.nn.functional.conv._conv_nd(var_5, self.parameter_31, bias=self.parameter_1, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_7 = paddle.nn.functional.activation.relu(var_6)
        var_8 = paddle.nn.functional.conv._conv_nd(var_5, self.parameter_35, bias=self.parameter_28, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_9 = paddle.nn.functional.activation.relu(var_8)
        var_10 = paddle.tensor.manipulation.concat([var_7, var_9], axis=1)
        var_11 = paddle.nn.functional.conv._conv_nd(var_10, self.parameter_42, bias=self.parameter_45, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_12 = paddle.nn.functional.activation.relu(var_11)
        var_13 = paddle.nn.functional.conv._conv_nd(var_12, self.parameter_16, bias=self.parameter_46, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_14 = paddle.nn.functional.activation.relu(var_13)
        var_15 = paddle.nn.functional.conv._conv_nd(var_12, self.parameter_24, bias=self.parameter_40, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_16 = paddle.nn.functional.activation.relu(var_15)
        var_17 = paddle.tensor.manipulation.concat([var_14, var_16], axis=1)
        var_18 = paddle.nn.functional.conv._conv_nd(var_17, self.parameter_25, bias=self.parameter_41, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_19 = paddle.nn.functional.activation.relu(var_18)
        var_20 = paddle.nn.functional.conv._conv_nd(var_19, self.parameter_20, bias=self.parameter_8, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_21 = paddle.nn.functional.activation.relu(var_20)
        var_22 = paddle.nn.functional.conv._conv_nd(var_19, self.parameter_49, bias=self.parameter_12, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_26 = paddle.nn.functional.conv._conv_nd(var_25, self.parameter_18, bias=self.parameter_26, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_27 = paddle.nn.functional.activation.relu(var_26)
        var_28 = paddle.nn.functional.conv._conv_nd(var_27, self.parameter_6, bias=self.parameter_47, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_29 = paddle.nn.functional.activation.relu(var_28)
        var_30 = paddle.nn.functional.conv._conv_nd(var_27, self.parameter_9, bias=self.parameter_48, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_31 = paddle.nn.functional.activation.relu(var_30)
        var_32 = paddle.tensor.manipulation.concat([var_29, var_31], axis=1)
        var_33 = paddle.nn.functional.conv._conv_nd(var_32, self.parameter_21, bias=self.parameter_10, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_34 = paddle.nn.functional.activation.relu(var_33)
        var_35 = paddle.nn.functional.conv._conv_nd(var_34, self.parameter_50, bias=self.parameter_0, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_36 = paddle.nn.functional.activation.relu(var_35)
        var_37 = paddle.nn.functional.conv._conv_nd(var_34, self.parameter_27, bias=self.parameter_11, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_38 = paddle.nn.functional.activation.relu(var_37)
        var_39 = paddle.tensor.manipulation.concat([var_36, var_38], axis=1)
        var_40 = paddle.nn.functional.conv._conv_nd(var_39, self.parameter_38, bias=self.parameter_13, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_41 = paddle.nn.functional.activation.relu(var_40)
        var_42 = paddle.nn.functional.conv._conv_nd(var_41, self.parameter_19, bias=self.parameter_22, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_43 = paddle.nn.functional.activation.relu(var_42)
        var_44 = paddle.nn.functional.conv._conv_nd(var_41, self.parameter_15, bias=self.parameter_14, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_45 = paddle.nn.functional.activation.relu(var_44)
        var_46 = paddle.tensor.manipulation.concat([var_43, var_45], axis=1)
        var_47 = paddle.nn.functional.conv._conv_nd(var_46, self.parameter_23, bias=self.parameter_17, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_48 = paddle.nn.functional.activation.relu(var_47)
        var_49 = paddle.nn.functional.conv._conv_nd(var_48, self.parameter_32, bias=self.parameter_7, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_50 = paddle.nn.functional.activation.relu(var_49)
        var_51 = paddle.nn.functional.conv._conv_nd(var_48, self.parameter_51, bias=self.parameter_3, stride=[1, 1], padding=[1, 1], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        ...
        var_55 = paddle.nn.functional.conv._conv_nd(var_54, self.parameter_36, bias=self.parameter_33, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
        var_56 = paddle.nn.functional.activation.relu(var_55)
        var_57 = paddle.nn.functional.conv._conv_nd(var_56, self.parameter_43, bias=self.parameter_39, stride=[1, 1], padding=[0, 0], padding_algorithm='EXPLICIT', dilation=[1, 1], groups=1, data_format='NCHW', channel_dim=1, op_type='conv2d', use_cudnn=True)
...
def create_paddle_inputs():
    inputs = (
        paddle.rand(shape=[43, 3, 224, 224], dtype=paddle.float32),
    )
    return inputs
...
def create_numpy_inputs():
    inputs = (
        np.random.random(size=[43, 3, 224, 224]).astype('float32'),
    )
    return inputs
