...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_1 = paddle.nn.functional.conv._conv_nd(var_0, self.parameter_1, bias=None, stride=[1, 1], padding=[0, 0], padding_algorithm='SAME', dilation=[1, 1], groups=128, data_format='NCHW', channel_dim=1, op_type='depthwise_conv2d', use_cudnn=False)
        ...
        var_4 = paddle.nn.functional.conv._conv_nd(var_0, self.parameter_0, bias=None, stride=[1, 1], padding=[0, 0], padding_algorithm='SAME', dilation=[2, 2], groups=128, data_format='NCHW', channel_dim=1, op_type='depthwise_conv2d', use_cudnn=False)
