...
def LayerCase():
    """模型库中间态"""
    model = ErnieModel.from_pretrained('ernie-search-large-cross-encoder-marco-en')
    return model
...
def create_tensor_inputs():
    tokenizer = ErnieTokenizer.from_pretrained('ernie-search-large-cross-encoder-marco-en')
