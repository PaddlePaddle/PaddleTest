...
def LayerCase():
    """模型库中间态"""
    model = UnifiedTransformerModel.from_pretrained('unified_transformer-12L-cn-luge')
    return model
...
def create_tensor_inputs():
    tokenizer = UnifiedTransformerTokenizer.from_pretrained('unified_transformer-12L-cn-luge')
