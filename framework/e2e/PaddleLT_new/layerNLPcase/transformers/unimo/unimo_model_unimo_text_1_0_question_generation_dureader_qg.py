...
def LayerCase():
    """模型库中间态"""
    model = UNIMOModel.from_pretrained('unimo-text-1.0-question-generation-dureader_qg')
    return model
...
def create_tensor_inputs():
    tokenizer = UNIMOTokenizer.from_pretrained('unimo-text-1.0-question-generation-dureader_qg')
