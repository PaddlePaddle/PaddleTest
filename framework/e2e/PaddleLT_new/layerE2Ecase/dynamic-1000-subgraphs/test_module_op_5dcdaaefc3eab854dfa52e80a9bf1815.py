...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0):
        ...
        # pd_op.shape: (4xi32) <- (-1x-1x15x25xf32)
        ...
        # pd_op.full: (1xi32) <- ()
        full_2 = paddle._C_ops.full([1], 25, paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (1xi32) <- ()
        full_3 = paddle._C_ops.full([1], 15, paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], 15, paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_6 = paddle._C_ops.full([], 25, paddle.int64, paddle.core.CPUPlace())
        ...
        # builtin.combine: ([-1x-1x15x25xf32, -1x2x-1x-1xf32]) <- (-1x-1x15x25xf32, -1x2x-1x-1xf32)
        combine_3 = [data_0, concat_0]

        # pd_op.concat: (-1x-1x15x25xf32) <- ([-1x-1x15x25xf32, -1x2x-1x-1xf32], 1xi32)
