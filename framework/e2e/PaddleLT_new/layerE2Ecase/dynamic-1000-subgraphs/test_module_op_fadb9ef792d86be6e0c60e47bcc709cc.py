...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1):
        ...
        scale_0 = paddle._C_ops.scale(uniform_0, full_2, 0.8375, True)
        ...
        # pd_op.full: (1xf32) <- ()
        full_3 = paddle._C_ops.full([1], 1.19403, paddle.float32, paddle.core.CPUPlace())

        # pd_op.scale: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(multiply_0, full_3, 0, True)
