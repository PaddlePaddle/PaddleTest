...
class BlockEntries:
    def builtin_module_170_0_0(self, data_0):
        ...
        # pd_op.full: (1xi32) <- ()
        full_2 = paddle._C_ops.full([1], float('38'), paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], float('25'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_6 = paddle._C_ops.full([], float('38'), paddle.int64, paddle.core.CPUPlace())
