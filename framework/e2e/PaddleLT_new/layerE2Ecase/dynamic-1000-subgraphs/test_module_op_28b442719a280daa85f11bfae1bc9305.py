...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7, data_8):
        ...
        # pd_op.full: (1xf32) <- ()
        full_2 = paddle._C_ops.full([1], 64, paddle.float32, paddle.core.CPUPlace())
        ...
        full_5 = paddle._C_ops.full([4096, 1], 8, paddle.float32, paddle.framework._current_expected_place())
        ...
        full_8 = paddle._C_ops.full([1024, 1], 16, paddle.float32, paddle.framework._current_expected_place())

        # pd_op.arange: (16xi64) <- (1xf32, 1xf32, 1xf32)
        arange_2 = paddle.arange(full_1, full_7, full_3, dtype=paddle.int64)
        ...
        # pd_op.scale: (16xf32) <- (16xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(scale_4, full_6, 0, True)
        ...
        full_9 = paddle._C_ops.full([256, 1], 32, paddle.float32, paddle.framework._current_expected_place())

        # pd_op.full: (1xi32) <- ()
        full_10 = paddle._C_ops.full([1], 0, paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (1xi32) <- ()
        full_11 = paddle._C_ops.full([1], 2, paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (1xf32) <- ()
        full_12 = paddle._C_ops.full([1], 0.5, paddle.float32, paddle.core.CPUPlace())

        # pd_op.scale: (-1x-1x-1xf32) <- (-1x-1x-1xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(exp_0, full_12, 0, True)
        ...
        # pd_op.full: (1xi32) <- ()
        full_13 = paddle._C_ops.full([1], -1, paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.scale: (16xf32) <- (16xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(scale_11, full_6, 0, True)
