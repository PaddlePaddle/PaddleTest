...
class BlockEntries:
    ...
    def builtin_module_68_0_0(self, parameter_0, parameter_1, data_0):
        ...
        # pd_op.split: ([-1x600x-1x-1xf32, -1x600x-1x-1xf32]) <- (-1x1200x-1x-1xf32, 2xi64, 1xi32)
        split_0 = paddle._C_ops.split(data_0, full_int_array_0, full_0)

        # builtin.split: (-1x600x-1x-1xf32, -1x600x-1x-1xf32) <- ([-1x600x-1x-1xf32, -1x600x-1x-1xf32])
        split_1, split_2, = split_0

        # pd_op.assign: (-1x600x-1x-1xf32) <- (-1x600x-1x-1xf32)
        assign_2 = split_2

        # pd_op.assign: (-1x600x-1x-1xf32) <- (-1x600x-1x-1xf32)
        assign_3 = split_1

        # pd_op.conv2d: (-1x100x-1x-1xf32) <- (-1x600x-1x-1xf32, 100x600x1x1xf32)
