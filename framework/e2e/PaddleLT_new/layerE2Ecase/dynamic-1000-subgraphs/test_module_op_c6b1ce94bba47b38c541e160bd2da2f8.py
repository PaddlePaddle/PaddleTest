...
class BlockEntries:
    ...
    def builtin_module_95_0_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0):
        ...
        # pd_op.matmul: (-1x60xf32) <- (-1x-1xf32, 240x60xf32)
        ...
        # pd_op.clip: (-1x240xf32) <- (-1x240xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(add_1, min(full_0, full_1), max(full_0, full_1))

        # pd_op.unsqueeze: (-1x240x1x1xf32, 0x-1x240xf32) <- (-1x240xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x240x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x240x1x1xf32)
...
class Block_builtin_module_95_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_full_int_array_1(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0):
        ...
        return [parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1]

    def op_assign_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1):
        ...
        return [parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0]

    def op_squeeze_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0):
        ...
        return [parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0, squeeze_0, squeeze_1]

    def op_matmul_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0, squeeze_0, squeeze_1):
        ...
        return [parameter_2, parameter_3, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0, squeeze_0, squeeze_1, matmul_0]

    def op_add_0(self, parameter_2, parameter_3, parameter_1, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0, squeeze_0, squeeze_1, matmul_0):
