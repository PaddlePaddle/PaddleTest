...
class BlockEntries:
    ...
    def builtin_module_184_0_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_0, parameter_6, parameter_1, data_0):
        ...
        full_int_array_0 = [11, 3136, 3, 32]

        # pd_op.reshape: (11x3136x3x32xf32, 0x-1x-1x96xi64) <- (-1x-1x96xf32, 4xi64)
        ...
        # pd_op.transpose: (11x3x3136x32xf32) <- (11x3136x3x32xf32)
        ...
        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_1 = [11, 96, 56, 56]

        # pd_op.reshape: (11x96x56x56xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 4xi64)
        ...
        # pd_op.conv2d: (11x96x7x7xf32) <- (11x96x56x56xf32, 96x96x8x8xf32)
        ...
        # pd_op.add: (11x96x7x7xf32) <- (11x96x7x7xf32, 1x96x1x1xf32)
        add_1 = conv2d_0 + reshape_4

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_3 = [11, 96, 49]

        # pd_op.reshape: (11x96x49xf32, 0x11x96x7x7xi64) <- (11x96x7x7xf32, 3xi64)
        ...
        # pd_op.transpose: (11x49x96xf32) <- (11x96x49xf32)
        transpose_2 = paddle._C_ops.transpose(reshape_6, [0, 2, 1])

        # pd_op.layer_norm: (11x49x96xf32, 11x49xf32, 11x49xf32) <- (11x49x96xf32, 96xf32, 96xf32)
        ...
        # pd_op.matmul: (11x49x192xf32) <- (11x49x96xf32, 96x192xf32)
        matmul_1 = paddle.matmul(layer_norm_0, parameter_6, transpose_x=False, transpose_y=False)

        # pd_op.add: (11x49x192xf32) <- (11x49x192xf32, 192xf32)
        add_2 = matmul_1 + parameter_7

        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_4 = [11, 49, 2, 3, 32]

        # pd_op.reshape: (11x49x2x3x32xf32, 0x11x49x192xi64) <- (11x49x192xf32, 5xi64)
        ...
        # pd_op.transpose: (2x11x3x49x32xf32) <- (11x49x2x3x32xf32)
        ...
        # pd_op.slice: (11x3x49x32xf32) <- (2x11x3x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (11x3x32x49xf32) <- (11x3x49x32xf32)
...
class Block_builtin_module_184_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_0, parameter_6, parameter_1, data_0):
        args = [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_0, parameter_6, parameter_1, data_0]
    ...
    def op_matmul_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_0, parameter_6, parameter_1, data_0):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, parameter_1, data_0, matmul_0]

    def op_add_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, parameter_1, data_0, matmul_0):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, add_0]

    def op_full_int_array_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, add_0):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, add_0, full_int_array_0]

    def op_reshape_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, add_0, full_int_array_0):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, reshape_0, reshape_1]

    def op_transpose_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, reshape_0, reshape_1):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, reshape_1, transpose_0]

    def op_transpose_1(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, data_0, matmul_0, reshape_1, transpose_0):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, transpose_1]

    def op_full_int_array_1(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, transpose_1):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, transpose_1, full_int_array_1]

    def op_reshape_1(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, transpose_1, full_int_array_1):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3]

    def op_conv2d_0(self, parameter_7, parameter_5, parameter_4, parameter_2, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0]

    def op_full_int_array_2(self, parameter_7, parameter_5, parameter_4, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, full_int_array_2]

    def op_reshape_2(self, parameter_7, parameter_5, parameter_4, parameter_3, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, full_int_array_2):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5]

    def op_add_1(self, parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1]

    def op_full_int_array_3(self, parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1, full_int_array_3]

    def op_reshape_3(self, parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1, full_int_array_3):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_6, reshape_7]

    def op_transpose_2(self, parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_6, reshape_7):
        ...
        return [parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2]

    def op_layer_norm_0(self, parameter_7, parameter_5, parameter_4, parameter_6, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2):
