...
class BlockEntries:
    ...
    def builtin_module_101_0_0(self, parameter_1, parameter_0, data_0):
        ...
        full_int_array_0 = [11, 8, 7, 8, 7, 96]

        # pd_op.reshape: (11x8x7x8x7x96xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 6xi64)
        ...
        # pd_op.transpose: (11x8x8x7x7x96xf32) <- (11x8x7x8x7x96xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 1, 3, 2, 4, 5])

        # pd_op.matmul: (11x8x8x7x7x288xf32) <- (11x8x8x7x7x96xf32, 96x288xf32)
        matmul_0 = paddle.matmul(transpose_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (11x8x8x7x7x288xf32) <- (11x8x8x7x7x288xf32, 288xf32)
        add_0 = matmul_0 + parameter_1

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_1 = [11, 64, 49, 3, 3, 32]

        # pd_op.reshape: (11x64x49x3x3x32xf32, 0x11x8x8x7x7x288xi64) <- (11x8x8x7x7x288xf32, 6xi64)
        ...
        # pd_op.transpose: (3x11x64x3x49x32xf32) <- (11x64x49x3x3x32xf32)
        ...
        # pd_op.slice: (11x64x3x49x32xf32) <- (3x11x64x3x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (11x64x3x32x49xf32) <- (11x64x3x49x32xf32)
