...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, parameter_0, parameter_1, data_0, data_1, data_2):
        ...
        # pd_op.conv2d: (-1x91x-1x-1xf32) <- (-1x192x-1x-1xf32, 91x192x3x3xf32)
        ...
        # pd_op.flatten: (-1x-1x-1xf32, 0x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        flatten_2, flatten_3 = paddle._C_ops.flatten(data_2, 2, 3), None

        # pd_op.transpose: (-1x-1x-1xf32) <- (-1x-1x-1xf32)
        transpose_1 = paddle.transpose(flatten_2, perm=[0, 2, 1])

        # pd_op.flatten: (-1x91x-1xf32, 0x-1x91x-1x-1xf32) <- (-1x91x-1x-1xf32)
        flatten_4, flatten_5 = paddle._C_ops.flatten(add_0, 2, 3), None
...
class Block_builtin_module_0_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_conv2d_0(self, parameter_0, parameter_1, data_0, data_1, data_2):
