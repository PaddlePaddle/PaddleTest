...
class BlockEntries:
    ...
    def builtin_module_477_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.clip: (-1x1xf32) <- (-1x1xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_2, min(assign_6, assign_7), max(assign_6, assign_7))
        ...
        clip_2 = paddle._C_ops.clip(concat_0, min(assign_5, full_7), max(assign_5, full_7))
