...
class BlockEntries:
    ...
    def builtin_module_73_0_0(self, parameter_1, parameter_0, data_1, data_0):

        # pd_op.full: (1xi32) <- ()
        full_0 = paddle._C_ops.full([1], float('1'), paddle.int32, paddle.core.CPUPlace())

        # builtin.combine: ([-1x144x-1x-1xf32, -1x144x-1x-1xf32]) <- (-1x144x-1x-1xf32, -1x144x-1x-1xf32)
        combine_0 = [data_0, data_1]

        # pd_op.concat: (-1x288x-1x-1xf32) <- ([-1x144x-1x-1xf32, -1x144x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.mean: (-1x288x1x1xf32) <- (-1x288x-1x-1xf32)
        mean_0 = paddle._C_ops.mean(concat_0, [2, 3], True)

        # pd_op.conv2d: (-1x288x1x1xf32) <- (-1x288x1x1xf32, 288x288x1x1xf32)
        ...
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(add_0, float('0.166667'), float('0.5'))
...
class Block_builtin_module_73_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_combine_0(self, parameter_1, parameter_0, data_1, data_0, full_0):
        ...
        return [parameter_1, parameter_0, full_0, combine_0]

    def op_concat_0(self, parameter_1, parameter_0, full_0, combine_0):
        ...
        return [parameter_1, parameter_0, full_0, concat_0]

    def op_mean_0(self, parameter_1, parameter_0, full_0, concat_0):
        ...
        return [parameter_1, parameter_0, full_0, concat_0, mean_0]

    def op_conv2d_0(self, parameter_1, parameter_0, full_0, concat_0, mean_0):
