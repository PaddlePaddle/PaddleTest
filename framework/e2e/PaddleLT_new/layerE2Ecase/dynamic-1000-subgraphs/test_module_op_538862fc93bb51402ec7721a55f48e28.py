...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7, data_8):
        ...
        # pd_op.full: (1xf32) <- ()
        full_2 = paddle._C_ops.full([1], 96, paddle.float32, paddle.core.CPUPlace())
        ...
        full_5 = paddle._C_ops.full([9216, 1], 8, paddle.float32, paddle.framework._current_expected_place())

        # pd_op.full: (1xf32) <- ()
        full_6 = paddle._C_ops.full([1], 48, paddle.float32, paddle.core.CPUPlace())
        ...
        full_8 = paddle._C_ops.full([2304, 1], 16, paddle.float32, paddle.framework._current_expected_place())

        # pd_op.full: (1xf32) <- ()
        full_9 = paddle._C_ops.full([1], 24, paddle.float32, paddle.core.CPUPlace())
        ...
        full_11 = paddle._C_ops.full([576, 1], 32, paddle.float32, paddle.framework._current_expected_place())
