...
class BlockEntries:
    ...
    def builtin_module_75_0_0(self, parameter_0, parameter_1, data_0, data_1):

        # pd_op.conv2d: (-1x17x-1x-1xf32) <- (-1x32x-1x-1xf32, 17x32x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(data_0, parameter_0, [1, 1], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_0 = [1, -1, 1, 1]

        # pd_op.reshape: (1x17x1x1xf32, 0x17xi64) <- (17xf32, 4xi64)
        ...
        # pd_op.add: (-1x17x-1x-1xf32) <- (-1x17x-1x-1xf32, 1x17x1x1xf32)
        ...
        return conv2d_0, reshape_0, reshape_1, full_0, split_0, add_0, split_1
...
class Block_builtin_module_75_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
    ...
    def op_full_0(self, data_1, conv2d_0, reshape_0, reshape_1, add_0):
        ...
        return [data_1, conv2d_0, reshape_0, reshape_1, add_0, full_0]

    def op_split_with_num_0(self, data_1, conv2d_0, reshape_0, reshape_1, add_0, full_0):
        ...
        return [conv2d_0, reshape_0, reshape_1, add_0, full_0, split_with_num_0]

    def op_split_0(self, conv2d_0, reshape_0, reshape_1, add_0, full_0, split_with_num_0):
...
class Test_builtin_module_75_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_75_0_0()
