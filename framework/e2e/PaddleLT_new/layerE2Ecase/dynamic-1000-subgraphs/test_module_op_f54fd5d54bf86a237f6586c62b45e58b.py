...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, parameter_2, parameter_0, parameter_3, parameter_1, data_0):
        ...
        # pd_op.pool2d: (-1x576x1x1xf32) <- (-1x576x-1x-1xf32, 2xi64)
        ...
        # pd_op.reshape: (1x576x1x1xf32, 0x576xi64) <- (576xf32, 4xi64)
        ...
        # pd_op.multiply: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32, -1x576x1x1xf32)
