...
class BlockEntries:
    ...
    def builtin_module_95_0_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0):
        ...
        # pd_op.matmul: (-1x240xf32) <- (-1x-1xf32, 960x240xf32)
        ...
        # pd_op.relu: (-1x240xf32) <- (-1x240xf32)
        ...
        # pd_op.add: (-1x960xf32) <- (-1x960xf32, 960xf32)
        ...
        # pd_op.clip: (-1x960xf32) <- (-1x960xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(add_1, min(full_0, full_1), max(full_0, full_1))

        # pd_op.unsqueeze: (-1x960x1x1xf32, 0x-1x960xf32) <- (-1x960xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x960x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x960x1x1xf32)
