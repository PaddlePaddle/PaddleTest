...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, parameter_5, parameter_1, parameter_4, parameter_3, parameter_2, parameter_0, data_0, data_1, data_2, data_3):
        ...
        # pd_op.full: (xi64) <- ()
        full_0 = paddle._C_ops.full([], 320, paddle.int64, paddle.core.CPUPlace())
