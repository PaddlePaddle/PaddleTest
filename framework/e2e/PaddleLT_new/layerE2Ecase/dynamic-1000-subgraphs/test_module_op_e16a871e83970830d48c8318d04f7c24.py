...
class BlockEntries:
    ...
    def builtin_module_184_0_0(self, parameter_1, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, parameter_0, data_0):

        # pd_op.matmul: (-1x-1x96xf32) <- (-1x-1x-1xf32, 96x96xf32)
        ...
        full_int_array_0 = [43, 3136, 3, 32]

        # pd_op.reshape: (43x3136x3x32xf32, 0x-1x-1x96xi64) <- (-1x-1x96xf32, 4xi64)
        ...
        # pd_op.transpose: (43x3x3136x32xf32) <- (43x3136x3x32xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 2, 1, 3])

        # pd_op.transpose: (-1x-1x-1xf32) <- (-1x-1x-1xf32)
        transpose_1 = paddle._C_ops.transpose(data_0, [0, 2, 1])

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_1 = [43, 96, 56, 56]

        # pd_op.reshape: (43x96x56x56xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 4xi64)
        reshape_2, reshape_3 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_1, full_int_array_1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (43x96x7x7xf32) <- (43x96x56x56xf32, 96x96x8x8xf32)
        conv2d_0 = paddle._C_ops.conv2d(reshape_2, parameter_2, [8, 8], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_2 = [1, -1, 1, 1]

        # pd_op.reshape: (1x96x1x1xf32, 0x96xi64) <- (96xf32, 4xi64)
        reshape_4, reshape_5 = (lambda x, f: f(x))(paddle._C_ops.reshape(parameter_3, full_int_array_2), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.add: (43x96x7x7xf32) <- (43x96x7x7xf32, 1x96x1x1xf32)
        add_1 = conv2d_0 + reshape_4

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_3 = [43, 96, 49]

        # pd_op.reshape: (43x96x49xf32, 0x43x96x7x7xi64) <- (43x96x7x7xf32, 3xi64)
        reshape_6, reshape_7 = (lambda x, f: f(x))(paddle._C_ops.reshape(add_1, full_int_array_3), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (43x49x96xf32) <- (43x96x49xf32)
        transpose_2 = paddle._C_ops.transpose(reshape_6, [0, 2, 1])

        # pd_op.layer_norm: (43x49x96xf32, 43x49xf32, 43x49xf32) <- (43x49x96xf32, 96xf32, 96xf32)
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(transpose_2, parameter_4, parameter_5, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))

        # pd_op.matmul: (43x49x192xf32) <- (43x49x96xf32, 96x192xf32)
        matmul_1 = paddle.matmul(layer_norm_0, parameter_6, transpose_x=False, transpose_y=False)

        # pd_op.add: (43x49x192xf32) <- (43x49x192xf32, 192xf32)
        add_2 = matmul_1 + parameter_7

        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_4 = [43, 49, 2, 3, 32]

        # pd_op.reshape: (43x49x2x3x32xf32, 0x43x49x192xi64) <- (43x49x192xf32, 5xi64)
        reshape_8, reshape_9 = (lambda x, f: f(x))(paddle._C_ops.reshape(add_2, full_int_array_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (2x43x3x49x32xf32) <- (43x49x2x3x32xf32)
        ...
        # pd_op.slice: (43x3x49x32xf32) <- (2x43x3x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (43x3x32x49xf32) <- (43x3x49x32xf32)
...
class Block_builtin_module_184_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()

    def forward(self, parameter_1, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, parameter_0, data_0):
        args = [parameter_1, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, parameter_0, data_0]
    ...
    def op_matmul_0(self, parameter_1, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, parameter_0, data_0):
        ...
        return [parameter_1, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0]

    def op_add_0(self, parameter_1, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, add_0]

    def op_full_int_array_0(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, add_0):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, add_0, full_int_array_0]

    def op_reshape_0(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, add_0, full_int_array_0):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, reshape_0, reshape_1]

    def op_transpose_0(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, reshape_0, reshape_1):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, reshape_1, transpose_0]

    def op_transpose_1(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, data_0, matmul_0, reshape_1, transpose_0):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, transpose_1]

    def op_full_int_array_1(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, transpose_1):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, transpose_1, full_int_array_1]

    def op_reshape_1(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, transpose_1, full_int_array_1):
        ...
        return [parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3]

    def op_conv2d_0(self, parameter_2, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0]

    def op_full_int_array_2(self, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, full_int_array_2]

    def op_reshape_2(self, parameter_7, parameter_5, parameter_6, parameter_3, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, full_int_array_2):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5]

    def op_add_1(self, parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1]

    def op_full_int_array_3(self, parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1, full_int_array_3]

    def op_reshape_3(self, parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1, full_int_array_3):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_6, reshape_7]

    def op_transpose_2(self, parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_6, reshape_7):
        ...
        return [parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2]

    def op_layer_norm_0(self, parameter_7, parameter_5, parameter_6, parameter_4, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2):
...
class Test_builtin_module_184_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_184_0_0()
