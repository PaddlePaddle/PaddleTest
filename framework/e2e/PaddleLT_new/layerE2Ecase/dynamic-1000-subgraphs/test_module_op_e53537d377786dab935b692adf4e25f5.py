...
class BlockEntries:
    ...
    def builtin_module_60_0_0(self, parameter_1, parameter_0, data_0):
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [43, 320]

        # pd_op.reshape: (43x320xf32, 0x-1x-1x1x1xi64) <- (-1x-1x1x1xf32, 2xi64)
        ...
        # pd_op.dropout: (43x320xf32, 43x320xui8) <- (43x320xf32, None, 1xf32)
        dropout_0, dropout_1 = (lambda x, f: f(x))(paddle._C_ops.dropout(reshape_0, None, full_0, False, 'upscale_in_train', 0, False), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.matmul: (43x1000xf32) <- (43x320xf32, 320x1000xf32)
        matmul_0 = paddle.matmul(dropout_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (43x1000xf32) <- (43x1000xf32, 1000xf32)
