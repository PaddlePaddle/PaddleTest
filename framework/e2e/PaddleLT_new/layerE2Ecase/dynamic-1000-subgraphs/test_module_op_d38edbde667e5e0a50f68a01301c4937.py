...
class BlockEntries:
    ...
    def builtin_module_110_0_0(self, data_1, data_0, data_2):
        ...
        cross_entropy_with_softmax_0, cross_entropy_with_softmax_1 = (lambda x, f: f(x))(paddle._C_ops.cross_entropy_with_softmax(data_1, unsqueeze_0, False, True, True, -100, -1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze: (-1x1xi64, 0x-1xi64) <- (-1xi64, 1xi64)
        unsqueeze_2, unsqueeze_3 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(scale_0, full_int_array_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.cross_entropy_with_softmax: (-1x-1xf32, -1x1xf32) <- (-1x-1xf32, -1x1xi64)
        cross_entropy_with_softmax_2, cross_entropy_with_softmax_3 = (lambda x, f: f(x))(paddle._C_ops.cross_entropy_with_softmax(data_1, unsqueeze_2, False, True, True, -100, -1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.full: (1xf32) <- ()
        full_1 = paddle._C_ops.full([1], float('0.25'), paddle.float32, paddle.core.CPUPlace())
        ...
        scale_2 = paddle._C_ops.scale(sum_0, assign_2, float('0'), True)
