...
class BlockEntries:
    ...
    def builtin_module_56_0_0(self, parameter_0, parameter_1, data_0, data_1):

        # pd_op.conv2d: (-1x150x-1x-1xf32) <- (-1x512x-1x-1xf32, 150x512x1x1xf32)
        ...
        # pd_op.bilinear_interp: (-1x150x-1x-1xf32) <- (-1x150x-1x-1xf32, 2xi32, None, None)
        bilinear_interp_0 = paddle._C_ops.bilinear_interp(add_0, cast_0, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', False, 0)
        return conv2d_0, reshape_0, reshape_1, add_0, cast_0, bilinear_interp_0
...
class Block_builtin_module_56_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
    ...
    def op_cast_0(self, data_1, conv2d_0, reshape_0, reshape_1, add_0):
        ...
        return [conv2d_0, reshape_0, reshape_1, add_0, cast_0]

    def op_bilinear_interp_0(self, conv2d_0, reshape_0, reshape_1, add_0, cast_0):
...
class Test_builtin_module_56_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_56_0_0()
