...
class BlockEntries:
    ...
    def builtin_module_47_0_0(self, data_0, data_1, data_2):
...
class Block_builtin_module_47_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
    ...
    def op_scale_0(self, data_0, data_1, data_2, full_0):
    ...
    def op_multiply_0(self, data_1, data_2, full_0, scale_0):
...
class Test_builtin_module_47_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_47_0_0()
