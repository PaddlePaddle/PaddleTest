...
class BlockEntries:
    ...
    def builtin_module_95_0_0(self, parameter_0, parameter_1, parameter_3, parameter_2, data_0):
        ...
        # pd_op.clip: (-1x120xf32) <- (-1x120xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(add_1, min(full_0, full_1), max(full_0, full_1))

        # pd_op.unsqueeze: (-1x120x1x1xf32, 0x-1x120xf32) <- (-1x120xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x120x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x120x1x1xf32)
