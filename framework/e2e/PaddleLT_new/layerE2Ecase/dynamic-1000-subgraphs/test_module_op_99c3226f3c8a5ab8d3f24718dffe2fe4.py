...
class BlockEntries:
    ...
    def builtin_module_130_0_0(self, parameter_0, parameter_1, data_0):
        ...
        scale_0 = paddle._C_ops.scale(split_2, full_0, float('0'), True)
        ...
        # pd_op.scale: (300xf32) <- (300xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(split_3, assign_3, float('0'), True)
        ...
        unsqueeze_0, unsqueeze_1 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(stack_0, full_int_array_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_1 = [-2]

        # pd_op.unsqueeze: (-1x1x-1xf32, 0x-1x-1xf32) <- (-1x-1xf32, 1xi64)
        unsqueeze_2, unsqueeze_3 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(data_0, full_int_array_1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        unsqueeze_4, unsqueeze_5 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_1, assign_6), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class Block_builtin_module_130_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_130_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_130_0_0()
