...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.clip: (-1x1xf32) <- (-1x1xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_2, assign_5, assign_6)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(multiply_3, assign_9, 1e-10, True)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(scale_2, assign_8, 0, True)
        ...
        # pd_op.full: (1xf32) <- ()
        full_7 = paddle._C_ops.full([1], -2, paddle.float32, paddle.core.CPUPlace())

        # pd_op.full: (1xf32) <- ()
        full_8 = paddle._C_ops.full([1], 15.99, paddle.float32, paddle.core.CPUPlace())
        ...
        scale_4 = paddle._C_ops.scale(cast_4, assign_7, 1, True)
        ...
        scale_5 = paddle._C_ops.scale(subtract_14, assign_10, 1, True)

        # pd_op.scale: (-1x4xi64) <- (-1x4xi64, 1xf32)
        scale_6 = paddle._C_ops.scale(cast_4, full_3, 2, True)
        ...
        # pd_op.scale: (-1x4xi64) <- (-1x4xi64, 1xf32)
        scale_7 = paddle._C_ops.scale(scale_4, full_3, 2, True)
