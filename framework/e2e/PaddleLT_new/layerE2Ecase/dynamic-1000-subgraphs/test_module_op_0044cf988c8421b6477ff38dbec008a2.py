...
class BlockEntries:
    ...
    def builtin_module_84_0_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0):
        ...
        # pd_op.matmul: (-1x-1x288xf32) <- (-1x-1x96xf32, 96x288xf32)
        matmul_0 = paddle.matmul(layer_norm_0, parameter_2, transpose_x=False, transpose_y=False)

        # pd_op.add: (-1x-1x288xf32) <- (-1x-1x288xf32, 288xf32)
        add_0 = matmul_0 + parameter_3

        # pd_op.full: (1xi32) <- ()
        full_0 = paddle._C_ops.full([1], float('2'), paddle.int32, paddle.core.CPUPlace())

        # pd_op.split_with_num: ([-1x-1x96xf32, -1x-1x96xf32, -1x-1x96xf32]) <- (-1x-1x288xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(add_0, 3, full_0)

        # builtin.split: (-1x-1x96xf32, -1x-1x96xf32, -1x-1x96xf32) <- ([-1x-1x96xf32, -1x-1x96xf32, -1x-1x96xf32])
...
class Block_builtin_module_84_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_layer_norm_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0):
