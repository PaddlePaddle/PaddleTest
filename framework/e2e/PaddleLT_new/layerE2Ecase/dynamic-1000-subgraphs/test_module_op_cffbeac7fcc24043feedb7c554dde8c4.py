...
class BlockEntries:
    ...
    def builtin_module_75_0_0(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.full: (xi64) <- ()
        full_1 = paddle._C_ops.full([], float('80'), paddle.int64, paddle.framework._current_expected_place())
        ...
        clip_0 = paddle._C_ops.clip(sum_1, min(full_0, full_2), max(full_0, full_2))
