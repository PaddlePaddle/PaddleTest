...
class BlockEntries:
    ...
    def builtin_module_91_0_0(self, parameter_0, parameter_3, parameter_2, parameter_1, data_0):

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [1, 1]

        # pd_op.pool2d: (-1x288x1x1xf32) <- (-1x288x-1x-1xf32, 2xi64)
        ...
        # pd_op.reshape: (1x288x1x1xf32, 0x288xi64) <- (288xf32, 4xi64)
        ...
        # pd_op.multiply: (-1x288x-1x-1xf32) <- (-1x288x-1x-1xf32, -1x288x1x1xf32)
...
class Block_builtin_module_91_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_conv2d_0(self, parameter_0, parameter_3, parameter_2, parameter_1, data_0, full_int_array_0, pool2d_0):
