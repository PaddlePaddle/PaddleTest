...
class BlockEntries:
    ...
    def builtin_module_87_0_0(self, parameter_1, parameter_3, parameter_2, parameter_0, data_0):
        ...
        full_int_array_0 = [0, 64, 8, 25]

        # pd_op.reshape: (-1x64x8x25xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 4xi64)
        ...
        # pd_op.add: (-1x128x4x25xf32) <- (-1x128x4x25xf32, 1x128x1x1xf32)
        add_0 = conv2d_0 + reshape_2

        # pd_op.flatten: (-1x128x100xf32, 0x-1x128x4x25xf32) <- (-1x128x4x25xf32)
        ...
        # pd_op.layer_norm: (-1x100x128xf32, -1x100xf32, -1x100xf32) <- (-1x100x128xf32, 128xf32, 128xf32)
...
class Block_builtin_module_87_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_transpose_0(self, parameter_1, parameter_3, parameter_2, parameter_0, data_0):
        ...
        return [parameter_1, parameter_3, parameter_2, parameter_0, transpose_0]

    def op_full_int_array_0(self, parameter_1, parameter_3, parameter_2, parameter_0, transpose_0):
        ...
        return [parameter_1, parameter_3, parameter_2, parameter_0, transpose_0, full_int_array_0]

    def op_reshape_0(self, parameter_1, parameter_3, parameter_2, parameter_0, transpose_0, full_int_array_0):
        ...
        return [parameter_1, parameter_3, parameter_2, parameter_0, reshape_0, reshape_1]

    def op_conv2d_0(self, parameter_1, parameter_3, parameter_2, parameter_0, reshape_0, reshape_1):
        ...
        return [parameter_1, parameter_3, parameter_2, reshape_0, reshape_1, conv2d_0]

    def op_full_int_array_1(self, parameter_1, parameter_3, parameter_2, reshape_0, reshape_1, conv2d_0):
        ...
        return [parameter_1, parameter_3, parameter_2, reshape_0, reshape_1, conv2d_0, full_int_array_1]

    def op_reshape_1(self, parameter_1, parameter_3, parameter_2, reshape_0, reshape_1, conv2d_0, full_int_array_1):
