...
class BlockEntries:
    ...
    def builtin_module_91_0_0(self, parameter_3, parameter_1, parameter_2, parameter_0, data_0):
        ...
        # pd_op.pool2d: (-1x44x1x1xf32) <- (-1x44x-1x-1xf32, 2xi64)
        ...
        # pd_op.reshape: (1x11x1x1xf32, 0x11xi64) <- (11xf32, 4xi64)
        ...
        # pd_op.add: (-1x11x1x1xf32) <- (-1x11x1x1xf32, 1x11x1x1xf32)
        add_0 = conv2d_0 + reshape_0

        # pd_op.relu: (-1x11x1x1xf32) <- (-1x11x1x1xf32)
        ...
        # pd_op.reshape: (1x44x1x1xf32, 0x44xi64) <- (44xf32, 4xi64)
        ...
        # pd_op.multiply: (-1x44x-1x-1xf32) <- (-1x44x-1x-1xf32, -1x44x1x1xf32)
