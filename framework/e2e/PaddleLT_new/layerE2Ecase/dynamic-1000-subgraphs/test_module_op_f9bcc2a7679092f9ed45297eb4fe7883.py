...
class BlockEntries:
    ...
    def builtin_module_263_0_0(self, parameter_0, data_0, data_2, data_1):
        ...
        reshape_2, reshape_3 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_2, full_int_array_18), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class Block_builtin_module_263_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_263_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_263_0_0()
