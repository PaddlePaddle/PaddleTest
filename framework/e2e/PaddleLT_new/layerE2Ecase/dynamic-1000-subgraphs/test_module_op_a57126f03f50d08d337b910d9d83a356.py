...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_2, reshape_3 = paddle.reshape(pool2d_1, full_int_array_1), None

        # pd_op.pow: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        pow_2 = paddle._C_ops.pow(data_2, 2)
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_4, reshape_5 = paddle.reshape(pool2d_2, full_int_array_1), None

        # pd_op.pow: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        pow_3 = paddle._C_ops.pow(data_3, 2)
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_6, reshape_7 = paddle.reshape(pool2d_3, full_int_array_1), None

        # pd_op.pow: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        pow_4 = paddle._C_ops.pow(data_4, 2)
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_8, reshape_9 = paddle.reshape(pool2d_4, full_int_array_1), None

        # pd_op.pow: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        pow_5 = paddle._C_ops.pow(data_5, 2)
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_10, reshape_11 = paddle.reshape(pool2d_5, full_int_array_1), None

        # pd_op.pow: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        pow_6 = paddle._C_ops.pow(data_6, 2)
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_12, reshape_13 = paddle.reshape(pool2d_6, full_int_array_1), None

        # pd_op.pow: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        pow_7 = paddle._C_ops.pow(data_7, 2)
        ...
        # pd_op.reshape: (22x196xf32, 0x-1x1x14x14xi64) <- (-1x1x14x14xf32, 2xi64)
        reshape_14, reshape_15 = paddle.reshape(pool2d_7, full_int_array_1), None

        # builtin.combine: ([22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32]) <- (22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32)
        combine_0 = [reshape_0, reshape_2, reshape_4, reshape_6, reshape_8, reshape_10, reshape_12, reshape_14]

        # pd_op.stack: (22x8x196xf32) <- ([22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32, 22x196xf32])
