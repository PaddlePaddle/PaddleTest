...
class BlockEntries:
    ...
    def builtin_module_176_0_0(self, data_1, data_0, data_2):
        ...
        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('3'), paddle.int64, paddle.core.CPUPlace())
        ...
        reshape_0, reshape_1 = (lambda x, f: f(x))(paddle._C_ops.reshape(data_2, stack_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
