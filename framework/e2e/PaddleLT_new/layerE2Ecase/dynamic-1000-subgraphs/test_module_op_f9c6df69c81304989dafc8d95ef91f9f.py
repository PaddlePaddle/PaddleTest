...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.pool2d: (-1x1x7x7xf32) <- (-1x1x-1x-1xf32, 2xi64)
        pool2d_0 = paddle._C_ops.pool2d(mean_0, full_int_array_0, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [10, 49]

        # pd_op.reshape: (10x49xf32, 0x-1x1x7x7xi64) <- (-1x1x7x7xf32, 2xi64)
        ...
        # builtin.combine: ([10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32]) <- (10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32)
        combine_0 = [reshape_0, reshape_2, reshape_4, reshape_6, reshape_8, reshape_10, reshape_12, reshape_14]

        # pd_op.stack: (10x8x49xf32) <- ([10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32, 10x49xf32])
