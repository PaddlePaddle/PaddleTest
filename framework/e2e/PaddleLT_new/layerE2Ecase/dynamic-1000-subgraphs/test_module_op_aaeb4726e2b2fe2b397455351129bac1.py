...
class BlockEntries:
    ...
    def builtin_module_101_0_0(self, parameter_0, parameter_1, data_0, data_1, data_2, data_3):
        ...
        full_int_array_2 = [4, 28, 28]

        # pd_op.reshape: (4x28x28xf32, 0x-1xi64) <- (-1xf32, 3xi64)
