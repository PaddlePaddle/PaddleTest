...
class BlockEntries:
    ...
    def builtin_module_99_0_0(self, parameter_1, parameter_0, data_0):
        ...
        # pd_op.full: (xi64) <- ()
        full_0 = paddle._C_ops.full([], float('14'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_1 = paddle._C_ops.full([], float('384'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x14x14x384xf32, 0x-1x-1x384xi64) <- (-1x-1x384xf32, 4xi64)
        ...
        # pd_op.shape: (4xi32) <- (-1x14x14x384xf32)
        ...
        roll_0 = paddle._C_ops.roll(reshape_0, full_int_array_3, [1, 2])
        return layer_norm_1, layer_norm_2, reshape_1, full_int_array_3, roll_0, reshape_0, slice_0
...
class Block_builtin_module_99_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_shape_0(self, parameter_1, parameter_0, data_0):
        ...
        return [parameter_1, parameter_0, data_0, shape_0]

    def op_full_int_array_0(self, parameter_1, parameter_0, data_0, shape_0):
        ...
        return [parameter_1, parameter_0, data_0, shape_0, full_int_array_0]

    def op_full_int_array_1(self, parameter_1, parameter_0, data_0, shape_0, full_int_array_0):
        ...
        return [parameter_1, parameter_0, data_0, shape_0, full_int_array_0, full_int_array_1]

    def op_slice_0(self, parameter_1, parameter_0, data_0, shape_0, full_int_array_0, full_int_array_1):
        ...
        return [parameter_1, parameter_0, data_0, shape_0, full_int_array_0, full_int_array_1, slice_0]

    def op_full_int_array_2(self, parameter_1, parameter_0, data_0, shape_0, full_int_array_0, full_int_array_1, slice_0):
        ...
        return [parameter_1, parameter_0, data_0, shape_0, full_int_array_0, full_int_array_1, slice_0, full_int_array_2]

    def op_slice_1(self, parameter_1, parameter_0, data_0, shape_0, full_int_array_0, full_int_array_1, slice_0, full_int_array_2):
        ...
        return [parameter_1, parameter_0, data_0, full_int_array_0, full_int_array_1, slice_0]

    def op_layer_norm_0(self, parameter_1, parameter_0, data_0, full_int_array_0, full_int_array_1, slice_0):
    ...
    def op_slice_2(self, full_int_array_0, full_int_array_1, slice_0, layer_norm_1, layer_norm_2, reshape_0, reshape_1, shape_1):
        ...
        return [slice_0, layer_norm_1, layer_norm_2, reshape_0, reshape_1]

    def op_full_int_array_3(self, slice_0, layer_norm_1, layer_norm_2, reshape_0, reshape_1):
        ...
        return [slice_0, layer_norm_1, layer_norm_2, reshape_0, reshape_1, full_int_array_3]

    def op_roll_0(self, slice_0, layer_norm_1, layer_norm_2, reshape_0, reshape_1, full_int_array_3):
