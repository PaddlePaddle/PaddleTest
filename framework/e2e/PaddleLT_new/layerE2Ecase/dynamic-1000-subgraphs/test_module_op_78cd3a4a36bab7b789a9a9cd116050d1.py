...
class BlockEntries:
    ...
    def builtin_module_87_0_0(self, parameter_1, parameter_2, parameter_0, parameter_3, data_0):

        # pd_op.depthwise_conv2d: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32, 64x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(data_0, parameter_0, [1, 1], [0, 0], 'SAME', 64, [1, 1], 'NCHW')

        # pd_op.depthwise_conv2d: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32, 64x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(data_0, parameter_1, [1, 1], [0, 0], 'SAME', 64, [2, 2], 'NCHW')

        # pd_op.add: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32, -1x64x-1x-1xf32)
        add_0 = depthwise_conv2d_1 + depthwise_conv2d_0

        # pd_op.depthwise_conv2d: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32, 64x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(data_0, parameter_2, [1, 1], [0, 0], 'SAME', 64, [3, 3], 'NCHW')

        # pd_op.add: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32, -1x64x-1x-1xf32)
        add_1 = depthwise_conv2d_2 + add_0

        # pd_op.depthwise_conv2d: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32, 64x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(data_0, parameter_3, [1, 1], [0, 0], 'SAME', 64, [4, 4], 'NCHW')
...
class Block_builtin_module_87_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_depthwise_conv2d_0(self, parameter_1, parameter_2, parameter_0, parameter_3, data_0):
        ...
        return [parameter_1, parameter_2, parameter_3, data_0, depthwise_conv2d_0]

    def op_depthwise_conv2d_1(self, parameter_1, parameter_2, parameter_3, data_0, depthwise_conv2d_0):
        ...
        return [parameter_2, parameter_3, data_0, depthwise_conv2d_0, depthwise_conv2d_1]

    def op_add_0(self, parameter_2, parameter_3, data_0, depthwise_conv2d_0, depthwise_conv2d_1):
        ...
        return [parameter_2, parameter_3, data_0, depthwise_conv2d_0, depthwise_conv2d_1, add_0]

    def op_depthwise_conv2d_2(self, parameter_2, parameter_3, data_0, depthwise_conv2d_0, depthwise_conv2d_1, add_0):
