...
class BlockEntries:
    ...
    def builtin_module_127_0_0(self, parameter_0, data_0):
        ...
        reshape_0, reshape_1 = (lambda x, f: f(x))(paddle._C_ops.reshape(data_0, full_int_array_5), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        reshape_2, reshape_3 = (lambda x, f: f(x))(paddle._C_ops.reshape(bmm_1, stack_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class Block_builtin_module_127_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_127_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_127_0_0()
