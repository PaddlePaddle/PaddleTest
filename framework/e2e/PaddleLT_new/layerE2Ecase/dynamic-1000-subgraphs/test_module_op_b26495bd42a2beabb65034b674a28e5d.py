...
class BlockEntries:
    ...
    def builtin_module_108_0_0(self, data_0, data_1, data_2, data_4, data_3, data_5):
        ...
        # pd_op.full: (1xf32) <- ()
        full_2 = paddle._C_ops.full([1], float('0.00390625'), paddle.float32, paddle.core.CPUPlace())

        # pd_op.assign: (1xf32) <- (1xf32)
        assign_4 = full_2

        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(sum_0, full_2, float('0'), True)

        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(sum_1, assign_4, float('0'), True)
...
class Block_builtin_module_108_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_108_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_108_0_0()
