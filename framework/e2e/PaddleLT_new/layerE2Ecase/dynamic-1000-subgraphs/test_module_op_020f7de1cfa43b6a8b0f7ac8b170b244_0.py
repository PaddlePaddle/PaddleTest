...
class BlockEntries:
    def builtin_module_492_0_0(self, parameter_4, parameter_11, parameter_1, parameter_0, parameter_5, parameter_3, parameter_10, parameter_6, parameter_8, parameter_2, parameter_9, parameter_7, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        reshape_12, reshape_13 = (lambda x, f: f(x))(paddle._C_ops.reshape(concat_0, stack_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (-1x20x2x-1x-1xf32) <- (-1x2x20x-1x-1xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_12, [0, 2, 1, 3, 4])
        ...
        reshape_14, reshape_15 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_0, stack_1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        reshape_16, reshape_17 = (lambda x, f: f(x))(paddle._C_ops.reshape(concat_1, stack_2), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (-1x40x2x-1x-1xf32) <- (-1x2x40x-1x-1xf32)
        transpose_1 = paddle._C_ops.transpose(reshape_16, [0, 2, 1, 3, 4])
        ...
        reshape_18, reshape_19 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_1, stack_3), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        reshape_20, reshape_21 = (lambda x, f: f(x))(paddle._C_ops.reshape(concat_2, stack_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (-1x80x2x-1x-1xf32) <- (-1x2x80x-1x-1xf32)
        transpose_2 = paddle._C_ops.transpose(reshape_20, [0, 2, 1, 3, 4])

        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], float('160'), paddle.int64, paddle.core.CPUPlace())
        ...
        reshape_22, reshape_23 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_2, stack_5), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_4, parameter_11, parameter_1, parameter_0, parameter_5, parameter_3, parameter_10, parameter_6, parameter_8, parameter_2, parameter_9, parameter_7, data_0, data_1, data_2, data_3, data_4, data_5):
        return self.builtin_module_492_0_0(parameter_4, parameter_11, parameter_1, parameter_0, parameter_5, parameter_3, parameter_10, parameter_6, parameter_8, parameter_2, parameter_9, parameter_7, data_0, data_1, data_2, data_3, data_4, data_5)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_492_0_0(CinnTestBase, unittest.TestCase):
