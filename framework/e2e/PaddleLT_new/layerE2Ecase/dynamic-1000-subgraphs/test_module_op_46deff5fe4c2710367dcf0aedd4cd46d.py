...
class BlockEntries:
    ...
    def builtin_module_100_0_0(self, data_1, data_0):
        ...
        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('116'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x2x116x-1x-1xf32, 0x-1x-1x-1x-1xi64) <- (-1x-1x-1x-1xf32, 5xi64)
        ...
        # pd_op.transpose: (-1x116x2x-1x-1xf32) <- (-1x2x116x-1x-1xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 2, 1, 3, 4])

        # pd_op.full: (xi64) <- ()
        full_3 = paddle._C_ops.full([], float('232'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x232x-1x-1xf32, 0x-1x116x2x-1x-1xi64) <- (-1x116x2x-1x-1xf32, 4xi64)
