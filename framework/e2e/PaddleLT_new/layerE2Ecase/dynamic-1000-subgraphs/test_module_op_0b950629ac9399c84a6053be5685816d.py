...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0):
        ...
        # pd_op.shape: (4xi32) <- (-1x-1x24x36xf32)
        ...
        # pd_op.full: (1xi32) <- ()
        full_2 = paddle._C_ops.full([1], 36, paddle.int32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (1xi32) <- ()
        full_3 = paddle._C_ops.full([1], 24, paddle.int32, paddle.core.CPUPlace())
        ...
        unsqueeze_0, unsqueeze_1 = paddle.unsqueeze(split_1, full_int_array_3), None

        # pd_op.unsqueeze: (1x1x-1x-1xf32, 0x-1x-1xf32) <- (-1x-1xf32, 2xi64)
        unsqueeze_2, unsqueeze_3 = paddle.unsqueeze(split_0, full_int_array_3), None
        ...
        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], 24, paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_6 = paddle._C_ops.full([], 36, paddle.int64, paddle.core.CPUPlace())
        ...
        expand_0 = paddle.expand(unsqueeze_2, stack_0)

        # pd_op.expand: (-1x1x-1x-1xf32) <- (1x1x-1x-1xf32, 4xi64)
        expand_1 = paddle.expand(unsqueeze_0, stack_0)
        ...
        # builtin.combine: ([-1x-1x24x36xf32, -1x2x-1x-1xf32]) <- (-1x-1x24x36xf32, -1x2x-1x-1xf32)
        combine_3 = [data_0, concat_0]

        # pd_op.concat: (-1x-1x24x36xf32) <- ([-1x-1x24x36xf32, -1x2x-1x-1xf32], 1xi32)
