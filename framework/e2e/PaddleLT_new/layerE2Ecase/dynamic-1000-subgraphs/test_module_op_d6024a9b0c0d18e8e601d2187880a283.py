...
class BlockEntries:
    ...
    def builtin_module_626_0_0(self, parameter_0, data_0, data_2, data_1):
        ...
        transpose_1 = paddle._C_ops.transpose(parameter_0, [1, 0])
        ...
        transpose_2 = paddle._C_ops.transpose(concat_0, [1, 0])

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_51 = [0, 49, 196]

        # pd_op.reshape: (8x49x196xf32, 0x8x9604xi64) <- (8x9604xf32, 3xi64)
        reshape_2, reshape_3 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_2, full_int_array_51), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (22x8x16x196xf32) <- (22x8x196x16xf32)
        transpose_3 = paddle._C_ops.transpose(data_2, [0, 1, 3, 2])
...
class Block_builtin_module_626_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_626_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_626_0_0()
