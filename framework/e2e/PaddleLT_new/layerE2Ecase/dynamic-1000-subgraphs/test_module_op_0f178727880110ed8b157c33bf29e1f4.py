...
class BlockEntries:
    ...
    def builtin_module_59_0_0(self, parameter_1, parameter_0, data_1, data_0):

        # pd_op.conv2d: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32, 576x576x1x1xf32)
        ...
        # pd_op.add: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32, 1x576x1x1xf32)
        add_0 = conv2d_0 + reshape_0

        # pd_op.sigmoid: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32)
        sigmoid_0 = paddle.nn.functional.sigmoid(add_0)

        # pd_op.multiply: (-1x576x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x576x-1x-1xf32)
        multiply_0 = data_1 * sigmoid_0
        return conv2d_0, reshape_0, reshape_1, sigmoid_0, multiply_0
...
class Block_builtin_module_59_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_conv2d_0(self, parameter_1, parameter_0, data_1, data_0):
    ...
    def op_sigmoid_0(self, data_1, conv2d_0, reshape_0, reshape_1, add_0):
        ...
        return [data_1, conv2d_0, reshape_0, reshape_1, sigmoid_0]

    def op_multiply_0(self, data_1, conv2d_0, reshape_0, reshape_1, sigmoid_0):
