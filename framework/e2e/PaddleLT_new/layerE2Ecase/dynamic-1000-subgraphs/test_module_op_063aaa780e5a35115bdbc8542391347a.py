...
class BlockEntries:
    ...
    def builtin_module_51_0_0(self, data_0):

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_0 = [22, 49, 16, -1]

        # pd_op.reshape: (22x49x16x-1xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 4xi64)
        ...
        # pd_op.split: ([22x49x16x-1xf32, 22x49x16x-1xf32]) <- (22x49x16x-1xf32, 2xi64, 1xi32)
        split_0 = paddle._C_ops.split(reshape_0, full_int_array_1, full_0)

        # builtin.split: (22x49x16x-1xf32, 22x49x16x-1xf32) <- ([22x49x16x-1xf32, 22x49x16x-1xf32])
        split_1, split_2, = split_0

        # pd_op.transpose: (22x16x49x-1xf32) <- (22x49x16x-1xf32)
