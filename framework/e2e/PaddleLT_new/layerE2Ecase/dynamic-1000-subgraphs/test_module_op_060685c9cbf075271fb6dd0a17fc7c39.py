...
class BlockEntries:
    ...
    def builtin_module_251_0_0(self, parameter_1, parameter_3, parameter_5, parameter_4, parameter_11, parameter_0, parameter_9, parameter_8, parameter_7, parameter_2, parameter_10, parameter_6, data_0, data_1, data_2):

        # pd_op.layer_norm: (1x4096x160xf32, 1x4096xf32, 1x4096xf32) <- (1x4096x160xf32, 160xf32, 160xf32)
        ...
        # pd_op.matmul: (1x4096x160xf32) <- (1x4096x160xf32, 160x160xf32)
        matmul_0 = paddle.matmul(layer_norm_0, parameter_2, transpose_x=False, transpose_y=False)

        # pd_op.add: (1x4096x160xf32) <- (1x4096x160xf32, 160xf32)
        add_0 = matmul_0 + parameter_3

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_0 = [1, 4096, 5, 32]

        # pd_op.reshape: (1x4096x5x32xf32, 0x1x4096x160xi64) <- (1x4096x160xf32, 4xi64)
        ...
        # pd_op.transpose: (1x5x4096x32xf32) <- (1x4096x5x32xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 2, 1, 3])

        # pd_op.transpose: (1x160x4096xf32) <- (1x4096x160xf32)
        ...
        # pd_op.reshape: (1x160x-1x-1xf32, 0x1x160x4096xi64) <- (1x160x4096xf32, 4xi64)
        ...
        # pd_op.matmul: (1x5x4096x-1xf32) <- (1x5x4096x32xf32, 1x5x32x-1xf32)
        ...
        # pd_op.matmul: (1x5x4096x32xf32) <- (1x5x4096x-1xf32, 1x5x-1x32xf32)
        matmul_3 = paddle.matmul(softmax_0, slice_1, transpose_x=False, transpose_y=False)

        # pd_op.transpose: (1x4096x5x32xf32) <- (1x5x4096x32xf32)
        transpose_5 = paddle._C_ops.transpose(matmul_3, [0, 2, 1, 3])

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_7 = [1, 4096, 160]

        # pd_op.reshape: (1x4096x160xf32, 0x1x4096x5x32xi64) <- (1x4096x5x32xf32, 3xi64)
...
class Block_builtin_module_251_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_1, parameter_3, parameter_5, parameter_4, parameter_11, parameter_0, parameter_9, parameter_8, parameter_7, parameter_2, parameter_10, parameter_6, data_0, data_1, data_2):
        args = [parameter_1, parameter_3, parameter_5, parameter_4, parameter_11, parameter_0, parameter_9, parameter_8, parameter_7, parameter_2, parameter_10, parameter_6, data_0, data_1, data_2]
    ...
    def op_layer_norm_0(self, parameter_1, parameter_3, parameter_5, parameter_4, parameter_11, parameter_0, parameter_9, parameter_8, parameter_7, parameter_2, parameter_10, parameter_6, data_0, data_1, data_2):
        ...
        return [parameter_3, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_2, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2]

    def op_matmul_0(self, parameter_3, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_2, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2):
        ...
        return [parameter_3, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0]

    def op_add_0(self, parameter_3, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, add_0]

    def op_full_int_array_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, add_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, add_0, full_int_array_0]

    def op_reshape_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, add_0, full_int_array_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_0, reshape_1]

    def op_transpose_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_0, reshape_1):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0]

    def op_transpose_1(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1]

    def op_full_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0]

    def op_full_1(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0, full_1]

    def op_cast_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_1, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0, full_1):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0, full_1, cast_0]

    def op_cast_1(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, data_2, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0, full_1, cast_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0, full_1, cast_0, cast_1]

    def op_combine_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, full_0, full_1, cast_0, cast_1):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, combine_0]

    def op_stack_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, combine_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, stack_0]

    def op_reshape_1(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, transpose_1, stack_0):
        ...
        return [parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3]

    def op_conv2d_0(self, parameter_5, parameter_4, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3):
        ...
        return [parameter_5, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0]

    def op_full_int_array_1(self, parameter_5, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0):
        ...
        return [parameter_5, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, full_int_array_1]

    def op_reshape_2(self, parameter_5, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, full_int_array_1):
        ...
        return [parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5]

    def op_add_1(self, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5):
        ...
        return [parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1]

    def op_full_int_array_2(self, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1):
        ...
        return [parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1, full_int_array_2]

    def op_reshape_3(self, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, add_1, full_int_array_2):
        ...
        return [parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_6, reshape_7]

    def op_transpose_2(self, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_6, reshape_7):
        ...
        return [parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2]

    def op_layer_norm_1(self, parameter_11, parameter_9, parameter_8, parameter_7, parameter_10, parameter_6, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2):
        ...
        return [parameter_11, parameter_9, parameter_8, parameter_10, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2, layer_norm_3, layer_norm_4, layer_norm_5]

    def op_matmul_1(self, parameter_11, parameter_9, parameter_8, parameter_10, layer_norm_0, layer_norm_1, layer_norm_2, matmul_0, reshape_1, transpose_0, reshape_2, reshape_3, conv2d_0, reshape_4, reshape_5, reshape_7, transpose_2, layer_norm_3, layer_norm_4, layer_norm_5):
