...
class BlockEntries:
    ...
    def builtin_module_74_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        roi_align_0 = paddle._C_ops.roi_align(data_2, split_0, split_4, 14, 14, float('0.25'), 0, True)

        # pd_op.roi_align: (-1x-1x14x14xf32) <- (-1x-1x-1x-1xf32, -1x4xf32, -1xi32)
        roi_align_1 = paddle._C_ops.roi_align(data_3, split_1, split_5, 14, 14, float('0.125'), 0, True)

        # pd_op.roi_align: (-1x-1x14x14xf32) <- (-1x-1x-1x-1xf32, -1x4xf32, -1xi32)
        roi_align_2 = paddle._C_ops.roi_align(data_4, split_2, split_6, 14, 14, float('0.0625'), 0, True)

        # pd_op.roi_align: (-1x-1x14x14xf32) <- (-1x-1x-1x-1xf32, -1x4xf32, -1xi32)
        roi_align_3 = paddle._C_ops.roi_align(data_5, split_3, split_7, 14, 14, float('0.03125'), 0, True)
...
class Test_builtin_module_74_0_0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            # data_0
            paddle.uniform([3, 4], dtype='float32', min=0, max=0.5),
            # data_1
