...
class BlockEntries:
    ...
    def builtin_module_101_0_0(self, parameter_0, parameter_1, data_0):

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_0 = [43, 1, 7, 1, 7, 768]

        # pd_op.reshape: (43x1x7x1x7x768xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 6xi64)
        ...
        # pd_op.transpose: (43x1x1x7x7x768xf32) <- (43x1x7x1x7x768xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 1, 3, 2, 4, 5])

        # pd_op.matmul: (43x1x1x7x7x2304xf32) <- (43x1x1x7x7x768xf32, 768x2304xf32)
        matmul_0 = paddle.matmul(transpose_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (43x1x1x7x7x2304xf32) <- (43x1x1x7x7x2304xf32, 2304xf32)
        add_0 = matmul_0 + parameter_1

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_1 = [43, 1, 49, 3, 24, 32]

        # pd_op.reshape: (43x1x49x3x24x32xf32, 0x43x1x1x7x7x2304xi64) <- (43x1x1x7x7x2304xf32, 6xi64)
        ...
        # pd_op.transpose: (3x43x1x24x49x32xf32) <- (43x1x49x3x24x32xf32)
        ...
        # pd_op.slice: (43x1x24x49x32xf32) <- (3x43x1x24x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (43x1x24x32x49xf32) <- (43x1x24x49x32xf32)
