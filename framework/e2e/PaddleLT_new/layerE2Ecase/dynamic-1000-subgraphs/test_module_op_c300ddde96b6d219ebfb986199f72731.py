...
class BlockEntries:
    ...
    def builtin_module_110_0_0(self, data_0, data_1):
        ...
        full_int_array_0 = [-1, 96, 48]

        # pd_op.reshape: (-1x96x48xf32, 0x-1x-1x-1x-1xi64) <- (-1x-1x-1x-1xf32, 3xi64)
        ...
        # pd_op.full: (xi32) <- ()
        full_0 = paddle._C_ops.full([], float('96'), paddle.int32, paddle.framework._current_expected_place())
        ...
        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('96'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_3 = paddle._C_ops.full([], float('48'), paddle.int64, paddle.core.CPUPlace())

        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64, xi64)
        combine_0 = [cast_0, full_1, full_2, full_2, full_1, full_3]

        # pd_op.stack: (6xi64) <- ([xi64, xi64, xi64, xi64, xi64, xi64])
        stack_0 = paddle._C_ops.stack(combine_0, 0)

        # pd_op.reshape: (-1x1x96x96x1x48xf32, 0x-1x96x48xi64) <- (-1x96x48xf32, 6xi64)
        ...
        # pd_op.transpose: (-1x1x96x96x1x48xf32) <- (-1x1x96x96x1x48xf32)
        transpose_1 = paddle._C_ops.transpose(reshape_2, [0, 1, 3, 2, 4, 5])

        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_1 = [cast_0, full_2, full_2, full_3]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_1 = paddle._C_ops.stack(combine_1, 0)

        # pd_op.reshape: (-1x96x96x48xf32, 0x-1x1x96x96x1x48xi64) <- (-1x1x96x96x1x48xf32, 4xi64)
...
class Block_builtin_module_110_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_combine_0(self, reshape_0, reshape_1, cast_0, full_1, full_2, full_3):
        ...
        return [reshape_0, reshape_1, cast_0, full_2, full_3, combine_0]

    def op_stack_0(self, reshape_0, reshape_1, cast_0, full_2, full_3, combine_0):
        ...
        return [reshape_0, reshape_1, cast_0, full_2, full_3, stack_0]

    def op_reshape_1(self, reshape_0, reshape_1, cast_0, full_2, full_3, stack_0):
        ...
        return [reshape_1, cast_0, full_2, full_3, reshape_2, reshape_3]

    def op_transpose_1(self, reshape_1, cast_0, full_2, full_3, reshape_2, reshape_3):
        ...
        return [reshape_1, cast_0, full_2, full_3, reshape_3, transpose_1]

    def op_combine_1(self, reshape_1, cast_0, full_2, full_3, reshape_3, transpose_1):
