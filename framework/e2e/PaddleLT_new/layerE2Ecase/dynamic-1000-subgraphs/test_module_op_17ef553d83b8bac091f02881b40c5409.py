...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1):
        ...
        # pd_op.full: (xi32) <- ()
        full_0 = paddle._C_ops.full([], 24, paddle.int32, paddle.framework._current_expected_place())
        ...
        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], 24, paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_3 = paddle._C_ops.full([], 48, paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_4 = paddle._C_ops.full([], 2, paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], 96, paddle.int64, paddle.core.CPUPlace())
