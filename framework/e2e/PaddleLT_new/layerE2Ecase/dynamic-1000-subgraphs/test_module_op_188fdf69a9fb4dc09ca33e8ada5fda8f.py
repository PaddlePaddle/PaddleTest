...
class BlockEntries:
    ...
    def builtin_module_110_0_0(self, data_0, data_1):
        ...
        full_int_array_0 = [-1, 96, 96]

        # pd_op.reshape: (-1x96x96xf32, 0x-1x-1x-1x-1xi64) <- (-1x-1x-1x-1xf32, 3xi64)
        ...
        # pd_op.full: (xi32) <- ()
        full_0 = paddle._C_ops.full([], float('24'), paddle.int32, paddle.framework._current_expected_place())
        ...
        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('24'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_3 = paddle._C_ops.full([], float('48'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_4 = paddle._C_ops.full([], float('2'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], float('96'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x1x24x48x2x96xf32, 0x-1x96x96xi64) <- (-1x96x96xf32, 6xi64)
        ...
        # pd_op.transpose: (-1x1x48x24x2x96xf32) <- (-1x1x24x48x2x96xf32)
        ...
        # pd_op.reshape: (-1x48x48x96xf32, 0x-1x1x48x24x2x96xi64) <- (-1x1x48x24x2x96xf32, 4xi64)
