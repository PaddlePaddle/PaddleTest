...
class BlockEntries:
    ...
    def builtin_module_99_0_0(self, parameter_1, parameter_0, data_0):
        ...
        # pd_op.full: (xi64) <- ()
        full_0 = paddle._C_ops.full([], float('7'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_1 = paddle._C_ops.full([], float('768'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x7x7x768xf32, 0x-1x-1x768xi64) <- (-1x-1x768xf32, 4xi64)
        ...
        # pd_op.shape: (4xi32) <- (-1x7x7x768xf32)
