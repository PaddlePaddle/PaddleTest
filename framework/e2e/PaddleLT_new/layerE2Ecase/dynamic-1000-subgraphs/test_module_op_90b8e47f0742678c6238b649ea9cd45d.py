...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_2, data_3, data_4, data_5, data_0, data_1):
        ...
        roi_align_0 = paddle._C_ops.roi_align(data_2, split_0, split_4, 7, 7, 0.25, 0, True)

        # pd_op.roi_align: (-1x-1x7x7xf32) <- (-1x-1x-1x-1xf32, -1x4xf32, -1xi32)
        roi_align_1 = paddle._C_ops.roi_align(data_3, split_1, split_5, 7, 7, 0.125, 0, True)

        # pd_op.roi_align: (-1x-1x7x7xf32) <- (-1x-1x-1x-1xf32, -1x4xf32, -1xi32)
        roi_align_2 = paddle._C_ops.roi_align(data_4, split_2, split_6, 7, 7, 0.0625, 0, True)

        # pd_op.roi_align: (-1x-1x7x7xf32) <- (-1x-1x-1x-1xf32, -1x4xf32, -1xi32)
        roi_align_3 = paddle._C_ops.roi_align(data_5, split_3, split_7, 7, 7, 0.03125, 0, True)
