...
class BlockEntries:
    ...
    def builtin_module_95_0_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0):
        ...
        # pd_op.clip: (-1x92xf32) <- (-1x92xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(add_1, min(full_0, full_1), max(full_0, full_1))

        # pd_op.unsqueeze: (-1x92x1x1xf32, 0x-1x92xf32) <- (-1x92xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x92x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x92x1x1xf32)
...
class Block_builtin_module_95_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_full_int_array_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0):
        ...
        return [parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0]

    def op_pool2d_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0):
        ...
        return [parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0]

    def op_full_int_array_1(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0):
        ...
        return [parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0, full_int_array_1]

    def op_assign_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0, full_int_array_1):
        ...
        return [parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0]

    def op_squeeze_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0):
        ...
        return [parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0, squeeze_0, squeeze_1]

    def op_matmul_0(self, parameter_2, parameter_1, parameter_3, parameter_0, data_0, full_int_array_0, pool2d_0, full_int_array_1, assign_0, squeeze_0, squeeze_1):
...
class Test_builtin_module_95_0_0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            # parameter_1
            paddle.uniform([23], dtype='float32', min=0, max=0.5),
            # parameter_3
