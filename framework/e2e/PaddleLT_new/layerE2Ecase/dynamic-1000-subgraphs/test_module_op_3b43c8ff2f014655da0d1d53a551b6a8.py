...
class BlockEntries:
    ...
    def builtin_module_170_0_0(self, data_0, data_2, data_4, data_6, data_1, data_3, data_5, data_7):
        ...
        # pd_op.clip: (-1x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1x-1xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, min(assign_2, assign_5), max(assign_2, assign_5))
        ...
        # pd_op.clip: (-1x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1x-1xf32, 1xf32, 1xf32)
        clip_2 = paddle._C_ops.clip(multiply_1, min(assign_1, assign_4), max(assign_1, assign_4))
        ...
        # pd_op.clip: (-1x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1x-1xf32, 1xf32, 1xf32)
        clip_3 = paddle._C_ops.clip(multiply_2, min(assign_0, assign_3), max(assign_0, assign_3))
        ...
        # pd_op.scale: (-1x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1x-1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(multiply_3, full_3, float('1'), True)

        # pd_op.full: (1xf32) <- ()
        full_4 = paddle._C_ops.full([1], float('2.5'), paddle.float32, paddle.core.CPUPlace())
