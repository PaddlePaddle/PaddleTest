...
class BlockEntries:
    ...
    def builtin_module_99_0_0(self, parameter_0, parameter_1, data_0):

        # pd_op.shape: (3xi32) <- (-1x-1x192xf32)
        ...
        # pd_op.full: (xi64) <- ()
        full_0 = paddle._C_ops.full([], float('28'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_1 = paddle._C_ops.full([], float('192'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x28x28x192xf32, 0x-1x-1x192xi64) <- (-1x-1x192xf32, 4xi64)
        ...
        # pd_op.shape: (4xi32) <- (-1x28x28x192xf32)
