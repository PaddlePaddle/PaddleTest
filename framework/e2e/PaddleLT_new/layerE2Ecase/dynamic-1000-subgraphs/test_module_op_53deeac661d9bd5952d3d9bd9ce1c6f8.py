...
class BlockEntries:
    ...
    def builtin_module_70_0_0(self, data_0):
...
class Block_builtin_module_70_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_70_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_70_0_0()
