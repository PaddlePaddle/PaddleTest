...
class BlockEntries:
    ...
    def builtin_module_176_0_0(self, data_0, data_1):
        ...
        clip_0 = paddle._C_ops.clip(subtract_0, min(full_1, full_2), max(full_1, full_2))

        # pd_op.subtract: (-1x-1xf32) <- (-1x-1xf32, -1x-1xf32)
        subtract_1 = minimum_1 - maximum_1

        # pd_op.clip: (-1x-1xf32) <- (-1x-1xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, min(assign_1, assign_2), max(assign_1, assign_2))
