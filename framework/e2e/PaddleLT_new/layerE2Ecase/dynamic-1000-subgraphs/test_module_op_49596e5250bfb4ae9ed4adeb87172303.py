...
class BlockEntries:
    def builtin_module_77_0_0(self, data_0, data_1, data_2):
        ...
        # pd_op.full: (1xf32) <- ()
        full_0 = paddle._C_ops.full([1], float('0.0909091'), paddle.float32, paddle.core.CPUPlace())
        ...
        scale_2 = paddle._C_ops.scale(data_2, assign_0, float('0'), True)
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, data_0, data_1, data_2):
        return self.builtin_module_77_0_0(data_0, data_1, data_2)
