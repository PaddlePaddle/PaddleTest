...
class BlockEntries:
    ...
    def builtin_module_95_0_0(self, parameter_2, parameter_3, parameter_0, parameter_1, data_0):
        ...
        # pd_op.add: (-1x72xf32) <- (-1x72xf32, 72xf32)
        ...
        # pd_op.clip: (-1x72xf32) <- (-1x72xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(add_1, min(full_0, full_1), max(full_0, full_1))

        # pd_op.unsqueeze: (-1x72x1x1xf32, 0x-1x72xf32) <- (-1x72xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x72x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x72x1x1xf32)
