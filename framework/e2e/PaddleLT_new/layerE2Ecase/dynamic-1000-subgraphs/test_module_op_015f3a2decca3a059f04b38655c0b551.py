...
class BlockEntries:
    ...
    def builtin_module_84_0_0(self, parameter_1, parameter_3, parameter_2, parameter_0, data_0):
        ...
        # pd_op.split_with_num: ([-1x-1x384xf32, -1x-1x384xf32, -1x-1x384xf32]) <- (-1x-1x1152xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(add_0, 3, full_0)

        # builtin.split: (-1x-1x384xf32, -1x-1x384xf32, -1x-1x384xf32) <- ([-1x-1x384xf32, -1x-1x384xf32, -1x-1x384xf32])
...
class Block_builtin_module_84_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_layer_norm_0(self, parameter_1, parameter_3, parameter_2, parameter_0, data_0):
