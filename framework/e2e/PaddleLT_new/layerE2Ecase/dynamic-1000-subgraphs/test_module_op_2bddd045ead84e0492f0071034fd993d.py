...
class BlockEntries:
    ...
    def builtin_module_105_0_0(self, parameter_3, parameter_1, parameter_0, parameter_2, data_1, data_0):

        # pd_op.full: (1xi32) <- ()
        full_0 = paddle._C_ops.full([1], float('1'), paddle.int32, paddle.core.CPUPlace())

        # builtin.combine: ([-1x80x-1x-1xf32, -1x80x-1x-1xf32]) <- (-1x80x-1x-1xf32, -1x80x-1x-1xf32)
        combine_0 = [data_0, data_1]

        # pd_op.concat: (-1x160x-1x-1xf32) <- ([-1x80x-1x-1xf32, -1x80x-1x-1xf32], 1xi32)
        ...
        # pd_op.hardsigmoid: (-1x160x1x1xf32) <- (-1x160x1x1xf32)
...
class Block_builtin_module_105_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_3, parameter_1, parameter_0, parameter_2, data_1, data_0):
        args = [parameter_3, parameter_1, parameter_0, parameter_2, data_1, data_0]
    ...
    def op_full_0(self, parameter_3, parameter_1, parameter_0, parameter_2, data_1, data_0):
        ...
        return [parameter_3, parameter_1, parameter_0, parameter_2, data_1, data_0, full_0]

    def op_combine_0(self, parameter_3, parameter_1, parameter_0, parameter_2, data_1, data_0, full_0):
        ...
        return [parameter_3, parameter_1, parameter_0, parameter_2, full_0, combine_0]

    def op_concat_0(self, parameter_3, parameter_1, parameter_0, parameter_2, full_0, combine_0):
        ...
        return [parameter_3, parameter_1, parameter_0, parameter_2, full_0, concat_0]

    def op_full_int_array_0(self, parameter_3, parameter_1, parameter_0, parameter_2, full_0, concat_0):
        ...
        return [parameter_3, parameter_1, parameter_0, parameter_2, full_0, concat_0, full_int_array_0]

    def op_pool2d_0(self, parameter_3, parameter_1, parameter_0, parameter_2, full_0, concat_0, full_int_array_0):
        ...
        return [parameter_3, parameter_1, parameter_0, parameter_2, full_0, concat_0, full_int_array_0, pool2d_0]

    def op_conv2d_0(self, parameter_3, parameter_1, parameter_0, parameter_2, full_0, concat_0, full_int_array_0, pool2d_0):
