...
class BlockEntries:
    ...
    def builtin_module_73_0_0(self, parameter_1, parameter_0, data_1, data_0):
        ...
        # builtin.combine: ([-1x288x-1x-1xf32, -1x288x-1x-1xf32]) <- (-1x288x-1x-1xf32, -1x288x-1x-1xf32)
        combine_0 = [data_0, data_1]

        # pd_op.concat: (-1x576x-1x-1xf32) <- ([-1x288x-1x-1xf32, -1x288x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.mean: (-1x576x1x1xf32) <- (-1x576x-1x-1xf32)
