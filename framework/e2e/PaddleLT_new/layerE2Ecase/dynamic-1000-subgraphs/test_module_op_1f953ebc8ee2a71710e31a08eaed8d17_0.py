...
class BlockEntries:
    def builtin_module_158_0_0(self, parameter_5, parameter_2, parameter_3, parameter_4, parameter_1, parameter_0, parameter_6, parameter_7, data_3, data_0, data_1, data_2):
        ...
        # pd_op.full: (1xf32) <- ()
        full_0 = paddle._C_ops.full([1], float('0.25'), paddle.float32, paddle.core.CPUPlace())

        # pd_op.scale: (-1x19x-1x-1xf32) <- (-1x19x-1x-1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(add_6, full_0, float('0'), True)
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_5, parameter_2, parameter_3, parameter_4, parameter_1, parameter_0, parameter_6, parameter_7, data_3, data_0, data_1, data_2):
        return self.builtin_module_158_0_0(parameter_5, parameter_2, parameter_3, parameter_4, parameter_1, parameter_0, parameter_6, parameter_7, data_3, data_0, data_1, data_2)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_158_0_0(CinnTestBase, unittest.TestCase):
