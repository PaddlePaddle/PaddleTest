...
class BlockEntries:
    def builtin_module_87_0_0(self, data_0, data_1):
        ...
        scale_0 = paddle._C_ops.scale(uniform_0, full_2, float('0.9125'), True)
        ...
        # pd_op.full: (1xf32) <- ()
        full_3 = paddle._C_ops.full([1], float('1.09589'), paddle.float32, paddle.core.CPUPlace())
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, data_0, data_1):
        return self.builtin_module_87_0_0(data_0, data_1)
