...
class BlockEntries:
    ...
    def builtin_module_91_0_0(self, parameter_3, parameter_1, parameter_0, parameter_2, data_0):
        ...
        # pd_op.add: (-1x25x1x1xf32) <- (-1x25x1x1xf32, 1x25x1x1xf32)
        add_0 = conv2d_0 + reshape_0

        # pd_op.relu: (-1x25x1x1xf32) <- (-1x25x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_0)

        # pd_op.conv2d: (-1x100x1x1xf32) <- (-1x25x1x1xf32, 100x25x1x1xf32)
        ...
        # pd_op.hardsigmoid: (-1x100x1x1xf32) <- (-1x100x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(add_1, float('0.166667'), float('0.5'))

        # pd_op.multiply: (-1x100x-1x-1xf32) <- (-1x100x-1x-1xf32, -1x100x1x1xf32)
...
class Block_builtin_module_91_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_relu_0(self, parameter_3, parameter_2, data_0, full_int_array_0, pool2d_0, conv2d_0, full_int_array_1, reshape_0, reshape_1, add_0):
        ...
        return [parameter_3, parameter_2, data_0, full_int_array_0, pool2d_0, conv2d_0, full_int_array_1, reshape_0, reshape_1, relu_0]

    def op_conv2d_1(self, parameter_3, parameter_2, data_0, full_int_array_0, pool2d_0, conv2d_0, full_int_array_1, reshape_0, reshape_1, relu_0):
