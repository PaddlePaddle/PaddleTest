...
class BlockEntries:
    ...
    def builtin_module_101_0_0(self, parameter_1, parameter_0, data_0):

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_0 = [11, 1, 7, 1, 7, 768]

        # pd_op.reshape: (11x1x7x1x7x768xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 6xi64)
        ...
        # pd_op.transpose: (11x1x1x7x7x768xf32) <- (11x1x7x1x7x768xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 1, 3, 2, 4, 5])

        # pd_op.matmul: (11x1x1x7x7x2304xf32) <- (11x1x1x7x7x768xf32, 768x2304xf32)
        matmul_0 = paddle.matmul(transpose_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (11x1x1x7x7x2304xf32) <- (11x1x1x7x7x2304xf32, 2304xf32)
        add_0 = matmul_0 + parameter_1

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_1 = [11, 1, 49, 3, 24, 32]

        # pd_op.reshape: (11x1x49x3x24x32xf32, 0x11x1x1x7x7x2304xi64) <- (11x1x1x7x7x2304xf32, 6xi64)
        ...
        # pd_op.transpose: (3x11x1x24x49x32xf32) <- (11x1x49x3x24x32xf32)
        transpose_1 = paddle._C_ops.transpose(reshape_2, [3, 0, 1, 4, 2, 5])
        ...
        # pd_op.slice: (11x1x24x49x32xf32) <- (3x11x1x24x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (11x1x24x32x49xf32) <- (11x1x24x49x32xf32)
        transpose_2 = paddle._C_ops.transpose(slice_1, [0, 1, 2, 4, 3])
...
class Block_builtin_module_101_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_reshape_0(self, parameter_1, parameter_0, data_0, full_int_array_0):
    ...
    def op_transpose_0(self, parameter_1, parameter_0, reshape_0, reshape_1):
        ...
        return [parameter_1, parameter_0, reshape_1, transpose_0]

    def op_matmul_0(self, parameter_1, parameter_0, reshape_1, transpose_0):
