...
class BlockEntries:
    ...
    def builtin_module_72_0_0(self, parameter_1, parameter_0, parameter_2, parameter_3, data_0):

        # pd_op.flatten: (-1x-1xf32, 0x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        flatten_0, flatten_1 = (lambda x, f: f(x))(paddle._C_ops.flatten(data_0, 1, 3), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.matmul: (-1x1024xf32) <- (-1x-1xf32, 3136x1024xf32)
...
class Block_builtin_module_72_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_flatten_0(self, parameter_1, parameter_0, parameter_2, parameter_3, data_0):
        ...
        return [parameter_1, parameter_0, parameter_2, parameter_3, flatten_0, flatten_1]

    def op_matmul_0(self, parameter_1, parameter_0, parameter_2, parameter_3, flatten_0, flatten_1):
        ...
        return [parameter_1, parameter_2, parameter_3, flatten_0, flatten_1, matmul_0]

    def op_add_0(self, parameter_1, parameter_2, parameter_3, flatten_0, flatten_1, matmul_0):
