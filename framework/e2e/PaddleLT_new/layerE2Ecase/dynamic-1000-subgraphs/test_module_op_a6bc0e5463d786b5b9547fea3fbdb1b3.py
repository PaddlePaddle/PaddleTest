...
class BlockEntries:
    ...
    def builtin_module_164_0_0(self, parameter_5, parameter_2, parameter_3, parameter_1, parameter_0, parameter_4, data_0, data_1, data_2, data_3):
        ...
        # pd_op.full: (xi64) <- ()
        full_0 = paddle._C_ops.full([], float('64'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x-1x-1x64xf32, 0x1x65536x64xi64) <- (1x65536x64xf32, 4xi64)
        ...
        # pd_op.flatten: (-1x128x-1xf32, 0x-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32)
...
class Block_builtin_module_164_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_5, parameter_2, parameter_3, parameter_1, parameter_0, parameter_4, data_0, data_1, data_2, data_3):
        args = [parameter_5, parameter_2, parameter_3, parameter_1, parameter_0, parameter_4, data_0, data_1, data_2, data_3]
    ...
    def op_layer_norm_0(self, parameter_5, parameter_2, parameter_3, parameter_1, parameter_0, parameter_4, data_0, data_1, data_2, data_3):
