...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, parameter_6, parameter_4, parameter_3, parameter_5, parameter_0, parameter_1, parameter_2, data_0, data_1):
        ...
        # pd_op.full: (1xf32) <- ()
        full_0 = paddle._C_ops.full([1], 64, paddle.float32, paddle.core.CPUPlace())
