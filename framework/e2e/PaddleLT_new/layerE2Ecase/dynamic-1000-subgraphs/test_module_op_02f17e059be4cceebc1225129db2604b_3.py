...
class BlockEntries:
    def builtin_module_502_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7, data_8):
        ...
        # pd_op.full: (1xf32) <- ()
        full_2 = paddle._C_ops.full([1], float('72'), paddle.float32, paddle.core.CPUPlace())

        # pd_op.full: (1xf32) <- ()
        full_3 = paddle._C_ops.full([1], float('1'), paddle.float32, paddle.core.CPUPlace())

        # pd_op.arange: (72xi64) <- (1xf32, 1xf32, 1xf32)
        ...
        # pd_op.reshape: (5184x2xf32, 0x72x72x2xi64) <- (72x72x2xf32, 2xi64)
        ...
        full_5 = paddle._C_ops.full([5184, 1], float('8'), paddle.float32, paddle.framework._current_expected_place())

        # pd_op.full: (1xf32) <- ()
        full_6 = paddle._C_ops.full([1], float('36'), paddle.float32, paddle.core.CPUPlace())

        # pd_op.arange: (36xi64) <- (1xf32, 1xf32, 1xf32)
        ...
        # pd_op.reshape: (1296x2xf32, 0x36x36x2xi64) <- (36x36x2xf32, 2xi64)
        ...
        full_8 = paddle._C_ops.full([1296, 1], float('16'), paddle.float32, paddle.framework._current_expected_place())

        # pd_op.full: (1xf32) <- ()
        full_9 = paddle._C_ops.full([1], float('18'), paddle.float32, paddle.core.CPUPlace())

        # pd_op.arange: (18xi64) <- (1xf32, 1xf32, 1xf32)
        ...
        # pd_op.reshape: (324x2xf32, 0x18x18x2xi64) <- (18x18x2xf32, 2xi64)
        ...
        full_11 = paddle._C_ops.full([324, 1], float('32'), paddle.float32, paddle.framework._current_expected_place())
        ...
        # pd_op.cast: (6804x2xf32) <- (6804x2xf32)
        ...
        # pd_op.add: (-1x6804x2xf32) <- (-1x-1x-1xf32, 6804x2xf32)
        ...
        # pd_op.subtract: (-1x6804x2xf32) <- (-1x6804x2xf32, -1x-1x-1xf32)
        subtract_0 = add_0 - scale_6

        # pd_op.add: (-1x6804x2xf32) <- (-1x6804x2xf32, -1x-1x-1xf32)
        add_1 = add_0 + scale_6
