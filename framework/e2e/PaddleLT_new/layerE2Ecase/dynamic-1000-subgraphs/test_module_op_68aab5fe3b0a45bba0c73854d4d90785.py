...
class BlockEntries:
    ...
    def builtin_module_56_0_0(self, parameter_0, parameter_1, data_0, data_1):
        ...
        # pd_op.conv2d: (1x19x512x512xf32) <- (1x48x512x512xf32, 19x48x1x1xf32)
        ...
        # pd_op.add: (1x19x512x512xf32) <- (1x19x512x512xf32, 1x19x1x1xf32)
        add_0 = conv2d_0 + reshape_0

        # pd_op.cast: (2xi32) <- (2xi32)
        cast_0 = paddle._C_ops.cast(data_1, paddle.int32)

        # pd_op.bilinear_interp: (1x19x-1x-1xf32) <- (1x19x512x512xf32, 2xi32, None, None)
