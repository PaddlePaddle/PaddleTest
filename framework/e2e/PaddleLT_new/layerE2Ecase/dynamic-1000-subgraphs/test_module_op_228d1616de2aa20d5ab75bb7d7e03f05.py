...
class BlockEntries:
    ...
    def builtin_module_134_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.full: (2xi32) <- ()
        full_2 = paddle._C_ops.full([2], float('0'), paddle.int32, paddle.framework._current_expected_place())
        ...
        unsqueeze_0, unsqueeze_1 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(data_2, full_int_array_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.pad3d: (1x512x-1x-1x-1xf32) <- (1x512x1x97x97xf32, 6xi32)
        pad3d_0 = paddle._C_ops.pad3d(unsqueeze_0, concat_1, 'constant', float('0'), 'NCDHW')
        ...
        # pd_op.full: (xi64) <- ()
        full_3 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.full: (xi64) <- ()
        full_4 = paddle._C_ops.full([], float('8'), paddle.int64, paddle.core.CPUPlace())
        ...
        reshape_0, reshape_1 = (lambda x, f: f(x))(paddle._C_ops.reshape(squeeze_0, stack_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (1x8x8x-1x-1x-1xf32) <- (1x-1x-1x8x-1x8xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 3, 5, 1, 2, 4])

        # pd_op.full: (xi64) <- ()
        full_5 = paddle._C_ops.full([], float('-1'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_6 = paddle._C_ops.full([], float('512'), paddle.int64, paddle.core.CPUPlace())
...
class Block_builtin_module_134_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_134_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_134_0_0()
