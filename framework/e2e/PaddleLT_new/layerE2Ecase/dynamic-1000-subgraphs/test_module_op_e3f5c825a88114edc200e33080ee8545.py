...
class BlockEntries:
    ...
    def builtin_module_823_0_0(self, parameter_27, parameter_26, parameter_38, parameter_0, parameter_23, parameter_45, parameter_42, parameter_4, parameter_2, parameter_35, parameter_9, parameter_15, parameter_14, parameter_16, parameter_13, parameter_11, parameter_5, parameter_18, parameter_21, parameter_8, parameter_20, parameter_29, parameter_34, parameter_46, parameter_3, parameter_41, parameter_7, parameter_43, parameter_37, parameter_39, parameter_40, parameter_44, parameter_28, parameter_24, parameter_22, parameter_36, parameter_30, parameter_17, parameter_32, parameter_1, parameter_10, parameter_6, parameter_31, parameter_33, parameter_19, parameter_25, parameter_12, data_0):
        ...
        # pd_op.full: (1xf32) <- ()
        full_0 = paddle._C_ops.full([1], float('1e-10'), paddle.float32, paddle.framework._current_expected_place())

        # pd_op.p_norm: (-1x1x-1x-1xf32) <- (-1x512x-1x-1xf32)
        p_norm_0 = paddle._C_ops.p_norm(relu_9, float('2'), 1, float('1e-10'), True, False)
        ...
        unsqueeze_0, unsqueeze_1 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_46, full_int_array_3), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [2]

        # pd_op.unsqueeze: (1x512x1xf32, 0x1x512xf32) <- (1x512xf32, 1xi64)
        unsqueeze_2, unsqueeze_3 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(unsqueeze_0, full_int_array_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_5 = [3]

        # pd_op.unsqueeze: (1x512x1x1xf32, 0x1x512x1xf32) <- (1x512x1xf32, 1xi64)
        unsqueeze_4, unsqueeze_5 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(unsqueeze_2, full_int_array_5), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class Block_builtin_module_823_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_823_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_823_0_0()
