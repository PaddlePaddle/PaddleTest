...
class BlockEntries:
    ...
    def builtin_module_116_0_0(self, parameter_0, data_1, data_0):
        ...
        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('19'), paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.reshape: (-1x-1x4x19xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 4xi64)
        ...
        # pd_op.softmax: (-1x-1x4x19xf32) <- (-1x-1x4x19xf32)
        softmax_0 = paddle._C_ops.softmax(reshape_0, -1)

        # pd_op.transpose: (-1x19x-1x4xf32) <- (-1x-1x4x19xf32)
        transpose_0 = paddle._C_ops.transpose(softmax_0, [0, 3, 1, 2])

        # pd_op.conv2d: (-1x1x-1x4xf32) <- (-1x19x-1x4xf32, 1x19x1x1xf32)
