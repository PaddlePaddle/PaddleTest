...
class BlockEntries:
    ...
    def builtin_module_101_0_0(self, parameter_1, parameter_0, data_0):
        ...
        full_int_array_0 = [43, 2, 7, 2, 7, 384]

        # pd_op.reshape: (43x2x7x2x7x384xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 6xi64)
        ...
        # pd_op.transpose: (43x2x2x7x7x384xf32) <- (43x2x7x2x7x384xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 1, 3, 2, 4, 5])

        # pd_op.matmul: (43x2x2x7x7x1152xf32) <- (43x2x2x7x7x384xf32, 384x1152xf32)
        matmul_0 = paddle.matmul(transpose_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (43x2x2x7x7x1152xf32) <- (43x2x2x7x7x1152xf32, 1152xf32)
        add_0 = matmul_0 + parameter_1

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_1 = [43, 4, 49, 3, 12, 32]

        # pd_op.reshape: (43x4x49x3x12x32xf32, 0x43x2x2x7x7x1152xi64) <- (43x2x2x7x7x1152xf32, 6xi64)
        ...
        # pd_op.transpose: (3x43x4x12x49x32xf32) <- (43x4x49x3x12x32xf32)
        ...
        # pd_op.slice: (43x4x12x49x32xf32) <- (3x43x4x12x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (43x4x12x32x49xf32) <- (43x4x12x49x32xf32)
