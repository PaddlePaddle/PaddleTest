...
class BlockEntries:
    ...
    def builtin_module_95_0_0(self, parameter_3, parameter_2, parameter_0, parameter_1, data_0):
        ...
        # pd_op.matmul: (-1x120xf32) <- (-1x-1xf32, 480x120xf32)
        matmul_0 = paddle.matmul(squeeze_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (-1x120xf32) <- (-1x120xf32, 120xf32)
        add_0 = matmul_0 + parameter_1

        # pd_op.relu: (-1x120xf32) <- (-1x120xf32)
        ...
        # pd_op.add: (-1x480xf32) <- (-1x480xf32, 480xf32)
        ...
        # pd_op.clip: (-1x480xf32) <- (-1x480xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(add_1, min(full_0, full_1), max(full_0, full_1))

        # pd_op.unsqueeze: (-1x480x1x1xf32, 0x-1x480xf32) <- (-1x480xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x480x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x480x1x1xf32)
