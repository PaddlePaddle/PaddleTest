...
class BlockEntries:
    ...
    def builtin_module_111_0_0(self, data_1, data_0):
        ...
        split_0 = paddle._C_ops.split(data_1, full_int_array_0, full_0)

        # builtin.split: (-1x-1x-1x-1xf32, -1x-1x-1x-1xf32) <- ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32])
        split_1, split_2, = split_0

        # pd_op.flatten: (-1x-1x-1xf32, 0x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        flatten_2, flatten_3 = (lambda x, f: f(x))(paddle._C_ops.flatten(split_1, 2, 3), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.flatten: (-1x-1x-1xf32, 0x-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        flatten_4, flatten_5 = (lambda x, f: f(x))(paddle._C_ops.flatten(sigmoid_1, 2, 3), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class Block_builtin_module_111_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
...
class Test_builtin_module_111_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_111_0_0()
