...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, parameter_0, parameter_1, parameter_2, parameter_3, parameter_6, parameter_4, parameter_7, parameter_5, data_0, data_1, data_2, data_3):
        ...
        reshape_8, reshape_9 = paddle.reshape(concat_0, stack_0), None

        # pd_op.transpose: (-1x20x2x-1x-1xf32) <- (-1x2x20x-1x-1xf32)
        transpose_0 = paddle.transpose(reshape_8, perm=[0, 2, 1, 3, 4])
        ...
        reshape_10, reshape_11 = paddle.reshape(transpose_0, stack_1), None
        ...
        reshape_12, reshape_13 = paddle.reshape(concat_1, stack_2), None

        # pd_op.transpose: (-1x40x2x-1x-1xf32) <- (-1x2x40x-1x-1xf32)
        transpose_1 = paddle.transpose(reshape_12, perm=[0, 2, 1, 3, 4])
        ...
        reshape_14, reshape_15 = paddle.reshape(transpose_1, stack_3), None
