...
class BlockEntries:
    ...
    def builtin_module_101_0_0(self, parameter_0, parameter_1, data_0):
        ...
        full_int_array_0 = [11, 4, 7, 4, 7, 192]

        # pd_op.reshape: (11x4x7x4x7x192xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 6xi64)
        ...
        # pd_op.transpose: (11x4x4x7x7x192xf32) <- (11x4x7x4x7x192xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 1, 3, 2, 4, 5])

        # pd_op.matmul: (11x4x4x7x7x576xf32) <- (11x4x4x7x7x192xf32, 192x576xf32)
        matmul_0 = paddle.matmul(transpose_0, parameter_0, transpose_x=False, transpose_y=False)

        # pd_op.add: (11x4x4x7x7x576xf32) <- (11x4x4x7x7x576xf32, 576xf32)
        add_0 = matmul_0 + parameter_1

        # pd_op.full_int_array: (6xi64) <- ()
        full_int_array_1 = [11, 16, 49, 3, 6, 32]

        # pd_op.reshape: (11x16x49x3x6x32xf32, 0x11x4x4x7x7x576xi64) <- (11x4x4x7x7x576xf32, 6xi64)
        ...
        # pd_op.transpose: (3x11x16x6x49x32xf32) <- (11x16x49x3x6x32xf32)
        ...
        # pd_op.slice: (11x16x6x49x32xf32) <- (3x11x16x6x49x32xf32, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (11x16x6x32x49xf32) <- (11x16x6x49x32xf32)
