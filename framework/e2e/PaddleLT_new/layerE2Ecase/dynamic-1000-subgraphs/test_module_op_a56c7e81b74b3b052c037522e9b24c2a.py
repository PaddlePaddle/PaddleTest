...
class BlockEntries:
    ...
    def builtin_module_106_0_0(self, data_0, data_1):

        # pd_op.add: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x-1x-1x-1xf32)
        add_0 = data_0 + data_1

        # pd_op.transpose: (-1x-1x-1x-1xf32) <- (-1x-1x-1x-1xf32)
        transpose_0 = paddle._C_ops.transpose(add_0, [0, 2, 1, 3])

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_0 = [-1, 144, 768]

        # pd_op.reshape: (-1x144x768xf32, 0x-1x-1x-1x-1xi64) <- (-1x-1x-1x-1xf32, 3xi64)
        ...
        # pd_op.full: (xi64) <- ()
        full_1 = paddle._C_ops.full([], float('12'), paddle.int64, paddle.core.CPUPlace())

        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('768'), paddle.int64, paddle.core.CPUPlace())

        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64, xi64)
        combine_0 = [cast_0, full_0, full_0, full_1, full_1, full_2]

        # pd_op.stack: (6xi64) <- ([xi64, xi64, xi64, xi64, xi64, xi64])
        stack_0 = paddle._C_ops.stack(combine_0, 0)

        # pd_op.reshape: (-1x1x1x12x12x768xf32, 0x-1x144x768xi64) <- (-1x144x768xf32, 6xi64)
        reshape_2, reshape_3 = (lambda x, f: f(x))(paddle._C_ops.reshape(reshape_0, stack_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (-1x1x12x1x12x768xf32) <- (-1x1x1x12x12x768xf32)
        transpose_1 = paddle._C_ops.transpose(reshape_2, [0, 1, 3, 2, 4, 5])

        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_1 = [cast_0, full_1, full_1, full_2]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_1 = paddle._C_ops.stack(combine_1, 0)

        # pd_op.reshape: (-1x12x12x768xf32, 0x-1x1x12x1x12x768xi64) <- (-1x1x12x1x12x768xf32, 4xi64)
        reshape_4, reshape_5 = (lambda x, f: f(x))(paddle._C_ops.reshape(transpose_1, stack_1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
...
class Block_builtin_module_106_0_0(paddle.nn.Layer, BlockEntries):
    def __init__(self):
        super().__init__()
    ...
    def op_cast_0(self, reshape_0, reshape_1, slice_0):
    ...
    def op_full_0(self, reshape_0, reshape_1, cast_0):
        ...
        return [reshape_0, reshape_1, cast_0, full_0]

    def op_full_1(self, reshape_0, reshape_1, cast_0, full_0):
        ...
        return [reshape_0, reshape_1, cast_0, full_0, full_1]

    def op_full_2(self, reshape_0, reshape_1, cast_0, full_0, full_1):
        ...
        return [reshape_0, reshape_1, cast_0, full_0, full_1, full_2]

    def op_combine_0(self, reshape_0, reshape_1, cast_0, full_0, full_1, full_2):
        ...
        return [reshape_0, reshape_1, cast_0, full_1, full_2, combine_0]

    def op_stack_0(self, reshape_0, reshape_1, cast_0, full_1, full_2, combine_0):
        ...
        return [reshape_0, reshape_1, cast_0, full_1, full_2, stack_0]

    def op_reshape_1(self, reshape_0, reshape_1, cast_0, full_1, full_2, stack_0):
        ...
        return [reshape_1, cast_0, full_1, full_2, reshape_2, reshape_3]

    def op_transpose_1(self, reshape_1, cast_0, full_1, full_2, reshape_2, reshape_3):
        ...
        return [reshape_1, cast_0, full_1, full_2, reshape_3, transpose_1]

    def op_combine_1(self, reshape_1, cast_0, full_1, full_2, reshape_3, transpose_1):
...
class Test_builtin_module_106_0_0(CinnTestBase, unittest.TestCase):
    ...
    def entry(self, use_cinn):
        net = Block_builtin_module_106_0_0()
