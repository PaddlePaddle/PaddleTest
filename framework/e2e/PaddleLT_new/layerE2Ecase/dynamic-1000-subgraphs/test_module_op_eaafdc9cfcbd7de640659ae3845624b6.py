...
class BlockEntries:
    ...
    def builtin_module_110_0_0(self, data_0, data_1):
        ...
        # pd_op.reshape: (-1x2x1x12x24x192xf32, 0x-1x288x192xi64) <- (-1x288x192xf32, 6xi64)
...
class Block_builtin_module_110_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_combine_0(self, reshape_0, reshape_1, cast_0, full_1, full_2, full_3, full_4, full_5):
        ...
        return [reshape_0, reshape_1, cast_0, full_4, full_5, combine_0]

    def op_stack_0(self, reshape_0, reshape_1, cast_0, full_4, full_5, combine_0):
        ...
        return [reshape_0, reshape_1, cast_0, full_4, full_5, stack_0]

    def op_reshape_1(self, reshape_0, reshape_1, cast_0, full_4, full_5, stack_0):
        ...
        return [reshape_1, cast_0, full_4, full_5, reshape_2, reshape_3]

    def op_transpose_1(self, reshape_1, cast_0, full_4, full_5, reshape_2, reshape_3):
        ...
        return [reshape_1, cast_0, full_4, full_5, reshape_3, transpose_1]

    def op_combine_1(self, reshape_1, cast_0, full_4, full_5, reshape_3, transpose_1):
