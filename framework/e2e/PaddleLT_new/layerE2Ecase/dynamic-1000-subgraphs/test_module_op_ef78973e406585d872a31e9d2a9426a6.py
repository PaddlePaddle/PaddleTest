...
class BlockEntries:
    ...
    def builtin_module_0_0_0(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [10, 784]

        # pd_op.reshape: (10x784xf32, 0x-1x1x28x28xi64) <- (-1x1x28x28xf32, 2xi64)
        ...
        # builtin.combine: ([10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32]) <- (10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32)
        combine_0 = [reshape_0, reshape_2, reshape_4, reshape_6, reshape_8, reshape_10, reshape_12, reshape_14]

        # pd_op.stack: (10x8x784xf32) <- ([10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32, 10x784xf32])
