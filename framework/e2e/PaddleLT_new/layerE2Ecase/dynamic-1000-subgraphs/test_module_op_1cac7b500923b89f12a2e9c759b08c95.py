...
class BlockEntries:
    ...
    def builtin_module_87_0_0(self, parameter_1, parameter_3, parameter_2, parameter_0, data_0):
        ...
        full_int_array_0 = [0, 64, 8, 80]

        # pd_op.reshape: (-1x64x8x80xf32, 0x-1x-1x-1xi64) <- (-1x-1x-1xf32, 4xi64)
        ...
        # pd_op.conv2d: (-1x128x4x80xf32) <- (-1x64x8x80xf32, 128x64x3x3xf32)
        ...
        # pd_op.add: (-1x128x4x80xf32) <- (-1x128x4x80xf32, 1x128x1x1xf32)
        add_0 = conv2d_0 + reshape_2

        # pd_op.flatten: (-1x128x320xf32, 0x-1x128x4x80xf32) <- (-1x128x4x80xf32)
        ...
        # pd_op.transpose: (-1x320x128xf32) <- (-1x128x320xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_0, [0, 2, 1])

        # pd_op.layer_norm: (-1x320x128xf32, -1x320xf32, -1x320xf32) <- (-1x320x128xf32, 128xf32, 128xf32)
