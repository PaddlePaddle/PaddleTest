...
class BlockEntries:
    ...
    def builtin_module_84_0_0(self, parameter_3, parameter_1, parameter_0, parameter_2, data_0):
        ...
        # pd_op.split_with_num: ([-1x-1x192xf32, -1x-1x192xf32, -1x-1x192xf32]) <- (-1x-1x576xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(add_0, 3, full_0)

        # builtin.split: (-1x-1x192xf32, -1x-1x192xf32, -1x-1x192xf32) <- ([-1x-1x192xf32, -1x-1x192xf32, -1x-1x192xf32])
...
class Block_builtin_module_84_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_layer_norm_0(self, parameter_3, parameter_1, parameter_0, parameter_2, data_0):
        ...
        return [parameter_3, parameter_2, layer_norm_0, layer_norm_1, layer_norm_2]

    def op_matmul_0(self, parameter_3, parameter_2, layer_norm_0, layer_norm_1, layer_norm_2):
