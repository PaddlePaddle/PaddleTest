...
class BlockEntries:
    ...
    def builtin_module_59_0_0(self, parameter_0, parameter_1, data_1, data_0):

        # pd_op.conv2d: (-1x288x-1x-1xf32) <- (-1x288x-1x-1xf32, 288x288x1x1xf32)
        ...
        # pd_op.add: (-1x288x-1x-1xf32) <- (-1x288x-1x-1xf32, 1x288x1x1xf32)
        add_0 = conv2d_0 + reshape_0

        # pd_op.sigmoid: (-1x288x-1x-1xf32) <- (-1x288x-1x-1xf32)
        sigmoid_0 = paddle.nn.functional.sigmoid(add_0)

        # pd_op.multiply: (-1x288x-1x-1xf32) <- (-1x-1x-1x-1xf32, -1x288x-1x-1xf32)
...
class Block_builtin_module_59_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def op_conv2d_0(self, parameter_0, parameter_1, data_1, data_0):
