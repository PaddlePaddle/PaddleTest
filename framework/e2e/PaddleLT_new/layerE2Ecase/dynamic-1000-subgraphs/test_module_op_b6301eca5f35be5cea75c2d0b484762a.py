...
class BlockEntries:
    ...
    def builtin_module_164_0_0(self, parameter_5, parameter_0, parameter_3, parameter_2, parameter_1, parameter_4, data_0, data_1, data_2, data_3):
        ...
        # pd_op.reshape: (-1x-1x-1x64xf32, 0x1x32768x64xi64) <- (1x32768x64xf32, 4xi64)
...
class Block_builtin_module_164_0_0(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_5, parameter_0, parameter_3, parameter_2, parameter_1, parameter_4, data_0, data_1, data_2, data_3):
        args = [parameter_5, parameter_0, parameter_3, parameter_2, parameter_1, parameter_4, data_0, data_1, data_2, data_3]
    ...
    def op_layer_norm_0(self, parameter_5, parameter_0, parameter_3, parameter_2, parameter_1, parameter_4, data_0, data_1, data_2, data_3):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, data_1, data_2, data_3, layer_norm_0, layer_norm_1, layer_norm_2]

    def op_cast_0(self, parameter_5, parameter_3, parameter_2, parameter_4, data_1, data_2, data_3, layer_norm_0, layer_norm_1, layer_norm_2):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, data_2, data_3, layer_norm_0, layer_norm_1, layer_norm_2, cast_0]

    def op_cast_1(self, parameter_5, parameter_3, parameter_2, parameter_4, data_2, data_3, layer_norm_0, layer_norm_1, layer_norm_2, cast_0):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, data_3, layer_norm_0, layer_norm_1, layer_norm_2, cast_0, cast_1]

    def op_cast_2(self, parameter_5, parameter_3, parameter_2, parameter_4, data_3, layer_norm_0, layer_norm_1, layer_norm_2, cast_0, cast_1):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, cast_0, cast_1, cast_2]

    def op_full_0(self, parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, cast_0, cast_1, cast_2):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, cast_0, cast_1, cast_2, full_0]

    def op_combine_0(self, parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, cast_0, cast_1, cast_2, full_0):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, combine_0]

    def op_stack_0(self, parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, combine_0):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, stack_0]

    def op_reshape_0(self, parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_0, layer_norm_1, layer_norm_2, stack_0):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_1, layer_norm_2, reshape_0, reshape_1]

    def op_transpose_0(self, parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_1, layer_norm_2, reshape_0, reshape_1):
        ...
        return [parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_1, layer_norm_2, reshape_1, transpose_0]

    def op_conv2d_0(self, parameter_5, parameter_3, parameter_2, parameter_4, layer_norm_1, layer_norm_2, reshape_1, transpose_0):
