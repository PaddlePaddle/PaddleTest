...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_a9d99c37ea10ee1c9eacfc4e3293cff6(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_c28a621f8ed781630f36a677c6a1f3bc
    def get_inputs(self):
        return [
            paddle.to_tensor([[[21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504], [21.08445167541504]]], dtype='float32').reshape([1, 25, 1]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_78c303d380d6d2779082f42db14fdb33(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_34522bde77356558568ccf3af16759d9(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_3affdab8a5d5660d5adca0941a7d302c(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_c28a621f8ed781630f36a677c6a1f3bc
    def get_inputs(self):
        return [
            paddle.to_tensor([[[64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562], [64.52090454101562]]], dtype='float32').reshape([1, 26, 1]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_e099ef42916d51f82e5c1741b761a843(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_67abd3a6b60908a1419906fe6480a657(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_4f9bef62020e8d5103e05067caa6980d
    def get_inputs(self):
        return [
            paddle.to_tensor([[[21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875], [21.46875]]], dtype='float16').reshape([1, 25, 1]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_ef6853f64611b3716a6380804ba395bc(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_d045ea6ce9f44e0dc555736083fc94ff(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_51debb02e5ceee938a8acb787fafedf5(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_d045ea6ce9f44e0dc555736083fc94ff
    def get_inputs(self):
        return [
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_49de2d86b9a9430d070aeaef335448bb(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_c9977fee5c357e302ec69b7e97c1141c(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_131cfcd9c5872a81008fc4482bab6bda(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_c9977fee5c357e302ec69b7e97c1141c
    def get_inputs(self):
        return [
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_f92e061989b07c829db1564c23863007(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_cefa1a56b9dfac499bac86f81301ac6c(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_af87d325877a0dc97c59d149d9ea8c32(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_9e51856fb50522efce9e388cdea78a26(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_3778a4ced0b0d50e85b25a09768fab89(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_83fa608f8478578349c9a2d3ff634869(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_97088f574b9959eb32a8b4854c08caba(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_d18d0723412e6c84c223246a0dda7f7f(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_7204ab81e503726baf3c878f0a7070da(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_2e499de41a2076d039d3e6c1fa3def69(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_dead86c7bf945b59c8e3c2fc7c1ab190(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_57fa604d30924f0529cca8325ff91e2c(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_719141f3406f88087718ca5d22e3d701(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_cc1cd753674f9b32b8feb362139904ae(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_719141f3406f88087718ca5d22e3d701
    def get_inputs(self):
        return [
            paddle.uniform([2, 8, 98, 98], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_35dd7a15652e62024ee27a177ade884d(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_58742f54ed5786ebbc2e48e5c47c868d(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_35dd7a15652e62024ee27a177ade884d
    def get_inputs(self):
        return [
            paddle.uniform([1, 25, 37], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_f71fed52f867cf1ff2e638cc4148675c(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_b36ce86d65fcdc953d32de9c8e7a017d(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_f71fed52f867cf1ff2e638cc4148675c
    def get_inputs(self):
        return [
            paddle.uniform([4, 16, 144, 144], dtype='float16', min=0, max=0.5),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_7a1169a52c9b93e691ff7c536ad87b67(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_8df38adcba2903f2bc49045700d6682a(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_f69189bc186a54582e25265a9e03142e(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_8df38adcba2903f2bc49045700d6682a
    def get_inputs(self):
        return [
            paddle.uniform([1, 32, 144, 144], dtype='float16', min=0, max=0.5),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_293418ad0a85c79ff33ee5f4e6f34b5b(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_facb45659bf1a5cdddfca2e76ebb1761(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_b616f8abb5f86e652434078dbf794c91(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_facb45659bf1a5cdddfca2e76ebb1761
    def get_inputs(self):
        return [
            paddle.uniform([14, 4, 56, 56], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_963d95a8e9455b86a1b33c23c90892a3(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_aca00f1c2c650666bb3350c67108213c(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_963d95a8e9455b86a1b33c23c90892a3
    def get_inputs(self):
        return [
            paddle.uniform([1600, 8], dtype='float32', min=0, max=0.5),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_5449793f2b2c2d38da8f970ec03f0b30(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_e825edf3944b2f3acd79c891d20aaad0(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_dc459ada4be8a9015d49caedfc6d581b(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_e825edf3944b2f3acd79c891d20aaad0
    def get_inputs(self):
        return [
            paddle.uniform([6400, 8], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_4de215860a9c21e7fea8af412059d3e0(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_c9a827a972c90b4483ad6f9771977513(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_4de215860a9c21e7fea8af412059d3e0
    def get_inputs(self):
        return [
            paddle.uniform([56, 2, 56, 56], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_d4c4f1010c91d63c8e76c62624580ed4(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_a459002e6a86b69b4fe99beb7eb7ce87(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_d4c4f1010c91d63c8e76c62624580ed4
    def get_inputs(self):
        return [
            paddle.uniform([16, 8, 144, 144], dtype='float16', min=0, max=0.5),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_d061dc867261da209811a55124c1100b(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_4fd6757cbec5fc9540d975a55f56d424(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_53ea2bdc80cb2fca2bafb1d0e9219dad(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_4fd6757cbec5fc9540d975a55f56d424
    def get_inputs(self):
        return [
            paddle.uniform([1, 2, 200, 200], dtype='float16', min=0, max=0.5),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_edf0247dc4256db93ab70efe433cb697(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_92c17efc4b74f98a7683e69db171b8ec(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_572a234911dbc0940fc160fca30f1ae5(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_7ee711eefa03fe79d51ddb8f3e410be7(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_698f9470935777d43cf04f3a9e74537e(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_7ee711eefa03fe79d51ddb8f3e410be7
    def get_inputs(self):
        return [
            paddle.uniform([1, 32, 49, 49], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_066eeba9ade837fd16d17f5f5e1ca969(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_8ff7417fc39aab973d228858c8ac54ef(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_066eeba9ade837fd16d17f5f5e1ca969
    def get_inputs(self):
        return [
            paddle.uniform([1, 4, 100, 100], dtype='float16', min=0, max=0.5),
        ]
...
class PrimitiveOp_2743c5c10d0b28401e458ad841ea35de(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_0a641c12ea0f25b990193df2f15a5dff(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_2743c5c10d0b28401e458ad841ea35de
    def get_inputs(self):
        return [
            paddle.uniform([64, 4, 144, 144], dtype='float16', min=0, max=0.5),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_73781148f8405bce0baa908c5c1bdf89(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_3e44e043404c3cb5ea28fae9215c2ba4(InstanceTrait, paddle.nn.Layer):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_5d56734da67ea0adf2323f07da463fab(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_3e44e043404c3cb5ea28fae9215c2ba4
    def get_inputs(self):
        return [
            paddle.uniform([1, 501, 30], dtype='float16', min=0, max=0.5),
        ]
