...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_d71ca862b346948213f17125294c9d0f(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_c74d8d508562863cba36dcb2fc799bb2
    def get_inputs(self):
        return [
            paddle.to_tensor([[[202343123517440.0], [180283601059840.0], [217324707643392.0], [254628008558592.0], [204574291918848.0], [190698057891840.0], [230120254078976.0], [175141350801408.0], [183051791368192.0], [242384231202816.0], [214490482212864.0], [175546218577920.0], [212916074708992.0]]], dtype='float32').reshape([1, 13, 1]),
            paddle.to_tensor([-1], dtype='int64').reshape([1]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_b25c44b26a121781b121c32b3e04bed0(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_84624748747206dc868380843f95b82a
    def get_inputs(self):
        return [
            paddle.to_tensor([[[[202343123517440.0]], [[180283601059840.0]], [[217324707643392.0]], [[254628008558592.0]], [[204574291918848.0]], [[190698057891840.0]], [[230120254078976.0]], [[175141350801408.0]], [[183051791368192.0]], [[242384231202816.0]], [[214490482212864.0]], [[175546218577920.0]], [[212916074708992.0]]]], dtype='float32').reshape([1, 13, 1, 1]),
            paddle.to_tensor([-1], dtype='int64').reshape([1]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_dc84642d5ab3eb18df96f4cd7ffe90a3(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_9e4fe2b17284869e3890abf62f3bb076(CinnTestBase, unittest.TestCase):
