...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_253c5478d788e7c9f4b558eafaff1d2b(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_69e6b916ba2f67cd073f35aea25468f6
    def get_inputs(self):
        return [
            paddle.to_tensor([[16.292903900146484, 16.25587272644043, 15.661948204040527, 15.946656227111816]], dtype='float32').reshape([1, 4]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_fc9635cc7fe054ac1413f5adae704fe9(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_37273dec28a4a0ce5db52248fbb36354
    def get_inputs(self):
        return [
            paddle.to_tensor([[16.421875, 16.78125, 17.890625, 17.65625]], dtype='float16').reshape([1, 4]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_7b5972e350bf650a4bc16ff1b5bde161(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_5a4be92f173f2516c9d571af1cb472c7
    def get_inputs(self):
        return [
            paddle.to_tensor([[[[16197618.0, 18490752.0, 18280206.0, 18435716.0, 18435782.0, 16642859.0], [16111549.0, 18474144.0, 18237012.0, 18453914.0, 18550928.0, 16731614.0]]]], dtype='float32').reshape([1, 1, 2, 6]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_a6cb46e0318fd9946780caecdd475230(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_c136a427649ff7eb73f46b90500d5e81(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_2bf448cf1bdcfdbafea2beda1b3d5d50(CinnTestBase, unittest.TestCase):
