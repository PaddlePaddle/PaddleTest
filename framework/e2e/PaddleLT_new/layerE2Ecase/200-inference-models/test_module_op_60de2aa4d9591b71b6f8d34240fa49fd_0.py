...
class BlockEntries:
    def builtin_module_758_0_0(self, parameter_93, parameter_89, parameter_85, constant_3, parameter_81, parameter_77, parameter_73, parameter_69, parameter_65, parameter_61, parameter_57, parameter_53, parameter_49, parameter_45, parameter_41, parameter_37, parameter_33, parameter_29, parameter_25, parameter_21, parameter_17, parameter_13, constant_2, parameter_9, parameter_5, parameter_1, constant_1, constant_0, parameter_0, parameter_3, parameter_2, parameter_4, parameter_7, parameter_6, parameter_8, parameter_11, parameter_10, parameter_12, parameter_15, parameter_14, parameter_16, parameter_19, parameter_18, parameter_20, parameter_23, parameter_22, parameter_24, parameter_27, parameter_26, parameter_28, parameter_31, parameter_30, parameter_32, parameter_35, parameter_34, parameter_36, parameter_39, parameter_38, parameter_40, parameter_43, parameter_42, parameter_44, parameter_47, parameter_46, parameter_48, parameter_51, parameter_50, parameter_52, parameter_55, parameter_54, parameter_56, parameter_59, parameter_58, parameter_60, parameter_63, parameter_62, parameter_64, parameter_67, parameter_66, parameter_68, parameter_71, parameter_70, parameter_72, parameter_75, parameter_74, parameter_76, parameter_79, parameter_78, parameter_80, parameter_83, parameter_82, parameter_84, parameter_87, parameter_86, parameter_88, parameter_91, parameter_90, parameter_92, feed_0):
        ...
        unsqueeze__0, unsqueeze__1 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_3, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__2, unsqueeze__3 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_4, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__4, unsqueeze__5 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_5, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__6, unsqueeze__7 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_6, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__8, unsqueeze__9 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_7, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__10, unsqueeze__11 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_8, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__12, unsqueeze__13 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_9, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__14, unsqueeze__15 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_10, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.unsqueeze_: (-1x256x1x-1x-1xf32, None) <- (-1x256x-1x-1xf32, 1xi64)
        unsqueeze__16, unsqueeze__17 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_11, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        unsqueeze__18, unsqueeze__19 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu_13, constant_0), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
