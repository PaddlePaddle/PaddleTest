...
def NumOperationsInBlock(block_idx):
    return [276][block_idx] - 1 # number-of-ops-in-block
...
class BlockEntries:
    def builtin_module_829_0_0(self, constant_14, constant_13, parameter_193, parameter_174, parameter_160, constant_12, constant_11, constant_10, constant_9, constant_8, constant_7, parameter_146, parameter_140, constant_6, parameter_134, constant_5, parameter_128, parameter_122, constant_4, constant_3, parameter_116, constant_2, constant_1, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_109, parameter_106, parameter_108, parameter_107, parameter_110, parameter_114, parameter_111, parameter_113, parameter_112, parameter_115, parameter_120, parameter_117, parameter_119, parameter_118, parameter_121, parameter_126, parameter_123, parameter_125, parameter_124, parameter_127, parameter_132, parameter_129, parameter_131, parameter_130, parameter_133, parameter_138, parameter_135, parameter_137, parameter_136, parameter_139, parameter_144, parameter_141, parameter_143, parameter_142, parameter_145, parameter_150, parameter_147, parameter_149, parameter_148, parameter_151, parameter_152, parameter_153, parameter_154, parameter_158, parameter_155, parameter_157, parameter_156, parameter_159, parameter_164, parameter_161, parameter_163, parameter_162, parameter_165, parameter_166, parameter_167, parameter_168, parameter_172, parameter_169, parameter_171, parameter_170, parameter_173, parameter_178, parameter_175, parameter_177, parameter_176, parameter_179, parameter_180, parameter_181, parameter_182, parameter_186, parameter_183, parameter_185, parameter_184, parameter_187, parameter_191, parameter_188, parameter_190, parameter_189, parameter_192, feed_0):
        ...
        # pd_op.pool2d: (-1x64x-1x-1xf16) <- (-1x64x-1x-1xf16, 2xi64)
        pool2d_1 = paddle._C_ops.pool2d(relu_6, constant_1, [2, 2], [0, 0], True, True, 'NCHW', 'avg', False, False, 'EXPLICIT')
        ...
        add_2 = batch_norm__60 + batch_norm__54
        ...
        add_4 = batch_norm__90 + batch_norm__84
        ...
        # pd_op.add: (-1x256x-1x-1xf16) <- (-1x256x-1x-1xf16, -1x256x-1x-1xf16)
        add_5 = relu_12 + batch_norm__102

        # pd_op.relu: (-1x256x-1x-1xf16) <- (-1x256x-1x-1xf16)
        relu_14 = paddle._C_ops.relu(add_5)

        # pd_op.conv2d: (-1x512x-1x-1xf16) <- (-1x256x-1x-1xf16, 512x256x3x3xf16)
        ...
        add_6 = batch_norm__120 + batch_norm__114
        ...
        # pd_op.add: (-1x512x-1x-1xf16) <- (-1x512x-1x-1xf16, -1x512x-1x-1xf16)
        add_7 = relu_16 + batch_norm__132

        # pd_op.relu: (-1x512x-1x-1xf16) <- (-1x512x-1x-1xf16)
        relu_18 = paddle._C_ops.relu(add_7)

        # pd_op.pool2d: (-1x512x1x1xf16) <- (-1x512x-1x-1xf16, 2xi64)
        pool2d_2 = paddle._C_ops.pool2d(relu_18, constant_2, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')
        ...
        # pd_op.shape: (4xi32) <- (-1x512x-1x-1xf16)
        shape_0 = paddle._C_ops.shape(paddle.cast(relu_18, 'float32'))
        ...
        # pd_op.pool2d: (-1x512x2x2xf16) <- (-1x512x-1x-1xf16, 2xi64)
        pool2d_3 = paddle._C_ops.pool2d(relu_18, constant_1, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')
        ...
        # pd_op.shape: (4xi32) <- (-1x512x-1x-1xf16)
        shape_1 = paddle._C_ops.shape(paddle.cast(relu_18, 'float32'))
        ...
        # pd_op.pool2d: (-1x512x3x3xf16) <- (-1x512x-1x-1xf16, 2xi64)
        pool2d_4 = paddle._C_ops.pool2d(relu_18, constant_0, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')

        # pd_op.conv2d: (-1x128x3x3xf16) <- (-1x512x3x3xf16, 128x512x1x1xf16)
        conv2d_25 = paddle._C_ops.conv2d(pool2d_4, parameter_127, [1, 1], [0, 0], 'SAME', [1, 1], 1, 'NCHW')

        # pd_op.add_: (-1x128x3x3xf16) <- (-1x128x3x3xf16, 1x128x1x1xf16)
        add__2 = paddle._C_ops.add_(conv2d_25, parameter_128)

        # pd_op.batch_norm_: (-1x128x3x3xf16, 128xf32, 128xf32, xf32, xf32, None) <- (-1x128x3x3xf16, 128xf32, 128xf32, 128xf32, 128xf32)
        ...
        # pd_op.relu_: (-1x128x3x3xf16) <- (-1x128x3x3xf16)
        relu__2 = paddle._C_ops.relu_(batch_norm__150)

        # pd_op.shape: (4xi32) <- (-1x512x-1x-1xf16)
        shape_2 = paddle._C_ops.shape(paddle.cast(relu_18, 'float32'))
        ...
        # pd_op.bilinear_interp: (-1x128x-1x-1xf16) <- (-1x128x3x3xf16, 2xi32, None, None)
        bilinear_interp_2 = paddle._C_ops.bilinear_interp(relu__2, cast__2, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)

        # pd_op.pool2d: (-1x512x6x6xf16) <- (-1x512x-1x-1xf16, 2xi64)
        pool2d_5 = paddle._C_ops.pool2d(relu_18, constant_5, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')

        # pd_op.conv2d: (-1x128x6x6xf16) <- (-1x512x6x6xf16, 128x512x1x1xf16)
        conv2d_26 = paddle._C_ops.conv2d(pool2d_5, parameter_133, [1, 1], [0, 0], 'SAME', [1, 1], 1, 'NCHW')

        # pd_op.add_: (-1x128x6x6xf16) <- (-1x128x6x6xf16, 1x128x1x1xf16)
        add__3 = paddle._C_ops.add_(conv2d_26, parameter_134)

        # pd_op.batch_norm_: (-1x128x6x6xf16, 128xf32, 128xf32, xf32, xf32, None) <- (-1x128x6x6xf16, 128xf32, 128xf32, 128xf32, 128xf32)
        ...
        # pd_op.relu_: (-1x128x6x6xf16) <- (-1x128x6x6xf16)
        relu__3 = paddle._C_ops.relu_(batch_norm__156)

        # pd_op.shape: (4xi32) <- (-1x512x-1x-1xf16)
        shape_3 = paddle._C_ops.shape(paddle.cast(relu_18, 'float32'))
        ...
        # pd_op.bilinear_interp: (-1x128x-1x-1xf16) <- (-1x128x6x6xf16, 2xi32, None, None)
        bilinear_interp_3 = paddle._C_ops.bilinear_interp(relu__3, cast__3, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)

        # builtin.combine: ([-1x512x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16]) <- (-1x512x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16)
        combine_0 = [relu_18, bilinear_interp_3, bilinear_interp_2, bilinear_interp_1, bilinear_interp_0]

        # pd_op.concat: (-1x1024x-1x-1xf16) <- ([-1x512x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, constant_6)

        # pd_op.conv2d: (-1x128x-1x-1xf16) <- (-1x1024x-1x-1xf16, 128x1024x3x3xf16)
        ...
        shape_4 = paddle._C_ops.shape(paddle.cast(relu_20, 'float32'))

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(shape_4, [0], constant_3, constant_4, [1], [])
        ...
        cast_1 = paddle._C_ops.cast(slice_4, paddle.int32)

        # pd_op.bilinear_interp: (-1x64x-1x-1xf16) <- (-1x64x-1x-1xf16, 2xi32, None, None)
        bilinear_interp_4 = paddle._C_ops.bilinear_interp(conv2d_30, cast_1, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)

        # builtin.combine: ([-1x64x-1x-1xf16, -1x64x-1x-1xf16]) <- (-1x64x-1x-1xf16, -1x64x-1x-1xf16)
        combine_1 = [bilinear_interp_4, conv2d_29]

        # pd_op.concat: (-1x128x-1x-1xf16) <- ([-1x64x-1x-1xf16, -1x64x-1x-1xf16], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, constant_6)
        ...
        # pd_op.full: (1xf16) <- ()
        full_0 = paddle._C_ops.full([1], float('-1'), paddle.float16, paddle.core.CPUPlace())

        # pd_op.full: (1xf16) <- ()
        full_1 = paddle._C_ops.full([1], float('1'), paddle.float16, paddle.core.CPUPlace())

        # pd_op.linspace: (-1xf16) <- (1xf16, 1xf16, xi32)
        linspace_0 = paddle._C_ops.linspace(full_0, full_1, slice_5, paddle.float16, paddle.framework._current_expected_place())

        # pd_op.reshape_: (-1x1xf16, 0x-1xf16) <- (-1xf16, 2xi64)
        ...
        # pd_op.slice: (xi32) <- (2xi32, 1xi64, 1xi64)
        slice_7 = paddle._C_ops.slice(slice_4, [0], constant_10, constant_3, [1], [0])

        # pd_op.linspace: (-1xf16) <- (1xf16, 1xf16, xi32)
        linspace_1 = paddle._C_ops.linspace(full_0, full_1, slice_7, paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.unsqueeze_: (-1x-1x1xf16, None) <- (-1x-1xf16, 1xi64)
        ...
        # builtin.combine: ([-1x-1x1xf16, -1x-1x1xf16]) <- (-1x-1x1xf16, -1x-1x1xf16)
        combine_4 = [unsqueeze__0, unsqueeze__2]

        # pd_op.concat: (-1x-1x2xf16) <- ([-1x-1x1xf16, -1x-1x1xf16], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_4, constant_12)

        # pd_op.transpose: (-1x-1x-1x2xf16) <- (-1x2x-1x-1xf16)
        transpose_1 = paddle._C_ops.transpose(conv2d_31, [0, 2, 3, 1])

        # pd_op.cast: (1x1x1x2xf16) <- (1x1x1x2xi32)
        cast_2 = paddle._C_ops.cast(reshape__0, paddle.float16)

        # pd_op.memcpy_h2d: (1x1x1x2xf16) <- (1x1x1x2xf16)
        memcpy_h2d_0 = paddle._C_ops.memcpy_h2d(cast_2, 1)

        # pd_op.divide: (-1x-1x-1x2xf16) <- (-1x-1x-1x2xf16, 1x1x1x2xf16)
        divide_0 = transpose_1 / memcpy_h2d_0

        # pd_op.add: (-1x-1x-1x2xf16) <- (-1x-1x2xf16, -1x-1x-1x2xf16)
        add_10 = concat_2 + divide_0

        # pd_op.cast: (-1x-1x-1x2xf32) <- (-1x-1x-1x2xf16)
        cast_3 = paddle._C_ops.cast(add_10, paddle.float32)

        # pd_op.cast: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf16)
        cast_4 = paddle._C_ops.cast(relu_19, paddle.float32)

        # pd_op.grid_sample: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x-1x-1x2xf32)
        grid_sample_0 = paddle._C_ops.grid_sample(cast_4, cast_3, 'bilinear', 'zeros', True)

        # pd_op.cast: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf32)
        cast_5 = paddle._C_ops.cast(grid_sample_0, paddle.float16)

        # pd_op.add: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, -1x128x-1x-1xf16)
        add_11 = relu_20 + cast_5
        ...
        # pd_op.add: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, 1x128x1x1xf16)
        add_12 = conv2d_33 + parameter_160
        ...
        # pd_op.shape: (4xi32) <- (-1x128x-1x-1xf16)
        shape_5 = paddle._C_ops.shape(paddle.cast(relu_22, 'float32'))

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(shape_5, [0], constant_3, constant_4, [1], [])
        ...
        # pd_op.bilinear_interp: (-1x64x-1x-1xf16) <- (-1x64x-1x-1xf16, 2xi32, None, None)
        bilinear_interp_5 = paddle._C_ops.bilinear_interp(conv2d_35, cast_6, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)

        # builtin.combine: ([-1x64x-1x-1xf16, -1x64x-1x-1xf16]) <- (-1x64x-1x-1xf16, -1x64x-1x-1xf16)
        combine_5 = [bilinear_interp_5, conv2d_34]

        # pd_op.concat: (-1x128x-1x-1xf16) <- ([-1x64x-1x-1xf16, -1x64x-1x-1xf16], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_5, constant_6)
        ...
        # pd_op.linspace: (-1xf16) <- (1xf16, 1xf16, xi32)
        linspace_2 = paddle._C_ops.linspace(full_0, full_1, slice_10, paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.slice: (xi32) <- (2xi32, 1xi64, 1xi64)
        slice_12 = paddle._C_ops.slice(slice_9, [0], constant_10, constant_3, [1], [0])

        # pd_op.linspace: (-1xf16) <- (1xf16, 1xf16, xi32)
        linspace_3 = paddle._C_ops.linspace(full_0, full_1, slice_12, paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.concat: (-1x-1x2xf16) <- ([-1x-1x1xf16, -1x-1x1xf16], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_8, constant_12)

        # pd_op.transpose: (-1x-1x-1x2xf16) <- (-1x2x-1x-1xf16)
        transpose_3 = paddle._C_ops.transpose(conv2d_36, [0, 2, 3, 1])

        # pd_op.cast: (1x1x1x2xf16) <- (1x1x1x2xi32)
        cast_7 = paddle._C_ops.cast(reshape__6, paddle.float16)

        # pd_op.memcpy_h2d: (1x1x1x2xf16) <- (1x1x1x2xf16)
        memcpy_h2d_1 = paddle._C_ops.memcpy_h2d(cast_7, 1)

        # pd_op.divide: (-1x-1x-1x2xf16) <- (-1x-1x-1x2xf16, 1x1x1x2xf16)
        divide_1 = transpose_3 / memcpy_h2d_1

        # pd_op.add: (-1x-1x-1x2xf16) <- (-1x-1x2xf16, -1x-1x-1x2xf16)
        add_13 = concat_4 + divide_1

        # pd_op.cast: (-1x-1x-1x2xf32) <- (-1x-1x-1x2xf16)
        cast_8 = paddle._C_ops.cast(add_13, paddle.float32)

        # pd_op.cast: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf16)
        cast_9 = paddle._C_ops.cast(add_11, paddle.float32)

        # pd_op.grid_sample: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x-1x-1x2xf32)
        grid_sample_1 = paddle._C_ops.grid_sample(cast_9, cast_8, 'bilinear', 'zeros', True)

        # pd_op.cast: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf32)
        cast_10 = paddle._C_ops.cast(grid_sample_1, paddle.float16)

        # pd_op.add: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, -1x128x-1x-1xf16)
        add_14 = relu_22 + cast_10
        ...
        # pd_op.add: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, 1x128x1x1xf16)
        add_15 = conv2d_38 + parameter_174
        ...
        # pd_op.shape: (4xi32) <- (-1x128x-1x-1xf16)
        shape_6 = paddle._C_ops.shape(paddle.cast(relu_24, 'float32'))

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_14 = paddle._C_ops.slice(shape_6, [0], constant_3, constant_4, [1], [])
        ...
        # pd_op.cast: (2xi32) <- (2xi32)
        cast_11 = paddle._C_ops.cast(slice_14, paddle.int32)

        # pd_op.bilinear_interp: (-1x64x-1x-1xf16) <- (-1x64x-1x-1xf16, 2xi32, None, None)
        bilinear_interp_6 = paddle._C_ops.bilinear_interp(conv2d_40, cast_11, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)

        # builtin.combine: ([-1x64x-1x-1xf16, -1x64x-1x-1xf16]) <- (-1x64x-1x-1xf16, -1x64x-1x-1xf16)
        combine_9 = [bilinear_interp_6, conv2d_39]

        # pd_op.concat: (-1x128x-1x-1xf16) <- ([-1x64x-1x-1xf16, -1x64x-1x-1xf16], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_9, constant_6)
        ...
        # pd_op.linspace: (-1xf16) <- (1xf16, 1xf16, xi32)
        linspace_4 = paddle._C_ops.linspace(full_0, full_1, slice_15, paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.slice: (xi32) <- (2xi32, 1xi64, 1xi64)
        slice_17 = paddle._C_ops.slice(slice_14, [0], constant_10, constant_3, [1], [0])

        # pd_op.linspace: (-1xf16) <- (1xf16, 1xf16, xi32)
        linspace_5 = paddle._C_ops.linspace(full_0, full_1, slice_17, paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.concat: (-1x-1x2xf16) <- ([-1x-1x1xf16, -1x-1x1xf16], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_12, constant_12)

        # pd_op.transpose: (-1x-1x-1x2xf16) <- (-1x2x-1x-1xf16)
        transpose_5 = paddle._C_ops.transpose(conv2d_41, [0, 2, 3, 1])

        # pd_op.cast: (1x1x1x2xf16) <- (1x1x1x2xi32)
        cast_12 = paddle._C_ops.cast(reshape__12, paddle.float16)

        # pd_op.memcpy_h2d: (1x1x1x2xf16) <- (1x1x1x2xf16)
        memcpy_h2d_2 = paddle._C_ops.memcpy_h2d(cast_12, 1)

        # pd_op.divide: (-1x-1x-1x2xf16) <- (-1x-1x-1x2xf16, 1x1x1x2xf16)
        divide_2 = transpose_5 / memcpy_h2d_2

        # pd_op.add: (-1x-1x-1x2xf16) <- (-1x-1x2xf16, -1x-1x-1x2xf16)
        add_16 = concat_6 + divide_2

        # pd_op.cast: (-1x-1x-1x2xf32) <- (-1x-1x-1x2xf16)
        cast_13 = paddle._C_ops.cast(add_16, paddle.float32)

        # pd_op.cast: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf16)
        cast_14 = paddle._C_ops.cast(add_14, paddle.float32)

        # pd_op.grid_sample: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x-1x-1x2xf32)
        grid_sample_2 = paddle._C_ops.grid_sample(cast_14, cast_13, 'bilinear', 'zeros', True)

        # pd_op.cast: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf32)
        cast_15 = paddle._C_ops.cast(grid_sample_2, paddle.float16)

        # pd_op.add: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, -1x128x-1x-1xf16)
        add_17 = relu_24 + cast_15
        ...
        # pd_op.shape: (4xi32) <- (-1x128x-1x-1xf16)
        shape_7 = paddle._C_ops.shape(paddle.cast(relu_25, 'float32'))

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_19 = paddle._C_ops.slice(shape_7, [0], constant_3, constant_4, [1], [])

        # pd_op.cast: (2xi32) <- (2xi32)
        cast_16 = paddle._C_ops.cast(slice_19, paddle.int32)

        # pd_op.bilinear_interp: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, 2xi32, None, None)
        bilinear_interp_7 = paddle._C_ops.bilinear_interp(relu_23, cast_16, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)

        # pd_op.cast: (2xi32) <- (2xi32)
        cast_17 = paddle._C_ops.cast(slice_19, paddle.int32)

        # pd_op.bilinear_interp: (-1x128x-1x-1xf16) <- (-1x128x-1x-1xf16, 2xi32, None, None)
        bilinear_interp_8 = paddle._C_ops.bilinear_interp(relu_21, cast_17, None, None, 'NCHW', -1, -1, -1, [], 'bilinear', True, 0)
        ...
        # builtin.combine: ([-1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16]) <- (-1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16)
        combine_13 = [relu_25, bilinear_interp_7, bilinear_interp_8, bilinear_interp_9]

        # pd_op.concat: (-1x512x-1x-1xf16) <- ([-1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16, -1x128x-1x-1xf16], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_13, constant_6)

        # pd_op.conv2d: (-1x128x-1x-1xf16) <- (-1x512x-1x-1xf16, 128x512x3x3xf16)
        ...
        add_18 = conv2d_44 + parameter_193

        # pd_op.shape: (4xi32) <- (-1x3x-1x-1xf16)
        shape_8 = paddle._C_ops.shape(paddle.cast(cast_0, 'float32'))
        ...
        argmax_0 = paddle._C_ops.argmax(bilinear_interp_10, constant_13, False, False, paddle.int32)

        # pd_op.scale: (-1x-1x-1xi32) <- (-1x-1x-1xi32, 1xf32)
        scale_0 = paddle._C_ops.scale(argmax_0, constant_14, float('0'), True)
        return scale_0
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, constant_14, constant_13, parameter_193, parameter_174, parameter_160, constant_12, constant_11, constant_10, constant_9, constant_8, constant_7, parameter_146, parameter_140, constant_6, parameter_134, constant_5, parameter_128, parameter_122, constant_4, constant_3, parameter_116, constant_2, constant_1, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_109, parameter_106, parameter_108, parameter_107, parameter_110, parameter_114, parameter_111, parameter_113, parameter_112, parameter_115, parameter_120, parameter_117, parameter_119, parameter_118, parameter_121, parameter_126, parameter_123, parameter_125, parameter_124, parameter_127, parameter_132, parameter_129, parameter_131, parameter_130, parameter_133, parameter_138, parameter_135, parameter_137, parameter_136, parameter_139, parameter_144, parameter_141, parameter_143, parameter_142, parameter_145, parameter_150, parameter_147, parameter_149, parameter_148, parameter_151, parameter_152, parameter_153, parameter_154, parameter_158, parameter_155, parameter_157, parameter_156, parameter_159, parameter_164, parameter_161, parameter_163, parameter_162, parameter_165, parameter_166, parameter_167, parameter_168, parameter_172, parameter_169, parameter_171, parameter_170, parameter_173, parameter_178, parameter_175, parameter_177, parameter_176, parameter_179, parameter_180, parameter_181, parameter_182, parameter_186, parameter_183, parameter_185, parameter_184, parameter_187, parameter_191, parameter_188, parameter_190, parameter_189, parameter_192, feed_0):
        return self.builtin_module_829_0_0(constant_14, constant_13, parameter_193, parameter_174, parameter_160, constant_12, constant_11, constant_10, constant_9, constant_8, constant_7, parameter_146, parameter_140, constant_6, parameter_134, constant_5, parameter_128, parameter_122, constant_4, constant_3, parameter_116, constant_2, constant_1, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_109, parameter_106, parameter_108, parameter_107, parameter_110, parameter_114, parameter_111, parameter_113, parameter_112, parameter_115, parameter_120, parameter_117, parameter_119, parameter_118, parameter_121, parameter_126, parameter_123, parameter_125, parameter_124, parameter_127, parameter_132, parameter_129, parameter_131, parameter_130, parameter_133, parameter_138, parameter_135, parameter_137, parameter_136, parameter_139, parameter_144, parameter_141, parameter_143, parameter_142, parameter_145, parameter_150, parameter_147, parameter_149, parameter_148, parameter_151, parameter_152, parameter_153, parameter_154, parameter_158, parameter_155, parameter_157, parameter_156, parameter_159, parameter_164, parameter_161, parameter_163, parameter_162, parameter_165, parameter_166, parameter_167, parameter_168, parameter_172, parameter_169, parameter_171, parameter_170, parameter_173, parameter_178, parameter_175, parameter_177, parameter_176, parameter_179, parameter_180, parameter_181, parameter_182, parameter_186, parameter_183, parameter_185, parameter_184, parameter_187, parameter_191, parameter_188, parameter_190, parameter_189, parameter_192, feed_0)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_829_0_0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.uniform([128], dtype='float32', min=0, max=0.5),
            # parameter_139
            paddle.uniform([128, 1024, 3, 3], dtype='float16', min=0, max=0.5),
            # parameter_144
            paddle.uniform([128], dtype='float32', min=0, max=0.5),
            # parameter_141
            paddle.uniform([128], dtype='float32', min=0, max=0.5),
            ...
            paddle.uniform([128], dtype='float32', min=0, max=0.5),
            # parameter_187
            paddle.uniform([128, 512, 3, 3], dtype='float16', min=0, max=0.5),
            # parameter_191
            paddle.uniform([128], dtype='float32', min=0, max=0.5),
            # parameter_188
            paddle.uniform([128], dtype='float32', min=0, max=0.5),
