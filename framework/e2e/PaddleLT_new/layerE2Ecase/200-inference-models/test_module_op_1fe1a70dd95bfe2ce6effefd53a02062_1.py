...
def NumOperationsInBlock(block_idx):
    return [320][block_idx] - 1 # number-of-ops-in-block
...
class BlockEntries:
    def builtin_module_680_0_0(self, constant_8, constant_7, constant_6, constant_5, constant_4, constant_3, constant_2, parameter_1, constant_1, constant_0, parameter_0, parameter_2, parameter_3, parameter_5, parameter_4, parameter_6, parameter_7, parameter_8, parameter_9, parameter_11, parameter_10, parameter_12, parameter_13, parameter_14, parameter_15, parameter_17, parameter_16, parameter_18, parameter_19, parameter_20, parameter_21, parameter_23, parameter_22, parameter_24, parameter_25, parameter_26, parameter_27, parameter_29, parameter_28, parameter_30, parameter_31, parameter_32, parameter_33, parameter_35, parameter_34, parameter_36, parameter_37, parameter_38, parameter_39, parameter_41, parameter_40, parameter_42, parameter_43, parameter_44, parameter_45, parameter_47, parameter_46, parameter_48, parameter_49, parameter_50, parameter_51, parameter_53, parameter_52, parameter_54, parameter_55, parameter_56, parameter_57, parameter_59, parameter_58, parameter_60, parameter_61, parameter_62, parameter_63, parameter_65, parameter_64, parameter_66, parameter_67, parameter_68, parameter_69, parameter_71, parameter_70, parameter_72, parameter_73, parameter_74, parameter_75, parameter_77, parameter_76, parameter_78, parameter_79, parameter_80, parameter_81, parameter_83, parameter_82, parameter_84, parameter_85, parameter_86, parameter_87, parameter_89, parameter_88, parameter_90, parameter_91, parameter_92, parameter_93, parameter_95, parameter_94, parameter_96, parameter_97, parameter_98, parameter_99, parameter_101, parameter_100, parameter_102, parameter_103, parameter_104, parameter_105, parameter_107, parameter_106, parameter_108, parameter_109, parameter_110, parameter_111, parameter_113, parameter_112, parameter_114, parameter_115, parameter_116, parameter_117, parameter_119, parameter_118, parameter_120, parameter_121, parameter_122, parameter_123, parameter_125, parameter_124, parameter_126, parameter_127, parameter_128, parameter_129, parameter_131, parameter_130, parameter_132, parameter_133, parameter_134, parameter_135, parameter_137, parameter_136, parameter_138, parameter_139, parameter_140, parameter_141, parameter_143, parameter_142, parameter_144, parameter_145, parameter_146, parameter_147, parameter_149, parameter_148, parameter_150, parameter_151, feed_0):
        ...
        # pd_op.add_: (-1x768x24x24xf16) <- (-1x768x24x24xf16, 1x768x1x1xf16)
        add__0 = paddle._C_ops.add(conv2d_0, parameter_1)

        # pd_op.flatten_: (-1x768x576xf16, None) <- (-1x768x24x24xf16)
        ...
        # pd_op.transpose: (-1x576x768xf16) <- (-1x768x576xf16)
        ...
        # builtin.combine: ([-1x1x768xf16, -1x576x768xf16]) <- (-1x1x768xf16, -1x576x768xf16)
        combine_1 = [cast_2, transpose_0]

        # pd_op.concat: (-1x577x768xf16) <- ([-1x1x768xf16, -1x576x768xf16], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, constant_3)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 1x577x768xf16)
        add__1 = paddle._C_ops.add(concat_0, parameter_3)

        # pd_op.layer_norm: (-1x577x768xf16, -577xf32, -577xf32) <- (-1x577x768xf16, 768xf32, 768xf32)
        ...
        # pd_op.matmul: (-1x577x2304xf16) <- (-1x577x768xf16, 768x2304xf16)
        matmul_0 = paddle.matmul(layer_norm_0, parameter_6, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__2 = paddle._C_ops.add(matmul_0, parameter_7)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__0, reshape__1 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__2, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.transpose: (3x-1x12x577x64xf16) <- (-1x577x3x12x64xf16)
        transpose_1 = paddle._C_ops.transpose(reshape__0, [2, 0, 3, 1, 4])

        # pd_op.slice: (-1x12x577x64xf16) <- (3x-1x12x577x64xf16, 1xi64, 1xi64)
        ...
        # pd_op.transpose: (-1x12x64x577xf16) <- (-1x12x577x64xf16)
        transpose_2 = paddle._C_ops.transpose(slice_2, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x577x577xf16) <- (-1x12x577x64xf16, -1x12x64x577xf16)
        matmul_1 = paddle.matmul(slice_1, transpose_2, transpose_x=False, transpose_y=False)

        # pd_op.scale_: (-1x12x577x577xf16) <- (-1x12x577x577xf16, 1xf32)
        scale__0 = paddle._C_ops.scale(matmul_1, constant_7, float('0'), True)

        # pd_op.softmax_: (-1x12x577x577xf16) <- (-1x12x577x577xf16)
        softmax__0 = paddle._C_ops.softmax(scale__0, -1)

        # pd_op.matmul: (-1x12x577x64xf16) <- (-1x12x577x577xf16, -1x12x577x64xf16)
        matmul_2 = paddle.matmul(softmax__0, slice_3, transpose_x=False, transpose_y=False)

        # pd_op.transpose: (-1x577x12x64xf16) <- (-1x12x577x64xf16)
        transpose_3 = paddle._C_ops.transpose(matmul_2, [0, 2, 1, 3])

        # pd_op.reshape_: (-1x577x768xf16, 0x-1x577x12x64xf16) <- (-1x577x12x64xf16, 3xi64)
        ...
        # pd_op.matmul: (-1x577x768xf16) <- (-1x577x768xf16, 768x768xf16)
        matmul_3 = paddle.matmul(reshape__2, parameter_8, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__3 = paddle._C_ops.add(matmul_3, parameter_9)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, -1x577x768xf16)
        add__4 = paddle._C_ops.add(add__1, add__3)
        ...
        # pd_op.matmul: (-1x577x3072xf16) <- (-1x577x768xf16, 768x3072xf16)
        matmul_4 = paddle.matmul(layer_norm_3, parameter_12, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__5 = paddle._C_ops.add(matmul_4, parameter_13)

        # pd_op.gelu: (-1x577x3072xf16) <- (-1x577x3072xf16)
        gelu_0 = paddle._C_ops.gelu(add__5, False)

        # pd_op.matmul: (-1x577x768xf16) <- (-1x577x3072xf16, 3072x768xf16)
        matmul_5 = paddle.matmul(gelu_0, parameter_14, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__6 = paddle._C_ops.add(matmul_5, parameter_15)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__8 = paddle._C_ops.add(matmul_6, parameter_19)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__4, reshape__5 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__8, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__9 = paddle._C_ops.add(matmul_9, parameter_21)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__11 = paddle._C_ops.add(matmul_10, parameter_25)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__12 = paddle._C_ops.add(matmul_11, parameter_27)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__14 = paddle._C_ops.add(matmul_12, parameter_31)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__8, reshape__9 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__14, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__15 = paddle._C_ops.add(matmul_15, parameter_33)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__17 = paddle._C_ops.add(matmul_16, parameter_37)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__18 = paddle._C_ops.add(matmul_17, parameter_39)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__20 = paddle._C_ops.add(matmul_18, parameter_43)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__12, reshape__13 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__20, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__21 = paddle._C_ops.add(matmul_21, parameter_45)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__23 = paddle._C_ops.add(matmul_22, parameter_49)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__24 = paddle._C_ops.add(matmul_23, parameter_51)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__26 = paddle._C_ops.add(matmul_24, parameter_55)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__16, reshape__17 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__26, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__27 = paddle._C_ops.add(matmul_27, parameter_57)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__29 = paddle._C_ops.add(matmul_28, parameter_61)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__30 = paddle._C_ops.add(matmul_29, parameter_63)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__32 = paddle._C_ops.add(matmul_30, parameter_67)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__20, reshape__21 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__32, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__33 = paddle._C_ops.add(matmul_33, parameter_69)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, -1x577x768xf16)
        add__34 = paddle._C_ops.add(add__31, add__33)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__35 = paddle._C_ops.add(matmul_34, parameter_73)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__36 = paddle._C_ops.add(matmul_35, parameter_75)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__38 = paddle._C_ops.add(matmul_36, parameter_79)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__24, reshape__25 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__38, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__39 = paddle._C_ops.add(matmul_39, parameter_81)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__41 = paddle._C_ops.add(matmul_40, parameter_85)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__42 = paddle._C_ops.add(matmul_41, parameter_87)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, -1x577x768xf16)
        add__43 = paddle._C_ops.add(add__40, add__42)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__44 = paddle._C_ops.add(matmul_42, parameter_91)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__28, reshape__29 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__44, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__45 = paddle._C_ops.add(matmul_45, parameter_93)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__47 = paddle._C_ops.add(matmul_46, parameter_97)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__48 = paddle._C_ops.add(matmul_47, parameter_99)

        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, -1x577x768xf16)
        add__49 = paddle._C_ops.add(add__46, add__48)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__50 = paddle._C_ops.add(matmul_48, parameter_103)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__32, reshape__33 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__50, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__51 = paddle._C_ops.add(matmul_51, parameter_105)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__53 = paddle._C_ops.add(matmul_52, parameter_109)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__54 = paddle._C_ops.add(matmul_53, parameter_111)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__56 = paddle._C_ops.add(matmul_54, parameter_115)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__36, reshape__37 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__56, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__57 = paddle._C_ops.add(matmul_57, parameter_117)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__59 = paddle._C_ops.add(matmul_58, parameter_121)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__60 = paddle._C_ops.add(matmul_59, parameter_123)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__62 = paddle._C_ops.add(matmul_60, parameter_127)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__40, reshape__41 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__62, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__63 = paddle._C_ops.add(matmul_63, parameter_129)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__65 = paddle._C_ops.add(matmul_64, parameter_133)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__66 = paddle._C_ops.add(matmul_65, parameter_135)
        ...
        # pd_op.add_: (-1x577x2304xf16) <- (-1x577x2304xf16, 2304xf16)
        add__68 = paddle._C_ops.add(matmul_66, parameter_139)

        # pd_op.reshape_: (-1x577x3x12x64xf16, 0x-1x577x2304xf16) <- (-1x577x2304xf16, 5xi64)
        reshape__44, reshape__45 = (lambda x, f: f(x))(paddle._C_ops.reshape(add__68, constant_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__69 = paddle._C_ops.add(matmul_69, parameter_141)
        ...
        # pd_op.add_: (-1x577x3072xf16) <- (-1x577x3072xf16, 3072xf16)
        add__71 = paddle._C_ops.add(matmul_70, parameter_145)
        ...
        # pd_op.add_: (-1x577x768xf16) <- (-1x577x768xf16, 768xf16)
        add__72 = paddle._C_ops.add(matmul_71, parameter_147)
        ...
        # pd_op.slice: (-1x768xf16) <- (-1x577x768xf16, 1xi64, 1xi64)
        ...
        add__74 = paddle._C_ops.add(matmul_72, parameter_151)

        # pd_op.softmax_: (-1x1000xf16) <- (-1x1000xf16)
        softmax__12 = paddle._C_ops.softmax(add__74, -1)
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, constant_8, constant_7, constant_6, constant_5, constant_4, constant_3, constant_2, parameter_1, constant_1, constant_0, parameter_0, parameter_2, parameter_3, parameter_5, parameter_4, parameter_6, parameter_7, parameter_8, parameter_9, parameter_11, parameter_10, parameter_12, parameter_13, parameter_14, parameter_15, parameter_17, parameter_16, parameter_18, parameter_19, parameter_20, parameter_21, parameter_23, parameter_22, parameter_24, parameter_25, parameter_26, parameter_27, parameter_29, parameter_28, parameter_30, parameter_31, parameter_32, parameter_33, parameter_35, parameter_34, parameter_36, parameter_37, parameter_38, parameter_39, parameter_41, parameter_40, parameter_42, parameter_43, parameter_44, parameter_45, parameter_47, parameter_46, parameter_48, parameter_49, parameter_50, parameter_51, parameter_53, parameter_52, parameter_54, parameter_55, parameter_56, parameter_57, parameter_59, parameter_58, parameter_60, parameter_61, parameter_62, parameter_63, parameter_65, parameter_64, parameter_66, parameter_67, parameter_68, parameter_69, parameter_71, parameter_70, parameter_72, parameter_73, parameter_74, parameter_75, parameter_77, parameter_76, parameter_78, parameter_79, parameter_80, parameter_81, parameter_83, parameter_82, parameter_84, parameter_85, parameter_86, parameter_87, parameter_89, parameter_88, parameter_90, parameter_91, parameter_92, parameter_93, parameter_95, parameter_94, parameter_96, parameter_97, parameter_98, parameter_99, parameter_101, parameter_100, parameter_102, parameter_103, parameter_104, parameter_105, parameter_107, parameter_106, parameter_108, parameter_109, parameter_110, parameter_111, parameter_113, parameter_112, parameter_114, parameter_115, parameter_116, parameter_117, parameter_119, parameter_118, parameter_120, parameter_121, parameter_122, parameter_123, parameter_125, parameter_124, parameter_126, parameter_127, parameter_128, parameter_129, parameter_131, parameter_130, parameter_132, parameter_133, parameter_134, parameter_135, parameter_137, parameter_136, parameter_138, parameter_139, parameter_140, parameter_141, parameter_143, parameter_142, parameter_144, parameter_145, parameter_146, parameter_147, parameter_149, parameter_148, parameter_150, parameter_151, feed_0):
        return self.builtin_module_680_0_0(constant_8, constant_7, constant_6, constant_5, constant_4, constant_3, constant_2, parameter_1, constant_1, constant_0, parameter_0, parameter_2, parameter_3, parameter_5, parameter_4, parameter_6, parameter_7, parameter_8, parameter_9, parameter_11, parameter_10, parameter_12, parameter_13, parameter_14, parameter_15, parameter_17, parameter_16, parameter_18, parameter_19, parameter_20, parameter_21, parameter_23, parameter_22, parameter_24, parameter_25, parameter_26, parameter_27, parameter_29, parameter_28, parameter_30, parameter_31, parameter_32, parameter_33, parameter_35, parameter_34, parameter_36, parameter_37, parameter_38, parameter_39, parameter_41, parameter_40, parameter_42, parameter_43, parameter_44, parameter_45, parameter_47, parameter_46, parameter_48, parameter_49, parameter_50, parameter_51, parameter_53, parameter_52, parameter_54, parameter_55, parameter_56, parameter_57, parameter_59, parameter_58, parameter_60, parameter_61, parameter_62, parameter_63, parameter_65, parameter_64, parameter_66, parameter_67, parameter_68, parameter_69, parameter_71, parameter_70, parameter_72, parameter_73, parameter_74, parameter_75, parameter_77, parameter_76, parameter_78, parameter_79, parameter_80, parameter_81, parameter_83, parameter_82, parameter_84, parameter_85, parameter_86, parameter_87, parameter_89, parameter_88, parameter_90, parameter_91, parameter_92, parameter_93, parameter_95, parameter_94, parameter_96, parameter_97, parameter_98, parameter_99, parameter_101, parameter_100, parameter_102, parameter_103, parameter_104, parameter_105, parameter_107, parameter_106, parameter_108, parameter_109, parameter_110, parameter_111, parameter_113, parameter_112, parameter_114, parameter_115, parameter_116, parameter_117, parameter_119, parameter_118, parameter_120, parameter_121, parameter_122, parameter_123, parameter_125, parameter_124, parameter_126, parameter_127, parameter_128, parameter_129, parameter_131, parameter_130, parameter_132, parameter_133, parameter_134, parameter_135, parameter_137, parameter_136, parameter_138, parameter_139, parameter_140, parameter_141, parameter_143, parameter_142, parameter_144, parameter_145, parameter_146, parameter_147, parameter_149, parameter_148, parameter_150, parameter_151, feed_0)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_680_0_0(CinnTestBase, unittest.TestCase):
