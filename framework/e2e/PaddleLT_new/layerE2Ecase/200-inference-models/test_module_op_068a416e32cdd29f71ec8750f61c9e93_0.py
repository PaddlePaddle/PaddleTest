...
def NumOperationsInBlock(block_idx):
    return [67, 308][block_idx] - 1 # number-of-ops-in-block
...
class BlockEntries:
    def pd_op_while_1819_0_0(self, constant_0, parameter_0, constant_1, transpose_0, parameter_1, parameter_2, parameter_3, constant_2, parameter_4, constant_3, parameter_5, parameter_6, parameter_7, parameter_8, parameter_9, parameter_10, parameter_11, parameter_12, parameter_13, parameter_14, parameter_15, parameter_16, constant_4, parameter_17, less_than_1, full_1, assign_value_0, assign_value_1, full_with_tensor_0, full_2, full_with_tensor_3, full_with_tensor_2, full_with_tensor_1, full_0, assign_value_2):
        ...
        matmul_2 = paddle.matmul(tanh_0, parameter_4, transpose_x=False, transpose_y=False)

        # pd_op.softmax: (-1x-1x1xf32) <- (-1x-1x1xf32)
        softmax_0 = paddle._C_ops.softmax(matmul_2, 1)

        # pd_op.transpose: (-1x1x-1xf32) <- (-1x-1x1xf32)
        ...
        # pd_op.squeeze_: (-1x96xf32, None) <- (-1x1x96xf32, 1xi64)
        ...
        matmul_4 = paddle.matmul(concat_0, parameter_5, transpose_x=False, transpose_y=True)

        # pd_op.add_: (-1x768xf32) <- (-1x768xf32, 768xf32)
        add__1 = paddle._C_ops.add(matmul_4, parameter_6)
        ...
        # pd_op.add_: (-1x768xf32) <- (-1x768xf32, 768xf32)
        add__2 = paddle._C_ops.add(matmul_5, parameter_8)

        # pd_op.split_with_num: ([-1x256xf32, -1x256xf32, -1x256xf32]) <- (-1x768xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(add__1, 3, constant_3)

        # pd_op.split_with_num: ([-1x256xf32, -1x256xf32, -1x256xf32]) <- (-1x768xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(add__2, 3, constant_3)
        ...
        add__3 = paddle._C_ops.add(slice_1, slice_2)
        ...
        # pd_op.add_: (-1x256xf32) <- (-1x256xf32, -1x256xf32)
        add__4 = paddle._C_ops.add(slice_3, slice_4)
        ...
        # pd_op.add_: (-1x256xf32) <- (-1x256xf32, -1x256xf32)
        add__5 = paddle._C_ops.add(slice_6, multiply__0)

        # pd_op.tanh_: (-1x256xf32) <- (-1x256xf32)
        tanh__0 = paddle._C_ops.tanh(add__5)
        ...
        # pd_op.add_: (-1x256xf32) <- (-1x256xf32, -1x256xf32)
        add__6 = paddle._C_ops.add(multiply__1, tanh__0)

        # pd_op.matmul: (-1x256xf32) <- (-1x256xf32, 256x256xf32)
        matmul_6 = paddle.matmul(add__6, parameter_9, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x256xf32) <- (-1x256xf32, 256xf32)
        add__7 = paddle._C_ops.add(matmul_6, parameter_10)

        # pd_op.matmul: (-1x30xf32) <- (-1x256xf32, 256x30xf32)
        matmul_7 = paddle.matmul(add__7, parameter_11, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x30xf32) <- (-1x30xf32, 30xf32)
        add__8 = paddle._C_ops.add(matmul_7, parameter_12)

        # pd_op.matmul: (-1x256xf32) <- (-1x256xf32, 256x256xf32)
        matmul_8 = paddle.matmul(add__6, parameter_13, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x256xf32) <- (-1x256xf32, 256xf32)
        add__9 = paddle._C_ops.add(matmul_8, parameter_14)

        # pd_op.matmul: (-1x4xf32) <- (-1x256xf32, 256x4xf32)
        matmul_9 = paddle.matmul(add__9, parameter_15, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x4xf32) <- (-1x4xf32, 4xf32)
        add__10 = paddle._C_ops.add(matmul_9, parameter_16)

        # pd_op.sigmoid_: (-1x4xf32) <- (-1x4xf32)
        ...
        # pd_op.cast: (-1x30xf32) <- (-1x30xf32)
        cast_0 = paddle._C_ops.cast(add__8, paddle.float32)
        ...
        # pd_op.set_value_with_tensor: (-1x501x30xf32) <- (-1x501x30xf32, -1x30xf32, [xi64], [xi64], 1xi64)
        set_value_with_tensor_0 = paddle._C_ops.set_value_with_tensor(full_with_tensor_2, cast_0, combine_3, combine_4, constant_2, [1], [1], [])

        # pd_op.cast: (-1x4xf32) <- (-1x4xf32)
        cast_1 = paddle._C_ops.cast(sigmoid__2, paddle.float32)

        # pd_op.set_value_with_tensor: (-1x501x4xf32) <- (-1x501x4xf32, -1x4xf32, [xi64], [xi64], 1xi64)
        set_value_with_tensor_1 = paddle._C_ops.set_value_with_tensor(full_with_tensor_3, cast_1, combine_3, combine_4, constant_2, [1], [1], [])

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_0 = scale_0 < parameter_17
        ...
        assign_out__2 = paddle._C_ops.assign_out_(add__8, assign_value_0)

        # pd_op.assign_out_: (xi64) <- (xi64, xi64)
        assign_out__3 = paddle._C_ops.assign_out_(scale_0, full_0)
        ...
        assign_out__5 = paddle._C_ops.assign_out_(sigmoid__2, assign_value_1)

        # pd_op.assign_out_: (xi64) <- (xi64, xi64)
        assign_out__6 = paddle._C_ops.assign_out_(slice_0, assign_value_2)

        # pd_op.assign_out_: (-1x501x4xf32) <- (-1x501x4xf32, -1x501x4xf32)
    ...
    def builtin_module_1106_0_0(self, constant_10, constant_9, parameter_377, parameter_378, constant_8, parameter_376, parameter_375, parameter_374, parameter_373, constant_7, constant_6, constant_5, constant_4, constant_3, constant_2, constant_1, parameter_137, parameter_135, parameter_123, parameter_121, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_109, parameter_106, parameter_108, parameter_107, parameter_110, parameter_114, parameter_111, parameter_113, parameter_112, parameter_115, parameter_119, parameter_116, parameter_118, parameter_117, parameter_120, parameter_122, parameter_124, parameter_128, parameter_125, parameter_127, parameter_126, parameter_129, parameter_133, parameter_130, parameter_132, parameter_131, parameter_134, parameter_136, parameter_138, parameter_142, parameter_139, parameter_141, parameter_140, parameter_143, parameter_147, parameter_144, parameter_146, parameter_145, parameter_148, parameter_152, parameter_149, parameter_151, parameter_150, parameter_153, parameter_157, parameter_154, parameter_156, parameter_155, parameter_158, parameter_162, parameter_159, parameter_161, parameter_160, parameter_163, parameter_167, parameter_164, parameter_166, parameter_165, parameter_168, parameter_172, parameter_169, parameter_171, parameter_170, parameter_173, parameter_177, parameter_174, parameter_176, parameter_175, parameter_178, parameter_182, parameter_179, parameter_181, parameter_180, parameter_183, parameter_187, parameter_184, parameter_186, parameter_185, parameter_188, parameter_192, parameter_189, parameter_191, parameter_190, parameter_193, parameter_197, parameter_194, parameter_196, parameter_195, parameter_198, parameter_202, parameter_199, parameter_201, parameter_200, parameter_203, parameter_207, parameter_204, parameter_206, parameter_205, parameter_208, parameter_212, parameter_209, parameter_211, parameter_210, parameter_213, parameter_217, parameter_214, parameter_216, parameter_215, parameter_218, parameter_222, parameter_219, parameter_221, parameter_220, parameter_223, parameter_227, parameter_224, parameter_226, parameter_225, parameter_228, parameter_232, parameter_229, parameter_231, parameter_230, parameter_233, parameter_237, parameter_234, parameter_236, parameter_235, parameter_238, parameter_242, parameter_239, parameter_241, parameter_240, parameter_243, parameter_247, parameter_244, parameter_246, parameter_245, parameter_248, parameter_252, parameter_249, parameter_251, parameter_250, parameter_253, parameter_257, parameter_254, parameter_256, parameter_255, parameter_258, parameter_262, parameter_259, parameter_261, parameter_260, parameter_263, parameter_267, parameter_264, parameter_266, parameter_265, parameter_268, parameter_272, parameter_269, parameter_271, parameter_270, parameter_273, parameter_277, parameter_274, parameter_276, parameter_275, parameter_278, parameter_282, parameter_279, parameter_281, parameter_280, parameter_283, parameter_287, parameter_284, parameter_286, parameter_285, parameter_288, parameter_292, parameter_289, parameter_291, parameter_290, parameter_293, parameter_297, parameter_294, parameter_296, parameter_295, parameter_298, parameter_302, parameter_299, parameter_301, parameter_300, parameter_303, parameter_307, parameter_304, parameter_306, parameter_305, parameter_308, parameter_312, parameter_309, parameter_311, parameter_310, parameter_313, parameter_317, parameter_314, parameter_316, parameter_315, parameter_318, parameter_322, parameter_319, parameter_321, parameter_320, parameter_323, parameter_327, parameter_324, parameter_326, parameter_325, parameter_328, parameter_332, parameter_329, parameter_331, parameter_330, parameter_333, parameter_337, parameter_334, parameter_336, parameter_335, parameter_338, parameter_342, parameter_339, parameter_341, parameter_340, parameter_343, parameter_347, parameter_344, parameter_346, parameter_345, parameter_348, parameter_352, parameter_349, parameter_351, parameter_350, parameter_353, parameter_357, parameter_354, parameter_356, parameter_355, parameter_358, parameter_362, parameter_359, parameter_361, parameter_360, parameter_363, parameter_367, parameter_364, parameter_366, parameter_365, parameter_368, parameter_372, parameter_369, parameter_371, parameter_370, parameter_394, parameter_387, parameter_393, parameter_379, parameter_384, parameter_386, parameter_388, parameter_381, parameter_382, parameter_385, parameter_392, parameter_383, parameter_380, parameter_390, parameter_391, parameter_389, feed_0):
        ...
        pool2d_0 = paddle._C_ops.pool2d(hardswish_23, constant_0, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')
        ...
        add__0 = paddle._C_ops.add(conv2d_12, parameter_121)
        ...
        add__1 = paddle._C_ops.add(conv2d_13, parameter_123)
        ...
        pool2d_1 = paddle._C_ops.pool2d(hardswish_25, constant_0, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')
        ...
        add__2 = paddle._C_ops.add(conv2d_15, parameter_135)
        ...
        add__3 = paddle._C_ops.add(conv2d_16, parameter_137)
        ...
        # pd_op.conv2d: (-1x96x-1x-1xf32) <- (-1x64x-1x-1xf32, 96x64x1x1xf32)
        ...
        # pd_op.conv2d: (-1x96x-1x-1xf32) <- (-1x128x-1x-1xf32, 96x128x1x1xf32)
        ...
        # pd_op.shape: (4xi32) <- (-1x96x-1x-1xf32)
        shape_0 = paddle._C_ops.shape(hardswish_29)

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(shape_0, [0], constant_1, constant_2, [1], [])

        # pd_op.cast_: (2xi32) <- (2xi32)
        cast__0 = paddle._C_ops.cast(slice_0, paddle.int32)

        # pd_op.nearest_interp: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, 2xi32, None, None)
        ...
        # pd_op.shape: (4xi32) <- (-1x96x-1x-1xf32)
        shape_1 = paddle._C_ops.shape(hardswish_28)

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(shape_1, [0], constant_1, constant_2, [1], [])
        ...
        # pd_op.shape: (4xi32) <- (-1x96x-1x-1xf32)
        shape_2 = paddle._C_ops.shape(hardswish_27)

        # pd_op.slice: (2xi32) <- (4xi32, 1xi64, 1xi64)
        slice_2 = paddle._C_ops.slice(shape_2, [0], constant_1, constant_2, [1], [])
        ...
        # pd_op.concat: (-1x192x-1x-1xf32) <- ([-1x96x-1x-1xf32, -1x96x-1x-1xf32], 1xi32)
        concat_10 = paddle._C_ops.concat(combine_10, constant_3)
        ...
        # pd_op.concat: (-1x96x-1x-1xf32) <- ([-1x48x-1x-1xf32, -1x48x-1x-1xf32], 1xi32)
        concat_11 = paddle._C_ops.concat(combine_11, constant_3)
        ...
        # pd_op.shape: (4xi32) <- (-1x96x-1x-1xf32)
        shape_3 = paddle._C_ops.shape(hardswish_72)

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_3 = paddle._C_ops.slice(shape_3, [0], constant_4, constant_5, [1], [0])

        # pd_op.shape: (4xi32) <- (-1x96x-1x-1xf32)
        shape_4 = paddle._C_ops.shape(hardswish_72)

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(shape_4, [0], constant_4, constant_5, [1], [0])

        # builtin.combine: ([xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32)
        combine_12 = [slice_4, constant_6, constant_7]

        # pd_op.reshape_: (-1x96x-1xf32, 0x-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, [xi32, 1xi32, 1xi32])
        reshape__0, reshape__1 = (lambda x, f: f(x))(paddle._C_ops.reshape(hardswish_72, combine_12), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        combine_15 = [slice_3, parameter_374, parameter_375]

        # pd_op.memcpy_h2d: (xi32) <- (xi32)
        memcpy_h2d_1 = paddle._C_ops.memcpy_h2d(slice_3, 1)

        # builtin.combine: ([xi32, xi32, xi32]) <- (xi32, xi32, xi32)
        combine_16 = [memcpy_h2d_1, parameter_374, parameter_375]

        # pd_op.stack: (3xi32) <- ([xi32, xi32, xi32])
        stack_1 = paddle._C_ops.stack(combine_16, 0)

        # pd_op.full_with_tensor: (-1x501x30xf32) <- (1xf32, 3xi32)
        full_with_tensor_1 = paddle._C_ops.full_with_tensor(full_0, stack_1, paddle.float32)

        # builtin.combine: ([xi32, xi32, xi32]) <- (xi32, xi32, xi32)
        combine_17 = [slice_3, parameter_374, parameter_376]

        # pd_op.memcpy_h2d: (xi32) <- (xi32)
        memcpy_h2d_2 = paddle._C_ops.memcpy_h2d(slice_3, 1)

        # builtin.combine: ([xi32, xi32, xi32]) <- (xi32, xi32, xi32)
        combine_18 = [memcpy_h2d_2, parameter_374, parameter_376]

        # pd_op.stack: (3xi32) <- ([xi32, xi32, xi32])
        stack_2 = paddle._C_ops.stack(combine_18, 0)

        # pd_op.full_with_tensor: (-1x501x4xf32) <- (1xf32, 3xi32)
        full_with_tensor_2 = paddle._C_ops.full_with_tensor(full_0, stack_2, paddle.float32)

        # builtin.combine: ([xi32]) <- (xi32)
        combine_19 = [slice_3]

        # pd_op.stack: (1xi32) <- ([xi32])
        stack_3 = paddle._C_ops.stack(combine_19, 0)

        # pd_op.full_with_tensor: (-1xi32) <- (1xf32, 1xi32)
        full_with_tensor_3 = paddle._C_ops.full_with_tensor(full_0, stack_3, paddle.int32)
        ...
        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_0 = full_1 < parameter_377

        # pd_op.full: (-1x501x30xf32) <- ()
        full_2 = paddle._C_ops.full([], float('0'), paddle.float32, paddle.framework._current_expected_place())

        # pd_op.full: (-1x501x4xf32) <- ()
        ...
        # pd_op.while: (-1x501x4xf32, -1x30xf32, -1x4xf32, -1xi32, -1x501x30xf32, -1x501x4xf32, -1x501x30xf32, -1x256xf32, xi64, xi64) <- (xb, -1x501x4xf32, -1x30xf32, -1x4xf32, -1xi32, -1x501x30xf32, -1x501x4xf32, -1x501x30xf32, -1x256xf32, xi64, xi64)
        import os
        ...
        while_loop_counter_1819 = 0
        while less_than_0:
            less_than_0, full_3, assign_value_0, assign_value_1, full_with_tensor_3, full_2, full_with_tensor_2, full_with_tensor_1, full_with_tensor_0, full_1, assign_value_2, = self.pd_op_while_1819_0_0(constant_8, parameter_378, constant_9, transpose_0, parameter_379, parameter_380, parameter_381, constant_5, parameter_382, constant_3, parameter_383, parameter_384, parameter_385, parameter_386, parameter_387, parameter_388, parameter_389, parameter_390, parameter_391, parameter_392, parameter_393, parameter_394, constant_10, parameter_377, less_than_0, full_3, assign_value_0, assign_value_1, full_with_tensor_3, full_2, full_with_tensor_2, full_with_tensor_1, full_with_tensor_0, full_1, assign_value_2)
            while_loop_counter_1819 += 1
            if while_loop_counter_1819 > kWhileLoopLimit:
                break
            
        while_0, while_1, while_2, while_3, while_4, while_5, while_6, while_7, while_8, while_9, = full_3, assign_value_0, assign_value_1, full_with_tensor_3, full_2, full_with_tensor_2, full_with_tensor_1, full_with_tensor_0, full_1, assign_value_2,

        # pd_op.softmax_: (-1x501x30xf32) <- (-1x501x30xf32)
        softmax__0 = paddle._C_ops.softmax(while_4, -1)

        # pd_op.scale_: (-1x501x4xf32) <- (-1x501x4xf32, 1xf32)
        scale__0 = paddle._C_ops.scale(while_0, constant_8, float('0'), True)

        # pd_op.scale_: (-1x501x30xf32) <- (-1x501x30xf32, 1xf32)
        scale__1 = paddle._C_ops.scale(softmax__0, constant_8, float('0'), True)
        return scale__0, scale__1
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, constant_10, constant_9, parameter_377, parameter_378, constant_8, parameter_376, parameter_375, parameter_374, parameter_373, constant_7, constant_6, constant_5, constant_4, constant_3, constant_2, constant_1, parameter_137, parameter_135, parameter_123, parameter_121, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_109, parameter_106, parameter_108, parameter_107, parameter_110, parameter_114, parameter_111, parameter_113, parameter_112, parameter_115, parameter_119, parameter_116, parameter_118, parameter_117, parameter_120, parameter_122, parameter_124, parameter_128, parameter_125, parameter_127, parameter_126, parameter_129, parameter_133, parameter_130, parameter_132, parameter_131, parameter_134, parameter_136, parameter_138, parameter_142, parameter_139, parameter_141, parameter_140, parameter_143, parameter_147, parameter_144, parameter_146, parameter_145, parameter_148, parameter_152, parameter_149, parameter_151, parameter_150, parameter_153, parameter_157, parameter_154, parameter_156, parameter_155, parameter_158, parameter_162, parameter_159, parameter_161, parameter_160, parameter_163, parameter_167, parameter_164, parameter_166, parameter_165, parameter_168, parameter_172, parameter_169, parameter_171, parameter_170, parameter_173, parameter_177, parameter_174, parameter_176, parameter_175, parameter_178, parameter_182, parameter_179, parameter_181, parameter_180, parameter_183, parameter_187, parameter_184, parameter_186, parameter_185, parameter_188, parameter_192, parameter_189, parameter_191, parameter_190, parameter_193, parameter_197, parameter_194, parameter_196, parameter_195, parameter_198, parameter_202, parameter_199, parameter_201, parameter_200, parameter_203, parameter_207, parameter_204, parameter_206, parameter_205, parameter_208, parameter_212, parameter_209, parameter_211, parameter_210, parameter_213, parameter_217, parameter_214, parameter_216, parameter_215, parameter_218, parameter_222, parameter_219, parameter_221, parameter_220, parameter_223, parameter_227, parameter_224, parameter_226, parameter_225, parameter_228, parameter_232, parameter_229, parameter_231, parameter_230, parameter_233, parameter_237, parameter_234, parameter_236, parameter_235, parameter_238, parameter_242, parameter_239, parameter_241, parameter_240, parameter_243, parameter_247, parameter_244, parameter_246, parameter_245, parameter_248, parameter_252, parameter_249, parameter_251, parameter_250, parameter_253, parameter_257, parameter_254, parameter_256, parameter_255, parameter_258, parameter_262, parameter_259, parameter_261, parameter_260, parameter_263, parameter_267, parameter_264, parameter_266, parameter_265, parameter_268, parameter_272, parameter_269, parameter_271, parameter_270, parameter_273, parameter_277, parameter_274, parameter_276, parameter_275, parameter_278, parameter_282, parameter_279, parameter_281, parameter_280, parameter_283, parameter_287, parameter_284, parameter_286, parameter_285, parameter_288, parameter_292, parameter_289, parameter_291, parameter_290, parameter_293, parameter_297, parameter_294, parameter_296, parameter_295, parameter_298, parameter_302, parameter_299, parameter_301, parameter_300, parameter_303, parameter_307, parameter_304, parameter_306, parameter_305, parameter_308, parameter_312, parameter_309, parameter_311, parameter_310, parameter_313, parameter_317, parameter_314, parameter_316, parameter_315, parameter_318, parameter_322, parameter_319, parameter_321, parameter_320, parameter_323, parameter_327, parameter_324, parameter_326, parameter_325, parameter_328, parameter_332, parameter_329, parameter_331, parameter_330, parameter_333, parameter_337, parameter_334, parameter_336, parameter_335, parameter_338, parameter_342, parameter_339, parameter_341, parameter_340, parameter_343, parameter_347, parameter_344, parameter_346, parameter_345, parameter_348, parameter_352, parameter_349, parameter_351, parameter_350, parameter_353, parameter_357, parameter_354, parameter_356, parameter_355, parameter_358, parameter_362, parameter_359, parameter_361, parameter_360, parameter_363, parameter_367, parameter_364, parameter_366, parameter_365, parameter_368, parameter_372, parameter_369, parameter_371, parameter_370, parameter_394, parameter_387, parameter_393, parameter_379, parameter_384, parameter_386, parameter_388, parameter_381, parameter_382, parameter_385, parameter_392, parameter_383, parameter_380, parameter_390, parameter_391, parameter_389, feed_0):
        return self.builtin_module_1106_0_0(constant_10, constant_9, parameter_377, parameter_378, constant_8, parameter_376, parameter_375, parameter_374, parameter_373, constant_7, constant_6, constant_5, constant_4, constant_3, constant_2, constant_1, parameter_137, parameter_135, parameter_123, parameter_121, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_109, parameter_106, parameter_108, parameter_107, parameter_110, parameter_114, parameter_111, parameter_113, parameter_112, parameter_115, parameter_119, parameter_116, parameter_118, parameter_117, parameter_120, parameter_122, parameter_124, parameter_128, parameter_125, parameter_127, parameter_126, parameter_129, parameter_133, parameter_130, parameter_132, parameter_131, parameter_134, parameter_136, parameter_138, parameter_142, parameter_139, parameter_141, parameter_140, parameter_143, parameter_147, parameter_144, parameter_146, parameter_145, parameter_148, parameter_152, parameter_149, parameter_151, parameter_150, parameter_153, parameter_157, parameter_154, parameter_156, parameter_155, parameter_158, parameter_162, parameter_159, parameter_161, parameter_160, parameter_163, parameter_167, parameter_164, parameter_166, parameter_165, parameter_168, parameter_172, parameter_169, parameter_171, parameter_170, parameter_173, parameter_177, parameter_174, parameter_176, parameter_175, parameter_178, parameter_182, parameter_179, parameter_181, parameter_180, parameter_183, parameter_187, parameter_184, parameter_186, parameter_185, parameter_188, parameter_192, parameter_189, parameter_191, parameter_190, parameter_193, parameter_197, parameter_194, parameter_196, parameter_195, parameter_198, parameter_202, parameter_199, parameter_201, parameter_200, parameter_203, parameter_207, parameter_204, parameter_206, parameter_205, parameter_208, parameter_212, parameter_209, parameter_211, parameter_210, parameter_213, parameter_217, parameter_214, parameter_216, parameter_215, parameter_218, parameter_222, parameter_219, parameter_221, parameter_220, parameter_223, parameter_227, parameter_224, parameter_226, parameter_225, parameter_228, parameter_232, parameter_229, parameter_231, parameter_230, parameter_233, parameter_237, parameter_234, parameter_236, parameter_235, parameter_238, parameter_242, parameter_239, parameter_241, parameter_240, parameter_243, parameter_247, parameter_244, parameter_246, parameter_245, parameter_248, parameter_252, parameter_249, parameter_251, parameter_250, parameter_253, parameter_257, parameter_254, parameter_256, parameter_255, parameter_258, parameter_262, parameter_259, parameter_261, parameter_260, parameter_263, parameter_267, parameter_264, parameter_266, parameter_265, parameter_268, parameter_272, parameter_269, parameter_271, parameter_270, parameter_273, parameter_277, parameter_274, parameter_276, parameter_275, parameter_278, parameter_282, parameter_279, parameter_281, parameter_280, parameter_283, parameter_287, parameter_284, parameter_286, parameter_285, parameter_288, parameter_292, parameter_289, parameter_291, parameter_290, parameter_293, parameter_297, parameter_294, parameter_296, parameter_295, parameter_298, parameter_302, parameter_299, parameter_301, parameter_300, parameter_303, parameter_307, parameter_304, parameter_306, parameter_305, parameter_308, parameter_312, parameter_309, parameter_311, parameter_310, parameter_313, parameter_317, parameter_314, parameter_316, parameter_315, parameter_318, parameter_322, parameter_319, parameter_321, parameter_320, parameter_323, parameter_327, parameter_324, parameter_326, parameter_325, parameter_328, parameter_332, parameter_329, parameter_331, parameter_330, parameter_333, parameter_337, parameter_334, parameter_336, parameter_335, parameter_338, parameter_342, parameter_339, parameter_341, parameter_340, parameter_343, parameter_347, parameter_344, parameter_346, parameter_345, parameter_348, parameter_352, parameter_349, parameter_351, parameter_350, parameter_353, parameter_357, parameter_354, parameter_356, parameter_355, parameter_358, parameter_362, parameter_359, parameter_361, parameter_360, parameter_363, parameter_367, parameter_364, parameter_366, parameter_365, parameter_368, parameter_372, parameter_369, parameter_371, parameter_370, parameter_394, parameter_387, parameter_393, parameter_379, parameter_384, parameter_386, parameter_388, parameter_381, parameter_382, parameter_385, parameter_392, parameter_383, parameter_380, parameter_390, parameter_391, parameter_389, feed_0)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_1106_0_0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.uniform([96], dtype='float32', min=0, max=0.5),
            # parameter_148
            paddle.uniform([96, 128, 1, 1], dtype='float32', min=0, max=0.5),
            # parameter_152
            paddle.uniform([96], dtype='float32', min=0, max=0.5),
            # parameter_149
            paddle.uniform([96], dtype='float32', min=0, max=0.5),
            ...
            paddle.uniform([96], dtype='float32', min=0, max=0.5),
            # parameter_158
            paddle.uniform([96, 512, 1, 1], dtype='float32', min=0, max=0.5),
            # parameter_162
            paddle.uniform([96], dtype='float32', min=0, max=0.5),
            # parameter_159
            paddle.uniform([96], dtype='float32', min=0, max=0.5),
