...
def NumOperationsInBlock(block_idx):
    return [73][block_idx] - 1 # number-of-ops-in-block
...
class BlockEntries:
    def builtin_module_203_0_0(self, constant_1, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_106, feed_0):
        ...
        conv2d_6 = paddle._C_ops.conv2d(relu__4, parameter_30, [2, 2], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        conv2d_8 = paddle._C_ops.conv2d(relu__4, parameter_40, [2, 2], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128x128x3x3xf32)
        conv2d_9 = paddle._C_ops.conv2d(relu__6, parameter_45, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.relu_: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu__7 = paddle._C_ops.relu(batch_norm__54)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128x128x3x3xf32)
        conv2d_10 = paddle._C_ops.conv2d(relu__7, parameter_50, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.add_: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add__3 = paddle._C_ops.add(batch_norm__60, relu__6)

        # pd_op.relu_: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu__8 = paddle._C_ops.relu(add__3)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x128x28x28xf32, 256x128x3x3xf32)
        conv2d_11 = paddle._C_ops.conv2d(relu__8, parameter_55, [2, 2], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        conv2d_13 = paddle._C_ops.conv2d(relu__8, parameter_65, [2, 2], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        add__4 = paddle._C_ops.add(batch_norm__72, batch_norm__78)

        # pd_op.relu_: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu__10 = paddle._C_ops.relu(add__4)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(relu__10, parameter_70, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_15 = paddle._C_ops.conv2d(relu__11, parameter_75, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.add_: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add__5 = paddle._C_ops.add(batch_norm__90, relu__10)

        # pd_op.relu_: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu__12 = paddle._C_ops.relu(add__5)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x256x14x14xf32, 512x256x3x3xf32)
        conv2d_16 = paddle._C_ops.conv2d(relu__12, parameter_80, [2, 2], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        relu__13 = paddle._C_ops.relu(batch_norm__96)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_17 = paddle._C_ops.conv2d(relu__13, parameter_85, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        conv2d_18 = paddle._C_ops.conv2d(relu__12, parameter_90, [2, 2], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        add__6 = paddle._C_ops.add(batch_norm__102, batch_norm__108)

        # pd_op.relu_: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu__14 = paddle._C_ops.relu(add__6)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_19 = paddle._C_ops.conv2d(relu__14, parameter_95, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.relu_: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu__15 = paddle._C_ops.relu(batch_norm__114)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_20 = paddle._C_ops.conv2d(relu__15, parameter_100, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.add_: (-1x512x7x7xf32) <- (-1x512x7x7xf32, -1x512x7x7xf32)
        add__7 = paddle._C_ops.add(batch_norm__120, relu__14)

        # pd_op.relu_: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu__16 = paddle._C_ops.relu(add__7)

        # pd_op.pool2d: (-1x512x1x1xf32) <- (-1x512x7x7xf32, 2xi64)
        pool2d_1 = paddle._C_ops.pool2d(relu__16, constant_1, [1, 1], [0, 0], False, True, 'NCHW', 'avg', False, True, 'EXPLICIT')
        ...
        matmul_0 = paddle.matmul(flatten__0, parameter_105, transpose_x=False, transpose_y=False)

        # pd_op.add_: (-1x1000xf32) <- (-1x1000xf32, 1000xf32)
        add__8 = paddle._C_ops.add(matmul_0, parameter_106)

        # pd_op.softmax_: (-1x1000xf32) <- (-1x1000xf32)
        softmax__0 = paddle._C_ops.softmax(add__8, -1)
        return softmax__0
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, constant_1, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_106, feed_0):
        return self.builtin_module_203_0_0(constant_1, constant_0, parameter_0, parameter_4, parameter_1, parameter_3, parameter_2, parameter_5, parameter_9, parameter_6, parameter_8, parameter_7, parameter_10, parameter_14, parameter_11, parameter_13, parameter_12, parameter_15, parameter_19, parameter_16, parameter_18, parameter_17, parameter_20, parameter_24, parameter_21, parameter_23, parameter_22, parameter_25, parameter_29, parameter_26, parameter_28, parameter_27, parameter_30, parameter_34, parameter_31, parameter_33, parameter_32, parameter_35, parameter_39, parameter_36, parameter_38, parameter_37, parameter_40, parameter_44, parameter_41, parameter_43, parameter_42, parameter_45, parameter_49, parameter_46, parameter_48, parameter_47, parameter_50, parameter_54, parameter_51, parameter_53, parameter_52, parameter_55, parameter_59, parameter_56, parameter_58, parameter_57, parameter_60, parameter_64, parameter_61, parameter_63, parameter_62, parameter_65, parameter_69, parameter_66, parameter_68, parameter_67, parameter_70, parameter_74, parameter_71, parameter_73, parameter_72, parameter_75, parameter_79, parameter_76, parameter_78, parameter_77, parameter_80, parameter_84, parameter_81, parameter_83, parameter_82, parameter_85, parameter_89, parameter_86, parameter_88, parameter_87, parameter_90, parameter_94, parameter_91, parameter_93, parameter_92, parameter_95, parameter_99, parameter_96, parameter_98, parameter_97, parameter_100, parameter_104, parameter_101, parameter_103, parameter_102, parameter_105, parameter_106, feed_0)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_203_0_0(CinnTestBase, unittest.TestCase):
