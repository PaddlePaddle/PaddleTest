...
class BlockEntries:
    def builtin_module_153_0_0(self, parameter_0, parameter_1, parameter_5, parameter_2, parameter_4, parameter_3, parameter_6, parameter_10, parameter_7, parameter_9, parameter_8, parameter_11, parameter_15, parameter_12, parameter_14, parameter_13, parameter_16, parameter_20, parameter_17, parameter_19, parameter_18, parameter_21, parameter_25, parameter_22, parameter_24, parameter_23, parameter_26, parameter_30, parameter_27, parameter_29, parameter_28, parameter_31, parameter_32, parameter_36, parameter_33, parameter_35, parameter_34, parameter_37, parameter_41, parameter_38, parameter_40, parameter_39, parameter_42, parameter_46, parameter_43, parameter_45, parameter_44, parameter_47, parameter_51, parameter_48, parameter_50, parameter_49, parameter_52, parameter_56, parameter_53, parameter_55, parameter_54, parameter_57, parameter_61, parameter_58, parameter_60, parameter_59, parameter_62, parameter_66, parameter_63, parameter_65, parameter_64, parameter_67, parameter_68, feed_0):
        ...
        conv2d_transpose_0 = paddle._C_ops.conv2d_transpose(relu_0, parameter_32, [2, 2], [1, 1], [], full_int_array_0, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        conv2d_transpose_1 = paddle._C_ops.conv2d_transpose(relu_1, parameter_37, [2, 2], [1, 1], [], full_int_array_1, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        # pd_op.conv2d_transpose: (-1x512x-1x-1xf32) <- (-1x1024x-1x-1xf32, 1024x512x4x4xf32, 0xi64)
        conv2d_transpose_2 = paddle._C_ops.conv2d_transpose(relu_2, parameter_42, [2, 2], [1, 1], [], full_int_array_2, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        # pd_op.conv2d_transpose: (-1x512x-1x-1xf32) <- (-1x1024x-1x-1xf32, 1024x512x4x4xf32, 0xi64)
        conv2d_transpose_3 = paddle._C_ops.conv2d_transpose(relu_3, parameter_47, [2, 2], [1, 1], [], full_int_array_3, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        conv2d_transpose_4 = paddle._C_ops.conv2d_transpose(relu_4, parameter_52, [2, 2], [1, 1], [], full_int_array_4, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        conv2d_transpose_5 = paddle._C_ops.conv2d_transpose(relu_5, parameter_57, [2, 2], [1, 1], [], full_int_array_5, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        conv2d_transpose_6 = paddle._C_ops.conv2d_transpose(relu_6, parameter_62, [2, 2], [1, 1], [], full_int_array_6, 'EXPLICIT', 1, [1, 1], 'NCHW')
        ...
        conv2d_transpose_7 = paddle._C_ops.conv2d_transpose(relu_7, parameter_67, [2, 2], [1, 1], [], full_int_array_7, 'EXPLICIT', 1, [1, 1], 'NCHW')
