...
def NumOperationsInBlock(block_idx):
    return [115][block_idx] - 1 # number-of-ops-in-block
...
class BlockEntries:
    def builtin_module_151_0_0(self, parameter_0, parameter_1, parameter_2, parameter_3, parameter_4, parameter_5, parameter_6, parameter_7, parameter_8, parameter_9, parameter_10, parameter_11, parameter_12, parameter_13, parameter_14, parameter_15, parameter_16, parameter_17, parameter_18, parameter_19, parameter_20, parameter_21, parameter_22, parameter_23, parameter_24, feed_0):
        ...
        unsqueeze__0, unsqueeze__1 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze_(cast_0, full_int_array_1), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x256x1x100xf16) <- (-1x400x1x100xf16, 256x100x1x3xf16)
        conv2d_0 = paddle._C_ops.conv2d(unsqueeze__0, unsqueeze_0, [1, 1], [0, 1], 'EXPLICIT', [1, 1], 4, 'NCHW')

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_2 = [1, 256, 1, 1]

        # pd_op.reshape: (1x256x1x1xf16, 0x256xi64) <- (256xf16, 4xi64)
        ...
        # pd_op.unsqueeze: (256x64x1x3xf16, None) <- (256x64x3xf16, 1xi64)
        unsqueeze_2, unsqueeze_3 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_2, full_int_array_4), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_5 = [-2]

        # pd_op.unsqueeze_: (-1x256x1x100xf16, None) <- (-1x256x100xf16, 1xi64)
        unsqueeze__2, unsqueeze__3 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze_(relu__0, full_int_array_5), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x256x1x100xf16) <- (-1x256x1x100xf16, 256x64x1x3xf16)
        conv2d_1 = paddle._C_ops.conv2d(unsqueeze__2, unsqueeze_2, [1, 1], [0, 1], 'EXPLICIT', [1, 1], 4, 'NCHW')
        ...
        # pd_op.unsqueeze: (256x64x1x3xf16, None) <- (256x64x3xf16, 1xi64)
        unsqueeze_4, unsqueeze_5 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_4, full_int_array_8), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_9 = [-2]

        # pd_op.unsqueeze: (-1x256x1x100xf16, None) <- (-1x256x100xf16, 1xi64)
        unsqueeze_6, unsqueeze_7 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu__1, full_int_array_9), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x256x1x100xf16) <- (-1x256x1x100xf16, 256x64x1x3xf16)
        conv2d_2 = paddle._C_ops.conv2d(unsqueeze_6, unsqueeze_4, [1, 1], [0, 1], 'EXPLICIT', [1, 1], 4, 'NCHW')
        ...
        # pd_op.unsqueeze: (1x256x1x1xf16, None) <- (1x256x1xf16, 1xi64)
        unsqueeze_8, unsqueeze_9 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_6, full_int_array_12), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_13 = [-2]

        # pd_op.unsqueeze_: (-1x256x1x100xf16, None) <- (-1x256x100xf16, 1xi64)
        unsqueeze__4, unsqueeze__5 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze_(relu__2, full_int_array_13), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x1x1x100xf16) <- (-1x256x1x100xf16, 1x256x1x1xf16)
        conv2d_3 = paddle._C_ops.conv2d(unsqueeze__4, unsqueeze_8, [1, 1], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_14 = [1, 1, 1, 1]

        # pd_op.reshape: (1x1x1x1xf16, 0x1xi64) <- (1xf16, 4xi64)
        ...
        # pd_op.unsqueeze: (256x64x1x3xf16, None) <- (256x64x3xf16, 1xi64)
        unsqueeze_10, unsqueeze_11 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_8, full_int_array_17), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_18 = [-2]

        # pd_op.unsqueeze: (-1x256x1x100xf16, None) <- (-1x256x100xf16, 1xi64)
        unsqueeze_12, unsqueeze_13 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(relu__1, full_int_array_18), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x256x1x100xf16) <- (-1x256x1x100xf16, 256x64x1x3xf16)
        conv2d_4 = paddle._C_ops.conv2d(unsqueeze_12, unsqueeze_10, [1, 1], [0, 1], 'EXPLICIT', [1, 1], 4, 'NCHW')
        ...
        # pd_op.unsqueeze: (1x256x1x1xf16, None) <- (1x256x1xf16, 1xi64)
        unsqueeze_14, unsqueeze_15 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_10, full_int_array_21), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_22 = [-2]

        # pd_op.unsqueeze_: (-1x256x1x100xf16, None) <- (-1x256x100xf16, 1xi64)
        unsqueeze__6, unsqueeze__7 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze_(relu__3, full_int_array_22), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x1x1x100xf16) <- (-1x256x1x100xf16, 1x256x1x1xf16)
        conv2d_5 = paddle._C_ops.conv2d(unsqueeze__6, unsqueeze_14, [1, 1], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')
        ...
        # pd_op.unsqueeze: (128x256x1x3xf16, None) <- (128x256x3xf16, 1xi64)
        unsqueeze_16, unsqueeze_17 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze(parameter_12, full_int_array_26), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_27 = [-2]

        # pd_op.unsqueeze_: (-1x256x1x100xf16, None) <- (-1x256x100xf16, 1xi64)
        unsqueeze__8, unsqueeze__9 = (lambda x, f: f(x))(paddle._C_ops.unsqueeze_(relu__1, full_int_array_27), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.conv2d: (-1x128x1x100xf16) <- (-1x256x1x100xf16, 128x256x1x3xf16)
        conv2d_6 = paddle._C_ops.conv2d(unsqueeze__8, unsqueeze_16, [1, 1], [0, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_28 = [1, 128, 1, 1]

        # pd_op.reshape: (1x128x1x1xf16, 0x128xi64) <- (128xf16, 4xi64)
        ...
        # pd_op.reshape: (1x512x1x1x1xf16, 0x512xf16) <- (512xf16, 5xi64)
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_0, parameter_1, parameter_2, parameter_3, parameter_4, parameter_5, parameter_6, parameter_7, parameter_8, parameter_9, parameter_10, parameter_11, parameter_12, parameter_13, parameter_14, parameter_15, parameter_16, parameter_17, parameter_18, parameter_19, parameter_20, parameter_21, parameter_22, parameter_23, parameter_24, feed_0):
        return self.builtin_module_151_0_0(parameter_0, parameter_1, parameter_2, parameter_3, parameter_4, parameter_5, parameter_6, parameter_7, parameter_8, parameter_9, parameter_10, parameter_11, parameter_12, parameter_13, parameter_14, parameter_15, parameter_16, parameter_17, parameter_18, parameter_19, parameter_20, parameter_21, parameter_22, parameter_23, parameter_24, feed_0)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_151_0_0(CinnTestBase, unittest.TestCase):
