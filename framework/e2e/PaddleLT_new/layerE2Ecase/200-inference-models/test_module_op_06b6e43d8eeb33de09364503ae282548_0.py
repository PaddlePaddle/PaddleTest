...
def NumOperationsInBlock(block_idx):
    return [7, 0, 1, 0, 24, 7, 0, 1, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 7, 0, 2, 0, 24, 2878][block_idx] - 1 # number-of-ops-in-block
...
class BlockEntries:
    def pd_op_if_9914_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_0 = paddle._C_ops.scale(slice_0, full_0, float('1'), True)

        # pd_op.cast: (-1x40x6x40xf16) <- (-1x40x6x40xf32)
        cast_0 = paddle._C_ops.cast(reshape__0, paddle.float16)

        # builtin.combine: ([xi64, xi32]) <- (xi64, xi32)
        combine_0 = [slice_0, cast_1]

        # builtin.combine: ([xi64, 1xi32]) <- (xi64, 1xi32)
        combine_1 = [scale_0, constant_0]

        # pd_op.set_value_: (-1x40x6x40xf16) <- (-1x40x6x40xf16, [xi64, xi32], [xi64, 1xi32], 2xi64)
        set_value__0 = paddle._C_ops.set_value_(cast_0, combine_0, combine_1, constant_1, [0, 3], [0], [], [1], [float('-inf')])

        # pd_op.cast: (-1x40x6x40xf32) <- (-1x40x6x40xf16)
        cast_2 = paddle._C_ops.cast(set_value__0, paddle.float32)

        # pd_op.assign_: (-1x40x6x40xf32) <- (-1x40x6x40xf32)
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_9914_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_9925_0_0(self, reshape__0):

        # pd_op.assign: (-1x40x6x40xf32) <- (-1x40x6x40xf32)
        assign_0 = reshape__0
        return assign_0
    def pd_op_if_9925_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_9903_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, assign_value_1, full_0, reshape__0, assign_value_2, assign_value_0):
        ...
        # pd_op.slice: (xf16) <- (-1xf16, [xi64], [xi64])
        slice_1 = paddle._C_ops.slice(cast_0, [0], combine_0, combine_1, [-1], [0])

        # pd_op.scale: (xf16) <- (xf16, 1xf32)
        scale_1 = paddle._C_ops.scale(slice_1, constant_0, float('0'), True)

        # pd_op.scale_: (xf16) <- (xf16, 1xf32)
        scale__0 = paddle._C_ops.scale_(scale_1, full_1, float('0.5'), True)

        # pd_op.cast: (xf32) <- (xf16)
        cast_1 = paddle._C_ops.cast(scale__0, paddle.float32)

        # pd_op.cast: (xi32) <- (xf32)
        cast_2 = paddle._C_ops.cast(cast_1, paddle.int32)

        # pd_op.less_than: (xb) <- (xi32, xi32)
        less_than_0 = cast_2 < parameter_0

        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_9914_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_9914_1_0(parameter_1, full_2)
        ...
        if logical_not_0:
            if_2, = self.pd_op_if_9925_0_0(reshape__0)
        else:
            if_2, = self.pd_op_if_9925_1_0(parameter_2)
        ...
        memcpy_h2d_0 = paddle._C_ops.memcpy_h2d(cast_4, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_1 = scale_0 < memcpy_h2d_0

        # pd_op.cast: (xf32) <- (xf16)
        cast_5 = paddle._C_ops.cast(slice_1, paddle.float32)

        # pd_op.assign_out_: (xf32) <- (xf32, xf32)
        assign_out__0 = paddle._C_ops.assign_out_(cast_5, assign_value_0)

        # pd_op.assign_out_: (xi64) <- (xi64, xi64)
        assign_out__1 = paddle._C_ops.assign_out_(scale_0, full_0)

        # pd_op.assign_out_: (xi32) <- (xi32, xi32)
        assign_out__2 = paddle._C_ops.assign_out_(cast_2, assign_value_1)
    ...
    def pd_op_if_10004_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_10004_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_10015_0_0(self, reshape__0):

        # pd_op.assign: (-1x40x6x40xf32) <- (-1x40x6x40xf32)
        assign_0 = reshape__0
        return assign_0
    def pd_op_if_10015_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_9993_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, assign_value_1, assign_value_2, assign_value_0, full_0, reshape__0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10004_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10004_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10015_0_0(reshape__0)
        else:
            if_2, = self.pd_op_if_10015_1_0(parameter_2)
    ...
    def pd_op_if_10109_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        # pd_op.assign_: (-1x40x6x40xf32) <- (-1x40x6x40xf32)
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_10109_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_10120_0_0(self, if_0):

        # pd_op.cast: (-1x40x6x40xf32) <- (-1x40x6x40xf16)
        cast_0 = paddle._C_ops.cast(if_0, paddle.float32)

        # pd_op.assign_: (-1x40x6x40xf32) <- (-1x40x6x40xf32)
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10120_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10098_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, full_2, assign_value_0, reshape__0, full_0, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10109_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10109_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10120_0_0(if_0)
        else:
            if_2, = self.pd_op_if_10120_1_0(parameter_2)
    ...
    def pd_op_if_10214_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_10214_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_10225_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10225_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10203_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, assign_value_1, assign_value_0, reshape__0, full_2, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10214_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10214_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10225_0_0(if_1)
        else:
            if_2, = self.pd_op_if_10225_1_0(parameter_2)
    ...
    def pd_op_if_10319_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_10319_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_10330_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10330_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10308_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, reshape__0, full_0, assign_value_2, full_2, assign_value_1, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10319_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10319_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10330_0_0(if_1)
        else:
            if_2, = self.pd_op_if_10330_1_0(parameter_2)
    ...
    def pd_op_if_10424_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_10424_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_10435_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10435_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10413_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, reshape__0, assign_value_2, full_0, full_2, assign_value_1, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10424_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10424_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10435_0_0(if_0)
        else:
            if_2, = self.pd_op_if_10435_1_0(parameter_2)
    ...
    def pd_op_if_10529_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_10529_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_10540_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10540_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10518_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, assign_value_1, reshape__0, assign_value_0, full_2, assign_value_2):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10529_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10529_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10540_0_0(if_0)
        else:
            if_2, = self.pd_op_if_10540_1_0(parameter_2)
    ...
    def pd_op_if_10634_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_10634_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_10645_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10645_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10623_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, full_0, reshape__0, assign_value_1, assign_value_2, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10634_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10634_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10645_0_0(if_0)
        else:
            if_2, = self.pd_op_if_10645_1_0(parameter_2)
    ...
    def pd_op_if_10739_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_10739_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_10750_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10750_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10728_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, reshape__0, assign_value_0, assign_value_2, full_2, assign_value_1, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10739_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10739_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10750_0_0(if_0)
        else:
            if_2, = self.pd_op_if_10750_1_0(parameter_2)
    ...
    def pd_op_if_10844_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_10844_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_10855_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10855_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10833_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, full_0, reshape__0, full_2, assign_value_2, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10844_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10844_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10855_0_0(if_1)
        else:
            if_2, = self.pd_op_if_10855_1_0(parameter_2)
    ...
    def pd_op_if_10949_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_10949_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_10960_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_10960_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_10938_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, full_2, assign_value_0, reshape__0, full_0, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_10949_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_10949_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_10960_0_0(if_1)
        else:
            if_2, = self.pd_op_if_10960_1_0(parameter_2)
    ...
    def pd_op_if_11054_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_11054_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_11065_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11065_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11043_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, assign_value_0, assign_value_2, full_2, full_0, reshape__0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11054_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11054_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11065_0_0(if_1)
        else:
            if_2, = self.pd_op_if_11065_1_0(parameter_2)
    ...
    def pd_op_if_11159_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_11159_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_11170_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11170_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11148_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, reshape__0, assign_value_1, assign_value_0, full_0, assign_value_2):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11159_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11159_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11170_0_0(if_0)
        else:
            if_2, = self.pd_op_if_11170_1_0(parameter_2)
    ...
    def pd_op_if_11264_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_11264_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_11275_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11275_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11253_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, assign_value_1, reshape__0, full_2, assign_value_0, assign_value_2):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11264_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11264_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11275_0_0(if_1)
        else:
            if_2, = self.pd_op_if_11275_1_0(parameter_2)
    ...
    def pd_op_if_11369_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_11369_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_11380_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11380_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11358_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, full_2, reshape__0, assign_value_0, full_0, assign_value_2):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11369_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11369_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11380_0_0(if_0)
        else:
            if_2, = self.pd_op_if_11380_1_0(parameter_2)
    ...
    def pd_op_if_11474_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_11474_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_11485_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11485_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11463_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, full_2, assign_value_0, assign_value_1, reshape__0, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11474_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11474_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11485_0_0(if_1)
        else:
            if_2, = self.pd_op_if_11485_1_0(parameter_2)
    ...
    def pd_op_if_11579_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_11579_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_11590_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11590_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11568_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_0, full_0, full_2, assign_value_2, assign_value_1, reshape__0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11579_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11579_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11590_0_0(if_0)
        else:
            if_2, = self.pd_op_if_11590_1_0(parameter_2)
    ...
    def pd_op_if_11684_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_11684_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_11695_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11695_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11673_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, full_2, assign_value_0, assign_value_1, reshape__0, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11684_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11684_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11695_0_0(if_1)
        else:
            if_2, = self.pd_op_if_11695_1_0(parameter_2)
        ...
        assign_out__5 = paddle._C_ops.assign_out_(less_than_1, less_than_2)
        return assign_out__5, assign_out__3, if_1, assign_out__0, assign_out__2, assign_out__4, assign_out__1
    def pd_op_if_11789_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_11789_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_11800_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11800_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11778_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, full_0, full_2, reshape__0, assign_value_2, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11789_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11789_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11800_0_0(if_0)
        else:
            if_2, = self.pd_op_if_11800_1_0(parameter_2)
    ...
    def pd_op_if_11894_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_11894_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_11905_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_11905_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11883_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, reshape__0, full_2, full_0, assign_value_2, assign_value_0, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11894_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11894_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_11905_0_0(if_0)
        else:
            if_2, = self.pd_op_if_11905_1_0(parameter_2)
    ...
    def pd_op_if_11999_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_11999_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_12010_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12010_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_11988_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, assign_value_2, assign_value_0, reshape__0, full_0, full_2):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_11999_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_11999_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12010_0_0(if_0)
        else:
            if_2, = self.pd_op_if_12010_1_0(parameter_2)
    ...
    def pd_op_if_12104_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_12104_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_12115_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12115_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12093_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, assign_value_1, full_2, reshape__0, assign_value_2, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12104_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12104_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12115_0_0(if_1)
        else:
            if_2, = self.pd_op_if_12115_1_0(parameter_2)
    ...
    def pd_op_if_12209_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_12209_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_12220_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12220_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12198_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, assign_value_1, reshape__0, full_2, assign_value_0, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12209_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12209_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12220_0_0(if_0)
        else:
            if_2, = self.pd_op_if_12220_1_0(parameter_2)
    ...
    def pd_op_if_12314_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_12314_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_12325_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12325_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12303_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, assign_value_1, reshape__0, assign_value_0, assign_value_2, full_2):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12314_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12314_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12325_0_0(if_1)
        else:
            if_2, = self.pd_op_if_12325_1_0(parameter_2)
    ...
    def pd_op_if_12419_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_12419_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_12430_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12430_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12408_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, assign_value_0, reshape__0, assign_value_1, assign_value_2, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12419_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12419_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12430_0_0(if_1)
        else:
            if_2, = self.pd_op_if_12430_1_0(parameter_2)
    ...
    def pd_op_if_12524_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_12524_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_12535_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12535_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12513_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, assign_value_2, reshape__0, assign_value_0, assign_value_1, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12524_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12524_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12535_0_0(if_0)
        else:
            if_2, = self.pd_op_if_12535_1_0(parameter_2)
    ...
    def pd_op_if_12629_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_12629_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_12640_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12640_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12618_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, assign_value_1, assign_value_0, reshape__0, full_2, assign_value_2):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12629_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12629_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12640_0_0(if_1)
        else:
            if_2, = self.pd_op_if_12640_1_0(parameter_2)
    ...
    def pd_op_if_12734_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_12734_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_12745_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12745_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12723_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, full_0, reshape__0, assign_value_2, assign_value_0, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12734_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12734_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12745_0_0(if_0)
        else:
            if_2, = self.pd_op_if_12745_1_0(parameter_2)
    ...
    def pd_op_if_12839_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_12839_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_12850_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12850_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12828_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, reshape__0, assign_value_0, assign_value_1, full_0, full_2):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12839_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12839_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12850_0_0(if_0)
        else:
            if_2, = self.pd_op_if_12850_1_0(parameter_2)
    ...
    def pd_op_if_12944_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_12944_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_12955_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_12955_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_12933_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_0, assign_value_2, full_2, assign_value_1, reshape__0, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_12944_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_12944_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_12955_0_0(if_1)
        else:
            if_2, = self.pd_op_if_12955_1_0(parameter_2)
    ...
    def pd_op_if_13049_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_13049_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_13060_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13060_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13038_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, full_2, assign_value_2, full_0, assign_value_0, reshape__0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13049_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13049_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13060_0_0(if_0)
        else:
            if_2, = self.pd_op_if_13060_1_0(parameter_2)
    ...
    def pd_op_if_13154_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13154_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_13165_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13165_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13143_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, full_2, assign_value_2, reshape__0, assign_value_0, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13154_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13154_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13165_0_0(if_1)
        else:
            if_2, = self.pd_op_if_13165_1_0(parameter_2)
    ...
    def pd_op_if_13259_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_13259_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_13270_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13270_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13248_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, reshape__0, full_0, assign_value_0, assign_value_2, full_2, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13259_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13259_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13270_0_0(if_0)
        else:
            if_2, = self.pd_op_if_13270_1_0(parameter_2)
    ...
    def pd_op_if_13364_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13364_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_13375_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13375_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13353_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, full_0, reshape__0, full_2, assign_value_0, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13364_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13364_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13375_0_0(if_1)
        else:
            if_2, = self.pd_op_if_13375_1_0(parameter_2)
    ...
    def pd_op_if_13469_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13469_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_13480_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13480_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13458_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_2, assign_value_0, reshape__0, full_2, full_0, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13469_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13469_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13480_0_0(if_1)
        else:
            if_2, = self.pd_op_if_13480_1_0(parameter_2)
    ...
    def pd_op_if_13574_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_13574_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_13585_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13585_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13563_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_2, assign_value_0, assign_value_2, reshape__0, assign_value_1, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13574_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13574_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13585_0_0(if_0)
        else:
            if_2, = self.pd_op_if_13585_1_0(parameter_2)
    ...
    def pd_op_if_13679_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13679_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_13690_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13690_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13668_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, reshape__0, assign_value_0, full_0, assign_value_2, full_2, assign_value_1):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13679_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13679_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13690_0_0(if_1)
        else:
            if_2, = self.pd_op_if_13690_1_0(parameter_2)
    ...
    def pd_op_if_13784_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13784_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_13795_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13795_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13773_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, full_0, full_2, assign_value_0, assign_value_2, reshape__0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13784_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13784_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13795_0_0(if_1)
        else:
            if_2, = self.pd_op_if_13795_1_0(parameter_2)
    ...
    def pd_op_if_13889_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13889_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_13900_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_13900_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13878_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, reshape__0, assign_value_2, full_2, assign_value_1, assign_value_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13889_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13889_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_13900_0_0(if_1)
        else:
            if_2, = self.pd_op_if_13900_1_0(parameter_2)
    ...
    def pd_op_if_13994_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return assign__0, set_value__0
    def pd_op_if_13994_1_0(self, parameter_0, full_0):
        return parameter_0, full_0
    def pd_op_if_14005_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_14005_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_13983_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, assign_value_1, assign_value_2, assign_value_0, reshape__0, full_2, full_0):
        ...
        # pd_op.if: (-1x40x6x40xf32, -1x40x6x40xf16) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_13994_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_13994_1_0(parameter_1, full_2)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_14005_0_0(if_1)
        else:
            if_2, = self.pd_op_if_14005_1_0(parameter_2)
    ...
    def pd_op_if_14099_0_0(self, slice_0, full_0, reshape__0, cast_1, constant_0, constant_1):
        ...
        assign__0 = paddle._C_ops.assign_(cast_2)
        return set_value__0, assign__0
    def pd_op_if_14099_1_0(self, full_0, parameter_0):
        return full_0, parameter_0
    def pd_op_if_14110_0_0(self, if_0):
        ...
        assign__0 = paddle._C_ops.assign_(cast_0)
        return assign__0
    def pd_op_if_14110_1_0(self, parameter_0):
        return parameter_0
    def pd_op_while_14088_0_0(self, full_1, arange_0, cast_0, constant_0, parameter_0, constant_1, constant_2, parameter_1, parameter_2, cast_4, less_than_2, full_0, assign_value_1, assign_value_2, full_2, assign_value_0, reshape__0):
        ...
        # pd_op.if: (-1x40x6x40xf16, -1x40x6x40xf32) <- (xb)
        if less_than_0:
            if_0, if_1, = self.pd_op_if_14099_0_0(slice_0, full_1, reshape__0, cast_2, constant_1, constant_2)
        else:
            if_0, if_1, = self.pd_op_if_14099_1_0(full_2, parameter_1)
        ...
        # pd_op.if: (-1x40x6x40xf32) <- (xb)
        if logical_not_0:
            if_2, = self.pd_op_if_14110_0_0(if_0)
        else:
            if_2, = self.pd_op_if_14110_1_0(parameter_2)
    ...
    def builtin_module_9221_0_0(self, parameter_310, parameter_309, constant_177, constant_176, parameter_308, constant_175, parameter_307, parameter_306, constant_173, constant_172, parameter_305, constant_171, parameter_304, parameter_303, constant_169, constant_168, parameter_302, constant_167, parameter_301, parameter_300, constant_165, constant_164, parameter_299, constant_163, parameter_298, parameter_297, constant_161, constant_160, parameter_296, constant_159, parameter_295, parameter_294, constant_157, constant_156, parameter_293, constant_155, parameter_292, parameter_291, constant_153, constant_152, parameter_290, constant_151, parameter_289, parameter_288, constant_149, constant_148, parameter_287, constant_147, parameter_286, parameter_285, constant_145, constant_144, parameter_284, constant_143, parameter_283, parameter_282, constant_141, constant_140, parameter_281, constant_139, parameter_280, parameter_279, constant_137, constant_136, parameter_278, constant_135, parameter_277, parameter_276, constant_133, constant_132, parameter_275, constant_131, parameter_274, parameter_273, constant_129, constant_128, parameter_272, constant_127, parameter_271, parameter_270, constant_125, constant_124, parameter_269, constant_123, parameter_268, parameter_267, constant_121, constant_120, parameter_266, constant_119, parameter_265, parameter_264, constant_117, constant_116, parameter_263, constant_115, parameter_262, parameter_261, constant_113, constant_112, parameter_260, constant_111, parameter_259, parameter_258, constant_109, constant_108, parameter_257, constant_107, parameter_256, parameter_255, constant_105, constant_104, parameter_254, constant_103, parameter_253, parameter_252, constant_101, constant_100, parameter_251, constant_99, parameter_250, parameter_249, constant_97, constant_96, parameter_248, constant_95, parameter_247, parameter_246, constant_93, constant_92, parameter_245, constant_91, parameter_244, parameter_243, constant_89, constant_88, parameter_242, constant_87, parameter_241, parameter_240, constant_85, constant_84, parameter_239, constant_83, parameter_238, parameter_237, constant_81, constant_80, parameter_236, constant_79, parameter_235, parameter_234, constant_77, constant_76, parameter_233, constant_75, parameter_232, parameter_231, constant_73, constant_72, parameter_230, constant_71, parameter_229, parameter_228, constant_69, constant_68, parameter_227, constant_67, parameter_226, parameter_225, constant_65, constant_64, parameter_224, constant_63, parameter_223, parameter_222, constant_61, constant_60, parameter_221, constant_59, parameter_220, parameter_219, constant_57, constant_56, parameter_218, constant_55, parameter_217, parameter_216, constant_53, constant_52, parameter_215, constant_51, parameter_214, parameter_213, constant_49, constant_48, parameter_212, constant_47, parameter_211, parameter_210, constant_45, constant_44, parameter_209, constant_43, parameter_208, parameter_207, constant_41, constant_40, parameter_206, constant_39, parameter_205, parameter_204, constant_37, constant_36, parameter_203, constant_35, parameter_202, parameter_201, constant_33, constant_32, parameter_200, constant_31, parameter_199, parameter_198, constant_29, constant_28, parameter_197, constant_27, parameter_196, parameter_195, constant_25, constant_24, parameter_194, constant_23, parameter_189, parameter_188, constant_18, constant_17, parameter_187, constant_16, parameter_177, parameter_176, constant_15, constant_14, parameter_175, constant_13, constant_174, constant_170, constant_166, constant_162, constant_158, constant_154, constant_150, constant_146, constant_142, constant_138, constant_134, constant_130, constant_126, constant_122, constant_118, constant_114, constant_110, constant_106, constant_102, constant_98, constant_94, constant_90, constant_86, constant_82, constant_78, constant_74, constant_70, constant_66, constant_62, constant_58, constant_54, constant_50, constant_46, constant_42, constant_38, constant_34, constant_30, constant_26, constant_22, constant_21, constant_20, constant_19, constant_12, constant_11, constant_10, constant_9, parameter_173, parameter_171, constant_8, parameter_169, parameter_160, parameter_159, constant_7, constant_6, constant_5, constant_4, parameter_158, constant_3, constant_2, parameter_157, parameter_151, parameter_115, constant_1, parameter_54, parameter_28, constant_0, parameter_7, parameter_1, parameter_0, parameter_5, parameter_2, parameter_4, parameter_3, parameter_6, parameter_11, parameter_8, parameter_10, parameter_9, parameter_12, parameter_16, parameter_13, parameter_15, parameter_14, parameter_17, parameter_21, parameter_18, parameter_20, parameter_19, parameter_22, parameter_26, parameter_23, parameter_25, parameter_24, parameter_27, parameter_32, parameter_29, parameter_31, parameter_30, parameter_33, parameter_37, parameter_34, parameter_36, parameter_35, parameter_38, parameter_42, parameter_39, parameter_41, parameter_40, parameter_43, parameter_47, parameter_44, parameter_46, parameter_45, parameter_48, parameter_52, parameter_49, parameter_51, parameter_50, parameter_53, parameter_58, parameter_55, parameter_57, parameter_56, parameter_59, parameter_63, parameter_60, parameter_62, parameter_61, parameter_64, parameter_68, parameter_65, parameter_67, parameter_66, parameter_69, parameter_73, parameter_70, parameter_72, parameter_71, parameter_74, parameter_78, parameter_75, parameter_77, parameter_76, parameter_79, parameter_83, parameter_80, parameter_82, parameter_81, parameter_84, parameter_88, parameter_85, parameter_87, parameter_86, parameter_89, parameter_93, parameter_90, parameter_92, parameter_91, parameter_94, parameter_98, parameter_95, parameter_97, parameter_96, parameter_99, parameter_103, parameter_100, parameter_102, parameter_101, parameter_104, parameter_108, parameter_105, parameter_107, parameter_106, parameter_109, parameter_113, parameter_110, parameter_112, parameter_111, parameter_114, parameter_119, parameter_116, parameter_118, parameter_117, parameter_120, parameter_124, parameter_121, parameter_123, parameter_122, parameter_125, parameter_129, parameter_126, parameter_128, parameter_127, parameter_130, parameter_134, parameter_131, parameter_133, parameter_132, parameter_135, parameter_139, parameter_136, parameter_138, parameter_137, parameter_140, parameter_144, parameter_141, parameter_143, parameter_142, parameter_145, parameter_149, parameter_146, parameter_148, parameter_147, parameter_150, parameter_155, parameter_152, parameter_154, parameter_153, parameter_156, parameter_161, parameter_162, parameter_163, parameter_164, parameter_165, parameter_166, parameter_167, parameter_168, parameter_170, parameter_172, parameter_174, parameter_178, parameter_179, parameter_180, parameter_181, parameter_182, parameter_183, parameter_184, parameter_185, parameter_186, parameter_190, parameter_191, parameter_192, parameter_193, feed_1, feed_2, feed_0):
        ...
        # pd_op.relu_: (-1x64x48x160xf16) <- (-1x64x48x160xf16)
        relu__0 = paddle._C_ops.relu_(batch_norm__0)

        # pd_op.conv2d: (-1x128x48x160xf16) <- (-1x64x48x160xf16, 128x64x3x3xf16)
        conv2d_1 = paddle._C_ops.conv2d(relu__0, parameter_6, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.add_: (-1x128x48x160xf16) <- (-1x128x48x160xf16, 1x128x1x1xf16)
        add__1 = paddle._C_ops.add_(conv2d_1, parameter_7)

        # pd_op.batch_norm_: (-1x128x48x160xf16, 128xf32, 128xf32, xf32, xf32, None) <- (-1x128x48x160xf16, 128xf32, 128xf32, 128xf32, 128xf32)
        ...
        # pd_op.relu_: (-1x128x48x160xf16) <- (-1x128x48x160xf16)
        relu__1 = paddle._C_ops.relu_(batch_norm__6)

        # pd_op.pool2d: (-1x128x24x80xf16) <- (-1x128x48x160xf16, 2xi64)
        pool2d_0 = paddle._C_ops.pool2d(relu__1, constant_0, [2, 2], [0, 0], True, True, 'NCHW', 'max', False, False, 'EXPLICIT')

        # pd_op.conv2d: (-1x256x24x80xf16) <- (-1x128x24x80xf16, 256x128x3x3xf16)
        conv2d_2 = paddle._C_ops.conv2d(pool2d_0, parameter_12, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.batch_norm_: (-1x256x24x80xf16, 256xf32, 256xf32, xf32, xf32, None) <- (-1x256x24x80xf16, 256xf32, 256xf32, 256xf32, 256xf32)
        ...
        # pd_op.relu_: (-1x256x24x80xf16) <- (-1x256x24x80xf16)
        relu__2 = paddle._C_ops.relu_(batch_norm__12)

        # pd_op.conv2d: (-1x256x24x80xf16) <- (-1x256x24x80xf16, 256x256x3x3xf16)
        ...
        # pd_op.conv2d: (-1x256x24x80xf16) <- (-1x128x24x80xf16, 256x128x1x1xf16)
        ...
        # pd_op.add_: (-1x256x24x80xf16) <- (-1x256x24x80xf16, -1x256x24x80xf16)
        ...
        # pd_op.add_: (-1x256x24x80xf16) <- (-1x256x24x80xf16, 1x256x1x1xf16)
        ...
        # pd_op.pool2d: (-1x256x12x40xf16) <- (-1x256x24x80xf16, 2xi64)
        pool2d_1 = paddle._C_ops.pool2d(relu__4, constant_0, [2, 2], [0, 0], True, True, 'NCHW', 'max', False, False, 'EXPLICIT')

        # pd_op.conv2d: (-1x256x12x40xf16) <- (-1x256x12x40xf16, 256x256x3x3xf16)
        conv2d_6 = paddle._C_ops.conv2d(pool2d_1, parameter_33, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.batch_norm_: (-1x256x12x40xf16, 256xf32, 256xf32, xf32, xf32, None) <- (-1x256x12x40xf16, 256xf32, 256xf32, 256xf32, 256xf32)
        ...
        # pd_op.relu_: (-1x256x12x40xf16) <- (-1x256x12x40xf16)
        ...
        # pd_op.add_: (-1x256x12x40xf16) <- (-1x256x12x40xf16, -1x256x12x40xf16)
        ...
        # pd_op.add_: (-1x256x12x40xf16) <- (-1x256x12x40xf16, 1x256x1x1xf16)
        ...
        # pd_op.pool2d: (-1x256x6x40xf16) <- (-1x256x12x40xf16, 2xi64)
        pool2d_2 = paddle._C_ops.pool2d(relu__9, constant_1, [2, 1], [0, 0], True, True, 'NCHW', 'max', False, False, 'EXPLICIT')

        # pd_op.conv2d: (-1x512x6x40xf16) <- (-1x256x6x40xf16, 512x256x3x3xf16)
        conv2d_11 = paddle._C_ops.conv2d(pool2d_2, parameter_59, [1, 1], [1, 1], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.batch_norm_: (-1x512x6x40xf16, 512xf32, 512xf32, xf32, xf32, None) <- (-1x512x6x40xf16, 512xf32, 512xf32, 512xf32, 512xf32)
        ...
        # pd_op.relu_: (-1x512x6x40xf16) <- (-1x512x6x40xf16)
        relu__10 = paddle._C_ops.relu_(batch_norm__66)

        # pd_op.conv2d: (-1x512x6x40xf16) <- (-1x512x6x40xf16, 512x512x3x3xf16)
        ...
        # pd_op.conv2d: (-1x512x6x40xf16) <- (-1x256x6x40xf16, 512x256x1x1xf16)
        ...
        # pd_op.add_: (-1x512x6x40xf16) <- (-1x512x6x40xf16, -1x512x6x40xf16)
        ...
        # pd_op.add_: (-1x512x6x40xf16) <- (-1x512x6x40xf16, 1x512x1x1xf16)
        ...
        # pd_op.conv2d: (-1x128x6x40xf16) <- (-1x512x6x40xf16, 128x512x1x1xf16)
        conv2d_30 = paddle._C_ops.conv2d(relu__27, parameter_156, [1, 1], [0, 0], 'EXPLICIT', [1, 1], 1, 'NCHW')

        # pd_op.add_: (-1x128x6x40xf16) <- (-1x128x6x40xf16, 1x128x1x1xf16)
        add__17 = paddle._C_ops.add_(conv2d_30, parameter_157)

        # pd_op.shape: (4xi32) <- (-1x512x6x40xf16)
        shape_0 = paddle._C_ops.shape(paddle.cast(relu__27, 'float32'))
        ...
        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_1 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(shape_1, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_2 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_2 = paddle._C_ops.slice(shape_2, [0], constant_2, constant_3, [1], [0])

        # pd_op.transpose: (-1x6x40x128xf16) <- (-1x128x6x40xf16)
        ...
        # pd_op.reshape_: (-1x40x128xf16, 0x-1x6x40x128xf16) <- (-1x6x40x128xf16, [xi32, 1xi32, 1xi32])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_3 = paddle._C_ops.shape(paddle.cast(reshape__0, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_1 = paddle._C_ops.full_with_tensor(full_1, stack_1, paddle.float16)
        ...
        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_1 = paddle._C_ops.transpose(reshape__0, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_1 = paddle._C_ops.cast(transpose_1, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_2 = paddle._C_ops.cast(full_with_tensor_1, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_3 = paddle._C_ops.cast(full_with_tensor_2, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_7 = [cast_2, cast_3]
        ...
        rnn__0, rnn__1, rnn__2, rnn__3 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_1, combine_7, combine_8, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_4 = paddle._C_ops.cast(rnn__0, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        ...
        # pd_op.reshape_: (-1x6x40x128xf16, 0x-1x40x128xf16) <- (-1x40x128xf16, [xi32, 1xi32, 1xi32, 1xi32])
        ...
        # pd_op.transpose: (-1x128x6x40xf16) <- (-1x6x40x128xf16)
        transpose_3 = paddle._C_ops.transpose(reshape__2, [0, 3, 1, 2])

        # pd_op.conv2d: (-1x128x6x40xf16) <- (-1x128x6x40xf16, 128x128x3x3xf16)
        ...
        # pd_op.relu_: (-1x128x6x40xf16) <- (-1x128x6x40xf16)
        ...
        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 41x128xf16)
        embedding_0 = paddle._C_ops.embedding(feed_1, parameter_174, -1, False)

        # pd_op.transpose: (-1x128x40xf16) <- (-1x40x128xf16)
        transpose_4 = paddle._C_ops.transpose(embedding_0, [0, 2, 1])

        # builtin.combine: ([xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32)
        combine_10 = [slice_1, constant_7, constant_9]

        # pd_op.reshape_: (-1x128x240xf16, 0x-1x128x6x40xf16) <- (-1x128x6x40xf16, [xi32, 1xi32, 1xi32])
        ...
        # pd_op.reshape: (-1x512x240xf16, 0x-1x512x6x40xf16) <- (-1x512x6x40xf16, [xi32, 1xi32, 1xi32])
        ...
        # pd_op.transpose: (-1x40x128xf16) <- (-1x128x40xf16)
        transpose_5 = paddle._C_ops.transpose(transpose_4, [0, 2, 1])

        # pd_op.matmul: (-1x40x240xf16) <- (-1x40x128xf16, -1x128x240xf16)
        matmul_0 = paddle.matmul(transpose_5, reshape__4, transpose_x=False, transpose_y=False)

        # pd_op.scale_: (-1x40x240xf16) <- (-1x40x240xf16, 1xf32)
        scale__1 = paddle._C_ops.scale_(matmul_0, full_0, float('0'), True)

        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_4 = paddle._C_ops.shape(paddle.cast(scale__1, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(shape_4, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_5 = paddle._C_ops.cast(scale__1, paddle.float32)
        ...
        reshape__6, reshape__7 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_5, combine_12), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.cast: (-1xf16) <- (-1xf32)
        cast_6 = paddle._C_ops.cast(feed_2, paddle.float16)

        # pd_op.shape: (1xi32) <- (-1xf16)
        shape_5 = paddle._C_ops.shape(paddle.cast(cast_6, 'float32'))
        ...
        cast_7 = paddle._C_ops.cast(scale_1, paddle.int64)

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_0 = paddle.arange(constant_11, cast_7, constant_12, dtype='int64')

        # pd_op.full: (xi64) <- ()
        full_2 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.cast: (xi64) <- (xi32)
        cast_8 = paddle._C_ops.cast(slice_5, paddle.int64)

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_3 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_0 = full_2 < memcpy_h2d_3

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_3 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xi32, xi64, -1x40x6x40xf32, xi64, xf32) <- (xb, -1x40x6x40xf16, xi32, xi64, -1x40x6x40xf32, xi64, xf32)
        import os
        ...
        while_loop_counter_9903 = 0
        while less_than_0:
            less_than_0, full_3, assign_value_1, full_2, reshape__6, assign_value_2, assign_value_0, = self.pd_op_while_9903_0_0(full_0, arange_0, cast_6, constant_13, parameter_175, constant_14, constant_15, parameter_176, parameter_177, cast_8, less_than_0, full_3, assign_value_1, full_2, reshape__6, assign_value_2, assign_value_0)
            while_loop_counter_9903 += 1
            if while_loop_counter_9903 > kWhileLoopLimit:
                break
            
        while_0, while_1, while_2, while_3, while_4, while_5, = full_3, assign_value_1, full_2, reshape__6, assign_value_2, assign_value_0,

        # pd_op.cast: (-1x40x6x40xf16) <- (-1x40x6x40xf32)
        cast_9 = paddle._C_ops.cast(while_3, paddle.float16)

        # builtin.combine: ([xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32)
        combine_13 = [slice_4, constant_6, constant_9]

        # pd_op.reshape_: (-1x40x240xf16, 0x-1x40x6x40xf16) <- (-1x40x6x40xf16, [xi32, 1xi32, 1xi32])
        reshape__8, reshape__9 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_9, combine_13), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.softmax_: (-1x40x240xf16) <- (-1x40x240xf16)
        softmax__0 = paddle._C_ops.softmax_(reshape__8, 2)

        # pd_op.transpose: (-1x240x512xf16) <- (-1x512x240xf16)
        transpose_6 = paddle._C_ops.transpose(reshape_0, [0, 2, 1])

        # pd_op.matmul: (-1x40x512xf16) <- (-1x40x240xf16, -1x240x512xf16)
        matmul_1 = paddle.matmul(softmax__0, transpose_6, transpose_x=False, transpose_y=False)

        # pd_op.transpose: (-1x512x40xf16) <- (-1x40x512xf16)
        transpose_7 = paddle._C_ops.transpose(matmul_1, [0, 2, 1])

        # pd_op.transpose: (-1x40x512xf16) <- (-1x512x40xf16)
        transpose_8 = paddle._C_ops.transpose(transpose_7, [0, 2, 1])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_1 = paddle._C_ops.embedding(scale__0, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_6 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_6 = paddle._C_ops.slice(shape_6, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_7 = paddle._C_ops.shape(paddle.cast(embedding_1, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_3 = paddle._C_ops.full_with_tensor(full_1, stack_3, paddle.float16)
        ...
        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_10 = paddle._C_ops.cast(transpose_9, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_11 = paddle._C_ops.cast(full_with_tensor_3, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_12 = paddle._C_ops.cast(full_with_tensor_4, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_18 = [cast_11, cast_12]
        ...
        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__4, rnn__5, rnn__6, rnn__7 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_10, combine_18, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_13 = paddle._C_ops.cast(rnn__4, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_10 = paddle._C_ops.transpose(cast_13, [1, 0, 2])
        ...
        # pd_op.reshape: (-1x128x240xf16, 0x-1x128x6x40xf16) <- (-1x128x6x40xf16, [xi32, 1xi32, 1xi32])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_8 = paddle._C_ops.shape(paddle.cast(scale__2, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_8 = paddle._C_ops.slice(shape_8, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_14 = paddle._C_ops.cast(scale__2, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_22 = [slice_8, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__10, reshape__11 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_14, combine_22), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_4 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_6 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_1 = full_4 < memcpy_h2d_6

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_5 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xi32, xi64, xf32, xi64, -1x40x6x40xf32) <- (xb, -1x40x6x40xf16, xi32, xi64, xf32, xi64, -1x40x6x40xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_9993 = 0
        while less_than_1:
            less_than_1, full_5, assign_value_4, assign_value_5, assign_value_3, full_4, reshape__10, = self.pd_op_while_9993_0_0(full_0, arange_0, cast_6, constant_16, parameter_187, constant_17, constant_18, parameter_188, parameter_189, cast_8, less_than_1, full_5, assign_value_4, assign_value_5, assign_value_3, full_4, reshape__10)
            while_loop_counter_9993 += 1
            if while_loop_counter_9993 > kWhileLoopLimit:
                break
            
        while_6, while_7, while_8, while_9, while_10, while_11, = full_5, assign_value_4, assign_value_5, assign_value_3, full_4, reshape__10,

        # pd_op.cast: (-1x40x6x40xf16) <- (-1x40x6x40xf32)
        cast_15 = paddle._C_ops.cast(while_11, paddle.float16)

        # builtin.combine: ([xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32)
        combine_23 = [slice_8, constant_6, constant_9]

        # pd_op.reshape_: (-1x40x240xf16, 0x-1x40x6x40xf16) <- (-1x40x6x40xf16, [xi32, 1xi32, 1xi32])
        reshape__12, reshape__13 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_15, combine_23), lambda out: out if isinstance(out, (list, tuple)) else (out, None))
        ...
        # pd_op.slice: (-1x512xf16) <- (-1x512x40xf16, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(transpose_14, [2], constant_2, constant_3, [1], [2])

        # pd_op.slice: (-1x512xf16) <- (-1x40x512xf16, 1xi64, 1xi64)
        slice_10 = paddle._C_ops.slice(transpose_8, [1], constant_2, constant_3, [1], [1])

        # builtin.combine: ([-1x512xf16, -1x512xf16]) <- (-1x512xf16, -1x512xf16)
        combine_24 = [slice_9, slice_10]

        # pd_op.concat: (-1x1024xf16) <- ([-1x512xf16, -1x512xf16], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_24, constant_19)

        # pd_op.matmul: (-1x1024xf16) <- (-1x1024xf16, 1024x1024xf16)
        ...
        # pd_op.split_with_num: ([-1x512xf16, -1x512xf16]) <- (-1x1024xf16, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(add__20, 2, constant_20)

        # builtin.slice: (-1x512xf16) <- ([-1x512xf16, -1x512xf16])
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_5 = paddle._C_ops.full_with_tensor(full_1, stack_5, paddle.float16)
        ...
        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_17 = paddle._C_ops.cast(transpose_15, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_18 = paddle._C_ops.cast(full_with_tensor_5, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_19 = paddle._C_ops.cast(full_with_tensor_6, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_29 = [cast_18, cast_19]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__8, rnn__9, rnn__10, rnn__11 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_17, combine_29, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_20 = paddle._C_ops.cast(rnn__8, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_16 = paddle._C_ops.transpose(cast_20, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_11 = paddle._C_ops.shape(paddle.cast(scale__3, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_15 = paddle._C_ops.slice(shape_11, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_21 = paddle._C_ops.cast(scale__3, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_32 = [slice_15, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__14, reshape__15 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_21, combine_32), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_6 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_9 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_2 = full_6 < memcpy_h2d_9

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_7 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, -1x40x6x40xf16, xf32, -1x40x6x40xf32, xi64, xi32) <- (xb, xi64, -1x40x6x40xf16, xf32, -1x40x6x40xf32, xi64, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10098 = 0
        while less_than_2:
            less_than_2, assign_value_8, full_7, assign_value_6, reshape__14, full_6, assign_value_7, = self.pd_op_while_10098_0_0(full_0, arange_0, cast_6, constant_23, parameter_194, constant_24, constant_25, parameter_195, parameter_196, cast_8, less_than_2, assign_value_8, full_7, assign_value_6, reshape__14, full_6, assign_value_7)
            while_loop_counter_10098 += 1
            if while_loop_counter_10098 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_22 = paddle._C_ops.cast(argmax_1, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__1 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__0, cast_22, constant_22, constant_26, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_3 = paddle._C_ops.embedding(set_value_with_tensor__1, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_12 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_20 = paddle._C_ops.slice(shape_12, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_13 = paddle._C_ops.shape(paddle.cast(embedding_3, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_7 = paddle._C_ops.full_with_tensor(full_1, stack_7, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_8 = paddle._C_ops.full_with_tensor(full_1, stack_8, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_21 = paddle._C_ops.transpose(embedding_3, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_23 = paddle._C_ops.cast(transpose_21, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_24 = paddle._C_ops.cast(full_with_tensor_7, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_25 = paddle._C_ops.cast(full_with_tensor_8, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_39 = [cast_24, cast_25]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__12, rnn__13, rnn__14, rnn__15 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_23, combine_39, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_26 = paddle._C_ops.cast(rnn__12, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_22 = paddle._C_ops.transpose(cast_26, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_14 = paddle._C_ops.shape(paddle.cast(scale__4, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_22 = paddle._C_ops.slice(shape_14, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_27 = paddle._C_ops.cast(scale__4, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_42 = [slice_22, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__18, reshape__19 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_27, combine_42), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_8 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_12 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_3 = full_8 < memcpy_h2d_12

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_9 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi32, xf32, -1x40x6x40xf32, -1x40x6x40xf16, xi64) <- (xb, xi64, xi32, xf32, -1x40x6x40xf32, -1x40x6x40xf16, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10203 = 0
        while less_than_3:
            less_than_3, assign_value_11, assign_value_10, assign_value_9, reshape__18, full_9, full_8, = self.pd_op_while_10203_0_0(full_0, arange_0, cast_6, constant_27, parameter_197, constant_28, constant_29, parameter_198, parameter_199, cast_8, less_than_3, assign_value_11, assign_value_10, assign_value_9, reshape__18, full_9, full_8)
            while_loop_counter_10203 += 1
            if while_loop_counter_10203 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_28 = paddle._C_ops.cast(argmax_2, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__2 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__1, cast_28, constant_26, constant_30, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_4 = paddle._C_ops.embedding(set_value_with_tensor__2, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_15 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_27 = paddle._C_ops.slice(shape_15, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_16 = paddle._C_ops.shape(paddle.cast(embedding_4, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_9 = paddle._C_ops.full_with_tensor(full_1, stack_9, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_10 = paddle._C_ops.full_with_tensor(full_1, stack_10, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_27 = paddle._C_ops.transpose(embedding_4, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_29 = paddle._C_ops.cast(transpose_27, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_30 = paddle._C_ops.cast(full_with_tensor_9, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_31 = paddle._C_ops.cast(full_with_tensor_10, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_49 = [cast_30, cast_31]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__16, rnn__17, rnn__18, rnn__19 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_29, combine_49, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_32 = paddle._C_ops.cast(rnn__16, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_28 = paddle._C_ops.transpose(cast_32, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_17 = paddle._C_ops.shape(paddle.cast(scale__5, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_29 = paddle._C_ops.slice(shape_17, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_33 = paddle._C_ops.cast(scale__5, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_52 = [slice_29, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__22, reshape__23 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_33, combine_52), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_10 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_15 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_4 = full_10 < memcpy_h2d_15

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_11 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf32, xi64, xi64, -1x40x6x40xf16, xi32, xf32) <- (xb, -1x40x6x40xf32, xi64, xi64, -1x40x6x40xf16, xi32, xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10308 = 0
        while less_than_4:
            less_than_4, reshape__22, full_10, assign_value_14, full_11, assign_value_13, assign_value_12, = self.pd_op_while_10308_0_0(full_0, arange_0, cast_6, constant_31, parameter_200, constant_32, constant_33, parameter_201, parameter_202, cast_8, less_than_4, reshape__22, full_10, assign_value_14, full_11, assign_value_13, assign_value_12)
            while_loop_counter_10308 += 1
            if while_loop_counter_10308 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_34 = paddle._C_ops.cast(argmax_3, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__3 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__2, cast_34, constant_30, constant_34, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_5 = paddle._C_ops.embedding(set_value_with_tensor__3, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_18 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_34 = paddle._C_ops.slice(shape_18, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_19 = paddle._C_ops.shape(paddle.cast(embedding_5, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_11 = paddle._C_ops.full_with_tensor(full_1, stack_11, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_12 = paddle._C_ops.full_with_tensor(full_1, stack_12, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_33 = paddle._C_ops.transpose(embedding_5, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_35 = paddle._C_ops.cast(transpose_33, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_36 = paddle._C_ops.cast(full_with_tensor_11, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_37 = paddle._C_ops.cast(full_with_tensor_12, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_59 = [cast_36, cast_37]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__20, rnn__21, rnn__22, rnn__23 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_35, combine_59, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_38 = paddle._C_ops.cast(rnn__20, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_34 = paddle._C_ops.transpose(cast_38, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_20 = paddle._C_ops.shape(paddle.cast(scale__6, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_36 = paddle._C_ops.slice(shape_20, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_39 = paddle._C_ops.cast(scale__6, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_62 = [slice_36, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__26, reshape__27 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_39, combine_62), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_12 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_18 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_5 = full_12 < memcpy_h2d_18

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_13 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10413 = 0
        while less_than_5:
            less_than_5, reshape__26, assign_value_17, full_12, full_13, assign_value_16, assign_value_15, = self.pd_op_while_10413_0_0(full_0, arange_0, cast_6, constant_35, parameter_203, constant_36, constant_37, parameter_204, parameter_205, cast_8, less_than_5, reshape__26, assign_value_17, full_12, full_13, assign_value_16, assign_value_15)
            while_loop_counter_10413 += 1
            if while_loop_counter_10413 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_40 = paddle._C_ops.cast(argmax_4, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__4 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__3, cast_40, constant_34, constant_38, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_6 = paddle._C_ops.embedding(set_value_with_tensor__4, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_21 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_41 = paddle._C_ops.slice(shape_21, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_22 = paddle._C_ops.shape(paddle.cast(embedding_6, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_13 = paddle._C_ops.full_with_tensor(full_1, stack_13, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_14 = paddle._C_ops.full_with_tensor(full_1, stack_14, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_39 = paddle._C_ops.transpose(embedding_6, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_41 = paddle._C_ops.cast(transpose_39, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_42 = paddle._C_ops.cast(full_with_tensor_13, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_43 = paddle._C_ops.cast(full_with_tensor_14, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_69 = [cast_42, cast_43]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__24, rnn__25, rnn__26, rnn__27 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_41, combine_69, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_44 = paddle._C_ops.cast(rnn__24, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_40 = paddle._C_ops.transpose(cast_44, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_23 = paddle._C_ops.shape(paddle.cast(scale__7, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_43 = paddle._C_ops.slice(shape_23, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_45 = paddle._C_ops.cast(scale__7, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_72 = [slice_43, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__30, reshape__31 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_45, combine_72), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_14 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_21 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_6 = full_14 < memcpy_h2d_21

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_15 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi32, -1x40x6x40xf32, xf32, -1x40x6x40xf16, xi64) <- (xb, xi64, xi32, -1x40x6x40xf32, xf32, -1x40x6x40xf16, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10518 = 0
        while less_than_6:
            less_than_6, full_14, assign_value_19, reshape__30, assign_value_18, full_15, assign_value_20, = self.pd_op_while_10518_0_0(full_0, arange_0, cast_6, constant_39, parameter_206, constant_40, constant_41, parameter_207, parameter_208, cast_8, less_than_6, full_14, assign_value_19, reshape__30, assign_value_18, full_15, assign_value_20)
            while_loop_counter_10518 += 1
            if while_loop_counter_10518 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_46 = paddle._C_ops.cast(argmax_5, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__5 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__4, cast_46, constant_38, constant_42, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_7 = paddle._C_ops.embedding(set_value_with_tensor__5, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_24 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_48 = paddle._C_ops.slice(shape_24, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_25 = paddle._C_ops.shape(paddle.cast(embedding_7, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_15 = paddle._C_ops.full_with_tensor(full_1, stack_15, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_16 = paddle._C_ops.full_with_tensor(full_1, stack_16, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_45 = paddle._C_ops.transpose(embedding_7, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_47 = paddle._C_ops.cast(transpose_45, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_48 = paddle._C_ops.cast(full_with_tensor_15, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_49 = paddle._C_ops.cast(full_with_tensor_16, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_79 = [cast_48, cast_49]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__28, rnn__29, rnn__30, rnn__31 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_47, combine_79, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_50 = paddle._C_ops.cast(rnn__28, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_46 = paddle._C_ops.transpose(cast_50, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_26 = paddle._C_ops.shape(paddle.cast(scale__8, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_50 = paddle._C_ops.slice(shape_26, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_51 = paddle._C_ops.cast(scale__8, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_82 = [slice_50, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__34, reshape__35 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_51, combine_82), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_16 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_24 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_7 = full_16 < memcpy_h2d_24

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_17 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xi64, -1x40x6x40xf32, xi32, xi64, xf32) <- (xb, -1x40x6x40xf16, xi64, -1x40x6x40xf32, xi32, xi64, xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10623 = 0
        while less_than_7:
            less_than_7, full_17, full_16, reshape__34, assign_value_22, assign_value_23, assign_value_21, = self.pd_op_while_10623_0_0(full_0, arange_0, cast_6, constant_43, parameter_209, constant_44, constant_45, parameter_210, parameter_211, cast_8, less_than_7, full_17, full_16, reshape__34, assign_value_22, assign_value_23, assign_value_21)
            while_loop_counter_10623 += 1
            if while_loop_counter_10623 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_52 = paddle._C_ops.cast(argmax_6, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__6 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__5, cast_52, constant_42, constant_46, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_8 = paddle._C_ops.embedding(set_value_with_tensor__6, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_27 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_55 = paddle._C_ops.slice(shape_27, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_28 = paddle._C_ops.shape(paddle.cast(embedding_8, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_17 = paddle._C_ops.full_with_tensor(full_1, stack_17, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_18 = paddle._C_ops.full_with_tensor(full_1, stack_18, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_51 = paddle._C_ops.transpose(embedding_8, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_53 = paddle._C_ops.cast(transpose_51, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_54 = paddle._C_ops.cast(full_with_tensor_17, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_55 = paddle._C_ops.cast(full_with_tensor_18, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_89 = [cast_54, cast_55]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__32, rnn__33, rnn__34, rnn__35 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_53, combine_89, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_56 = paddle._C_ops.cast(rnn__32, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_52 = paddle._C_ops.transpose(cast_56, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_29 = paddle._C_ops.shape(paddle.cast(scale__9, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_57 = paddle._C_ops.slice(shape_29, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_57 = paddle._C_ops.cast(scale__9, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_92 = [slice_57, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__38, reshape__39 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_57, combine_92), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_18 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_27 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_8 = full_18 < memcpy_h2d_27

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_19 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf32, xf32, xi64, -1x40x6x40xf16, xi32, xi64) <- (xb, -1x40x6x40xf32, xf32, xi64, -1x40x6x40xf16, xi32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10728 = 0
        while less_than_8:
            less_than_8, reshape__38, assign_value_24, assign_value_26, full_19, assign_value_25, full_18, = self.pd_op_while_10728_0_0(full_0, arange_0, cast_6, constant_47, parameter_212, constant_48, constant_49, parameter_213, parameter_214, cast_8, less_than_8, reshape__38, assign_value_24, assign_value_26, full_19, assign_value_25, full_18)
            while_loop_counter_10728 += 1
            if while_loop_counter_10728 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_58 = paddle._C_ops.cast(argmax_7, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__7 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__6, cast_58, constant_46, constant_50, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_9 = paddle._C_ops.embedding(set_value_with_tensor__7, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_30 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_62 = paddle._C_ops.slice(shape_30, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_31 = paddle._C_ops.shape(paddle.cast(embedding_9, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_19 = paddle._C_ops.full_with_tensor(full_1, stack_19, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_20 = paddle._C_ops.full_with_tensor(full_1, stack_20, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_57 = paddle._C_ops.transpose(embedding_9, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_59 = paddle._C_ops.cast(transpose_57, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_60 = paddle._C_ops.cast(full_with_tensor_19, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_61 = paddle._C_ops.cast(full_with_tensor_20, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_99 = [cast_60, cast_61]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__36, rnn__37, rnn__38, rnn__39 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_59, combine_99, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_62 = paddle._C_ops.cast(rnn__36, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_58 = paddle._C_ops.transpose(cast_62, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_32 = paddle._C_ops.shape(paddle.cast(scale__10, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_64 = paddle._C_ops.slice(shape_32, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_63 = paddle._C_ops.cast(scale__10, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_102 = [slice_64, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__42, reshape__43 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_63, combine_102), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_20 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_30 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_9 = full_20 < memcpy_h2d_30

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_21 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, xi64, -1x40x6x40xf32, -1x40x6x40xf16, xi64, xf32) <- (xb, xi32, xi64, -1x40x6x40xf32, -1x40x6x40xf16, xi64, xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10833 = 0
        while less_than_9:
            less_than_9, assign_value_28, full_20, reshape__42, full_21, assign_value_29, assign_value_27, = self.pd_op_while_10833_0_0(full_0, arange_0, cast_6, constant_51, parameter_215, constant_52, constant_53, parameter_216, parameter_217, cast_8, less_than_9, assign_value_28, full_20, reshape__42, full_21, assign_value_29, assign_value_27)
            while_loop_counter_10833 += 1
            if while_loop_counter_10833 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_64 = paddle._C_ops.cast(argmax_8, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__8 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__7, cast_64, constant_50, constant_54, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_10 = paddle._C_ops.embedding(set_value_with_tensor__8, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_33 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_69 = paddle._C_ops.slice(shape_33, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_34 = paddle._C_ops.shape(paddle.cast(embedding_10, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_21 = paddle._C_ops.full_with_tensor(full_1, stack_21, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_22 = paddle._C_ops.full_with_tensor(full_1, stack_22, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_63 = paddle._C_ops.transpose(embedding_10, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_65 = paddle._C_ops.cast(transpose_63, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_66 = paddle._C_ops.cast(full_with_tensor_21, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_67 = paddle._C_ops.cast(full_with_tensor_22, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_109 = [cast_66, cast_67]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__40, rnn__41, rnn__42, rnn__43 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_65, combine_109, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_68 = paddle._C_ops.cast(rnn__40, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_64 = paddle._C_ops.transpose(cast_68, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_35 = paddle._C_ops.shape(paddle.cast(scale__11, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_71 = paddle._C_ops.slice(shape_35, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_69 = paddle._C_ops.cast(scale__11, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_112 = [slice_71, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__46, reshape__47 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_69, combine_112), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_22 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_33 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_10 = full_22 < memcpy_h2d_33

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_23 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_10938 = 0
        while less_than_10:
            less_than_10, assign_value_32, full_23, assign_value_30, reshape__46, full_22, assign_value_31, = self.pd_op_while_10938_0_0(full_0, arange_0, cast_6, constant_55, parameter_218, constant_56, constant_57, parameter_219, parameter_220, cast_8, less_than_10, assign_value_32, full_23, assign_value_30, reshape__46, full_22, assign_value_31)
            while_loop_counter_10938 += 1
            if while_loop_counter_10938 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_70 = paddle._C_ops.cast(argmax_9, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__9 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__8, cast_70, constant_54, constant_58, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_11 = paddle._C_ops.embedding(set_value_with_tensor__9, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_36 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_76 = paddle._C_ops.slice(shape_36, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_37 = paddle._C_ops.shape(paddle.cast(embedding_11, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_23 = paddle._C_ops.full_with_tensor(full_1, stack_23, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_24 = paddle._C_ops.full_with_tensor(full_1, stack_24, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_69 = paddle._C_ops.transpose(embedding_11, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_71 = paddle._C_ops.cast(transpose_69, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_72 = paddle._C_ops.cast(full_with_tensor_23, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_73 = paddle._C_ops.cast(full_with_tensor_24, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_119 = [cast_72, cast_73]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__44, rnn__45, rnn__46, rnn__47 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_71, combine_119, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_74 = paddle._C_ops.cast(rnn__44, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_70 = paddle._C_ops.transpose(cast_74, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_38 = paddle._C_ops.shape(paddle.cast(scale__12, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_78 = paddle._C_ops.slice(shape_38, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_75 = paddle._C_ops.cast(scale__12, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_122 = [slice_78, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__50, reshape__51 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_75, combine_122), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_24 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_36 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_11 = full_24 < memcpy_h2d_36

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_25 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, xf32, xi64, -1x40x6x40xf16, xi64, -1x40x6x40xf32) <- (xb, xi32, xf32, xi64, -1x40x6x40xf16, xi64, -1x40x6x40xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11043 = 0
        while less_than_11:
            less_than_11, assign_value_34, assign_value_33, assign_value_35, full_25, full_24, reshape__50, = self.pd_op_while_11043_0_0(full_0, arange_0, cast_6, constant_59, parameter_221, constant_60, constant_61, parameter_222, parameter_223, cast_8, less_than_11, assign_value_34, assign_value_33, assign_value_35, full_25, full_24, reshape__50)
            while_loop_counter_11043 += 1
            if while_loop_counter_11043 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_76 = paddle._C_ops.cast(argmax_10, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__10 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__9, cast_76, constant_58, constant_62, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_12 = paddle._C_ops.embedding(set_value_with_tensor__10, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_39 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_83 = paddle._C_ops.slice(shape_39, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_40 = paddle._C_ops.shape(paddle.cast(embedding_12, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_25 = paddle._C_ops.full_with_tensor(full_1, stack_25, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_26 = paddle._C_ops.full_with_tensor(full_1, stack_26, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_75 = paddle._C_ops.transpose(embedding_12, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_77 = paddle._C_ops.cast(transpose_75, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_78 = paddle._C_ops.cast(full_with_tensor_25, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_79 = paddle._C_ops.cast(full_with_tensor_26, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_129 = [cast_78, cast_79]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__48, rnn__49, rnn__50, rnn__51 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_77, combine_129, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_80 = paddle._C_ops.cast(rnn__48, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_76 = paddle._C_ops.transpose(cast_80, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_41 = paddle._C_ops.shape(paddle.cast(scale__13, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_85 = paddle._C_ops.slice(shape_41, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_81 = paddle._C_ops.cast(scale__13, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_132 = [slice_85, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__54, reshape__55 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_81, combine_132), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_26 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_39 = paddle._C_ops.memcpy_h2d(cast_8, 1)
        ...
        # pd_op.while: (-1x40x6x40xf16, -1x40x6x40xf32, xi32, xf32, xi64, xi64) <- (xb, -1x40x6x40xf16, -1x40x6x40xf32, xi32, xf32, xi64, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11148 = 0
        while less_than_12:
            less_than_12, full_27, reshape__54, assign_value_37, assign_value_36, full_26, assign_value_38, = self.pd_op_while_11148_0_0(full_0, arange_0, cast_6, constant_63, parameter_224, constant_64, constant_65, parameter_225, parameter_226, cast_8, less_than_12, full_27, reshape__54, assign_value_37, assign_value_36, full_26, assign_value_38)
            while_loop_counter_11148 += 1
            if while_loop_counter_11148 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_82 = paddle._C_ops.cast(argmax_11, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__11 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__10, cast_82, constant_62, constant_66, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_13 = paddle._C_ops.embedding(set_value_with_tensor__11, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_42 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_90 = paddle._C_ops.slice(shape_42, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_43 = paddle._C_ops.shape(paddle.cast(embedding_13, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_27 = paddle._C_ops.full_with_tensor(full_1, stack_27, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_28 = paddle._C_ops.full_with_tensor(full_1, stack_28, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_81 = paddle._C_ops.transpose(embedding_13, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_83 = paddle._C_ops.cast(transpose_81, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_84 = paddle._C_ops.cast(full_with_tensor_27, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_85 = paddle._C_ops.cast(full_with_tensor_28, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_139 = [cast_84, cast_85]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__52, rnn__53, rnn__54, rnn__55 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_83, combine_139, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_86 = paddle._C_ops.cast(rnn__52, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_82 = paddle._C_ops.transpose(cast_86, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_44 = paddle._C_ops.shape(paddle.cast(scale__14, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_92 = paddle._C_ops.slice(shape_44, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_87 = paddle._C_ops.cast(scale__14, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_142 = [slice_92, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__58, reshape__59 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_87, combine_142), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_28 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_42 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_13 = full_28 < memcpy_h2d_42

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_29 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi32, -1x40x6x40xf32, -1x40x6x40xf16, xf32, xi64) <- (xb, xi64, xi32, -1x40x6x40xf32, -1x40x6x40xf16, xf32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11253 = 0
        while less_than_13:
            less_than_13, full_28, assign_value_40, reshape__58, full_29, assign_value_39, assign_value_41, = self.pd_op_while_11253_0_0(full_0, arange_0, cast_6, constant_67, parameter_227, constant_68, constant_69, parameter_228, parameter_229, cast_8, less_than_13, full_28, assign_value_40, reshape__58, full_29, assign_value_39, assign_value_41)
            while_loop_counter_11253 += 1
            if while_loop_counter_11253 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_88 = paddle._C_ops.cast(argmax_12, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__12 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__11, cast_88, constant_66, constant_70, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_14 = paddle._C_ops.embedding(set_value_with_tensor__12, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_45 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_97 = paddle._C_ops.slice(shape_45, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_46 = paddle._C_ops.shape(paddle.cast(embedding_14, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_29 = paddle._C_ops.full_with_tensor(full_1, stack_29, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_30 = paddle._C_ops.full_with_tensor(full_1, stack_30, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_87 = paddle._C_ops.transpose(embedding_14, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_89 = paddle._C_ops.cast(transpose_87, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_90 = paddle._C_ops.cast(full_with_tensor_29, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_91 = paddle._C_ops.cast(full_with_tensor_30, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_149 = [cast_90, cast_91]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__56, rnn__57, rnn__58, rnn__59 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_89, combine_149, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_92 = paddle._C_ops.cast(rnn__56, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_88 = paddle._C_ops.transpose(cast_92, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_47 = paddle._C_ops.shape(paddle.cast(scale__15, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_99 = paddle._C_ops.slice(shape_47, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_93 = paddle._C_ops.cast(scale__15, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_152 = [slice_99, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__62, reshape__63 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_93, combine_152), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_30 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_45 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_14 = full_30 < memcpy_h2d_45

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_31 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, -1x40x6x40xf16, -1x40x6x40xf32, xf32, xi64, xi64) <- (xb, xi32, -1x40x6x40xf16, -1x40x6x40xf32, xf32, xi64, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11358 = 0
        while less_than_14:
            less_than_14, assign_value_43, full_31, reshape__62, assign_value_42, full_30, assign_value_44, = self.pd_op_while_11358_0_0(full_0, arange_0, cast_6, constant_71, parameter_230, constant_72, constant_73, parameter_231, parameter_232, cast_8, less_than_14, assign_value_43, full_31, reshape__62, assign_value_42, full_30, assign_value_44)
            while_loop_counter_11358 += 1
            if while_loop_counter_11358 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_94 = paddle._C_ops.cast(argmax_13, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__13 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__12, cast_94, constant_70, constant_74, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_15 = paddle._C_ops.embedding(set_value_with_tensor__13, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_48 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_104 = paddle._C_ops.slice(shape_48, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_49 = paddle._C_ops.shape(paddle.cast(embedding_15, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_31 = paddle._C_ops.full_with_tensor(full_1, stack_31, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_32 = paddle._C_ops.full_with_tensor(full_1, stack_32, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_93 = paddle._C_ops.transpose(embedding_15, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_95 = paddle._C_ops.cast(transpose_93, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_96 = paddle._C_ops.cast(full_with_tensor_31, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_97 = paddle._C_ops.cast(full_with_tensor_32, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_159 = [cast_96, cast_97]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__60, rnn__61, rnn__62, rnn__63 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_95, combine_159, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_98 = paddle._C_ops.cast(rnn__60, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_94 = paddle._C_ops.transpose(cast_98, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_50 = paddle._C_ops.shape(paddle.cast(scale__16, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_106 = paddle._C_ops.slice(shape_50, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_99 = paddle._C_ops.cast(scale__16, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_162 = [slice_106, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__66, reshape__67 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_99, combine_162), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_32 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_48 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_15 = full_32 < memcpy_h2d_48

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_33 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, -1x40x6x40xf16, xf32, xi32, -1x40x6x40xf32, xi64) <- (xb, xi64, -1x40x6x40xf16, xf32, xi32, -1x40x6x40xf32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11463 = 0
        while less_than_15:
            less_than_15, assign_value_47, full_33, assign_value_45, assign_value_46, reshape__66, full_32, = self.pd_op_while_11463_0_0(full_0, arange_0, cast_6, constant_75, parameter_233, constant_76, constant_77, parameter_234, parameter_235, cast_8, less_than_15, assign_value_47, full_33, assign_value_45, assign_value_46, reshape__66, full_32)
            while_loop_counter_11463 += 1
            if while_loop_counter_11463 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_100 = paddle._C_ops.cast(argmax_14, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__14 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__13, cast_100, constant_74, constant_78, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_16 = paddle._C_ops.embedding(set_value_with_tensor__14, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_51 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_111 = paddle._C_ops.slice(shape_51, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_52 = paddle._C_ops.shape(paddle.cast(embedding_16, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_33 = paddle._C_ops.full_with_tensor(full_1, stack_33, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_34 = paddle._C_ops.full_with_tensor(full_1, stack_34, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_99 = paddle._C_ops.transpose(embedding_16, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_101 = paddle._C_ops.cast(transpose_99, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_102 = paddle._C_ops.cast(full_with_tensor_33, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_103 = paddle._C_ops.cast(full_with_tensor_34, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_169 = [cast_102, cast_103]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__64, rnn__65, rnn__66, rnn__67 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_101, combine_169, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_104 = paddle._C_ops.cast(rnn__64, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_100 = paddle._C_ops.transpose(cast_104, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_53 = paddle._C_ops.shape(paddle.cast(scale__17, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_113 = paddle._C_ops.slice(shape_53, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_105 = paddle._C_ops.cast(scale__17, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_172 = [slice_113, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__70, reshape__71 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_105, combine_172), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_34 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_51 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_16 = full_34 < memcpy_h2d_51

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_35 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xf32, xi64, -1x40x6x40xf16, xi64, xi32, -1x40x6x40xf32) <- (xb, xf32, xi64, -1x40x6x40xf16, xi64, xi32, -1x40x6x40xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11568 = 0
        while less_than_16:
            less_than_16, assign_value_48, full_34, full_35, assign_value_50, assign_value_49, reshape__70, = self.pd_op_while_11568_0_0(full_0, arange_0, cast_6, constant_79, parameter_236, constant_80, constant_81, parameter_237, parameter_238, cast_8, less_than_16, assign_value_48, full_34, full_35, assign_value_50, assign_value_49, reshape__70)
            while_loop_counter_11568 += 1
            if while_loop_counter_11568 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_106 = paddle._C_ops.cast(argmax_15, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__15 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__14, cast_106, constant_78, constant_82, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_17 = paddle._C_ops.embedding(set_value_with_tensor__15, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_54 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_118 = paddle._C_ops.slice(shape_54, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_55 = paddle._C_ops.shape(paddle.cast(embedding_17, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_35 = paddle._C_ops.full_with_tensor(full_1, stack_35, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_36 = paddle._C_ops.full_with_tensor(full_1, stack_36, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_105 = paddle._C_ops.transpose(embedding_17, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_107 = paddle._C_ops.cast(transpose_105, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_108 = paddle._C_ops.cast(full_with_tensor_35, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_109 = paddle._C_ops.cast(full_with_tensor_36, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_179 = [cast_108, cast_109]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__68, rnn__69, rnn__70, rnn__71 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_107, combine_179, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_110 = paddle._C_ops.cast(rnn__68, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_106 = paddle._C_ops.transpose(cast_110, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_56 = paddle._C_ops.shape(paddle.cast(scale__18, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_120 = paddle._C_ops.slice(shape_56, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_111 = paddle._C_ops.cast(scale__18, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_182 = [slice_120, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__74, reshape__75 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_111, combine_182), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_36 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_54 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_17 = full_36 < memcpy_h2d_54

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_37 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11673 = 0
        while less_than_17:
            less_than_17, assign_value_53, full_37, assign_value_51, assign_value_52, reshape__74, full_36, = self.pd_op_while_11673_0_0(full_0, arange_0, cast_6, constant_83, parameter_239, constant_84, constant_85, parameter_240, parameter_241, cast_8, less_than_17, assign_value_53, full_37, assign_value_51, assign_value_52, reshape__74, full_36)
            while_loop_counter_11673 += 1
            if while_loop_counter_11673 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_112 = paddle._C_ops.cast(argmax_16, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__16 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__15, cast_112, constant_82, constant_86, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_18 = paddle._C_ops.embedding(set_value_with_tensor__16, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_57 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_125 = paddle._C_ops.slice(shape_57, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_58 = paddle._C_ops.shape(paddle.cast(embedding_18, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_37 = paddle._C_ops.full_with_tensor(full_1, stack_37, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_38 = paddle._C_ops.full_with_tensor(full_1, stack_38, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_111 = paddle._C_ops.transpose(embedding_18, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_113 = paddle._C_ops.cast(transpose_111, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_114 = paddle._C_ops.cast(full_with_tensor_37, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_115 = paddle._C_ops.cast(full_with_tensor_38, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_189 = [cast_114, cast_115]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__72, rnn__73, rnn__74, rnn__75 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_113, combine_189, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_116 = paddle._C_ops.cast(rnn__72, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_112 = paddle._C_ops.transpose(cast_116, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_59 = paddle._C_ops.shape(paddle.cast(scale__19, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_127 = paddle._C_ops.slice(shape_59, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_117 = paddle._C_ops.cast(scale__19, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_192 = [slice_127, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__78, reshape__79 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_117, combine_192), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_38 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_57 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_18 = full_38 < memcpy_h2d_57

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_39 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, xi64, -1x40x6x40xf16, -1x40x6x40xf32, xi64, xf32) <- (xb, xi32, xi64, -1x40x6x40xf16, -1x40x6x40xf32, xi64, xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11778 = 0
        while less_than_18:
            less_than_18, assign_value_55, full_38, full_39, reshape__78, assign_value_56, assign_value_54, = self.pd_op_while_11778_0_0(full_0, arange_0, cast_6, constant_87, parameter_242, constant_88, constant_89, parameter_243, parameter_244, cast_8, less_than_18, assign_value_55, full_38, full_39, reshape__78, assign_value_56, assign_value_54)
            while_loop_counter_11778 += 1
            if while_loop_counter_11778 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_118 = paddle._C_ops.cast(argmax_17, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__17 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__16, cast_118, constant_86, constant_90, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_19 = paddle._C_ops.embedding(set_value_with_tensor__17, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_60 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_132 = paddle._C_ops.slice(shape_60, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_61 = paddle._C_ops.shape(paddle.cast(embedding_19, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_39 = paddle._C_ops.full_with_tensor(full_1, stack_39, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_40 = paddle._C_ops.full_with_tensor(full_1, stack_40, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_117 = paddle._C_ops.transpose(embedding_19, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_119 = paddle._C_ops.cast(transpose_117, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_120 = paddle._C_ops.cast(full_with_tensor_39, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_121 = paddle._C_ops.cast(full_with_tensor_40, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_199 = [cast_120, cast_121]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__76, rnn__77, rnn__78, rnn__79 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_119, combine_199, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_122 = paddle._C_ops.cast(rnn__76, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_118 = paddle._C_ops.transpose(cast_122, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_62 = paddle._C_ops.shape(paddle.cast(scale__20, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_134 = paddle._C_ops.slice(shape_62, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_123 = paddle._C_ops.cast(scale__20, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_202 = [slice_134, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__82, reshape__83 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_123, combine_202), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_40 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_60 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_19 = full_40 < memcpy_h2d_60

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_41 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf32, -1x40x6x40xf16, xi64, xi64, xf32, xi32) <- (xb, -1x40x6x40xf32, -1x40x6x40xf16, xi64, xi64, xf32, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11883 = 0
        while less_than_19:
            less_than_19, reshape__82, full_41, full_40, assign_value_59, assign_value_57, assign_value_58, = self.pd_op_while_11883_0_0(full_0, arange_0, cast_6, constant_91, parameter_245, constant_92, constant_93, parameter_246, parameter_247, cast_8, less_than_19, reshape__82, full_41, full_40, assign_value_59, assign_value_57, assign_value_58)
            while_loop_counter_11883 += 1
            if while_loop_counter_11883 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_124 = paddle._C_ops.cast(argmax_18, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__18 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__17, cast_124, constant_90, constant_94, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_20 = paddle._C_ops.embedding(set_value_with_tensor__18, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_63 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_139 = paddle._C_ops.slice(shape_63, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_64 = paddle._C_ops.shape(paddle.cast(embedding_20, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_41 = paddle._C_ops.full_with_tensor(full_1, stack_41, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_42 = paddle._C_ops.full_with_tensor(full_1, stack_42, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_123 = paddle._C_ops.transpose(embedding_20, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_125 = paddle._C_ops.cast(transpose_123, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_126 = paddle._C_ops.cast(full_with_tensor_41, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_127 = paddle._C_ops.cast(full_with_tensor_42, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_209 = [cast_126, cast_127]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__80, rnn__81, rnn__82, rnn__83 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_125, combine_209, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_128 = paddle._C_ops.cast(rnn__80, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_124 = paddle._C_ops.transpose(cast_128, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_65 = paddle._C_ops.shape(paddle.cast(scale__21, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_141 = paddle._C_ops.slice(shape_65, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_129 = paddle._C_ops.cast(scale__21, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_212 = [slice_141, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__86, reshape__87 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_129, combine_212), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_42 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_63 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_20 = full_42 < memcpy_h2d_63

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_43 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, xi64, xf32, -1x40x6x40xf32, xi64, -1x40x6x40xf16) <- (xb, xi32, xi64, xf32, -1x40x6x40xf32, xi64, -1x40x6x40xf16)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_11988 = 0
        while less_than_20:
            less_than_20, assign_value_61, assign_value_62, assign_value_60, reshape__86, full_42, full_43, = self.pd_op_while_11988_0_0(full_0, arange_0, cast_6, constant_95, parameter_248, constant_96, constant_97, parameter_249, parameter_250, cast_8, less_than_20, assign_value_61, assign_value_62, assign_value_60, reshape__86, full_42, full_43)
            while_loop_counter_11988 += 1
            if while_loop_counter_11988 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_130 = paddle._C_ops.cast(argmax_19, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__19 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__18, cast_130, constant_94, constant_98, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_21 = paddle._C_ops.embedding(set_value_with_tensor__19, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_66 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_146 = paddle._C_ops.slice(shape_66, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_67 = paddle._C_ops.shape(paddle.cast(embedding_21, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_43 = paddle._C_ops.full_with_tensor(full_1, stack_43, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_44 = paddle._C_ops.full_with_tensor(full_1, stack_44, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_129 = paddle._C_ops.transpose(embedding_21, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_131 = paddle._C_ops.cast(transpose_129, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_132 = paddle._C_ops.cast(full_with_tensor_43, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_133 = paddle._C_ops.cast(full_with_tensor_44, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_219 = [cast_132, cast_133]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__84, rnn__85, rnn__86, rnn__87 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_131, combine_219, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_134 = paddle._C_ops.cast(rnn__84, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_130 = paddle._C_ops.transpose(cast_134, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_68 = paddle._C_ops.shape(paddle.cast(scale__22, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_148 = paddle._C_ops.slice(shape_68, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_135 = paddle._C_ops.cast(scale__22, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_222 = [slice_148, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__90, reshape__91 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_135, combine_222), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_44 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_66 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_21 = full_44 < memcpy_h2d_66

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_45 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi32, -1x40x6x40xf16, -1x40x6x40xf32, xi64, xf32) <- (xb, xi64, xi32, -1x40x6x40xf16, -1x40x6x40xf32, xi64, xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12093 = 0
        while less_than_21:
            less_than_21, full_44, assign_value_64, full_45, reshape__90, assign_value_65, assign_value_63, = self.pd_op_while_12093_0_0(full_0, arange_0, cast_6, constant_99, parameter_251, constant_100, constant_101, parameter_252, parameter_253, cast_8, less_than_21, full_44, assign_value_64, full_45, reshape__90, assign_value_65, assign_value_63)
            while_loop_counter_12093 += 1
            if while_loop_counter_12093 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_136 = paddle._C_ops.cast(argmax_20, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__20 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__19, cast_136, constant_98, constant_102, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_22 = paddle._C_ops.embedding(set_value_with_tensor__20, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_69 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_153 = paddle._C_ops.slice(shape_69, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_70 = paddle._C_ops.shape(paddle.cast(embedding_22, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_45 = paddle._C_ops.full_with_tensor(full_1, stack_45, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_46 = paddle._C_ops.full_with_tensor(full_1, stack_46, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_135 = paddle._C_ops.transpose(embedding_22, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_137 = paddle._C_ops.cast(transpose_135, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_138 = paddle._C_ops.cast(full_with_tensor_45, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_139 = paddle._C_ops.cast(full_with_tensor_46, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_229 = [cast_138, cast_139]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__88, rnn__89, rnn__90, rnn__91 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_137, combine_229, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_140 = paddle._C_ops.cast(rnn__88, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_136 = paddle._C_ops.transpose(cast_140, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_71 = paddle._C_ops.shape(paddle.cast(scale__23, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_155 = paddle._C_ops.slice(shape_71, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_141 = paddle._C_ops.cast(scale__23, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_232 = [slice_155, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__94, reshape__95 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_141, combine_232), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_46 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_69 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_22 = full_46 < memcpy_h2d_69

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_47 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12198 = 0
        while less_than_22:
            less_than_22, assign_value_68, assign_value_67, reshape__94, full_47, assign_value_66, full_46, = self.pd_op_while_12198_0_0(full_0, arange_0, cast_6, constant_103, parameter_254, constant_104, constant_105, parameter_255, parameter_256, cast_8, less_than_22, assign_value_68, assign_value_67, reshape__94, full_47, assign_value_66, full_46)
            while_loop_counter_12198 += 1
            if while_loop_counter_12198 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_142 = paddle._C_ops.cast(argmax_21, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__21 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__20, cast_142, constant_102, constant_106, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_23 = paddle._C_ops.embedding(set_value_with_tensor__21, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_72 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_160 = paddle._C_ops.slice(shape_72, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_73 = paddle._C_ops.shape(paddle.cast(embedding_23, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_47 = paddle._C_ops.full_with_tensor(full_1, stack_47, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_48 = paddle._C_ops.full_with_tensor(full_1, stack_48, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_141 = paddle._C_ops.transpose(embedding_23, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_143 = paddle._C_ops.cast(transpose_141, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_144 = paddle._C_ops.cast(full_with_tensor_47, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_145 = paddle._C_ops.cast(full_with_tensor_48, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_239 = [cast_144, cast_145]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__92, rnn__93, rnn__94, rnn__95 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_143, combine_239, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_146 = paddle._C_ops.cast(rnn__92, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_142 = paddle._C_ops.transpose(cast_146, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_74 = paddle._C_ops.shape(paddle.cast(scale__24, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_162 = paddle._C_ops.slice(shape_74, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_147 = paddle._C_ops.cast(scale__24, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_242 = [slice_162, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__98, reshape__99 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_147, combine_242), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_48 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_72 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_23 = full_48 < memcpy_h2d_72

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_49 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi32, -1x40x6x40xf32, xf32, xi64, -1x40x6x40xf16) <- (xb, xi64, xi32, -1x40x6x40xf32, xf32, xi64, -1x40x6x40xf16)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12303 = 0
        while less_than_23:
            less_than_23, full_48, assign_value_70, reshape__98, assign_value_69, assign_value_71, full_49, = self.pd_op_while_12303_0_0(full_0, arange_0, cast_6, constant_107, parameter_257, constant_108, constant_109, parameter_258, parameter_259, cast_8, less_than_23, full_48, assign_value_70, reshape__98, assign_value_69, assign_value_71, full_49)
            while_loop_counter_12303 += 1
            if while_loop_counter_12303 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_148 = paddle._C_ops.cast(argmax_22, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__22 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__21, cast_148, constant_106, constant_110, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_24 = paddle._C_ops.embedding(set_value_with_tensor__22, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_75 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_167 = paddle._C_ops.slice(shape_75, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_76 = paddle._C_ops.shape(paddle.cast(embedding_24, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_49 = paddle._C_ops.full_with_tensor(full_1, stack_49, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_50 = paddle._C_ops.full_with_tensor(full_1, stack_50, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_147 = paddle._C_ops.transpose(embedding_24, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_149 = paddle._C_ops.cast(transpose_147, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_150 = paddle._C_ops.cast(full_with_tensor_49, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_151 = paddle._C_ops.cast(full_with_tensor_50, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_249 = [cast_150, cast_151]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__96, rnn__97, rnn__98, rnn__99 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_149, combine_249, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_152 = paddle._C_ops.cast(rnn__96, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_148 = paddle._C_ops.transpose(cast_152, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_77 = paddle._C_ops.shape(paddle.cast(scale__25, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_169 = paddle._C_ops.slice(shape_77, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_153 = paddle._C_ops.cast(scale__25, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_252 = [slice_169, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__102, reshape__103 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_153, combine_252), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_50 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_75 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_24 = full_50 < memcpy_h2d_75

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_51 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xf32, -1x40x6x40xf32, xi32, xi64, xi64) <- (xb, -1x40x6x40xf16, xf32, -1x40x6x40xf32, xi32, xi64, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12408 = 0
        while less_than_24:
            less_than_24, full_51, assign_value_72, reshape__102, assign_value_73, assign_value_74, full_50, = self.pd_op_while_12408_0_0(full_0, arange_0, cast_6, constant_111, parameter_260, constant_112, constant_113, parameter_261, parameter_262, cast_8, less_than_24, full_51, assign_value_72, reshape__102, assign_value_73, assign_value_74, full_50)
            while_loop_counter_12408 += 1
            if while_loop_counter_12408 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_154 = paddle._C_ops.cast(argmax_23, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__23 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__22, cast_154, constant_110, constant_114, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_25 = paddle._C_ops.embedding(set_value_with_tensor__23, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_78 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_174 = paddle._C_ops.slice(shape_78, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_79 = paddle._C_ops.shape(paddle.cast(embedding_25, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_51 = paddle._C_ops.full_with_tensor(full_1, stack_51, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_52 = paddle._C_ops.full_with_tensor(full_1, stack_52, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_153 = paddle._C_ops.transpose(embedding_25, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_155 = paddle._C_ops.cast(transpose_153, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_156 = paddle._C_ops.cast(full_with_tensor_51, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_157 = paddle._C_ops.cast(full_with_tensor_52, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_259 = [cast_156, cast_157]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__100, rnn__101, rnn__102, rnn__103 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_155, combine_259, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_158 = paddle._C_ops.cast(rnn__100, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_154 = paddle._C_ops.transpose(cast_158, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_80 = paddle._C_ops.shape(paddle.cast(scale__26, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_176 = paddle._C_ops.slice(shape_80, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_159 = paddle._C_ops.cast(scale__26, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_262 = [slice_176, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__106, reshape__107 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_159, combine_262), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_52 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_78 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_25 = full_52 < memcpy_h2d_78

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_53 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xi64, -1x40x6x40xf32, xf32, xi32, xi64) <- (xb, -1x40x6x40xf16, xi64, -1x40x6x40xf32, xf32, xi32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12513 = 0
        while less_than_25:
            less_than_25, full_53, assign_value_77, reshape__106, assign_value_75, assign_value_76, full_52, = self.pd_op_while_12513_0_0(full_0, arange_0, cast_6, constant_115, parameter_263, constant_116, constant_117, parameter_264, parameter_265, cast_8, less_than_25, full_53, assign_value_77, reshape__106, assign_value_75, assign_value_76, full_52)
            while_loop_counter_12513 += 1
            if while_loop_counter_12513 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_160 = paddle._C_ops.cast(argmax_24, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__24 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__23, cast_160, constant_114, constant_118, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_26 = paddle._C_ops.embedding(set_value_with_tensor__24, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_81 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_181 = paddle._C_ops.slice(shape_81, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_82 = paddle._C_ops.shape(paddle.cast(embedding_26, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_53 = paddle._C_ops.full_with_tensor(full_1, stack_53, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_54 = paddle._C_ops.full_with_tensor(full_1, stack_54, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_159 = paddle._C_ops.transpose(embedding_26, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_161 = paddle._C_ops.cast(transpose_159, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_162 = paddle._C_ops.cast(full_with_tensor_53, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_163 = paddle._C_ops.cast(full_with_tensor_54, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_269 = [cast_162, cast_163]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__104, rnn__105, rnn__106, rnn__107 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_161, combine_269, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_164 = paddle._C_ops.cast(rnn__104, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_160 = paddle._C_ops.transpose(cast_164, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_83 = paddle._C_ops.shape(paddle.cast(scale__27, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_183 = paddle._C_ops.slice(shape_83, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_165 = paddle._C_ops.cast(scale__27, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_272 = [slice_183, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__110, reshape__111 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_165, combine_272), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_54 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_81 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_26 = full_54 < memcpy_h2d_81

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_55 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12618 = 0
        while less_than_26:
            less_than_26, full_54, assign_value_79, assign_value_78, reshape__110, full_55, assign_value_80, = self.pd_op_while_12618_0_0(full_0, arange_0, cast_6, constant_119, parameter_266, constant_120, constant_121, parameter_267, parameter_268, cast_8, less_than_26, full_54, assign_value_79, assign_value_78, reshape__110, full_55, assign_value_80)
            while_loop_counter_12618 += 1
            if while_loop_counter_12618 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_166 = paddle._C_ops.cast(argmax_25, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__25 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__24, cast_166, constant_118, constant_122, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_27 = paddle._C_ops.embedding(set_value_with_tensor__25, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_84 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_188 = paddle._C_ops.slice(shape_84, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_85 = paddle._C_ops.shape(paddle.cast(embedding_27, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_55 = paddle._C_ops.full_with_tensor(full_1, stack_55, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_56 = paddle._C_ops.full_with_tensor(full_1, stack_56, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_165 = paddle._C_ops.transpose(embedding_27, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_167 = paddle._C_ops.cast(transpose_165, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_168 = paddle._C_ops.cast(full_with_tensor_55, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_169 = paddle._C_ops.cast(full_with_tensor_56, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_279 = [cast_168, cast_169]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__108, rnn__109, rnn__110, rnn__111 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_167, combine_279, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_170 = paddle._C_ops.cast(rnn__108, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_166 = paddle._C_ops.transpose(cast_170, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_86 = paddle._C_ops.shape(paddle.cast(scale__28, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_190 = paddle._C_ops.slice(shape_86, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_171 = paddle._C_ops.cast(scale__28, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_282 = [slice_190, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__114, reshape__115 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_171, combine_282), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_56 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_84 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_27 = full_56 < memcpy_h2d_84

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_57 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xi64, -1x40x6x40xf32, xi64, xf32, xi32) <- (xb, -1x40x6x40xf16, xi64, -1x40x6x40xf32, xi64, xf32, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12723 = 0
        while less_than_27:
            less_than_27, full_57, full_56, reshape__114, assign_value_83, assign_value_81, assign_value_82, = self.pd_op_while_12723_0_0(full_0, arange_0, cast_6, constant_123, parameter_269, constant_124, constant_125, parameter_270, parameter_271, cast_8, less_than_27, full_57, full_56, reshape__114, assign_value_83, assign_value_81, assign_value_82)
            while_loop_counter_12723 += 1
            if while_loop_counter_12723 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_172 = paddle._C_ops.cast(argmax_26, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__26 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__25, cast_172, constant_122, constant_126, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_28 = paddle._C_ops.embedding(set_value_with_tensor__26, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_87 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_195 = paddle._C_ops.slice(shape_87, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_88 = paddle._C_ops.shape(paddle.cast(embedding_28, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_57 = paddle._C_ops.full_with_tensor(full_1, stack_57, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_58 = paddle._C_ops.full_with_tensor(full_1, stack_58, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_171 = paddle._C_ops.transpose(embedding_28, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_173 = paddle._C_ops.cast(transpose_171, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_174 = paddle._C_ops.cast(full_with_tensor_57, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_175 = paddle._C_ops.cast(full_with_tensor_58, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_289 = [cast_174, cast_175]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__112, rnn__113, rnn__114, rnn__115 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_173, combine_289, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_176 = paddle._C_ops.cast(rnn__112, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_172 = paddle._C_ops.transpose(cast_176, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_89 = paddle._C_ops.shape(paddle.cast(scale__29, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_197 = paddle._C_ops.slice(shape_89, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_177 = paddle._C_ops.cast(scale__29, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_292 = [slice_197, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__118, reshape__119 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_177, combine_292), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_58 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_87 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_28 = full_58 < memcpy_h2d_87

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_59 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, -1x40x6x40xf32, xf32, xi32, xi64, -1x40x6x40xf16) <- (xb, xi64, -1x40x6x40xf32, xf32, xi32, xi64, -1x40x6x40xf16)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12828 = 0
        while less_than_28:
            less_than_28, assign_value_86, reshape__118, assign_value_84, assign_value_85, full_58, full_59, = self.pd_op_while_12828_0_0(full_0, arange_0, cast_6, constant_127, parameter_272, constant_128, constant_129, parameter_273, parameter_274, cast_8, less_than_28, assign_value_86, reshape__118, assign_value_84, assign_value_85, full_58, full_59)
            while_loop_counter_12828 += 1
            if while_loop_counter_12828 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_178 = paddle._C_ops.cast(argmax_27, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__27 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__26, cast_178, constant_126, constant_130, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_29 = paddle._C_ops.embedding(set_value_with_tensor__27, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_90 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_202 = paddle._C_ops.slice(shape_90, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_91 = paddle._C_ops.shape(paddle.cast(embedding_29, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_59 = paddle._C_ops.full_with_tensor(full_1, stack_59, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_60 = paddle._C_ops.full_with_tensor(full_1, stack_60, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_177 = paddle._C_ops.transpose(embedding_29, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_179 = paddle._C_ops.cast(transpose_177, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_180 = paddle._C_ops.cast(full_with_tensor_59, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_181 = paddle._C_ops.cast(full_with_tensor_60, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_299 = [cast_180, cast_181]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__116, rnn__117, rnn__118, rnn__119 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_179, combine_299, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_182 = paddle._C_ops.cast(rnn__116, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_178 = paddle._C_ops.transpose(cast_182, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_92 = paddle._C_ops.shape(paddle.cast(scale__30, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_204 = paddle._C_ops.slice(shape_92, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_183 = paddle._C_ops.cast(scale__30, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_302 = [slice_204, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__122, reshape__123 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_183, combine_302), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_60 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_90 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_29 = full_60 < memcpy_h2d_90

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_61 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xf32, xi64, -1x40x6x40xf16, xi32, -1x40x6x40xf32, xi64) <- (xb, xf32, xi64, -1x40x6x40xf16, xi32, -1x40x6x40xf32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_12933 = 0
        while less_than_29:
            less_than_29, assign_value_87, assign_value_89, full_61, assign_value_88, reshape__122, full_60, = self.pd_op_while_12933_0_0(full_0, arange_0, cast_6, constant_131, parameter_275, constant_132, constant_133, parameter_276, parameter_277, cast_8, less_than_29, assign_value_87, assign_value_89, full_61, assign_value_88, reshape__122, full_60)
            while_loop_counter_12933 += 1
            if while_loop_counter_12933 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_184 = paddle._C_ops.cast(argmax_28, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__28 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__27, cast_184, constant_130, constant_134, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_30 = paddle._C_ops.embedding(set_value_with_tensor__28, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_93 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_209 = paddle._C_ops.slice(shape_93, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_94 = paddle._C_ops.shape(paddle.cast(embedding_30, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_61 = paddle._C_ops.full_with_tensor(full_1, stack_61, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_62 = paddle._C_ops.full_with_tensor(full_1, stack_62, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_183 = paddle._C_ops.transpose(embedding_30, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_185 = paddle._C_ops.cast(transpose_183, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_186 = paddle._C_ops.cast(full_with_tensor_61, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_187 = paddle._C_ops.cast(full_with_tensor_62, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_309 = [cast_186, cast_187]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__120, rnn__121, rnn__122, rnn__123 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_185, combine_309, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_188 = paddle._C_ops.cast(rnn__120, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_184 = paddle._C_ops.transpose(cast_188, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_95 = paddle._C_ops.shape(paddle.cast(scale__31, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_211 = paddle._C_ops.slice(shape_95, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_189 = paddle._C_ops.cast(scale__31, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_312 = [slice_211, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__126, reshape__127 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_189, combine_312), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_62 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_93 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_30 = full_62 < memcpy_h2d_93

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_63 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, -1x40x6x40xf16, xi64, xi64, xf32, -1x40x6x40xf32) <- (xb, xi32, -1x40x6x40xf16, xi64, xi64, xf32, -1x40x6x40xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13038 = 0
        while less_than_30:
            less_than_30, assign_value_91, full_63, assign_value_92, full_62, assign_value_90, reshape__126, = self.pd_op_while_13038_0_0(full_0, arange_0, cast_6, constant_135, parameter_278, constant_136, constant_137, parameter_279, parameter_280, cast_8, less_than_30, assign_value_91, full_63, assign_value_92, full_62, assign_value_90, reshape__126)
            while_loop_counter_13038 += 1
            if while_loop_counter_13038 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_190 = paddle._C_ops.cast(argmax_29, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__29 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__28, cast_190, constant_134, constant_138, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_31 = paddle._C_ops.embedding(set_value_with_tensor__29, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_96 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_216 = paddle._C_ops.slice(shape_96, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_97 = paddle._C_ops.shape(paddle.cast(embedding_31, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_63 = paddle._C_ops.full_with_tensor(full_1, stack_63, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_64 = paddle._C_ops.full_with_tensor(full_1, stack_64, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_189 = paddle._C_ops.transpose(embedding_31, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_191 = paddle._C_ops.cast(transpose_189, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_192 = paddle._C_ops.cast(full_with_tensor_63, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_193 = paddle._C_ops.cast(full_with_tensor_64, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_319 = [cast_192, cast_193]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__124, rnn__125, rnn__126, rnn__127 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_191, combine_319, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_194 = paddle._C_ops.cast(rnn__124, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_190 = paddle._C_ops.transpose(cast_194, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_98 = paddle._C_ops.shape(paddle.cast(scale__32, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_218 = paddle._C_ops.slice(shape_98, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_195 = paddle._C_ops.cast(scale__32, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_322 = [slice_218, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__130, reshape__131 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_195, combine_322), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_64 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_96 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_31 = full_64 < memcpy_h2d_96

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_65 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, -1x40x6x40xf16, xi64, -1x40x6x40xf32, xf32, xi64) <- (xb, xi32, -1x40x6x40xf16, xi64, -1x40x6x40xf32, xf32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13143 = 0
        while less_than_31:
            less_than_31, assign_value_94, full_65, assign_value_95, reshape__130, assign_value_93, full_64, = self.pd_op_while_13143_0_0(full_0, arange_0, cast_6, constant_139, parameter_281, constant_140, constant_141, parameter_282, parameter_283, cast_8, less_than_31, assign_value_94, full_65, assign_value_95, reshape__130, assign_value_93, full_64)
            while_loop_counter_13143 += 1
            if while_loop_counter_13143 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_196 = paddle._C_ops.cast(argmax_30, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__30 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__29, cast_196, constant_138, constant_142, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_32 = paddle._C_ops.embedding(set_value_with_tensor__30, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_99 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_223 = paddle._C_ops.slice(shape_99, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_100 = paddle._C_ops.shape(paddle.cast(embedding_32, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_65 = paddle._C_ops.full_with_tensor(full_1, stack_65, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_66 = paddle._C_ops.full_with_tensor(full_1, stack_66, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_195 = paddle._C_ops.transpose(embedding_32, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_197 = paddle._C_ops.cast(transpose_195, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_198 = paddle._C_ops.cast(full_with_tensor_65, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_199 = paddle._C_ops.cast(full_with_tensor_66, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_329 = [cast_198, cast_199]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__128, rnn__129, rnn__130, rnn__131 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_197, combine_329, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_200 = paddle._C_ops.cast(rnn__128, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_196 = paddle._C_ops.transpose(cast_200, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_101 = paddle._C_ops.shape(paddle.cast(scale__33, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_225 = paddle._C_ops.slice(shape_101, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_201 = paddle._C_ops.cast(scale__33, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_332 = [slice_225, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__134, reshape__135 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_201, combine_332), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_66 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_99 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_32 = full_66 < memcpy_h2d_99

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_67 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf32, xi64, xf32, xi64, -1x40x6x40xf16, xi32) <- (xb, -1x40x6x40xf32, xi64, xf32, xi64, -1x40x6x40xf16, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13248 = 0
        while less_than_32:
            less_than_32, reshape__134, full_66, assign_value_96, assign_value_98, full_67, assign_value_97, = self.pd_op_while_13248_0_0(full_0, arange_0, cast_6, constant_143, parameter_284, constant_144, constant_145, parameter_285, parameter_286, cast_8, less_than_32, reshape__134, full_66, assign_value_96, assign_value_98, full_67, assign_value_97)
            while_loop_counter_13248 += 1
            if while_loop_counter_13248 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_202 = paddle._C_ops.cast(argmax_31, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__31 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__30, cast_202, constant_142, constant_146, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_33 = paddle._C_ops.embedding(set_value_with_tensor__31, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_102 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_230 = paddle._C_ops.slice(shape_102, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_103 = paddle._C_ops.shape(paddle.cast(embedding_33, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_67 = paddle._C_ops.full_with_tensor(full_1, stack_67, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_68 = paddle._C_ops.full_with_tensor(full_1, stack_68, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_201 = paddle._C_ops.transpose(embedding_33, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_203 = paddle._C_ops.cast(transpose_201, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_204 = paddle._C_ops.cast(full_with_tensor_67, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_205 = paddle._C_ops.cast(full_with_tensor_68, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_339 = [cast_204, cast_205]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__132, rnn__133, rnn__134, rnn__135 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_203, combine_339, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_206 = paddle._C_ops.cast(rnn__132, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_202 = paddle._C_ops.transpose(cast_206, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_104 = paddle._C_ops.shape(paddle.cast(scale__34, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_232 = paddle._C_ops.slice(shape_104, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_207 = paddle._C_ops.cast(scale__34, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_342 = [slice_232, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__138, reshape__139 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_207, combine_342), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_68 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_102 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_33 = full_68 < memcpy_h2d_102

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_69 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi64, -1x40x6x40xf32, -1x40x6x40xf16, xf32, xi32) <- (xb, xi64, xi64, -1x40x6x40xf32, -1x40x6x40xf16, xf32, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13353 = 0
        while less_than_33:
            less_than_33, assign_value_101, full_68, reshape__138, full_69, assign_value_99, assign_value_100, = self.pd_op_while_13353_0_0(full_0, arange_0, cast_6, constant_147, parameter_287, constant_148, constant_149, parameter_288, parameter_289, cast_8, less_than_33, assign_value_101, full_68, reshape__138, full_69, assign_value_99, assign_value_100)
            while_loop_counter_13353 += 1
            if while_loop_counter_13353 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_208 = paddle._C_ops.cast(argmax_32, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__32 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__31, cast_208, constant_146, constant_150, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_34 = paddle._C_ops.embedding(set_value_with_tensor__32, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_105 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_237 = paddle._C_ops.slice(shape_105, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_106 = paddle._C_ops.shape(paddle.cast(embedding_34, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_69 = paddle._C_ops.full_with_tensor(full_1, stack_69, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_70 = paddle._C_ops.full_with_tensor(full_1, stack_70, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_207 = paddle._C_ops.transpose(embedding_34, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_209 = paddle._C_ops.cast(transpose_207, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_210 = paddle._C_ops.cast(full_with_tensor_69, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_211 = paddle._C_ops.cast(full_with_tensor_70, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_349 = [cast_210, cast_211]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__136, rnn__137, rnn__138, rnn__139 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_209, combine_349, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_212 = paddle._C_ops.cast(rnn__136, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_208 = paddle._C_ops.transpose(cast_212, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_107 = paddle._C_ops.shape(paddle.cast(scale__35, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_239 = paddle._C_ops.slice(shape_107, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_213 = paddle._C_ops.cast(scale__35, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_352 = [slice_239, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__142, reshape__143 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_213, combine_352), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_70 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_105 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_34 = full_70 < memcpy_h2d_105

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_71 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xf32, -1x40x6x40xf32, -1x40x6x40xf16, xi64, xi32) <- (xb, xi64, xf32, -1x40x6x40xf32, -1x40x6x40xf16, xi64, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13458 = 0
        while less_than_34:
            less_than_34, assign_value_104, assign_value_102, reshape__142, full_71, full_70, assign_value_103, = self.pd_op_while_13458_0_0(full_0, arange_0, cast_6, constant_151, parameter_290, constant_152, constant_153, parameter_291, parameter_292, cast_8, less_than_34, assign_value_104, assign_value_102, reshape__142, full_71, full_70, assign_value_103)
            while_loop_counter_13458 += 1
            if while_loop_counter_13458 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_214 = paddle._C_ops.cast(argmax_33, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__33 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__32, cast_214, constant_150, constant_154, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_35 = paddle._C_ops.embedding(set_value_with_tensor__33, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_108 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_244 = paddle._C_ops.slice(shape_108, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_109 = paddle._C_ops.shape(paddle.cast(embedding_35, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_71 = paddle._C_ops.full_with_tensor(full_1, stack_71, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_72 = paddle._C_ops.full_with_tensor(full_1, stack_72, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_213 = paddle._C_ops.transpose(embedding_35, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_215 = paddle._C_ops.cast(transpose_213, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_216 = paddle._C_ops.cast(full_with_tensor_71, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_217 = paddle._C_ops.cast(full_with_tensor_72, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_359 = [cast_216, cast_217]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__140, rnn__141, rnn__142, rnn__143 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_215, combine_359, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_218 = paddle._C_ops.cast(rnn__140, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_214 = paddle._C_ops.transpose(cast_218, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_110 = paddle._C_ops.shape(paddle.cast(scale__36, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_246 = paddle._C_ops.slice(shape_110, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_219 = paddle._C_ops.cast(scale__36, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_362 = [slice_246, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__146, reshape__147 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_219, combine_362), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_72 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_108 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_35 = full_72 < memcpy_h2d_108

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_73 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf16, xf32, xi64, -1x40x6x40xf32, xi32, xi64) <- (xb, -1x40x6x40xf16, xf32, xi64, -1x40x6x40xf32, xi32, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13563 = 0
        while less_than_35:
            less_than_35, full_73, assign_value_105, assign_value_107, reshape__146, assign_value_106, full_72, = self.pd_op_while_13563_0_0(full_0, arange_0, cast_6, constant_155, parameter_293, constant_156, constant_157, parameter_294, parameter_295, cast_8, less_than_35, full_73, assign_value_105, assign_value_107, reshape__146, assign_value_106, full_72)
            while_loop_counter_13563 += 1
            if while_loop_counter_13563 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_220 = paddle._C_ops.cast(argmax_34, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__34 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__33, cast_220, constant_154, constant_158, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_36 = paddle._C_ops.embedding(set_value_with_tensor__34, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_111 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_251 = paddle._C_ops.slice(shape_111, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_112 = paddle._C_ops.shape(paddle.cast(embedding_36, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_73 = paddle._C_ops.full_with_tensor(full_1, stack_73, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_74 = paddle._C_ops.full_with_tensor(full_1, stack_74, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_219 = paddle._C_ops.transpose(embedding_36, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_221 = paddle._C_ops.cast(transpose_219, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_222 = paddle._C_ops.cast(full_with_tensor_73, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_223 = paddle._C_ops.cast(full_with_tensor_74, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_369 = [cast_222, cast_223]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__144, rnn__145, rnn__146, rnn__147 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_221, combine_369, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_224 = paddle._C_ops.cast(rnn__144, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_220 = paddle._C_ops.transpose(cast_224, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_113 = paddle._C_ops.shape(paddle.cast(scale__37, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_253 = paddle._C_ops.slice(shape_113, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_225 = paddle._C_ops.cast(scale__37, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_372 = [slice_253, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__150, reshape__151 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_225, combine_372), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_74 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_111 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_36 = full_74 < memcpy_h2d_111

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_75 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (-1x40x6x40xf32, xf32, xi64, xi64, -1x40x6x40xf16, xi32) <- (xb, -1x40x6x40xf32, xf32, xi64, xi64, -1x40x6x40xf16, xi32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13668 = 0
        while less_than_36:
            less_than_36, reshape__150, assign_value_108, full_74, assign_value_110, full_75, assign_value_109, = self.pd_op_while_13668_0_0(full_0, arange_0, cast_6, constant_159, parameter_296, constant_160, constant_161, parameter_297, parameter_298, cast_8, less_than_36, reshape__150, assign_value_108, full_74, assign_value_110, full_75, assign_value_109)
            while_loop_counter_13668 += 1
            if while_loop_counter_13668 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_226 = paddle._C_ops.cast(argmax_35, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__35 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__34, cast_226, constant_158, constant_162, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_37 = paddle._C_ops.embedding(set_value_with_tensor__35, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_114 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_258 = paddle._C_ops.slice(shape_114, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_115 = paddle._C_ops.shape(paddle.cast(embedding_37, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_75 = paddle._C_ops.full_with_tensor(full_1, stack_75, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_76 = paddle._C_ops.full_with_tensor(full_1, stack_76, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_225 = paddle._C_ops.transpose(embedding_37, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_227 = paddle._C_ops.cast(transpose_225, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_228 = paddle._C_ops.cast(full_with_tensor_75, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_229 = paddle._C_ops.cast(full_with_tensor_76, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_379 = [cast_228, cast_229]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__148, rnn__149, rnn__150, rnn__151 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_227, combine_379, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_230 = paddle._C_ops.cast(rnn__148, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_226 = paddle._C_ops.transpose(cast_230, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_116 = paddle._C_ops.shape(paddle.cast(scale__38, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_260 = paddle._C_ops.slice(shape_116, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_231 = paddle._C_ops.cast(scale__38, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_382 = [slice_260, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__154, reshape__155 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_231, combine_382), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_76 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_114 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_37 = full_76 < memcpy_h2d_114

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_77 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, xi64, -1x40x6x40xf16, xf32, xi64, -1x40x6x40xf32) <- (xb, xi32, xi64, -1x40x6x40xf16, xf32, xi64, -1x40x6x40xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13773 = 0
        while less_than_37:
            less_than_37, assign_value_112, full_76, full_77, assign_value_111, assign_value_113, reshape__154, = self.pd_op_while_13773_0_0(full_0, arange_0, cast_6, constant_163, parameter_299, constant_164, constant_165, parameter_300, parameter_301, cast_8, less_than_37, assign_value_112, full_76, full_77, assign_value_111, assign_value_113, reshape__154)
            while_loop_counter_13773 += 1
            if while_loop_counter_13773 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_232 = paddle._C_ops.cast(argmax_36, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__36 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__35, cast_232, constant_162, constant_166, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_38 = paddle._C_ops.embedding(set_value_with_tensor__36, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_117 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_265 = paddle._C_ops.slice(shape_117, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_118 = paddle._C_ops.shape(paddle.cast(embedding_38, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_77 = paddle._C_ops.full_with_tensor(full_1, stack_77, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_78 = paddle._C_ops.full_with_tensor(full_1, stack_78, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_231 = paddle._C_ops.transpose(embedding_38, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_233 = paddle._C_ops.cast(transpose_231, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_234 = paddle._C_ops.cast(full_with_tensor_77, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_235 = paddle._C_ops.cast(full_with_tensor_78, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_389 = [cast_234, cast_235]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__152, rnn__153, rnn__154, rnn__155 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_233, combine_389, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_236 = paddle._C_ops.cast(rnn__152, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_232 = paddle._C_ops.transpose(cast_236, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_119 = paddle._C_ops.shape(paddle.cast(scale__39, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_267 = paddle._C_ops.slice(shape_119, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_237 = paddle._C_ops.cast(scale__39, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_392 = [slice_267, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__158, reshape__159 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_237, combine_392), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_78 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_117 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_38 = full_78 < memcpy_h2d_117

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_79 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, -1x40x6x40xf32, xi64, -1x40x6x40xf16, xi32, xf32) <- (xb, xi64, -1x40x6x40xf32, xi64, -1x40x6x40xf16, xi32, xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13878 = 0
        while less_than_38:
            less_than_38, full_78, reshape__158, assign_value_116, full_79, assign_value_115, assign_value_114, = self.pd_op_while_13878_0_0(full_0, arange_0, cast_6, constant_167, parameter_302, constant_168, constant_169, parameter_303, parameter_304, cast_8, less_than_38, full_78, reshape__158, assign_value_116, full_79, assign_value_115, assign_value_114)
            while_loop_counter_13878 += 1
            if while_loop_counter_13878 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_238 = paddle._C_ops.cast(argmax_37, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__37 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__36, cast_238, constant_166, constant_170, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_39 = paddle._C_ops.embedding(set_value_with_tensor__37, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_120 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_272 = paddle._C_ops.slice(shape_120, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_121 = paddle._C_ops.shape(paddle.cast(embedding_39, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_79 = paddle._C_ops.full_with_tensor(full_1, stack_79, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_80 = paddle._C_ops.full_with_tensor(full_1, stack_80, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_237 = paddle._C_ops.transpose(embedding_39, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_239 = paddle._C_ops.cast(transpose_237, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_240 = paddle._C_ops.cast(full_with_tensor_79, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_241 = paddle._C_ops.cast(full_with_tensor_80, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_399 = [cast_240, cast_241]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__156, rnn__157, rnn__158, rnn__159 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_239, combine_399, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_242 = paddle._C_ops.cast(rnn__156, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_238 = paddle._C_ops.transpose(cast_242, [1, 0, 2])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_122 = paddle._C_ops.shape(paddle.cast(scale__40, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_274 = paddle._C_ops.slice(shape_122, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_243 = paddle._C_ops.cast(scale__40, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_402 = [slice_274, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__162, reshape__163 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_243, combine_402), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_80 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_120 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_39 = full_80 < memcpy_h2d_120

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_81 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi32, xi64, xf32, -1x40x6x40xf32, -1x40x6x40xf16, xi64) <- (xb, xi32, xi64, xf32, -1x40x6x40xf32, -1x40x6x40xf16, xi64)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_13983 = 0
        while less_than_39:
            less_than_39, assign_value_118, assign_value_119, assign_value_117, reshape__162, full_81, full_80, = self.pd_op_while_13983_0_0(full_0, arange_0, cast_6, constant_171, parameter_305, constant_172, constant_173, parameter_306, parameter_307, cast_8, less_than_39, assign_value_118, assign_value_119, assign_value_117, reshape__162, full_81, full_80)
            while_loop_counter_13983 += 1
            if while_loop_counter_13983 > kWhileLoopLimit:
                break
        ...
        # pd_op.cast: (-1xi64) <- (-1xi64)
        cast_244 = paddle._C_ops.cast(argmax_38, paddle.int64)

        # pd_op.set_value_with_tensor_: (-1x40xi64) <- (-1x40xi64, -1xi64, 1xi64, 1xi64, 1xi64)
        set_value_with_tensor__38 = paddle._C_ops.set_value_with_tensor_(set_value_with_tensor__37, cast_244, constant_170, constant_174, constant_3, [1], [1], [])

        # pd_op.embedding: (-1x40x128xf16) <- (-1x40xi64, 93x128xf16)
        embedding_40 = paddle._C_ops.embedding(set_value_with_tensor__38, parameter_178, 92, False)

        # pd_op.shape: (4xi32) <- (-1x128x6x40xf16)
        shape_123 = paddle._C_ops.shape(paddle.cast(add__17, 'float32'))

        # pd_op.slice: (xi32) <- (4xi32, 1xi64, 1xi64)
        slice_279 = paddle._C_ops.slice(shape_123, [0], constant_2, constant_3, [1], [0])

        # pd_op.shape: (3xi32) <- (-1x40x128xf16)
        shape_124 = paddle._C_ops.shape(paddle.cast(embedding_40, 'float32'))
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_81 = paddle._C_ops.full_with_tensor(full_1, stack_81, paddle.float16)
        ...
        # pd_op.full_with_tensor: (2x-1x128xf16) <- (1xf32, 3xi32)
        full_with_tensor_82 = paddle._C_ops.full_with_tensor(full_1, stack_82, paddle.float16)

        # pd_op.transpose: (40x-1x128xf16) <- (-1x40x128xf16)
        transpose_243 = paddle._C_ops.transpose(embedding_40, [1, 0, 2])

        # pd_op.cast: (40x-1x128xf32) <- (40x-1x128xf16)
        cast_245 = paddle._C_ops.cast(transpose_243, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_246 = paddle._C_ops.cast(full_with_tensor_81, paddle.float32)

        # pd_op.cast: (2x-1x128xf32) <- (2x-1x128xf16)
        cast_247 = paddle._C_ops.cast(full_with_tensor_82, paddle.float32)

        # builtin.combine: ([2x-1x128xf32, 2x-1x128xf32]) <- (2x-1x128xf32, 2x-1x128xf32)
        combine_409 = [cast_246, cast_247]

        # pd_op.rnn_: (40x-1x128xf32, xui8, [2x-1x128xf32, 2x-1x128xf32], xui8) <- (40x-1x128xf32, [2x-1x128xf32, 2x-1x128xf32], [512x128xf32, 512x128xf32, 512x128xf32, 512x128xf32, 512xf32, 512xf32, 512xf32, 512xf32], None, xui8)
        rnn__160, rnn__161, rnn__162, rnn__163 = (lambda x, f: f(x))(paddle._C_ops.rnn(cast_245, combine_409, combine_19, None, parameter_169, float('0'), False, 128, 128, 2, 'LSTM', 0, True), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None,None)) + (None,)

        # pd_op.cast: (40x-1x128xf16) <- (40x-1x128xf32)
        cast_248 = paddle._C_ops.cast(rnn__160, paddle.float16)

        # pd_op.transpose: (-1x40x128xf16) <- (40x-1x128xf16)
        transpose_244 = paddle._C_ops.transpose(cast_248, [1, 0, 2])
        ...
        # pd_op.reshape_: (-1x512x240xf16, 0x-1x512x6x40xf16) <- (-1x512x6x40xf16, [xi32, 1xi32, 1xi32])
        ...
        # pd_op.shape: (3xi32) <- (-1x40x240xf16)
        shape_125 = paddle._C_ops.shape(paddle.cast(scale__41, 'float32'))

        # pd_op.slice: (xi32) <- (3xi32, 1xi64, 1xi64)
        slice_281 = paddle._C_ops.slice(shape_125, [0], constant_2, constant_3, [1], [0])

        # pd_op.cast: (-1x40x240xf32) <- (-1x40x240xf16)
        cast_249 = paddle._C_ops.cast(scale__41, paddle.float32)

        # builtin.combine: ([xi32, 1xi32, 1xi32, 1xi32]) <- (xi32, 1xi32, 1xi32, 1xi32)
        combine_412 = [slice_281, constant_6, constant_8, constant_6]

        # pd_op.reshape_: (-1x40x6x40xf32, 0x-1x40x240xf32) <- (-1x40x240xf32, [xi32, 1xi32, 1xi32, 1xi32])
        reshape__170, reshape__171 = (lambda x, f: f(x))(paddle._C_ops.reshape_(cast_249, combine_412), lambda out: out if isinstance(out, (list, tuple)) else (out, None))

        # pd_op.full: (xi64) <- ()
        full_82 = paddle._C_ops.full([], float('0'), paddle.int64, paddle.framework._current_expected_place())

        # pd_op.memcpy_h2d: (xi64) <- (xi64)
        memcpy_h2d_123 = paddle._C_ops.memcpy_h2d(cast_8, 1)

        # pd_op.less_than: (xb) <- (xi64, xi64)
        less_than_40 = full_82 < memcpy_h2d_123

        # pd_op.full: (-1x40x6x40xf16) <- ()
        full_83 = paddle._C_ops.full([], float('0'), paddle.float16, paddle.framework._current_expected_place())
        ...
        # pd_op.while: (xi64, xi32, xi64, -1x40x6x40xf16, xf32, -1x40x6x40xf32) <- (xb, xi64, xi32, xi64, -1x40x6x40xf16, xf32, -1x40x6x40xf32)
        import os
        ATHENA_WHILE_LOOP_LIMIT = os.getenv('ATHENA_WHILE_LOOP_LIMIT')
        kWhileLoopLimit = (128 if ATHENA_WHILE_LOOP_LIMIT is not None else int(ATHENA_WHILE_LOOP_LIMIT))
        while_loop_counter_14088 = 0
        while less_than_40:
            less_than_40, full_82, assign_value_121, assign_value_122, full_83, assign_value_120, reshape__170, = self.pd_op_while_14088_0_0(full_0, arange_0, cast_6, constant_175, parameter_308, constant_176, constant_177, parameter_309, parameter_310, cast_8, less_than_40, full_82, assign_value_121, assign_value_122, full_83, assign_value_120, reshape__170)
            while_loop_counter_14088 += 1
            if while_loop_counter_14088 > kWhileLoopLimit:
                break
        ...
        # builtin.combine: ([-1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16]) <- (-1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16)
        ...
        # pd_op.stack: (-1x40x92xf16) <- ([-1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16, -1x92xf16])
        stack_83 = paddle._C_ops.stack(combine_415, 1)

        # pd_op.scale_: (-1x40x92xf16) <- (-1x40x92xf16, 1xf32)
        scale__42 = paddle._C_ops.scale_(stack_83, full_0, float('0'), True)

        # pd_op.cast: (-1x40x92xf32) <- (-1x40x92xf16)
        cast_250 = paddle._C_ops.cast(scale__42, paddle.float32)
        return cast_250
...
class ModuleOp(paddle.nn.Layer, BlockEntries):
    ...
    def forward(self, parameter_310, parameter_309, constant_177, constant_176, parameter_308, constant_175, parameter_307, parameter_306, constant_173, constant_172, parameter_305, constant_171, parameter_304, parameter_303, constant_169, constant_168, parameter_302, constant_167, parameter_301, parameter_300, constant_165, constant_164, parameter_299, constant_163, parameter_298, parameter_297, constant_161, constant_160, parameter_296, constant_159, parameter_295, parameter_294, constant_157, constant_156, parameter_293, constant_155, parameter_292, parameter_291, constant_153, constant_152, parameter_290, constant_151, parameter_289, parameter_288, constant_149, constant_148, parameter_287, constant_147, parameter_286, parameter_285, constant_145, constant_144, parameter_284, constant_143, parameter_283, parameter_282, constant_141, constant_140, parameter_281, constant_139, parameter_280, parameter_279, constant_137, constant_136, parameter_278, constant_135, parameter_277, parameter_276, constant_133, constant_132, parameter_275, constant_131, parameter_274, parameter_273, constant_129, constant_128, parameter_272, constant_127, parameter_271, parameter_270, constant_125, constant_124, parameter_269, constant_123, parameter_268, parameter_267, constant_121, constant_120, parameter_266, constant_119, parameter_265, parameter_264, constant_117, constant_116, parameter_263, constant_115, parameter_262, parameter_261, constant_113, constant_112, parameter_260, constant_111, parameter_259, parameter_258, constant_109, constant_108, parameter_257, constant_107, parameter_256, parameter_255, constant_105, constant_104, parameter_254, constant_103, parameter_253, parameter_252, constant_101, constant_100, parameter_251, constant_99, parameter_250, parameter_249, constant_97, constant_96, parameter_248, constant_95, parameter_247, parameter_246, constant_93, constant_92, parameter_245, constant_91, parameter_244, parameter_243, constant_89, constant_88, parameter_242, constant_87, parameter_241, parameter_240, constant_85, constant_84, parameter_239, constant_83, parameter_238, parameter_237, constant_81, constant_80, parameter_236, constant_79, parameter_235, parameter_234, constant_77, constant_76, parameter_233, constant_75, parameter_232, parameter_231, constant_73, constant_72, parameter_230, constant_71, parameter_229, parameter_228, constant_69, constant_68, parameter_227, constant_67, parameter_226, parameter_225, constant_65, constant_64, parameter_224, constant_63, parameter_223, parameter_222, constant_61, constant_60, parameter_221, constant_59, parameter_220, parameter_219, constant_57, constant_56, parameter_218, constant_55, parameter_217, parameter_216, constant_53, constant_52, parameter_215, constant_51, parameter_214, parameter_213, constant_49, constant_48, parameter_212, constant_47, parameter_211, parameter_210, constant_45, constant_44, parameter_209, constant_43, parameter_208, parameter_207, constant_41, constant_40, parameter_206, constant_39, parameter_205, parameter_204, constant_37, constant_36, parameter_203, constant_35, parameter_202, parameter_201, constant_33, constant_32, parameter_200, constant_31, parameter_199, parameter_198, constant_29, constant_28, parameter_197, constant_27, parameter_196, parameter_195, constant_25, constant_24, parameter_194, constant_23, parameter_189, parameter_188, constant_18, constant_17, parameter_187, constant_16, parameter_177, parameter_176, constant_15, constant_14, parameter_175, constant_13, constant_174, constant_170, constant_166, constant_162, constant_158, constant_154, constant_150, constant_146, constant_142, constant_138, constant_134, constant_130, constant_126, constant_122, constant_118, constant_114, constant_110, constant_106, constant_102, constant_98, constant_94, constant_90, constant_86, constant_82, constant_78, constant_74, constant_70, constant_66, constant_62, constant_58, constant_54, constant_50, constant_46, constant_42, constant_38, constant_34, constant_30, constant_26, constant_22, constant_21, constant_20, constant_19, constant_12, constant_11, constant_10, constant_9, parameter_173, parameter_171, constant_8, parameter_169, parameter_160, parameter_159, constant_7, constant_6, constant_5, constant_4, parameter_158, constant_3, constant_2, parameter_157, parameter_151, parameter_115, constant_1, parameter_54, parameter_28, constant_0, parameter_7, parameter_1, parameter_0, parameter_5, parameter_2, parameter_4, parameter_3, parameter_6, parameter_11, parameter_8, parameter_10, parameter_9, parameter_12, parameter_16, parameter_13, parameter_15, parameter_14, parameter_17, parameter_21, parameter_18, parameter_20, parameter_19, parameter_22, parameter_26, parameter_23, parameter_25, parameter_24, parameter_27, parameter_32, parameter_29, parameter_31, parameter_30, parameter_33, parameter_37, parameter_34, parameter_36, parameter_35, parameter_38, parameter_42, parameter_39, parameter_41, parameter_40, parameter_43, parameter_47, parameter_44, parameter_46, parameter_45, parameter_48, parameter_52, parameter_49, parameter_51, parameter_50, parameter_53, parameter_58, parameter_55, parameter_57, parameter_56, parameter_59, parameter_63, parameter_60, parameter_62, parameter_61, parameter_64, parameter_68, parameter_65, parameter_67, parameter_66, parameter_69, parameter_73, parameter_70, parameter_72, parameter_71, parameter_74, parameter_78, parameter_75, parameter_77, parameter_76, parameter_79, parameter_83, parameter_80, parameter_82, parameter_81, parameter_84, parameter_88, parameter_85, parameter_87, parameter_86, parameter_89, parameter_93, parameter_90, parameter_92, parameter_91, parameter_94, parameter_98, parameter_95, parameter_97, parameter_96, parameter_99, parameter_103, parameter_100, parameter_102, parameter_101, parameter_104, parameter_108, parameter_105, parameter_107, parameter_106, parameter_109, parameter_113, parameter_110, parameter_112, parameter_111, parameter_114, parameter_119, parameter_116, parameter_118, parameter_117, parameter_120, parameter_124, parameter_121, parameter_123, parameter_122, parameter_125, parameter_129, parameter_126, parameter_128, parameter_127, parameter_130, parameter_134, parameter_131, parameter_133, parameter_132, parameter_135, parameter_139, parameter_136, parameter_138, parameter_137, parameter_140, parameter_144, parameter_141, parameter_143, parameter_142, parameter_145, parameter_149, parameter_146, parameter_148, parameter_147, parameter_150, parameter_155, parameter_152, parameter_154, parameter_153, parameter_156, parameter_161, parameter_162, parameter_163, parameter_164, parameter_165, parameter_166, parameter_167, parameter_168, parameter_170, parameter_172, parameter_174, parameter_178, parameter_179, parameter_180, parameter_181, parameter_182, parameter_183, parameter_184, parameter_185, parameter_186, parameter_190, parameter_191, parameter_192, parameter_193, feed_1, feed_2, feed_0):
        return self.builtin_module_9221_0_0(parameter_310, parameter_309, constant_177, constant_176, parameter_308, constant_175, parameter_307, parameter_306, constant_173, constant_172, parameter_305, constant_171, parameter_304, parameter_303, constant_169, constant_168, parameter_302, constant_167, parameter_301, parameter_300, constant_165, constant_164, parameter_299, constant_163, parameter_298, parameter_297, constant_161, constant_160, parameter_296, constant_159, parameter_295, parameter_294, constant_157, constant_156, parameter_293, constant_155, parameter_292, parameter_291, constant_153, constant_152, parameter_290, constant_151, parameter_289, parameter_288, constant_149, constant_148, parameter_287, constant_147, parameter_286, parameter_285, constant_145, constant_144, parameter_284, constant_143, parameter_283, parameter_282, constant_141, constant_140, parameter_281, constant_139, parameter_280, parameter_279, constant_137, constant_136, parameter_278, constant_135, parameter_277, parameter_276, constant_133, constant_132, parameter_275, constant_131, parameter_274, parameter_273, constant_129, constant_128, parameter_272, constant_127, parameter_271, parameter_270, constant_125, constant_124, parameter_269, constant_123, parameter_268, parameter_267, constant_121, constant_120, parameter_266, constant_119, parameter_265, parameter_264, constant_117, constant_116, parameter_263, constant_115, parameter_262, parameter_261, constant_113, constant_112, parameter_260, constant_111, parameter_259, parameter_258, constant_109, constant_108, parameter_257, constant_107, parameter_256, parameter_255, constant_105, constant_104, parameter_254, constant_103, parameter_253, parameter_252, constant_101, constant_100, parameter_251, constant_99, parameter_250, parameter_249, constant_97, constant_96, parameter_248, constant_95, parameter_247, parameter_246, constant_93, constant_92, parameter_245, constant_91, parameter_244, parameter_243, constant_89, constant_88, parameter_242, constant_87, parameter_241, parameter_240, constant_85, constant_84, parameter_239, constant_83, parameter_238, parameter_237, constant_81, constant_80, parameter_236, constant_79, parameter_235, parameter_234, constant_77, constant_76, parameter_233, constant_75, parameter_232, parameter_231, constant_73, constant_72, parameter_230, constant_71, parameter_229, parameter_228, constant_69, constant_68, parameter_227, constant_67, parameter_226, parameter_225, constant_65, constant_64, parameter_224, constant_63, parameter_223, parameter_222, constant_61, constant_60, parameter_221, constant_59, parameter_220, parameter_219, constant_57, constant_56, parameter_218, constant_55, parameter_217, parameter_216, constant_53, constant_52, parameter_215, constant_51, parameter_214, parameter_213, constant_49, constant_48, parameter_212, constant_47, parameter_211, parameter_210, constant_45, constant_44, parameter_209, constant_43, parameter_208, parameter_207, constant_41, constant_40, parameter_206, constant_39, parameter_205, parameter_204, constant_37, constant_36, parameter_203, constant_35, parameter_202, parameter_201, constant_33, constant_32, parameter_200, constant_31, parameter_199, parameter_198, constant_29, constant_28, parameter_197, constant_27, parameter_196, parameter_195, constant_25, constant_24, parameter_194, constant_23, parameter_189, parameter_188, constant_18, constant_17, parameter_187, constant_16, parameter_177, parameter_176, constant_15, constant_14, parameter_175, constant_13, constant_174, constant_170, constant_166, constant_162, constant_158, constant_154, constant_150, constant_146, constant_142, constant_138, constant_134, constant_130, constant_126, constant_122, constant_118, constant_114, constant_110, constant_106, constant_102, constant_98, constant_94, constant_90, constant_86, constant_82, constant_78, constant_74, constant_70, constant_66, constant_62, constant_58, constant_54, constant_50, constant_46, constant_42, constant_38, constant_34, constant_30, constant_26, constant_22, constant_21, constant_20, constant_19, constant_12, constant_11, constant_10, constant_9, parameter_173, parameter_171, constant_8, parameter_169, parameter_160, parameter_159, constant_7, constant_6, constant_5, constant_4, parameter_158, constant_3, constant_2, parameter_157, parameter_151, parameter_115, constant_1, parameter_54, parameter_28, constant_0, parameter_7, parameter_1, parameter_0, parameter_5, parameter_2, parameter_4, parameter_3, parameter_6, parameter_11, parameter_8, parameter_10, parameter_9, parameter_12, parameter_16, parameter_13, parameter_15, parameter_14, parameter_17, parameter_21, parameter_18, parameter_20, parameter_19, parameter_22, parameter_26, parameter_23, parameter_25, parameter_24, parameter_27, parameter_32, parameter_29, parameter_31, parameter_30, parameter_33, parameter_37, parameter_34, parameter_36, parameter_35, parameter_38, parameter_42, parameter_39, parameter_41, parameter_40, parameter_43, parameter_47, parameter_44, parameter_46, parameter_45, parameter_48, parameter_52, parameter_49, parameter_51, parameter_50, parameter_53, parameter_58, parameter_55, parameter_57, parameter_56, parameter_59, parameter_63, parameter_60, parameter_62, parameter_61, parameter_64, parameter_68, parameter_65, parameter_67, parameter_66, parameter_69, parameter_73, parameter_70, parameter_72, parameter_71, parameter_74, parameter_78, parameter_75, parameter_77, parameter_76, parameter_79, parameter_83, parameter_80, parameter_82, parameter_81, parameter_84, parameter_88, parameter_85, parameter_87, parameter_86, parameter_89, parameter_93, parameter_90, parameter_92, parameter_91, parameter_94, parameter_98, parameter_95, parameter_97, parameter_96, parameter_99, parameter_103, parameter_100, parameter_102, parameter_101, parameter_104, parameter_108, parameter_105, parameter_107, parameter_106, parameter_109, parameter_113, parameter_110, parameter_112, parameter_111, parameter_114, parameter_119, parameter_116, parameter_118, parameter_117, parameter_120, parameter_124, parameter_121, parameter_123, parameter_122, parameter_125, parameter_129, parameter_126, parameter_128, parameter_127, parameter_130, parameter_134, parameter_131, parameter_133, parameter_132, parameter_135, parameter_139, parameter_136, parameter_138, parameter_137, parameter_140, parameter_144, parameter_141, parameter_143, parameter_142, parameter_145, parameter_149, parameter_146, parameter_148, parameter_147, parameter_150, parameter_155, parameter_152, parameter_154, parameter_153, parameter_156, parameter_161, parameter_162, parameter_163, parameter_164, parameter_165, parameter_166, parameter_167, parameter_168, parameter_170, parameter_172, parameter_174, parameter_178, parameter_179, parameter_180, parameter_181, parameter_182, parameter_183, parameter_184, parameter_185, parameter_186, parameter_190, parameter_191, parameter_192, parameter_193, feed_1, feed_2, feed_0)

@unittest.skipIf(need_skip, skip_message)
class Test_builtin_module_9221_0_0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.uniform([128, 128, 3, 3], dtype='float16', min=0, max=0.5),
            # parameter_174
            paddle.uniform([41, 128], dtype='float16', min=0, max=0.5),
            # parameter_178
            paddle.uniform([93, 128], dtype='float16', min=0, max=0.5),
            # parameter_179
            paddle.uniform([512, 128], dtype='float32', min=0, max=0.5),
            # parameter_180
            paddle.uniform([512, 128], dtype='float32', min=0, max=0.5),
