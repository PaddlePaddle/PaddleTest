...
class TestPrimitiveOp_2af2f55a6de5aede56c46c1a25630974(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_2c1909a3d2ad5316ea4cb8933c301609
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.30422443151474, 0.47660335898399353, 0.43539610505104065, 0.3719736933708191]]], dtype='float32').reshape([1, 1, 4]),
...
class TestPrimitiveOp_0299a76adb3f9f7e8aa15e95a7ff1589(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_901a01de81e498de45e5ad9630ca2e30
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.057881567627191544, 0.3979288637638092, 0.2679443955421448, 0.18576695024967194]]], dtype='float32').reshape([1, 1, 4]),
