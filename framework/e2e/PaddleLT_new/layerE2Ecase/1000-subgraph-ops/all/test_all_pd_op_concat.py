...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_d51562bafe955dd65466b448c92988de(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_8b5119acf06cbcee968b91525f140d0b
    def get_inputs(self):
        return [
            paddle.to_tensor([-0.43840399384498596, -0.327839732170105, -0.17912480235099792, -0.391951322555542, -0.46931910514831543, -0.4606434106826782], dtype='float32').reshape([6]),
            paddle.to_tensor([-0.040604084730148315, -0.43480491638183594, -0.25308480858802795, -0.24314609169960022, -0.1706901490688324, -0.15729832649230957], dtype='float32').reshape([6]),
            paddle.to_tensor([0.9870685338973999, 0.8617116212844849, 0.8354732990264893, 0.7684470415115356, 0.7881392240524292, 0.6752476692199707], dtype='float32').reshape([6]),
            paddle.to_tensor([0.9947642087936401, 1.0675170421600342, 1.0760701894760132, 1.0306272506713867, 1.0341500043869019, 0.9508200883865356], dtype='float32').reshape([6]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_8f94c80c28824fb6fcd3855ef596e245(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_04275cd298b5ef067e74f4e89fd3068a
    def get_inputs(self):
        return [
            paddle.to_tensor([0.499729186296463, 0.24165822565555573, 0.31530651450157166, 0.16001065075397491], dtype='float32').reshape([4]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_48daa6a082b48512025573cc174df554(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_04275cd298b5ef067e74f4e89fd3068a
    def get_inputs(self):
        return [
            paddle.to_tensor([0.2800355553627014, 0.2540261447429657, 0.38969722390174866, 0.03992180526256561, 0.11771050095558167, 0.31348323822021484], dtype='float32').reshape([6]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_cfe71011cb5659535d7a133e43a828f7(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_8b5119acf06cbcee968b91525f140d0b
    def get_inputs(self):
        return [
            paddle.to_tensor([-0.38679391145706177, -0.30428004264831543, -0.30818819999694824, -0.5701026320457458, -0.4401547610759735, -0.11101019382476807], dtype='float32').reshape([6]),
            paddle.to_tensor([-0.251693993806839, -0.40277808904647827, -0.4020683765411377, -0.4537431299686432, -0.15418192744255066, -0.3912210762500763], dtype='float32').reshape([6]),
            paddle.to_tensor([0.6779754757881165, 1.171152949333191, 0.8302243947982788, 0.6201093792915344, 1.0340571403503418, 0.9162471294403076], dtype='float32').reshape([6]),
            paddle.to_tensor([0.9401358366012573, 0.6049466729164124, 0.887830376625061, 1.1369600296020508, 1.0391061305999756, 0.8398326635360718], dtype='float32').reshape([6]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_a5161949c8424d28928f365058428ecb(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_04275cd298b5ef067e74f4e89fd3068a
    def get_inputs(self):
        return [
            paddle.to_tensor([0.16904424130916595, 0.228418231010437, 0.3399588167667389], dtype='float32').reshape([3]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_461062b7129eea0323a42cfb17933b65(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_d3704419e29f354b37ff528a8b462211(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_afdc8de5455957fa42a399eaca9ec64b(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_b019535400f6e98e97b5359f8cb28bbb(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_f7b8bd373929cd9375d6ec461670ac4b(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_0b35e71460fe8628163fc8af64b77c84(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_e72a4cc62ddca9eca564fedf906ed42a(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_04275cd298b5ef067e74f4e89fd3068a
    def get_inputs(self):
        return [
            paddle.to_tensor([0.38247039914131165, 0.04022563248872757], dtype='float32').reshape([2]),
        ]
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_9ae5a1e84786ceeb3fc5ff3c3233b922(CinnTestBase, unittest.TestCase):
...
@unittest.skipIf(need_skip, skip_message)
class TestPrimitiveOp_98d3997c004798ab2013d259817e610d(CinnTestBase, unittest.TestCase):
