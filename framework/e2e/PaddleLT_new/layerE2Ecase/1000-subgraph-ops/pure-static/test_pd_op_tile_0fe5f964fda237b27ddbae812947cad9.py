...
class TestPrimitiveOp_78a46cf39baec8209212ba5b50dd6060(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_f479e51e9b8793bd362fed9c4e5fc834
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.30735155940055847, 0.06421853601932526, 0.45994827151298523, 0.40719467401504517]]], dtype='float32').reshape([1, 1, 4]),
...
class TestPrimitiveOp_4c59f147c800778f24e8985234a5d262(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_7c815a346e23b62531d0f253d2170410
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.4294016659259796, 0.40295201539993286, 0.05356882885098457, 0.20176848769187927]]], dtype='float32').reshape([1, 1, 4]),
