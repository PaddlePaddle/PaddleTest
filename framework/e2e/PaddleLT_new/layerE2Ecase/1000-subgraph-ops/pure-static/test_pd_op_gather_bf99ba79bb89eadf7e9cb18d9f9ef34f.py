...
class TestPrimitiveOp_eb565c1662f9703db50de605b5481c26(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_82a7fe4184affbaea1e9f7856b21dab9
    def get_inputs(self):
        return [
            paddle.to_tensor([[0.22656895220279694, 0.27223077416419983, 0.08472530543804169, 0.22870087623596191]], dtype='float32').reshape([1, 4]),
            paddle.randint(low=0, high=3, shape=[2100], dtype='int64'),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]
...
class TestPrimitiveOp_e909fc5069b7e92171684d80b2281b26(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_e56aa4115e8209b33823b841d5f1ab95
    def get_inputs(self):
        return [
            paddle.to_tensor([[0.4562217891216278, 0.49085164070129395, 0.13156092166900635, 0.3099905848503113], [0.20750105381011963, 0.41399937868118286, 0.05941487103700638, 0.2675466239452362]], dtype='float32').reshape([2, 4]),
            paddle.randint(low=0, high=3, shape=[3549], dtype='int64'),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]
...
class TestPrimitiveOp_b4bcbd76a6fe64285c09f9d88189111a(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_1c43c06fc82b3e99743b832495311eff
    def get_inputs(self):
        return [
            paddle.to_tensor([[0.27820029854774475, 0.19560417532920837, 0.32972127199172974, 0.16917066276073456]], dtype='float32').reshape([1, 4]),
            paddle.randint(low=0, high=3, shape=[4116], dtype='int64'),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]
...
class TestPrimitiveOp_a7cb130ca6e5a941087b2e44b5493002(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            paddle.to_tensor([0, 1, 0, 0, 0, 0, 2, 1, 0, 1, 2, 0, 1, 2, 0, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_5f1a8ffe3880afec3c43acc0a7a163f2(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([2, 0, 2, 0, 1, 0, 1, 2, 1, 0, 1, 1, 0, 0, 0, 1], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_eeadb213e097bc08a7432ecbf539aed4(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([2, 0, 2, 1, 2, 2, 1, 1, 1, 0, 1, 0, 0, 1, 0, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_a19b4dac371636e7ebd430caa912b4e0(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([2, 0, 0, 1, 0, 2, 1, 1, 1, 0, 2, 0, 2, 2, 1, 1], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_c7c179ddb46e2fe791ec6c2977e0a322(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([1, 0, 2, 1, 0, 2, 2, 2, 1, 0, 1, 1, 1, 2, 1, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_29d79b8d36c3211e2ff1fb13c723d764(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([1, 0, 2, 1, 2, 0, 0, 1, 0, 0, 2, 1, 1, 0, 2, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_e57253f1aecf2a264710e3f59beff816(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([0, 0, 2, 1, 1, 0, 1, 1, 0, 1, 2, 0, 2, 0, 2, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_32b79130d071be5ce760c14cefed2ef3(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([0, 2, 0, 0, 1, 2, 2, 1, 0, 0, 1, 1, 0, 1, 2, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_010f8ec903be024fae48753f5fda7206(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([2, 1, 1, 1, 2, 0, 2, 2, 2, 2, 2, 0, 1, 0, 0, 1], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_a5144e417b0fef519593554e16a60440(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([1, 2, 0, 2, 2, 2, 0, 0, 2, 1, 1, 1, 2, 0, 1, 2], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_f9f9b4533faa89350103c0d7b59af5f3(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([2, 1, 0, 0, 0, 2, 2, 1, 0, 2, 2, 0, 0, 2, 1, 1], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_2ac17f3bb12a55d804dd21565475c9aa(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([2, 2, 0, 1, 1, 1, 1, 2, 1, 2, 1, 0, 0, 1, 0, 2], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_77907a627650bf75d77afeb95ef3b172(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([1, 1, 0, 0, 0, 0, 1, 0, 2, 2, 0, 1, 1, 0, 2, 2], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_26cf86227008e916471d17d23c25562f(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([0, 1, 1, 2, 2, 2, 2, 2, 1, 1, 1, 0, 1, 2, 1, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_23714249a4d8c3f8c29d7f352fbeeb1c(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([0, 2, 2, 0, 1, 1, 0, 1, 0, 1, 1, 2, 0, 1, 1, 0], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]


class TestPrimitiveOp_69d020251739558bfee7ce312face29f(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            paddle.uniform([16, 12], dtype='float32', min=0, max=0.5),
            paddle.to_tensor([1, 1, 1, 2, 2, 1, 0, 0, 0, 1, 0, 1, 1, 1, 2, 1], dtype='int64').reshape([16]),
            paddle.to_tensor([0], dtype='int32').reshape([1]),
        ]
