...
class PrimitiveOp_e22de676c615ccb3ba0883eef51f7ce3(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_7936ac2426f4985c3529264478f60023(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_e22de676c615ccb3ba0883eef51f7ce3
    def get_inputs(self):
        return [
...
class PrimitiveOp_82fac4e046357a0d3ef88d11967c7b68(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_fcfa9593705acfa1753888594febf1aa(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_82fac4e046357a0d3ef88d11967c7b68
    def get_inputs(self):
        return [
...
class TestPrimitiveOp_a83c4041e68ae4d8798f6794640a4a40(CinnTestBase, unittest.TestCase):
...
class PrimitiveOp_1c4d292cba93ed90eaf08172e4e88239(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_5c4a849a554fa46e5e9215ca0566ed86(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_1c4d292cba93ed90eaf08172e4e88239
    def get_inputs(self):
        return [
...
class PrimitiveOp_4624b1418cc0285bbc4b2f65446c2b2a(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_aedb79d5375f05e8f3757b8565287244(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_4624b1418cc0285bbc4b2f65446c2b2a
    def get_inputs(self):
        return [
...
class PrimitiveOp_42a8c40acf0af25de018bf50d3e93349(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_9e21a7cd53fb9be9123f4b7a420b1347(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_42a8c40acf0af25de018bf50d3e93349
    def get_inputs(self):
        return [
...
class PrimitiveOp_5f5c45f4477634446616bc58908618c1(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_df6491926cf7625619351044e6200daf(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_5f5c45f4477634446616bc58908618c1
    def get_inputs(self):
        return [
...
class PrimitiveOp_447f988106987482ae4757ffb89d1205(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_0d38f99e6528a48512f9623e5c908e8a(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_447f988106987482ae4757ffb89d1205
    def get_inputs(self):
        return [
...
class PrimitiveOp_55e050ee7dd17015371e3a56b8a4ed8b(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_366d26231181d10da6ff22ae62b9b422(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_55e050ee7dd17015371e3a56b8a4ed8b
    def get_inputs(self):
        return [
...
class PrimitiveOp_26ed4e4f7938af9cc99948c311a7e2a6(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_14b0914f770b5479adf4b533f19be30f(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_26ed4e4f7938af9cc99948c311a7e2a6
    def get_inputs(self):
        return [
...
class PrimitiveOp_449d273a7a6ebc7f088c4ef257892e0b(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_81869bc0923cca5bb6b33f3a327cffa2(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_449d273a7a6ebc7f088c4ef257892e0b
    def get_inputs(self):
        return [
...
class PrimitiveOp_5c471a4138bf7a4f9a0598f36a34e859(InstanceTrait, paddle.nn.Layer):
...
class TestPrimitiveOp_185d108e4c5bdd37feb9a01fd21bdf81(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_5c471a4138bf7a4f9a0598f36a34e859
    def get_inputs(self):
        return [
