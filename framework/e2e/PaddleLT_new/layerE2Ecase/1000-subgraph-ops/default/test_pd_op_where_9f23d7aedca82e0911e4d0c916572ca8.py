...
class TestPrimitiveOp_19499a0d42319456525b1b3fdcf67389(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_968ca60b3235334744979167198f0f64
    def get_inputs(self):
        return [
            paddle.cast(paddle.randint(low=0, high=2, shape=[4850], dtype='int32'), 'bool'),
...
class TestPrimitiveOp_621120bcd4c2b990e5224f7c70cc4837(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_968ca60b3235334744979167198f0f64
    def get_inputs(self):
        return [
            paddle.cast(paddle.randint(low=0, high=2, shape=[17524], dtype='int32'), 'bool'),
