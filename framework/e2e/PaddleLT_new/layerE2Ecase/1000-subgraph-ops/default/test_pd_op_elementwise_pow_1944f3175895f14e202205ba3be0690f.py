...
class TestPrimitiveOp_e57055e93971402bdd4a0378a212fce9(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_a3def189da0b22a42ab2bcf5d4af6d23
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.6081777215003967], [0.43945714831352234], [0.5654482841491699], [0.41265368461608887], [1.009686827659607], [0.11778593808412552]]], dtype='float32').reshape([1, 6, 1]),
...
class TestPrimitiveOp_85cb6d5a6597186835f628c8c39c02ea(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_a3def189da0b22a42ab2bcf5d4af6d23
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.7257311344146729], [0.7185588479042053], [0.7840720415115356], [0.4854361414909363], [0.6494575142860413], [0.7157453894615173]]], dtype='float32').reshape([1, 6, 1]),
            paddle.to_tensor(3.0, dtype='float32').reshape([]),
        ]
