...
class TestPrimitiveOp_eb2779540e7ff19ad207e9baa7a89643(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_e9300524861fd4309823753e1c54cdce
    def get_inputs(self):
        return [
            paddle.to_tensor([[[0.44851744174957275, 0.2999412417411804, -0.04478055238723755, 0.4395248293876648]]], dtype='float32').reshape([1, 1, 4]),
...
class TestPrimitiveOp_4fccab0ec3f4cbe1fa2fb54ffd8d2df0(CinnTestBase, unittest.TestCase):
    
    def get_test_class(self):
        return PrimitiveOp_e9300524861fd4309823753e1c54cdce
    def get_inputs(self):
        return [
            paddle.to_tensor([[[-0.24580878019332886, 0.042497873306274414, 0.19359058141708374, -0.11636760830879211]]], dtype='float32').reshape([1, 1, 4]),
