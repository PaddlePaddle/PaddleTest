...
# Network
net = psci.network.FCNet(num_ins=2, num_outs=3, num_layers=2, hidden_size=2, dtype="float32", activation="tanh")

net._parameters["w_0"].set_value(paddle.to_tensor([[1, 1], [1, 1]]).astype("float32"))
net._parameters["w_1"].set_value(paddle.to_tensor([[1, 1, 1], [1, 1, 1]]).astype("float32"))
...
geo_1 = psci.geometry.Rectangular(space_origin=(-0.05, -0.05), space_extent=(0.05, 0.05))
