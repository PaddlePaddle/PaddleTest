...
@pytest.mark.jit_bitwise_xor_vartype
def test_jit_bitwise_xor_base():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.bitwise_xor(inputs, inputs_)
...
def test_jit_bitwise_xor_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.bitwise_xor
        """
        a = paddle.bitwise_xor(inputs, inputs_)
        return a
...
@pytest.mark.jit_bitwise_xor_parameters
def test_jit_bitwise_xor_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.bitwise_xor(inputs, inputs_)
