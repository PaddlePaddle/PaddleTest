...
@pytest.mark.jit_less_equal_vartype
def test_jit_less_equal_base():
    """
...
def test_jit_less_equal_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.less_equal
        """
        a = paddle.less_equal(inputs, inputs_)
        return a
...
@pytest.mark.jit_less_equal_parameters
def test_jit_less_equal_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.less_equal(inputs, inputs_)
