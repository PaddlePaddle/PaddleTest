...
@pytest.mark.jit_greater_equal_vartype
def test_jit_greater_equal_base():
    """
...
def test_jit_greater_equal_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.greater_equal
        """
        a = paddle.greater_equal(inputs, inputs_)
        return a
...
@pytest.mark.jit_greater_equal_parameters
def test_jit_greater_equal_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.greater_equal(inputs, inputs_)
