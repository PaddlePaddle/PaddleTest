...
@pytest.mark.jit_logical_not_vartype
def test_jit_logical_not_base():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.logical_not(inputs, inputs_)
...
def test_jit_logical_not_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.logical_not
        """
        a = paddle.logical_not(inputs, inputs_)
        return a
...
@pytest.mark.jit_logical_not_parameters
def test_jit_logical_not_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.logical_not(inputs, inputs_)
