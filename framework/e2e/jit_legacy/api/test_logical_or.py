...
@pytest.mark.jit_logical_or_vartype
def test_jit_logical_or_base():
    """
...
def test_jit_logical_or_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.logical_or
        """
        a = paddle.logical_or(inputs, inputs_)
        return a
...
@pytest.mark.jit_logical_or_parameters
def test_jit_logical_or_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.logical_or(inputs, inputs_)
