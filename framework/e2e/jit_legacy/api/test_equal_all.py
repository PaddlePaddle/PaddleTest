...
@pytest.mark.jit_equal_all_vartype
def test_jit_equal_all_base():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.equal_all(inputs, inputs_)
...
def test_jit_equal_all_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.equal_all
        """
        a = paddle.equal_all(inputs, inputs_)
        return a
...
@pytest.mark.jit_equal_all_parameters
def test_jit_equal_all_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.equal_all(inputs, inputs_)
