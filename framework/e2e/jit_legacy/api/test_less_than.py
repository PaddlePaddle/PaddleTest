...
@pytest.mark.jit_less_than_vartype
def test_jit_less_than_base():
    """
...
def test_jit_less_than_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.less_than
        """
        a = paddle.less_than(inputs, inputs_)
        return a
...
@pytest.mark.jit_less_than_parameters
def test_jit_less_than_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.less_than(inputs, inputs_)
