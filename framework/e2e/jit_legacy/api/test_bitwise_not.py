...
@pytest.mark.jit_bitwise_not_vartype
def test_jit_bitwise_not_base():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.bitwise_not(inputs, inputs_)
...
def test_jit_bitwise_not_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.bitwise_not
        """
        a = paddle.bitwise_not(inputs, inputs_)
        return a
...
@pytest.mark.jit_bitwise_not_parameters
def test_jit_bitwise_not_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.bitwise_not(inputs, inputs_)
