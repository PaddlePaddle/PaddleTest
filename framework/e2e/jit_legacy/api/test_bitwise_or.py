...
@pytest.mark.jit_bitwise_or_vartype
def test_jit_bitwise_or_base():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.bitwise_or(inputs, inputs_)
...
def test_jit_bitwise_or_1():
    ...
    def func(inputs, inputs_):
        ...
        paddle.bitwise_or
        """
        a = paddle.bitwise_or(inputs, inputs_)
        return a
...
@pytest.mark.jit_bitwise_or_parameters
def test_jit_bitwise_or_2():
    """
    @paddle.jit.to_static
    def fun(inputs):
        return paddle.bitwise_or(inputs, inputs_)
