...
class ApiBenchmarkCI(ApiBenchmarkBASE):
    ...
    def __init__(self, yaml_path, python):
        ...
        # 效率云环境变量
        self.AGILE_PULL_ID = os.environ.get("PR_ID", "0")
        self.AGILE_REVISION = os.environ.get("COMMIT_ID", "0")
        self.AGILE_PIPELINE_BUILD_ID = os.environ.get("RUN_ID", 0)
        ...
        self.wheel_link = (
            "https://paddle-github-action.bj.bcebos.com/PR/build/{}/{}"
