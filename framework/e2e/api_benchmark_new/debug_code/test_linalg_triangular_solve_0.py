...
"""
test linalg_triangular_solve_0
"""
import timeit
...
api = "paddle.linalg.triangular_solve"
all_data = {
    "x": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
    "y": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
}
params = {"upper": True, "transpose": False, "unitriangular": False}
