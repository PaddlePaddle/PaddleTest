...
"""
test binary_cross_entropy_with_logits_0
"""
import timeit
...
api = "paddle.nn.functional.binary_cross_entropy_with_logits"
all_data = {
    "logit": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [0, 1]},
