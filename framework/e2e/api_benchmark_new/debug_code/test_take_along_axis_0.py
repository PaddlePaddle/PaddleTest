...
api = "paddle.take_along_axis"
all_data = {
    "arr": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
    "indices": {"random": True, "type": "Tensor", "dtype": "int", "shape": [1, 1, 1, 1], "range": [0, 1]},
}
params = {"axis": 0}
