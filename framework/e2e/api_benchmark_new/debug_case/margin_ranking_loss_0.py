...
api = "paddle.nn.functional.margin_ranking_loss"
all_data = {
    "input": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "other": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "label": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
}
params = {"margin": 0.0, "reduction": "mean"}
