...
api = "paddle.nn.functional.max_unpool3d"
all_data = {
    "x": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1, 1], "range": [-1, 1]},
    "indices": {"random": False, "type": "Tensor", "dtype": "int32", "value": [[[[[0]]]]]},
}
params = {"kernel_size": 1, "stride": 1, "padding": 0}
