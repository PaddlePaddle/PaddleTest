...
api = "__floordiv__"
all_data = {
    "x": {"random": True, "type": "Tensor", "dtype": "int64", "shape": [1, 1, 1, 1], "range": [1, 10]},
    "y": {"random": True, "type": "Tensor", "dtype": "int64", "shape": [1, 1, 1, 1], "range": [1, 10]},
}
params = {}
...
for i in range(loops):
    forward_time = timeit.timeit(lambda: func_x_y(inputs["x"], inputs["y"]), number=1000)
