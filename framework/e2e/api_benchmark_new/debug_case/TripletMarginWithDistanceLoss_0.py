...
"""
test TripletMarginWithDistanceLoss_0
"""
import timeit
...
api = "paddle.nn.TripletMarginWithDistanceLoss"
all_data = {
    "input": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "positive": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "negative": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
}
params = {"margin": 1.0, "reduction": "mean"}
