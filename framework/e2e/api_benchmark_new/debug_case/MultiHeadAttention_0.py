...
all_data = {
    "data0": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [-1, 1]},
    "data1": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [-1, 1]},
    "data2": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [-1, 1]},
}
params = {"embed_dim": 1, "num_heads": 1, "dropout": 0.0}
