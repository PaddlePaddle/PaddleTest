...
api = "paddle.linalg.lu_unpack"
all_data = {
    "x": {"random": False, "type": "Tensor", "dtype": "float32", "value": [[1.0, 3.0], [3.0, 2.0], [5.0, 6.0]]},
    "y": {"random": False, "type": "Tensor", "dtype": "int32", "value": [[3, 3]]},
}
params = {"unpack_ludata": True, "unpack_pivots": True}
