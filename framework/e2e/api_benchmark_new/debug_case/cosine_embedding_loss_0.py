...
api = "paddle.nn.functional.cosine_embedding_loss"
all_data = {
    "input1": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "input2": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "label": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1], "range": [-1, 1]},
}
params = {"margin": 0, "reduction": "mean"}
