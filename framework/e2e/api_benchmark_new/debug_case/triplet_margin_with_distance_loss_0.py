...
"""
test triplet_margin_with_distance_loss_0
"""
import timeit
...
api = "paddle.nn.functional.triplet_margin_with_distance_loss"
all_data = {
    "input": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
    "positive": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
    "negative": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
}
