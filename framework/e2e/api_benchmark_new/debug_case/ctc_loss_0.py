...
api = "paddle.nn.functional.ctc_loss"
all_data = {
    "log_probs": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [-1, 1]},
    "labels": {"random": True, "type": "Tensor", "dtype": "int32", "shape": [1, 1], "range": [-1, 1]},
    "input_lengths": {"random": False, "type": "Tensor", "dtype": "int64", "value": [1]},
    "label_lengths": {"random": False, "type": "Tensor", "dtype": "int64", "value": [1]},
}
params = {"blank": 0, "reduction": "mean"}
