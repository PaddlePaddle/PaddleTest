...
api = "paddle.nn.InstanceNorm3D"
all_data = {"data": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [2, 2, 2, 2, 2], "range": [-1, 1]}}
params = {"num_features": 2, "epsilon": 1e-05, "momentum": 0.9, "data_format": "NCL"}
