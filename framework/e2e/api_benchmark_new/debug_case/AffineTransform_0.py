...
api = "paddle.distribution.AffineTransform"
all_data = {}
params = {
    "loc": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
    "scale": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
}
