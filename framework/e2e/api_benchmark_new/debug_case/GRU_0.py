...
api = "paddle.nn.GRU"
all_data = {
    "inputs": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [-1, 1]},
    "initial_states": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1], "range": [-1, 1]},
}
params = {"input_size": 1, "hidden_size": 1}
