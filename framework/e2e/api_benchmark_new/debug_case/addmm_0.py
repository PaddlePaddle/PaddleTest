...
api = "paddle.addmm"
all_data = {
    "input": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-10, 10]},
    "x": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-10, 10]},
    "y": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [-10, 10]},
}
params = {"alpha": 5.0, "beta": 0.5}
