...
all_data = {
    ...
    "mask": {"random": True, "type": "Tensor", "dtype": "bool", "shape": [1, 1, 1, 1]},
}
params = {}

inputs = {
    "x": paddle.to_tensor(_randtool(dtype="float32", low=-1, high=1, shape=[1, 1, 1, 1])),
    "mask": paddle.to_tensor(_randtool(dtype="bool", low=-1, high=1, shape=[1, 1, 1, 1])),
}
