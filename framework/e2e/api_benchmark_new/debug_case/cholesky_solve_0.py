...
api = "paddle.linalg.cholesky_solve"
all_data = {
    "x": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [0, 10]},
    "y": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [0, 10]},
}
params = {}
