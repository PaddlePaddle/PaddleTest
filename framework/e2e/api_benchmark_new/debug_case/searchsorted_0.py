...
api = "paddle.searchsorted"
all_data = {
    "sorted_sequence": {"random": False, "type": "Tensor", "dtype": "float32", "value": [1.0, 2.0, 3.0]},
    "values": {"random": False, "type": "Tensor", "dtype": "float32", "value": [1.0, 2.0, 3.0]},
}
params = {"out_int32": False, "right": False}
