...
api = "paddle.nn.MarginRankingLoss"
all_data = {
    "input": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1], "range": [0, 1]},
    "other": {"random": False, "type": "Tensor", "dtype": "float32", "value": [[1]]},
    "label": {"random": False, "type": "Tensor", "dtype": "float32", "value": [[1]]},
}
