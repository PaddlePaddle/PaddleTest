...
api = "paddle.nn.functional.affine_grid"
all_data = {"theta": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 2, 3], "range": [-1, 1]}}
params = {"out_shape": [1, 1, 1, 1], "align_corners": True}
