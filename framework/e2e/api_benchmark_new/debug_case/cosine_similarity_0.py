...
api = "paddle.nn.functional.cosine_similarity"
all_data = {
    "x1": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
    "x2": {"random": True, "type": "Tensor", "dtype": "float32", "shape": [1, 1, 1, 1], "range": [-1, 1]},
}
params = {"axis": 1, "eps": 1e-08}
