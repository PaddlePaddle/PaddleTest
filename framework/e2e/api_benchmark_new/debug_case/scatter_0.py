...
api = "paddle.scatter"
all_data = {
    "x": {"random": False, "type": "Tensor", "dtype": "float32", "value": [[1, 1], [2, 2], [3, 3]]},
    "index": {"random": False, "type": "Tensor", "dtype": "int64", "value": [2, 1, 0, 1]},
    "updates": {"random": False, "type": "Tensor", "dtype": "float32", "value": [[1, 1], [2, 2], [3, 3], [4, 4]]},
}
params = {}
