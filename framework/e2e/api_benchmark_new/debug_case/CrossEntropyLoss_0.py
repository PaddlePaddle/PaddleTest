...
api = "paddle.nn.CrossEntropyLoss"
all_data = {
    "input": {"random": True, "dtype": "float32", "shape": [1, 1], "range": [-1, 1]},
    "label": {"random": False, "dtype": "float32", "value": [[0.0]]},
}
params = {"soft_label": True, "weight": None, "ignore_index": -100, "reduction": "mean"}
