...
class TestFunctionalAdaptiveMaxPool2D(APIBase):
    """
    test
    """
...
obj = TestFunctionalAdaptiveMaxPool2D(paddle.nn.functional.adaptive_max_pool2d)


@pytest.mark.api_nn_func_AdaptiveAvgPool2D_vartype
def test_func_adaptive_max_pool2D_base():
    """
    base
    """
...
@pytest.mark.api_nn_func_AdaptiveAvgPool2D_parameters
def test_func_adaptive_max_pool2D1():
    """
    default
    """
...
@pytest.mark.api_nn_func_AdaptiveAvgPool2D_parameters
def test_func_adaptive_max_pool2D2():
    """
    ...
    obj.static = False
    obj.base(res=res, x=x, output_size=output_size, return_mask=True)
    obj.static = True
