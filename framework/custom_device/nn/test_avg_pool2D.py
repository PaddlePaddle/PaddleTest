...
@pytest.mark.api_nn_AvgPool2D_vartype
...
@pytest.mark.api_nn_AvgPool2D_parameters
def test_avg_pool2D():
    """
    default
    """
...
def test_avg_pool2D1():
    ...
    obj.run(
        res=res, data=x, kernel_size=kernel_size, stride=strides, padding=padding, ceil_mode=ceil_mode, exclusive=False
    )
