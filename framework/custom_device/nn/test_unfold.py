...
obj = TestUnfold(paddle.nn.Unfold)
...
def test_unfold_base():
    ...
    res = im2col(x, 3, 3)
    obj.base(res=res, data=x, kernel_sizes=3)
...
def test_unfold0():
    ...
    x = np.random.rand(2, 3, 10, 10)
    res = im2col(x, 3, 3)
    obj.run(res=res, data=x, kernel_sizes=[3, 3])
...
def test_unfold1():
    ...
    obj.run(res=res, data=x, kernel_sizes=[3, 3], paddings=1)
...
def test_unfold2():
    ...
    obj.run(res=res, data=x, kernel_sizes=[2, 4], paddings=1)
...
def test_unfold3():
    ...
    obj.run(res=res, data=x, kernel_sizes=[2, 4], paddings=1, strides=2)
