...
obj = TestMaxPool2d(paddle.nn.layer.MaxPool2D)
...
@pytest.mark.api_nn_MaxPool2D_vartype
...
@pytest.mark.api_nn_MaxPool2D_parameters
def test_max_pool2d():
    """
    default
    """
...
def test_max_pool2d2():
    ...
    # return_indices = True
    res = max_pool2D_forward_naive(x=x, ksize=kernel_size, strides=strides, paddings=padding)
    obj.run(res=res, data=x, kernel_size=kernel_size, stride=strides)
...
def test_max_pool2d3():
    ...
    # return_indices = True
    res = max_pool2D_forward_naive(x=x, ksize=kernel_size, strides=strides, paddings=padding)
    obj.run(res=res, data=x, kernel_size=kernel_size, padding=padding, stride=strides)
