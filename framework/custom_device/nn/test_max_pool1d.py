...
obj = TestMaxpool1d(paddle.nn.layer.MaxPool1D)
...
@pytest.mark.api_nn_MaxPool1D_vartype
...
@pytest.mark.api_nn_MaxPool1D_parameters
def test_max_pool1d():
    """
    default
    """
...
def test_max_pool1d4():
    ...
    """
    obj1 = TestMaxpool1d(paddle.nn.layer.MaxPool1D)
    obj1.static = False
    np.random.seed(22)
    ...
    obj1.run(res=res, data=x, kernel_size=kernel_size, stride=stride, padding=padding, return_mask=True)
