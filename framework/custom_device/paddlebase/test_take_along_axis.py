...
class TakeAlongAxis(object):
    """
    calculate put_along_axis api
    """

    def __init__(self, indices, axis, types):
        """
        init
        """
    ...
    def cal_dynamic(self, device, dtype):
        ...
        return paddle.take_along_axis(arr, indices, self.axis)
    ...
    def cal_static(self, device):
        ...
        with paddle.utils.unique_name.guard():
            with paddle.static.program_guard(main_program=main_program, startup_program=startup_program):
                ...
                feed = {"s0": self.arr, "s1": self.indices}
                out = paddle.take_along_axis(data0, indices=data1, axis=self.axis)
...
@pytest.mark.api_base_take_along_axis_vartype
def test_take_along_axis_base():
    """
    base
    """
    ...
    axis = 0
    res = data[0]
    obj = TakeAlongAxis(ind, axis, types)
    r = obj.run(data)
    assert np.allclose(r, res)


@pytest.mark.api_base_take_along_axis_parameters
def test_take_along_axis0():
    """
    arr: 2d-tensor
    """
